...
## Cel dokumentu
Krótka definicja: Payment Security (PCI DSS) opisuje cel, rolę w procesie decyzyjnym oraz ryzyka, które dokument ma ograniczać (co najmniej w 2–3 zdaniach).
...
- Zakres CDE: strefy sieciowe, dane PAN/SAD, aplikacje płatnicze, kanały (e‑com, POS, m‑commerce).
- Kontrolki PCI DSS v4: wymagania 1–12 → status → dowód → owner → data.
- Tokenizacja/szyfrowanie: algorytmy, klucze/KMS/HSM, rotacja, storage PAN, maskowanie.
- Dostęp/logi: IAM, MFA, least privilege, SIEM, retencja logów, monitorowanie.
- Podatności i testy: ASV, pentesty (app/net), patching, wyjątki i CAPA.
- Third parties: dostawcy płatności, AOC/SAQ, due diligence, umowy.
- Raportowanie i certyfikacja: AOC/ROC/SAQ, harmonogram, compensating controls, waivery.

## Wymagane rozwinięcia
- Kontrolki rozwijają: Network Segmentation, Key Management, Vulnerability/Patch Management, Logging/Monitoring.
- Third parties rozwijają: Vendor Management, Due Diligence.
- Raportowanie rozwija: ASV/Pentest Reports, Change Management dla remediacji.

## Wymagane streszczenia
- Streszczenie statusu zgodności (1–12), kluczowych ryzyk i planów remediacji.
...
- DoR:
  - [ ] Zakres CDE i typ SAQ/AOC określone; segmentacja znana.
  - [ ] Dane o tokenizacji/szyfrowaniu, logach, skanach ASV dostępne.
  - [ ] Właściciele kontrolek i vendorzy płatności wskazani.
- DoD:
  - [ ] Wymagania 1–12 mają status, dowody, ownerów; wyjątki/compensating controls opisane.
  - [ ] ASV/pentest/remediacje ujęte; third parties i ich AOC/SAQ włączone.
  - [ ] AOC/ROC/SAQ gotowe; dokument wersjonowany i udostępniony.
