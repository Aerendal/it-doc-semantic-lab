...
Zdefiniować poziomy klasyfikacji danych i zasady ich stosowania, aby dopasować zabezpieczenia do wrażliwości informacji.
...
1. Poziomy klasyfikacji (np. Public, Internal, Confidential, Restricted) z definicjami i przykładami.
2. Zasady nadawania klasy (kto, kiedy, kryteria).
3. Wymagania bezpieczeństwa per poziom (szyfrowanie, dostęp, przechowywanie, transfer).
4. Etykietowanie i oznaczanie (metadata, tagi, watermarks).
5. Zmiana klasy i recertyfikacja.
6. Szkolenia i zgodność (audyt).
...
- [ ] Poziomy i przykłady zdefiniowane.
- [ ] Wymagania per poziom opisane.
- [ ] Etykietowanie i proces zmiany klasy działa.
- [ ] Audyt/szkolenia zaplanowane.
