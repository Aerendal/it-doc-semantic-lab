---
title: Experience Design Document
...
## Cel dokumentu
Experience Design Document opisuje docelową architekturę/projekt wraz z trade-offami i kryteriami akceptacji.
...
## Szybkie powiązania
- Zależność: {'depends_on': 'Experience Requirements', 'type': 'sequential'}
- Zależność: {'depends_on': 'Experience Requirements', 'type': 'sequential'}
