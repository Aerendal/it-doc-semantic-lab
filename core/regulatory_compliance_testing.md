...
Plan i wyniki testów na zgodność z regulacjami.
...
1. Wymagania testowane i referencje.
2. Metody i laboratoria: zakres, normy.
3. Środowisko: sprzęt, konfiguracja, dane.
4. Wyniki: pass/fail, pomiary.
5. Nie zgodności i działania.
...
- [ ] Testy pokrywają wymagania.
- [ ] Środowisko i metody opisane.
- [ ] Wyniki i niezgodności udokumentowane.
- [ ] Raport zarchiwizowany z dowodami.
