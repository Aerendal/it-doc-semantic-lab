---
title: Referencja architektury omnichannel
...
aligned_by: codex
---
# Referencja architektury omnichannel
...
Referencyjna architektura doświadczeń omnichannel.
...
1. Kanały i orkiestracja: web/app/store/call, CDP.
2. Warstwa danych: identyfikacja użytkownika, profile, consent.
3. Zamówienia i płatności: OMS, PSP, fraud.
4. Zasoby i stock: inventory realtime, rezerwacje, BOPIS.
5. Personalizacja i marketing: CMS, recommendation, journey.
6. Obserwowalność i SLA: monitoring, SLO, alerty.
...
- [ ] Kanały i przepływy cross-channel opisane.
- [ ] Dane użytkownika/consent i stock uwzględnione.
- [ ] Bezpieczeństwo i płatności ujęte.
- [ ] SLA/SLO i monitoring wskazane.
