...
Wytyczne bezpieczeństwa danych satelitarnych/space.
...
1. Źródła danych: satelity, stacje naziemne, łącza.
2. Klasyfikacja i regulacje (ITAR/ESA).
3. Szyfrowanie i łączność: link, at-rest.
4. Dostęp i IAM: role, segmentacja.
5. Łańcuch przetwarzania: integritet, audyt.
6. BCP/DR i retencja.
...
- [ ] Klasyfikacja/regulacje uwzględnione.
- [ ] Szyfrowanie link/at-rest opisane.
- [ ] IAM/segmentacja wdrożone.
- [ ] Audyt/retencja/DR zaplanowane.
