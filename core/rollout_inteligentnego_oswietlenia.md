---
title: Rollout inteligentnego oświetlenia
...
aligned_by: codex
---
# Rollout inteligentnego oświetlenia
...
1. Zakres: lokalizacje, typy opraw.
2. Technologia: sterowniki, sieć, sensory.
3. Instalacja: harmonogram, ekipy, bezpieczeństwo.
4. Konfiguracja i sceny: profile, automaty.
5. Testy i odbiory.
6. Utrzymanie: serwis, aktualizacje, SLA.
...
- [ ] Lokalizacje/oprawy zinwentaryzowane.
- [ ] Sieć/sterowniki zaplanowane.
- [ ] Testy/odbiór i SLA zdefiniowane.
- [ ] Utrzymanie i serwis opisane.
