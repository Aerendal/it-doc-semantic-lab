...
Przeprowadzić wdrożenie systemu MES na liniach produkcyjnych: konfiguracja, integracje, szkolenia i start produkcyjny.
...
1. Zakres linii/obszarów i modułów MES; priorytety rollout.
2. Integracje OT/IT: SCADA/PLC, ERP, QMS, WMS; mapowanie danych.
3. Konfiguracja: modele produkcyjne, receptury, kolejkowanie zleceń, raportowanie.
4. Testy: FAT/SAT, UAT na linii pilotażowej, walidacja danych.
5. Cutover i wsparcie startu: plan okien, role zespołów, procedury awaryjne.
6. Szkolenia operatorów i utrzymanie: instrukcje stanowiskowe, helpdesk.
...
- [ ] Linie i moduły MES z priorytetami rollout opisane.
- [ ] Integracje OT/IT zmapowane i przetestowane.
- [ ] Testy FAT/SAT/UAT z wynikami udokumentowane.
- [ ] Plan cutover/rollback oraz szkolenia operatorów gotowe.
