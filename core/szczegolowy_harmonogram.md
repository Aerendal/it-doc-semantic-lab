...
1. Zakres i kamienie milowe.
2. Zadania, zależności, ścieżka krytyczna.
3. Zasoby i obciążenie.
4. Ryzyka harmonogramowe.
5. Bufory i rezerwy.
6. Plan aktualizacji i raportowania.
...
- [ ] Kamienie i zadania z zależnościami spisane.
- [ ] Zasoby przypisane.
- [ ] Ryzyka/bufory określone.
- [ ] Plan aktualizacji istnieje.
