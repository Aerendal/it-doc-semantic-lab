---
title: PrzeglÄ…d zgÅ‚oszeÅ„ regulacyjnych
...
aligned_by: codex
---
# PrzeglÄ…d zgÅ‚oszeÅ„ regulacyjnych
...
Przegląd zgłoszeń regulacyjnych — szablon dokumentu IT.

Dokumentuje wyniki audytu lub przeglądu — zakres, metody, dowody, odchylenia od wymagań (nonconformities) i rekomendacje naprawcze (CAPA). Każde odchylenie powinno mieć właściciela, termin i plan korekcyjny.
...
- **Wejścia** (co musi być dostępne przed wypełnieniem): Plan audytu, wymagania standardu (ISO 27001, GDPR, NIS2), polityki i procedury wewnętrzne, wyniki poprzednich audytów, dowody.
- **Wyjścia** (co dokument wytwarza jako rezultat): Raport z audytu, lista odchyleń z klasyfikacją (major/minor), plan CAPA z terminami, certyfikat lub potwierdzenie zgodności.
...
- **Wpływa na** (downstream — co zależy od tego dokumentu): Plan CAPA (Corrective and Preventive Actions), aktualizacje polityk i procedur, rejestr ryzyk, raport dla zarządu.
- **Zależy od** (upstream — co musi istnieć przed tym dokumentem): Polityki i procedury wewnętrzne, wymagania standardu, poprzednie raporty audytów i statusy CAPA.
