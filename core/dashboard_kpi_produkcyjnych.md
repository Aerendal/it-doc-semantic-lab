---
title: Dashboard KPI produkcyjnych
...
Zaprojektować dashboard kluczowych metryk produkcyjnych (OEE, throughput, scrap, downtime) dla zakładu/linii.
...
1. Zakres (linie, zmiany, okres).
2. KPI i definicje: OEE, Availability, Performance, Quality, scrap, downtime, MTBF/MTTR.
3. Źródła danych (SCADA/MES/ERP, sensordane) i jakość.
4. Segmentacja i wymiary (linia, zmiana, produkt, operator).
5. Alerty i progi (downtime, scrap spike).
6. UX dashboardu (widoki exec vs operacyjne, drill-down).
...
- [ ] KPI zdefiniowane i spójne z MES/ERP.
- [ ] Dane i segmentacja poprawne.
- [ ] Alerty/progi ustawione.
- [ ] Widoki exec/operacyjne gotowe.
