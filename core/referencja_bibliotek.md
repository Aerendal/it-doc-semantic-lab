...
Katalog najważniejszych bibliotek i ich użycia.
...
1. Zakres: języki, frameworki, wersje.
2. Opis: cel biblioteki, key API, przykłady.
3. Zależności i kompatybilność: wersje, licencje.
4. Bezpieczeństwo: CVE, update policy.
5. Guidelines użycia: do/don’t, wzorce.
6. Właściciel i utrzymanie: kto aktualizuje, gdzie zgłaszać.
...
- [ ] Biblioteki mają opis i wersje.
- [ ] Licencje/CVE uwzględnione.
- [ ] Guidelines i przykłady dostępne.
- [ ] Właściciel utrzymania wskazany.
