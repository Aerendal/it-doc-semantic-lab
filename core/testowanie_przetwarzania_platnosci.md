---
title: Testowanie przetwarzania płatności
...
aligned_by: codex
---
# Testowanie przetwarzania płatności
...
1. Metody i PSP.
2. Autoryzacje, capture, refund, chargeback.
3. Fraud/3DS.
4. Waluty/podatki.
5. Failover i retry.
6. Raport/zgodność (PCI).
...
- [ ] Scenariusze płatności pokryte.
- [ ] Fraud/3DS i retry przetestowane.
- [ ] Waluty/podatki uwzględnione.
- [ ] Raport/PCI zgodność opisana.
