...
Procedura IR dla nieautoryzowanego dostępu.
...
1. Detekcja i klasyfikacja.
2. Izolacja i zabezpieczenie dowodów.
3. Analiza i zasięg.
4. Remediacja i rotacja kluczy.
5. Komunikacja: regulator, użytkownicy.
6. Postmortem i poprawki.
...
- [ ] Severity ustalone; dowody zabezpieczone.
- [ ] Remediacja/rotacja wykonane.
- [ ] Komunikacja zgodnie z polityką.
- [ ] Postmortem/lekcje zapisane.
