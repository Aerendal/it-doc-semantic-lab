...
Katalog źródeł danych używanych w organizacji: lokalizacja, właściciele, schemat, jakość, zasady dostępu.
...
1. Spis źródeł (system, opis, właściciel, kontakt).
2. Schemat/metadane (link do katalogu, format, częstotliwość aktualizacji).
3. Klasyfikacja i PII, poziom dostępu.
4. Jakość i SLA (freshness, completeness), testy DQ.
5. Integracje/linie rodowodowe (lineage) i konsumpcja (pipelines/BI).
6. Procedura dodawania/aktualizacji wpisu.
...
- [ ] Wpisy mają ownera, schemat i klasę dostępu.
- [ ] SLA/freshness i testy DQ opisane.
- [ ] PII/klasyfikacja oznaczone.
- [ ] Lineage i konsumpcja udokumentowane.
