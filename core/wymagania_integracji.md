...
Ogólne wymagania integracji systemów.
...
1. Zakres i kontrakty API.
2. Bezpieczeństwo i auth.
3. Idempotencja i retry.
4. Monitoring i SLA.
5. Dane i mapowanie.
...
- [ ] Kontrakty/bezpieczeństwo opisane.
- [ ] Idempotencja/monitoring ujęte.
- [ ] Mapowanie danych zdefiniowane.
