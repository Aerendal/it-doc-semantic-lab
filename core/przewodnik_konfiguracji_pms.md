---
title: Przewodnik konfiguracji PMS
...
Ustawić Property/Production/Project Management System zgodnie z wymaganiami.
...
1. Parametry podstawowe: obiekty/zasoby, kalendarze, strefy czasowe.
2. Cenniki i podatki: taryfy, opłaty, podatki lokalne, waluty.
3. Rezerwacje i kanały: źródła rezerwacji, allotmenty, overbooking rules.
4. Uprawnienia: role front office/back office, audyt działań.
5. Integracje: płatności, POS, housekeeping/maintenance, CRM.
6. Raporty i rozliczenia: dobowy raport, settlement, eksporty finansowe.
...
- [ ] Parametry obiektów i kalendarzy poprawne; cenniki zweryfikowane.
- [ ] Kanały i overbooking skonfigurowane; płatności działają.
- [ ] Role/uprawnienia i audyt aktywne.
- [ ] Raporty i eksporty finansowe generują poprawne dane.
