...
Zdefiniować zasady bezpieczeństwa danych (klasyfikacja, szyfrowanie, dostępy, backup/DR) dla systemu/API.


## Zakres i granice

- Obejmuje: klasyfikację danych, szyfrowanie at-rest/in-transit, IAM, DLP, backup/DR, logowanie/audyt.
- Poza zakresem: szczegółowa konfiguracja storage/DB.
...
- Zasady data security
- Checklisty DoR/DoD
- Powiązania do backup/DR/logowania
- Plan przeglądów
...
- [ ] backup_and_recovery_strategy.md
