---
title: Przegląd wydajności modeli
...
Ocenić wydajność i zdrowie modeli ML/AI w produkcji.
...
1. Metryki offline i online: accuracy/precision/recall, latency, koszt inferencji.
2. Drift i stabilność: monitoring danych, concept drift, alerty.
3. Bezpieczeństwo modeli: prompt injection, adversarial, PII leakage.
4. Zależności: featury, wersje modeli, pipeline treningowy/deployment.
5. Eksperymenty: A/B, shadow mode, canary; wyniki i decyzje.
6. Compliance i etyka: bias, fairness, explainability, audyt.
...
- [ ] Model ma aktualne metryki offline/online i progi alertów.
- [ ] Drift jest monitorowany; istnieje plan retrainingu/roll-back.
- [ ] Ryzyka bezpieczeństwa i PII są ocenione; logi audytowe są prowadzone.
- [ ] Eksperymenty mają wyniki i decyzje; modele są wersjonowane.
