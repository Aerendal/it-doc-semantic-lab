---
title: Referencja korekcji błędów
...
Opis technik korekcji błędów w transmisji i danych.
...
1. Standardy: FEC (Reed-Solomon, LDPC), ARQ, hybrydowe.
2. Zastosowania: sieci, storage, multimedia.
3. Parametry: opóźnienie, overhead, BER.
4. Implementacja: kodeki, biblioteki, HW vs SW.
5. Testy: kanały, symulacje, metryki.
6. Dobór: jak wybierać schemat pod use case.
...
- [ ] Schematy i parametry opisane.
- [ ] Dobór schematu uzasadniony dla use case.
- [ ] Testy i metryki zdefiniowane.
- [ ] Biblioteki/implementacje wskazane.
