...
Opisać pipeline DQ (reguły, walidacje, alerty) w przepływie danych.


## Zakres i granice

- Obejmuje: walidacje schematu/zakresów/unikalności, anomaly detection, enrichment, alerty, logowanie, retry.
- Poza zakresem: logika biznesowa analityki.
...
- Schemat/kontrakty danych
- Reguły DQ
- Architektura pipeline
- Narzędzia DQ/monitoringu


## Wyjścia

- Spec pipeline DQ
- Lista reguł i etapów
- Alerty i logi
- Powiązania do testów/monitoringu
