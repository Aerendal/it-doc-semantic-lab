...
Service Degradation Response — szablon dokumentu IT.

Definiuje usługę IT lub biznesową — cel, zakres, SLA, właściciela, klientów i procesy wsparcia. Stanowi wejście do Service Catalogue i podstawę dla SLA/OLA.

> Dokument satelitarny do: "Model Degradation Response" - rozszerza lub uszczegolawia jego tresc.
