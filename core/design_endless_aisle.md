...
Zaprojektować doświadczenie „endless aisle” w retail: sprzedaż produktów spoza fizycznego stanu sklepu, z dostawą lub pickupem.
...
1. Katalog i dostępność: połączenie stock store/warehouse/marketplace, real-time checks.
2. UX w sklepie: kiosk/tablet/sprzedawca, wyszukiwanie, konfiguracja, płatność.
3. Fulfillment: ship-to-home, ship-to-store, pickup; lead times, koszt.
4. Ceny/promocje: spójność kanałów, podatki/opłaty.
5. Zwroty/wymiany i obsługa klienta.
6. Integracje: POS/OMS/Inventory/PIM/payments.
7. Observability: konwersje, cancel/returns, stock accuracy.
...
- [ ] Real-time dostępność i ceny spójne.
- [ ] Flow kiosk/tablet i płatność przetestowane.
- [ ] Fulfillment options i lead times jasne.
- [ ] Zwroty/wymiany obsłużone.
