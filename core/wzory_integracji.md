...
Wzory implementacji integracji.
...
1. Patterny sync/async/event.
2. Idempotencja i retry.
3. Mapowanie i transformacje.
4. Bezpieczeństwo.
5. Monitorowanie.
6. Przykłady.
...
- [ ] Patterny i bezpieczeństwo opisane.
- [ ] Idempotencja/monitoring ujęte.
- [ ] Przykłady dodane.
- [ ] Transformacje zdefiniowane.
