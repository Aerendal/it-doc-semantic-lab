---
title: Runbook rozwiązywania zgłoszeń
...
aligned_by: codex
---
# Runbook rozwiązywania zgłoszeń
...
Krok po kroku obsługa i zamykanie zgłoszeń.
...
1. Przyjęcie: dane wymagane, kategoryzacja, SLA.
2. Diagnoza: repro, logi, wpływ, priorytet.
3. Działanie: fix/workaround, eskalacja, komunikacja.
4. Weryfikacja: potwierdzenie z klientem, testy.
5. Zamknięcie: dokumentacja, knowledge base, tagi.
6. Raportowanie: SLA, backlog, trend.
...
- [ ] SLA/priorytet nadany; dane zgłoszenia kompletne.
- [ ] Diagnoza i działania udokumentowane.
- [ ] Klient potwierdził rozwiązanie.
- [ ] Zgłoszenie ztagowane i zamknięte; wnioski dodane do KB.
