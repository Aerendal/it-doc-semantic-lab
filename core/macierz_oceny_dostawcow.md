...
Przygotować kryteria i scoring dostawców (sprzęt/usługi/soft) dla porównań i wyboru.
...
1. Kategorie oceny: cena/TCO, jakość/usługi, SLA, bezpieczeństwo/compliance, innowacyjność, referencje.
2. Wagi i scoring: skala, wagi per kategoria, próg akceptacji.
3. Dane wejściowe: RFP/RFQ odpowiedzi, POC/pilotaż wyniki, audyty, referencje klientów.
4. Wyniki: tabela dostawcy × kategorie × punkty, rankingi.
5. Ryzyka i lock-in: umowy, kary, migracja, wsparcie, roadmap.
6. Decyzja i rekomendacja: uzasadnienie, warunki negocjacji, następne kroki.
...
- [ ] Kategorie i wagi ustalone; kryteria punktacji opisane.
- [ ] Dane wejściowe (RFP/POC) zebrane i udokumentowane.
- [ ] Wyniki i ranking obliczone transparentnie.
- [ ] Ryzyka i rekomendacja końcowa spisane.
