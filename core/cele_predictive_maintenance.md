---
title: Cele predictive maintenance
...
Ustalić cele i KPI dla programów predictive maintenance: redukcja przestojów, kosztów serwisu i poprawa dostępności sprzętu.


## Zakres i granice

- Obejmuje: metryki (downtime, lead time alertów, precision/recall alertów, MTBF/MTTR), pokrycie assetów, progi alertów, SLA reakcji, zwrot z inwestycji.
- Nie obejmuje: szczegółów modeli predykcyjnych (osobny dokument) ani planu CAPEX.
...
1. KPI i targety (downtime↓, MTBF↑, MTTR↓, FP/FN alertów).
2. Zakres assetów i krytyczność.
3. Progi/alerty i SLA reakcji.
4. Proces reakcji (runbooki, eskalacje).
5. Ekonomika (oszczędność vs koszt wdrożenia).
...
- [ ] KPI/targety i assety zdefiniowane.
- [ ] Progi alertów i SLA reakcji opisane.
- [ ] Proces reakcji/runbooki gotowe.
- [ ] Ekonomika ROI monitorowana.
