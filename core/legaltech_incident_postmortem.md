---
title: LegalTech Incident Postmortem
...
## Cel dokumentu
Przeanalizować incydent w obszarze legaltech (np. dokumenty prawne, workflow podpisów, zarządzanie uprawnieniami), określić przyczyny i przywrócić zgodność oraz dostępność usług.

## Zakres i granice
Obejmuje: timeline, wpływ na dane wrażliwe/prawne, uprawnienia i audyt, integracje z usługami podpisu/archiwum, CAPA i aktualizację kontroli. Nie obejmuje: projektowania procesów prawnych (osobne dokumenty).

## Wejścia i wyjścia
- Wejścia: logi aplikacji i audytu, status podpisów/wersji dokumentów, raport IR, polityki dostępu, wymagania compliance.
- Wyjścia: postmortem legaltech, CAPA (uprawnienia, audyt, integracje, szyfrowanie), aktualizacje runbooków i kontroli dostępu, plan komunikacji z klientami/regulatorami (jeśli dotyczy).
...
- Streszczenie i wpływ (dane prawne, SLA, klienci)
- Timeline faktów i decyzji
- Root cause + contributory (uprawnienia, integracje podpisu, audyt, szyfrowanie)
- Wpływ na zgodność prawną/umowy
- CAPA: access control, audyt, integracje, szyfrowanie/archiwizacja
- Komunikacja do klientów/regulatorów (jeśli wymagane)
