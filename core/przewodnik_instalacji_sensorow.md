---
title: Przewodnik instalacji sensorów
...
aligned_by: codex
---
# Przewodnik instalacji sensorów
...
Opisać standard instalacji i kalibracji sensorów.
...
1. Planowanie: typ sensora, lokalizacja, zasilanie, łączność, środowisko.
2. Montaż: mocowanie, kierunek, uszczelnienie, bezpieczeństwo elektryczne.
3. Kalibracja: procedura, wzorce, częstotliwość, dokumentacja.
4. Łączność i dane: parowanie, adresacja, testy sygnału, firmware.
5. Bezpieczeństwo: autoryzacja urządzeń, klucze/certy, fizyczne zabezpieczenia.
6. Odbiór: protokół instalacji, zdjęcia, checklisty jakości.
...
- [ ] Sensor zamontowany zgodnie z planem i specyfikacją.
- [ ] Kalibracja wykonana i zapisana; parametry w normie.
- [ ] Łączność zweryfikowana; firmware aktualny.
- [ ] Dokumentacja instalacji i bezpieczeństwa kompletnie wypełniona.
