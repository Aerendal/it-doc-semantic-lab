...
Monitorować i raportować jakość danych.
...
1. Zakres danych: domeny, tabele, pola krytyczne.
2. Wymiary jakości: kompletność, spójność, unikalność, aktualność, poprawność.
3. Reguły i wyniki: liczba naruszeń, trend, próg akceptacji.
4. Źródła problemów: procesy, integracje, manualne błędy.
5. Działania naprawcze: właściciele, terminy, skuteczność.
6. Metryki biznesowe wpływu: opóźnienia, błędy, utracone przychody.
...
- [ ] Definicje i reguły jakości są jasne; wyniki mierzone.
- [ ] Naruszenia mają priorytety i właścicieli.
- [ ] Trend jakości pokazywany; skuteczność działań oceniona.
- [ ] Raport zawiera wpływ biznesowy i plan.
