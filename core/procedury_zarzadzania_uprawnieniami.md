---
title: Procedury zarządzania uprawnieniami
...
Standaryzować nadawanie, zmiany i odbieranie uprawnień z zasadą najmniejszych uprawnień.
...
1. Model uprawnień: RBAC/ABAC, katalog ról, separacja obowiązków (SoD).
2. Proces JML (joiner/mover/leaver): wnioski, zatwierdzenia, realizacja, SLA.
3. Ścieżki wyjątków: dostęp uprzywilejowany/emergency, czasowe podniesienia, rejestracja działań.
4. Recertyfikacja: okresowe przeglądy ról i dostępów, właściciele systemów, raporty.
5. Integracje z IdP/IAM: provisioning/deprovisioning, grupy, atrybuty, dziedziczenie.
6. Audyt i monitorowanie: logi nadawania, detekcja nadużyć, wskaźniki zgodności.
...
- [ ] Role i SoD zdefiniowane; wnioski JML mają ścieżkę akceptacji i SLA.
- [ ] Dostęp uprzywilejowany jest czasowy, rejestrowany i poddany recertyfikacji.
- [ ] Recertyfikacje są wykonywane cyklicznie, a wyniki dokumentowane.
- [ ] Provisioning/deprovisioning zautomatyzowany gdzie możliwe; logi audytowe kompletne.
