...
## Cel dokumentu
Krótka definicja: QA Engineer Onboarding opisuje cel, rolę w procesie decyzyjnym oraz ryzyka, które dokument ma ograniczać (co najmniej w 2–3 zdaniach).
...
- Wprowadzenie do produktu i domeny: cele biznesowe, krytyczne ścieżki, ryzyka.
- Środowiska i dostęp: konta, VPN/SSO, role, tajemnice, dostęp do repo, CI/CD, narzędzi QA.
- Procesy QA: sposób pracy (scrum/kanban), definition of ready/done, triage defektów, release flow, regression policy.
- Stack i narzędzia: frameworki testowe, raportowanie, monitorowanie, toolingi bezpieczeństwa/perf/A11y.
- Standardy i dobre praktyki: coverage krytycznych ścieżek, peer review testów, kodowanie testów, dane testowe/prywatność.
- Plan pierwszych zadań: quick wins, pierwsza automatyzacja, shadowing, „buddy”.
- Kryteria ukończenia onboardingu: lista kontrolna (dostępy, pierwsze testy, zrozumienie procesu, retrospektywa).

## Wymagane rozwinięcia
- Dostępy rozwijają: Security/Access Runbook, Secrets Management, Environment Runbook.
- Procesy QA rozwijają: QA Strategy, QA Test Plan, Incident/Defect Management.
- Standardy rozwijają: Coding Standards for Tests, Data Privacy/PIA, Performance/Security test guides.

## Wymagane streszczenia
- Streszczenie architektury produktu (1–2 diagramy) i głównych integracji krytycznych dla QA.
...
- DoR:
  - [ ] Dostępy (repo/CI/środowiska/narzędzia) przydzielone.
  - [ ] Buddy/mentor oraz plan pierwszych zadań ustalony.
  - [ ] Materiały o produkcie/architekturze/ryzykach dostępne.
- DoD:
  - [ ] Inżynier wykonał pierwszy zestaw testów/manual/auto i dodał wyniki.
  - [ ] Zrozumiał i potwierdził procesy (DoR/DoD, triage, release).
  - [ ] Retrospektywa onboarding + zaktualizowane wnioski w dokumencie.
