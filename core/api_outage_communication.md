---
title: API Outage Communication
...
Ustalić zasady komunikacji podczas awarii API do klientów/partnerów/interesariuszy.


## Zakres i granice

- Obejmuje: szablony komunikatów, kanały, częstotliwość update, role, FAQ, status page.
- Poza zakresem: techniczne naprawy.
...
- Kontekst i zakres
- Kanały i role
- Szablony i harmonogram
- FAQ
- Status page/aktualizacje
- Follow-up
...
- Streszczenie kluczowych decyzji/ryzyk; rozwinięcia planów/testów/konfiguracji.


## Wymagane powiązania

- Dokumenty gateway/monitoring/security/rate limiting; runbooki incydentów; plany testów.


## Kryteria DoR

- [ ] Runbook awarii dostępny
- [ ] Kanały/role zdefiniowane
- [ ] Lista klientów zebrana
- [ ] Status page gotowy


## Kryteria DoD

- [ ] Szablony przygotowane
- [ ] Plan komunikacji uruchomiony
- [ ] FAQ dodane
...
- Smoke/regresje po setup lub po testach wydajności/awarii; weryfikacja alertów/limitów.
...
- Liczba update w SLA
- CSAT/DX incydentowy
- Liczba zgłoszeń wsparcia podczas awarii


## Utrzymanie i aktualizacje

- Przegląd co release lub po zmianach polityk/konfiguracji.
