---
title: Specyfikacja wymagań IAM
...
1. Use case: użytkownicy, usługi, urządzenia.
2. Funkcje: auth, SSO, MFA, provisioning.
3. Bezpieczeństwo: polityki, SoD, logi.
4. Skalowanie i dostępność.
5. Zgodność i audyt.
...
- [ ] Funkcje IAM i SoD opisane.
- [ ] Bezpieczeństwo i logi ujęte.
- [ ] Skalowanie/dostępność zdefiniowane.
