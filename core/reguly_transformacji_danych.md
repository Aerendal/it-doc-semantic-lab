...
Katalog reguł transformacji danych (ETL/ELT).
...
1. Źródła i cele: tabele, pola, typy.
2. Reguły: mapowanie, agregacje, walidacje, maskowanie.
3. Jakość: testy, kontrakty, dopuszczalne odchylenia.
4. Wersjonowanie: zmiany schematu, migracje.
5. Monitorowanie: alerty na błędy i opóźnienia.
6. Własność: właściciele reguł, PR review.
...
- [ ] Reguły opisane i wersjonowane.
- [ ] Testy/walidacje pokrywają krytyczne pola.
- [ ] Monitorowanie błędów/opóźnień aktywne.
- [ ] Właściciele i proces zmian zdefiniowane.
