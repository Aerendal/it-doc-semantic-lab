...
Raport zbiorczy z testów penetracyjnych (gdy wymagany standardowy format).


## Zakres i granice

- Obejmuje: scope, metodologia, podatności, dowody, rekomendacje, retest.
- Poza zakresem: non-pentest findings.
