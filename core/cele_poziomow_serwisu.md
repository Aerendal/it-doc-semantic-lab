...
Określić cele i KPI dla poziomów serwisu (SLA/OLA/SLO), aby usługi były mierzone i zarządzane zgodnie z oczekiwaniami biznesu i użytkowników.


## Zakres i granice

- Obejmuje: SLO/SLI, SLA/OLA, metryki (dostępność, latencja, błędy), budżet błędów, procedury pomiaru, raportowanie, eskalacje i przeglądy.
- Nie obejmuje: szczegółowych planów DR/BCP (oddzielne) ani polityk refundacji.
...
1. Definicje SLI/SLO/SLA/OLA i zakres usług.
2. Metryki i targety (np. dostępność, p95 latencja, error rate).
3. Budżet błędów i zasady zużycia.
4. Pomiar i raportowanie (źródła danych, okresy, dashboardy).
5. Eskalacje i reakcje (co przy naruszeniu).
6. Przeglądy i rewizje celów.
...
- [ ] SLI/SLO i SLA/OLA spisane.
- [ ] Budżet błędów zdefiniowany.
- [ ] Pomiar i raporty działają.
- [ ] Eskalacje/reakcje ustalone.
- [ ] Przeglądy okresowe zaplanowane.
