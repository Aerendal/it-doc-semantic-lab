---
title: Reagowanie na awarie maszyn
...
Szybko przywrócić maszyny produkcyjne.
...
1. Detekcja: operator, sensory, SCADA.
2. Triage: bezpieczeństwo, zatrzymanie linii, priorytet.
3. Diagnoza: checklista, logi, części.
4. Naprawa: wymiana części, reset, serwis.
5. Powrót do produkcji: testy, kalibracja, ramp-up.
6. Raport: przyczyna, czas przestoju, działania prewencyjne.
...
- [ ] Diagnoza i naprawa udokumentowane.
- [ ] Testy po naprawie wykonane; produkcja wznowiona.
- [ ] Lekcje i działania prewencyjne zapisane.
