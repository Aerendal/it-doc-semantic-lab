...
Opisać wykrytą anomalię lub niezgodność w procesie walidacji i weryfikacji oprogramowania zgodnie z IEEE 1012 (Anomaly Report). Dokument rejestruje: opis anomalii, środowisko i kroki reprodukcji, wpływ na walidację/weryfikację, kategorię (błąd, niezgodność, dewacja), priorytet, działania naprawcze i status zamknięcia — umożliwiając śledzenie problemów jakościowych V&V.
