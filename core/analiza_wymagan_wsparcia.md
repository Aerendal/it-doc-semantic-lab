---
title: Analiza wymagań wsparcia
...
Określić, jakie wsparcie (support) jest potrzebne dla produktu/usługi: zakres, godziny, kanały, SLA, procedury eskalacji, aby zapewnić ciągłość i satysfakcję użytkowników.


## Zakres i granice

- Obejmuje: poziomy wsparcia (L1–L3), kanały kontaktu, okna dostępności, SLA/OLA, runbooki, przekazywanie do inżynierii.
- Nie obejmuje: szczegółowych runbooków technicznych (oddzielne dokumenty), polityk HR dla działu wsparcia.
...
- Wejścia: wymagania biznesowe, kontrakty/SLA z klientami, dane o incydentach, plan produktu.
- Wyjścia: katalog usług wsparcia, SLA/OLA, matryca eskalacji, wymagane narzędzia i kompetencje.
...
1. Zakres usług wsparcia i poziomy (L1–L3).
2. Godziny/okna dostępności, kanały (chat/email/phone/portal).
3. SLA/OLA i metryki (czas reakcji, rozwiązania).
4. Eskalacje i przekazanie do inżynierii.
5. Narzędzia i kompetencje.
...
- [ ] Poziomy i kanały wsparcia zdefiniowane.
- [ ] SLA/OLA ustalone i mierzalne.
- [ ] Eskalacje/runbooki opisane.
- [ ] Raportowanie i przeglądy zaplanowane.


## Definicje robocze

- **SLA/OLA** — umowa poziomu obsługi / wewnętrzna.
- **L1/L2/L3** — poziomy wsparcia (frontline → eksperci → inżynieria).
...
- „Poziomy i SLA” **constrains** „Eskalacje i runbooki”.
- „Kanały wsparcia” **feeds** „Monitoring i raporty”.
