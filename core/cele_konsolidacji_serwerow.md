---
title: Cele konsolidacji serwerów
...
Określić cele projektu konsolidacji serwerów: redukcja kosztów, poprawa wykorzystania zasobów, uproszczenie zarządzania i zwiększenie bezpieczeństwa.


## Zakres i granice

- Obejmuje: metryki przed/po (koszt, wykorzystanie CPU/RAM, liczba serwerów), standardyzację platform, migracje, ryzyka i planowanie okien, wpływ na SLA.
- Nie obejmuje: szczegółowych runbooków migracji (osobne) ani renegocjacji kontraktów.
...
1. Cele i KPI (koszt, użycie zasobów, liczba instancji, SLA).
2. Zakres konsolidacji (które serwery/workloady, kryteria).
3. Standard docelowy (OS/hypervisor/hardware, monitoring).
4. Plan migracji i okna (fazy, ryzyka, rollback).
5. Bezpieczeństwo i compliance (hardening, patching, audyt).
6. Wpływ na SLA i komunikacja.
...
- [ ] KPI i zakres ustalone.
- [ ] Standard docelowy opisany.
- [ ] Plan migracji z oknami/rollbackiem.
- [ ] Hardening/patching po migracji.
- [ ] SLA monitorowane i komunikacja zaplanowana.
