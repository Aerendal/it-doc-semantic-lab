---
title: Referencja bazy danych upraw
...
Opis referencyjny bazy danych upraw i powiązań.
...
1. Model danych: pola, uprawy, sezon, zabiegi.
2. Identyfikatory: GIS, właściciel, urządzenia.
3. Relacje: plony, zabiegi, sensory, prognozy.
4. Jakość i walidacje: spójność, zakresy, brakujące dane.
5. Bezpieczeństwo i dostęp: role, anonimizacja, DPIA.
6. Integracje: źródła (IoT, sat), eksporty, API.
...
- [ ] Model i klucze opisane.
- [ ] Walidacje i jakość danych zdefiniowane.
- [ ] Dostępy i prywatność uwzględnione.
- [ ] Integracje i właściciele danych wskazani.
