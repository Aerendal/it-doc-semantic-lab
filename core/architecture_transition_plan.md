---
title: Architecture Transition Plan
...
## Cel dokumentu
Architecture Transition Plan określa harmonogram, zakres i odpowiedzialności, aby dowieźć rezultat w kontrolowany sposób.
...
## Szybkie powiązania
- Zależność: {'depends_on': 'Business Architecture Design', 'type': 'INFORMED_BY'}
- Zależność: {'depends_on': 'Application Architecture Design', 'type': 'INFORMED_BY'}
- Zależność: {'depends_on': 'Business Architecture Design', 'type': 'INFORMED_BY'}
