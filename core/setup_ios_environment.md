...
1. Xcode/SDK wersje.
2. Cocoapods/SwiftPM.
3. Certificates/profiles, signing.
4. Simulatory/urządzenia.
5. Testy: unit/UI (XCTest).
6. CI cache, fastlane, artefakty.
...
- [ ] Xcode i dependency manager zainstalowane.
- [ ] Signing/profiles działają.
- [ ] Testy przechodzą.
- [ ] CI cache/artefakty ustawione.
