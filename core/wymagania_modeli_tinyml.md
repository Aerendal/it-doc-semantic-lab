...
1. Use case i budżety (latencja/energia/rozmiar).
2. Sprzęt i toolchain.
3. Metryki jakości i degradacja.
4. Kompresja i optymalizacje.
5. Testy on-device.
6. OTA i bezpieczeństwo.
...
- [ ] Budżety/metric zdefiniowane.
- [ ] Sprzęt/toolchain opisane.
- [ ] Testy on-device zaplanowane.
- [ ] OTA/bezpieczeństwo ujęte.
