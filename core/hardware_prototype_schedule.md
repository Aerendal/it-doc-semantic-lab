---
title: Hardware Prototype Schedule
...
Hardware Prototype Schedule określa harmonogram, zakres i odpowiedzialności, aby dowieźć rezultat w kontrolowany sposób.
...
- Zależność: {'depends_on': 'System Architecture Design', 'type': 'INFORMED_BY'}
- Zależność: {'depends_on': 'Hardware Architecture Design', 'type': 'INFORMED_BY'}
- Zależność: {'depends_on': 'System Architecture Design', 'type': 'INFORMED_BY'}
