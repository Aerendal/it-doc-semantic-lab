...
Przygotować okresowy raport użycia API (wolumen, klienci, trendy, anomalie).


## Zakres i granice

- Obejmuje: metryki wolumenowe, top klienci/ścieżki, trendy, anomalie, rekomendacje capacity/billing.
- Poza zakresem: szczegółowe rozliczenia finansowe.
...
- Logi/analityka
- Progi anomalii
- Zmiany planów/cennika


## Wyjścia

- Raport z metrykami i trendami
- Lista anomalii i działań
- Rekomendacje capacity/billing
- Powiązania do rate limiting/capacity
...
- [ ] api_gateway_performance_report.md
...
- [ ] Dane z okresu dostępne
- [ ] Progi/anomalie zidentyfikowane
- [ ] Zmiany planów/cennika znane
- [ ] Ownerzy raportu ustaleni


## Kryteria DoD

- [ ] Raport wypełniony
- [ ] Rekomendacje spisane
