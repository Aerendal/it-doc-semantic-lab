...
Monitorować czasy odpowiedzi API i alertować na degradacje w relacji do SLO.


## Zakres i granice

- Obejmuje: metryki latency (p50/p95/p99), per endpoint/region/klient, sampling, alerty, dashboardy, korelacje z error/throttle.
- Poza zakresem: monitoring backendów niedostępny z gateway (osobne dokumenty).
...
- SLO/SLA per endpoint
- Mapa ścieżek i klientów
- Źródła metryk (APM/gateway/logi)
- Alert policies
