...
Ustawić monitorowanie bramki API (latencja, błędy, throttling, auth) z alertami i dashboardami.


## Zakres i granice

- Obejmuje: metryki L7 (latency, error, throttle), auth failures, WAF events, capacity, logowanie/audyt, alerty, dashboardy, sampling.
- Poza zakresem: monitoring backendów usług (osobne dokumenty).
...
- SLO/SLA i budżety
- Mapa ścieżek/serwisów
- Polityki rate limiting i auth
- Źródła metryk/logów


## Wyjścia

- Zestaw metryk i progów alertów
- Dashboardy
- Plan sampling/logowania
...
- [ ] SLO/budżety ustalone
- [ ] Mapa ścieżek/serwisów znana
- [ ] Źródła metryk/logów działają
- [ ] Polityki rate limiting/auth dostępne


## Kryteria DoD

- [ ] Metryki/alerty opisane
- [ ] Dashboardy zlinkowane
- [ ] Sampling/logowanie opisane
- [ ] Checklisty/quick-links uzupełnione


## Artefakty do załączenia

- Definicje metryk/progów
