---
title: Reagowanie na awarie obwodów
...
Postępować przy awariach obwodów elektrycznych/PCB.
...
1. Bezpieczeństwo: odłączenie zasilania, lockout/tagout.
2. Triage: lokalizacja obwodu, objawy, krytyczność.
3. Diagnoza: pomiary, inspekcja wizualna, komponenty.
4. Naprawa: wymiana, lutowanie, rework, testy.
5. Testy funkcjonalne i burn-in.
6. Dokumentacja: przyczyna, częstotliwość, zmiany w projekcie/BOQ.
...
- [ ] Bezpieczeństwo przestrzegane.
- [ ] Przyczyna obwodu zidentyfikowana; naprawa wykonana.
- [ ] Testy funkcjonalne/burn-in zaliczone.
- [ ] Dokumentacja i wnioski aktualne.
