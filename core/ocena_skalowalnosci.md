...
Ocenić zdolność systemu do skalowania przy wzroście obciążenia, wskazać ograniczenia i plan usprawnień.
...
1. Zakres: komponenty, workloady, scenariusze wzrostu, SLA/SLO.
2. Testy i dane: load/stress/soak, profile ruchu, wyniki (latency, throughput, error).
3. Bottlenecks: CPU/IO, locki, baza, sieć, cache, limity zewnętrzne.
4. Architektura: horyzontal/vertical scale, autoscale, queue/backpressure, statelessness.
5. Plan usprawnień: quick wins, redesign, koszt, harmonogram.
6. Monitoring i regression: metryki skalowania, progi, retesty po zmianach.
...
- [ ] Scenariusze wzrostu i SLA zdefiniowane.
- [ ] Wyniki testów i bottlenecks zidentyfikowane.
- [ ] Plan usprawnień i koszty opisane; retesty zaplanowane.
- [ ] Metryki skalowania i alerty skonfigurowane.
