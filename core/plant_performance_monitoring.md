...
Monitorować wydajność zakładu produkcyjnego (plant) w czasie rzeczywistym, by poprawiać throughput, OEE i jakość.
...
1. KPI: OEE, throughput, scrap/rework, downtime, energy, safety incidents.
2. Źródła danych: MES/SCADA/PLC, czujniki, manuale; częstotliwość i jakość danych.
3. Dashboardy/alerty: per linia/zmiana/produkt, andon, progi SLA, eskalacje.
4. Analiza: Six Big Losses, Pareto, korelacje, root cause log.
5. Akcje: właściciele, plan doskonalenia, standard work, feedback loop do operatorów.
6. Raporty: dzienne/tygodniowe/miesięczne, trend, wyniki akcji, lessons learned.
...
- [ ] KPI i źródła danych zdefiniowane; jakość danych zweryfikowana.
- [ ] Alerty/andon i dashboardy działają na poziomie linii/zmian.
- [ ] Analiza strat i RCA prowadzona; działania z właścicielami.
- [ ] Raporty trendów i skuteczności akcji publikowane.
