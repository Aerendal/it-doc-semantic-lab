...
Plan i zasady segmentacji sieci IT/OT.
...
1. Model stref i konduktów (ISA/IEC 62443).
2. Inwentaryzacja: aktywa IT/OT.
3. Kontrole: firewalle, diody, jump hosts.
4. Dostępy: zarządzanie kontami, MFA, bastiony.
5. Monitoring: IDS/IPS OT, logi, SOC.
6. Utrzymanie: zmiany, testy, audyt.
...
- [ ] Strefy/konduity zdefiniowane.
- [ ] Kontrole i dostępy opisane.
- [ ] Monitoring OT skonfigurowany.
- [ ] Plan utrzymania/audytu istnieje.
