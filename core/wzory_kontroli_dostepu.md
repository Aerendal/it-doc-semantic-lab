...
1. Modele ról/atributów.
2. SoD i wyjątki.
3. Delegacje i czasowe dostępy.
4. Audyt/logi.
5. Recertyfikacje.
6. Przykłady policy.
...
- [ ] Role/SoD/wyjątki opisane.
- [ ] Audyt/recertyfikacje ujęte.
- [ ] Przykłady policy dodane.
- [ ] Delegacje/time-bound opisane.
