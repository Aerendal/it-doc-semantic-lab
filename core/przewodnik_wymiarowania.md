...
Opisać, jak dobierać rozmiary zasobów (compute, storage, sieć) do obciążeń.
...
1. Profil obciążenia: charakterystyka ruchu, szczyty, batch vs realtime.
2. Modele: kalkulacje CPU/RAM/IO, storage, sieć; współczynniki zapasu.
3. Testy wydajności: generatory ruchu, benchmarki, walidacja sizingu.
4. Koszty i optymalizacja: koszty jednostkowe, reserved/savings, autoscaling.
5. Dokumentacja: arkusze sizingowe, założenia, wersjonowanie.
6. Przeglądy okresowe: re-evaluacja na bazie obserwacji produkcyjnych.
...
- [ ] Założenia obciążenia są udokumentowane i zwalidowane testami.
- [ ] Sizing zawiera zapas i plan autoscalingu.
- [ ] Koszty i warianty (reserved/spot) są policzone.
- [ ] Przegląd sizingu jest zaplanowany cyklicznie.
