---
title: Raport statusu wydajności
...
Raportować aktualny stan wydajności systemów.
...
1. Metryki główne: latencja, błędy, throughput, zasoby.
2. Alerty i incydenty: ostatnie przekroczenia SLO.
3. Trend: porównanie do celów, sezonowość.
4. Prace optymalizacyjne: wykonane, planowane.
5. Ryzyka: nadchodzące szczyty, ograniczenia.
6. Rekomendacje: działania i właściciele.
...
- [ ] Metryki SLO są aktualne i kompletne.
- [ ] Incydenty i alerty opisane z przyczynami.
- [ ] Prace optymalizacyjne i ryzyka przedstawione.
