...
Sprecyzować wymagania funkcjonalne systemu/produktu w sposób testowalny.
...
1. Kontekst i cel systemu.
2. Zakres (in/out).
3. Wymagania funkcjonalne (use cases/user stories/aktorzy, kroki, AC).
4. Wymagania interfejsów/zależności (API, integracje).
5. Reguły biznesowe i walidacje.
6. Śledzenie wymagań → testy (traceability).
...
- [ ] Wymagania testowalne, jednoznaczne.
- [ ] AC i zależności opisane.
- [ ] Traceability do testów zapewnione.
