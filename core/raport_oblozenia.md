...
Raportować obłożenie zasobów (np. hotele, serwery, zespoły).
...
1. Zakres i jednostki: zasoby, okres, miara obłożenia.
2. Metryki: occupancy %, utilization, peak vs avg.
3. Segmentacja: lokalizacja, typ zasobu, kanał.
4. Anomalie: over/under utilization, braki zasobów.
5. Prognoza: przewidywane obłożenie, czynniki sezonowe.
6. Rekomendacje: alokacja, pricing, staffing.
...
- [ ] Dane obłożenia są poprawne i kompletne.
- [ ] Segmentacja i anomalie są opisane.
- [ ] Prognoza przedstawiona z założeniami.
