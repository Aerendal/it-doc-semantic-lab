...
Określić zasady i mechanizmy kontroli dostępu do systemu/danych, zgodne z least privilege i wymaganiami regulacyjnymi.
...
1. Zakres zasobów: aplikacje, dane, interfejsy administracyjne, API, fizyczny dostęp.
2. Modele: RBAC/ABAC, MAC/DAC; role, atrybuty, separacja obowiązków.
3. Uwierzytelnianie: MFA, SSO, klucze, urządzenia zaufane, sesje.
4. Autoryzacja: polityki, permisy, contextual access, just-in-time, approvals.
5. Audyt i logowanie: kto/co/kiedy, alerty anomalii, detekcja nadużyć.
6. Przeglądy i recertyfikacja: częstotliwość, właściciele, raporty, remediacja.
...
- [ ] Zasoby i modele dostępu zdefiniowane (role/atrybuty).
- [ ] MFA/SSO i zarządzanie sesją wdrożone.
- [ ] Polityki autoryzacji i separacja obowiązków opisane; JIT/JEA jeśli potrzebne.
- [ ] Audyt/logi oraz recertyfikacje zaplanowane.
