...
Monitorować wydajność sieci (LAN/WAN/Cloud) w celu utrzymania SLA i wykrywania degradacji.
...
1. Zakres: linki, urządzenia, segmenty, PoP, VPN, SD-WAN.
2. Metryki: latency, jitter, packet loss, throughput, utilization, errors, QoS queues.
3. Pomiar: syntetyczne sondy, NetFlow/sFlow, SNMP/telemetry, real user traffic.
4. Alerty: progi SLA, flapping, saturacje, zmiany jitter/loss, path changes.
5. Diagnostyka: traceroute/path, heatmapy, top talkers, QoS misconfigs.
6. Raporty: trend, capacity planning, raporty SLA, incydenty i RCA.
...
- [ ] Metryki latency/jitter/loss/throughput zbierane i segmentowane.
- [ ] Alerty na przekroczenia SLA, flapping i saturacje ustawione.
- [ ] Narzędzia diagnostyczne (path/top talkers/QoS) dostępne.
- [ ] Raporty trendów i capacity plan aktualizowane.
