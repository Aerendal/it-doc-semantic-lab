...
Opisać standardy zgodności i bezpieczeństwa przy korzystaniu z Google Cloud Platform.
...
1. Identity/IAM: least privilege, org policies, service accounts, workload identity.
2. Sieć: VPC, subnety, firewall, Private Service Connect, peering, egress controls.
3. Dane: szyfrowanie (CMEK), PII/PCI, DLP, klasyfikacja.
4. Logging/Monitoring: Cloud Logging, Audit Logs, metrics/alerts, retention.
5. Compliance: HIPAA/PCI/ISO/NIS2 (jeśli dotyczy), lokalizacja danych, rezydencja.
6. Deployment/IaC: org policies, scanners, policy-as-code (CCF/SCC), CI/CD gates.
...
- [ ] IAM/SA i org policies ustawione.
- [ ] Sieć i egress kontrolowane.
- [ ] CMEK/PII/DLP i lokalizacja danych uwzględnione.
- [ ] Audit logs/alerts aktywne.
- [ ] IaC i policy-as-code w CI/CD.
