---
title: Przegląd predykcji plonów
...
Sprawdzić jakość modeli predykcji plonów i ich użyteczność operacyjną.
...
1. Dane wejściowe: pogoda, gleba, satelity, IoT, historia plonów; brakujące dane.
2. Modelowanie: algorytmy, featury, walidacja przestrzenna i czasowa.
3. Metryki: RMSE/MAE, błędy per region/uprawa, kalibracja niepewności.
4. Drift i aktualizacje: monitoring danych, re-train, sezonowość.
5. Wyniki i wizualizacja: mapy, raporty dla rolników/agronomów.
6. Ryzyka i etyka: bias regionalny, błędne decyzje agronomiczne, komunikacja niepewności.
...
- [ ] Dane są kompletne i reprezentatywne; brakujące dane są obsłużone.
- [ ] Walidacja przestrzenno-czasowa pokazuje akceptowalne błędy.
- [ ] Drift jest monitorowany; harmonogram retrainingu istnieje.
- [ ] Wyniki mają komunikowaną niepewność; użytkownicy wiedzą jak je interpretować.
