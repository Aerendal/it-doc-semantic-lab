...
Przygotować przewodnik szkoleniowy dla użytkowników/deweloperów platformy (API/devportal), by przyspieszyć wdrożenie.
...
1. Odbiorcy i cele: poziom (beginner/advanced), co mają umieć po szkoleniu.
2. Agenda: moduły (auth, API, SDK, sandbox, monitoring), czas, prerekwizyty.
3. Materiały: slajdy, laby, sample code, checklisty, quizy.
4. Format i logistyka: online/on-site, środowiska, konta, instrukcje setup.
5. Ewaluacja: quiz/lab scoring, certyfikat, feedback ankieta.
6. Follow-up: linki do docs, office hours, community, aktualizacje materiałów.
...
- [ ] Agenda i materiały (slides/labs/sample code) kompletne; środowiska dostępne.
- [ ] Prerekwizyty/setup opisane; uczestnicy mają konta.
- [ ] Ewaluacja i certyfikat przygotowane; feedback zbierany.
- [ ] Aktualizacje materiałów i kanały wsparcia zapewnione.
