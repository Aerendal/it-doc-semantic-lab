---
title: POS Performance Monitoring
...
Monitorować wydajność POS (kasy/terminali), by utrzymać szybkie transakcje i dostępność.
...
1. Metryki: czas transakcji p95/p99, uptime terminali, błędy płatności, tryb offline, sieć.
2. Segmentacja: sklepy/region, hardware, wersja softu, typ płatności.
3. Alerty: wzrost latency, error rate, utrata łączności, degradacja urządzeń.
4. Diagnostyka: logi POS, integracje (płatności/OMS/WMS), Wi-Fi/Ethernet, peryferia.
5. Raporty: trend, heatmapy, porównania wersji, wpływ na sprzedaż/kolejki.
6. Reakcje: runbooki, fallback offline, hotfix rollout, wsparcie sklepów.
...
- [ ] Czas transakcji/error rate monitorowane per sklep/wersję.
- [ ] Alerty na degradacje/łączność ustawione; offline mode śledzony.
- [ ] Logi/integracje/sieć uwzględnione w diagnostyce.
- [ ] Raporty i runbooki reakcji dostępne.
