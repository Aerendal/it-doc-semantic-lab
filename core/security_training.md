...
Program szkoleń bezpieczeństwa (ogólne/techniczne) dla zespołów: cele, grupy, moduły, materiały, egzaminy i metryki skuteczności.


## Zakres i granice

- Obejmuje: cele szkolenia, grupy docelowe/persony, program/agenda, materiały i kanały, harmonogram/refresh, egzaminy/quizy, metryki ukończeń i skuteczności.
- Poza zakresem: szczegółowe wdrożenia kontrolek technicznych (opisane w runbookach) oraz treść konkretnych polityk (w dokumentach polityk).
...
- Określ grupy i cele; wybierz moduły, kanały i egzaminy; sekcje N/A uzasadnij.
- Dodaj quick-links i checklisty DoR/DoD w `reports/checklist_atomic.jsonl`.
- Po każdej edycji uzupełnij metryki i feedback; aktualizuj materiały i status.
...
- Polityki/standardy bezpieczeństwa, wymagania regulacyjne.
- Lista grup docelowych/person, incydenty i lessons learned.
- Kanały szkoleniowe (LMS/live), narzędzia quiz/exam, dostępność trenerów.


## Wyjścia

- Plan/program szkoleń z modułami i materiałami.
- Harmonogram i komunikacja.
- Egzaminy/quizy i raporty ukończeń/NPS.
...
- Tabela: moduł → grupa → kanał → egzamin → kryteria.
- Streszczenie celów, metryk i planu refresh.


## Wymagane powiązania

- Polityki, runbooki, rejestr ryzyk/incydentów, compliance matrix.
- LMS/quiz tooling, logi ukończeń, plan komunikacji.
...
- [ ] Wymagania regulacyjne dot. szkoleń zebrane.
...
- NPS/CSAT, liczba pytań/wyjątków po szkoleniu.
- Czas do ukończenia vs plan; luki w grupach.


## Utrzymanie i aktualizacje

- Refresh po zmianach polityk lub co 6–12 miesięcy.
- Aktualizuj przykłady i kanały; utrzymuj logi ukończeń.


## Zakończenie

Po spełnieniu DoD opublikuj materiały, podlinkuj raporty, odhacz checklisty w `reports/checklist_atomic.jsonl` i ustaw termin kolejnego refreshu.
