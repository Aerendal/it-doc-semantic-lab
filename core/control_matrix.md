...
Zdefiniować macierz podziału odpowiedzialności za kontrole bezpieczeństwa między dostawcę chmury (CSP) a klienta (tenant) — zgodnie z ISO/IEC 27017 klauzula 6.3 (Shared Responsibilities in Cloud Environments). Macierz precyzuje które kontrole z ISO/IEC 27001/27002 są realizowane przez CSP, klienta lub wspólnie — eliminując luki w pokryciu i umożliwiając audyt środowisk chmurowych.
