---
title: Problem Statement for Analytics
...
Sprecyzować problem analityczny/ML do rozwiązania: cel biznesowy, pytania, dane, metryki sukcesu i ograniczenia.


## Zakres i granice

- Obejmuje: opis biznesowy, hipotezy/pytania, definicje metryk/KPI, użytkowników i decyzji, dane dostępne/potrzebne, ograniczenia (czas, budżet, regulacje), kryteria sukcesu, potencjalne techniki (analiza/ML), plan walidacji.
- Poza zakresem: implementacja modelu/analityki (osobne dokumenty), projekt danych ogólny.
...
## Wejścia i wyjścia
- Wejścia: obserwacje z rynku/operacji, dane ilościowe (metryki błędów, czas procesów), feedback użytkowników, hipotezy produktowe.
- Wyjścia: zwięzły opis problemu, definicja done dla rozwiązania, kryteria sukcesu, priorytet (np. MoSCoW), lista ryzyk i założeń.
## Założenia
...
- Poprzedza: Product Vision Statement, Feasibility Study (dostarcza im kontekst).
- Dostarcza do: BRD/FRS/NFR, Roadmapy, ADR/RFC (uzasadnienie potrzeb).
## Fazy cyklu życia
...
- Cel biznesowy i pytania
- Zakres użytkowników/decyzji
- Metryki/KPI i kryteria sukcesu
- Dane dostępne/potrzebne (jakość, PII)
- Ograniczenia i ryzyka
- Proponowane podejście/techniki (wysokopoziomowo)
- Plan walidacji i następne kroki


## Szybkie powiązania

- Solution Guide, Data Governance, Privacy, Model Card (później), Experimentation/A-B.
...
- Kontekst biznesowy, istniejące KPI, dane źródłowe, ograniczenia prawne/bezpieczeństwa, interesariusze.


## Wyjścia

- Jasny opis problemu i metryk, lista danych i ograniczeń, kryteria sukcesu, plan kolejnych kroków.



## Jak używać (checklista)

- Opisz cel i decyzje, które będą wspierane.
- Zdefiniuj KPI i dane; oceń jakość/PII.
- Zapisz ograniczenia i kryteria sukcesu; ustal plan walidacji.


## Wymagane rozwinięcia / powiązania

- Szablon problem statement, tabelka KPI, lista źródeł danych, risk log, plan walidacji.


## Kryteria DoR

- Cel biznesowy określony; interesariusze dostępni; dane wstępnie zidentyfikowane.


## Kryteria DoD

- Problem statement uzupełniony, KPI/dane/ograniczenia opisane, kryteria sukcesu i plan walidacji zapisane.


## Artefakty

- Dokument problemu, tabela KPI, lista danych, risk log, plan walidacji.


## Walidacja

- Peer review z biznes/analitykami; sanity metryk/danych; zgodność z polityką danych/PII.


## Metryki

- Czas przygotowania statement, liczba rewizji, sukces projektów wynikających ze statementu.


## Utrzymanie

- Aktualizacja przy zmianie celu/danych; wersjonowanie; review po realizacji projektu.


## Zakończenie

Dobrze zdefiniowany problem analityczny zwiększa szanse sukcesu; utrzymuj go z metrykami, danymi i kryteriami sukcesu.
