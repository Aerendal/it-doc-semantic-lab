...
Procedura weryfikacji zgodności.
...
2. Checklisty i dowody.
3. Luki i plan działań.
4. Raport i akceptacja.
5. Ścieżka audytu.
...
- [ ] Zakres/dowody zebrane.
- [ ] Luki mają plan.
- [ ] Raport/akceptacja wykonane.
