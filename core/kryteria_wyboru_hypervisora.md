---
title: Kryteria wyboru hypervisora
...
Określić kryteria wyboru hypervisora dla środowiska wirtualizacji, uwzględniając funkcje, koszt i zgodność.
...
1. Wymagania: workloady, HA/DR, skala, wspierany hardware, zgodność z HCL.
2. Funkcje: live migration, snapshots, storage/vSAN, sieć (VDS/NSX), GPU/PCI passthrough.
3. Zarządzanie i automatyzacja: API, IaC, monitoring, aktualizacje/patching.
4. Bezpieczeństwo i compliance: izolacja, hardening, audyt, certyfikacje (FIPS/CC).
5. Ekonomia: licencje, support, TCO, ekosystem narzędzi.
6. Ryzyka i vendor lock-in: migracja, formaty VM, wsparcie multi-cloud.
...
- [ ] Zdefiniowane wymagania workloadów i HA/DR.
- [ ] Porównanie funkcji (live migrate, storage, sieć, GPU) wykonane.
- [ ] Ocena kosztów/licencji/supportu oraz narzędzi automatyzacji.
- [ ] Ryzyka lock-in i zgodność bezpieczeństwa ocenione.
