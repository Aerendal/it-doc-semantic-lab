...
## Cel dokumentu
Opisuje wizję produktu, adresowany problem, grupy użytkowników i oczekiwaną wartość biznesową. Uzgadnia wspólny kierunek dla biznesu, technologii i interesariuszy, zanim powstaną szczegółowe wymagania.

## Zakres i granice
Obejmuje cele strategiczne, kluczowe funkcje i ograniczenia biznesowe. Nie zawiera szczegółowych wymagań funkcjonalnych ani technicznego projektu – te trafiają do FRS/NFR i dokumentów projektowych.

## Wejścia i wyjścia
- Wejścia: wstępne założenia biznesowe, analizy rynku, persony użytkowników, ograniczenia strategiczne.
- Wyjścia: zaakceptowana wizja produktu, kryteria sukcesu na wysokim poziomie, zakres MVP, mapa wartości dla interesariuszy.
...
- Poprzedza: Problem Statement, Business Case / Feasibility Study.
- Dostarcza kontekst dla: FRS, NFR, Roadmapy produktu, Architecture Vision / ADR.

## Powiązania sekcja↔sekcja
- Streszczenie wizji → rozwinięcie w FRS/NFR.
- MVP scope → rozwinięcie w Product Roadmap i Planie wydawniczym.
- Kryteria sukcesu → powiązanie z metrykami w Test Plan / KPI.
...
- Grupy użytkowników / persony
- Propozycja wartości i unikalne wyróżniki
- Cele biznesowe i mierniki sukcesu (OKR/KPI)
- Zakres MVP i kolejne etapy
- Ryzyka strategiczne i założenia
- Zależności i ograniczenia (techniczne, regulacyjne, budżetowe)
