...
1. Metody MFA i scenariusze.
2. Środowiska i dane.
3. Testy pozytywne/negatywne/usability.
4. Security: replay, phishing, recovery.
...
- [ ] Scenariusze MFA zdefiniowane.
- [ ] Testy bezpieczeństwa i usability ujęte.
