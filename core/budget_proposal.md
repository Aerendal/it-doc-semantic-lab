...
Przedstawić propozycję budżetu dla projektu/produktu, z jasno opisanymi kosztami, założeniami, scenariuszami i oczekiwanymi korzyściami, aby uzyskać decyzję o finansowaniu.


## Zakres i granice

- Obejmuje: zakres inicjatywy, koszty CAPEX/OPEX, harmonogram wydatków, scenariusze (pesymistyczny/realistyczny/optymistyczny), założenia i czułość, korzyści/ROI, ryzyka kosztowe i plan mitigacji.
- Nie obejmuje: pełnej analizy TCO w całym cyklu życia (osobny dokument) ani szczegółowych arkuszy kalkulacyjnych (załączniki).
...
1. Zakres inicjatywy i cel biznesowy.
2. Założenia (wolumeny, stawki, rabaty, kursy, SLA).
3. Koszty CAPEX/OPEX i harmonogram wydatków.
4. Scenariusze (pesy/real/opty) i czułość na założenia.
5. Korzyści/ROI (przychody, oszczędności, ryzyko uniknięte).
6. Ryzyka kosztowe i mitigacje.
7. Rekomendacja i decyzja do podjęcia.
...
- [ ] Zakres i założenia jasno opisane.
- [ ] Koszty CAPEX/OPEX rozbite w czasie.
- [ ] Scenariusze i czułość policzone.
- [ ] Korzyści/ROI i ryzyka pokazane.
- [ ] Rekomendacja i decyzja do akceptacji.
