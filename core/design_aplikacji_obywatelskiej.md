---
title: Design aplikacji obywatelskiej
...
aligned_by: codex
---
# Design aplikacji obywatelskiej
...
Zaprojektować aplikację dla obywateli (usługi publiczne): bezpieczeństwo, dostępność, prywatność, prostota i zgodność z regulacjami.
...
1. Zakres funkcji (usługi, wnioski, płatności, powiadomienia).
2. Tożsamość i autoryzacja (eID/OIDC, MFA, podpis elektroniczny).
3. Dostępność i inkluzywność (WCAG, język prosty, offline, starsze urządzenia).
4. Prywatność i dane (minimalizacja, zgody, retencja, audyt).
5. Bezpieczeństwo (PII, płatności, anty-fraud, logi/audyt).
6. UX i komunikacja (jasne statusy spraw, powiadomienia, feedback).
7. Observability i support (SLA, monitoring, helpdesk).
...
- [ ] WCAG/dostępność i język prosty spełnione.
- [ ] eID/OIDC/MFA/podpis zaimplementowane.
- [ ] Prywatność/retencja/audyt opisane.
- [ ] Płatności/bezpieczeństwo uwzględnione.
- [ ] Statusy/powiadomienia i support dostępne.
