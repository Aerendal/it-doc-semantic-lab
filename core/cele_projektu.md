...
Jasno określić, co projekt ma osiągnąć (biznesowo i technicznie), jakie są mierniki sukcesu i granice zakresu.


## Zakres i granice

- Obejmuje: cele biznesowe, cele techniczne, KPI/OKR, zakres in/out, założenia i ograniczenia.
- Nie obejmuje: szczegółowego planu zadań (jest w planie projektu/backlogu).
...
1. Cel nadrzędny i kontekst biznesowy.
2. Cele szczegółowe (biznesowe i techniczne) z KPI/OKR.
3. Zakres: co wchodzi / co nie wchodzi.
4. Założenia i ograniczenia (czas, budżet, technologia).
5. Kryteria sukcesu i pomiar.
...
- [ ] Cele i KPI/OKR zdefiniowane.
- [ ] Zakres in/out opisany.
- [ ] Założenia/ograniczenia spisane.
