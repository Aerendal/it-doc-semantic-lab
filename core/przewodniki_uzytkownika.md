...
Szablon dla pojedynczych przewodników użytkownika końcowego.
...
1. Wstęp i wymagania: dla kogo, wersja systemu, prerekwizyty.
2. Kroki użycia: scenariusze, instrukcje krok po kroku ze zrzutami.
3. Najczęstsze problemy: FAQ, wskazówki, kiedy kontaktować wsparcie.
4. Bezpieczeństwo i prywatność: dobre praktyki, dane wrażliwe.
5. Dostępność: skróty, alternatywy, języki.
6. Aktualizacje: jak sprawdzić wersję, co nowego, gdzie zgłosić sugestie.
...
- [ ] Przewodnik ma jasno określonego odbiorcę i wersję.
- [ ] Instrukcje są poprawne, kompletne i przetestowane.
- [ ] FAQ i wsparcie są wskazane; dane wrażliwe opisane.
- [ ] Data ostatniej aktualizacji i właściciel są podane.
