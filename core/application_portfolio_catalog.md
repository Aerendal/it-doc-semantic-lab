...
Application Portfolio Catalog gromadzi ujednolicone wzorce/standardy jako punkt odniesienia.
...
- Zależność: {'depends_on': 'Enterprise Architecture Vision', 'type': 'REFERENCES'}
- Zależność: {'depends_on': 'Enterprise Architecture Repository', 'type': 'REFERENCES'}
- Zależność: {'depends_on': 'Enterprise Architecture Vision', 'type': 'REFERENCES'}
