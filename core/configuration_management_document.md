...
## Cel dokumentu
Opisać Plan Zarządzania Konfiguracją definiujący jak będą identyfikowane, kontrolowane i śledzone elementy konfiguracji (CI) oprogramowania/systemu — zgodnie z ISO/IEC 12207 SCM Process, ISO/IEC 29110 (Configuration Log) lub NIST SP 800-53 CM-2/CM-3 (Configuration Management Plan/ISCM). Dokument obejmuje: identyfikację CI, baseline zarządzania zmianami, audyt konfiguracji i status accounting.
