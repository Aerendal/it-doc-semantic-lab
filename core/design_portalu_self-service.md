---
title: Design portalu self-service
...
Zaprojektować portal self-service dla użytkowników/klientów: zgłoszenia, statusy, wiedza, płatności i konfiguracje.
...
1. Funkcje: ticketing, statusy zamówień/usług, KB/FAQ, płatności, konfiguracje konta.
2. Tożsamość i dostęp: SSO, role, uprawnienia (account/tenant), MFA.
3. UX: wyszukiwanie, nawigacja, dostępność, mobile.
4. Integracje: CRM/ITSM/billing, notyfikacje (email/push/SMS).
5. Observability: użycie, deflection rate, błędy, feedback.
6. Bezpieczeństwo/prywatność: PII, zgody, logi/audyt.
...
- [ ] Funkcje ticket/status/KB/płatności opisane.
- [ ] SSO/role/MFA wdrożone.
- [ ] UX/a11y i search działają.
- [ ] Integracje i notyfikacje skonfigurowane.
- [ ] Observability (deflection, błędy) i audyt.
