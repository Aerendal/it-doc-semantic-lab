...
Określić strategię wersjonowania API (semver, ścieżki, nagłówki, kompatybilność) z planem deprecacji.


## Zakres i granice

- Obejmuje: schemat wersji, kontrakty kompatybilności, komunikację, rollout/deprecacja, testy zgodności.
- Poza zakresem: implementacja w kodzie poszczególnych usług.
...
- Kontekst i cele
- Schemat wersji i kompatybilność
- Rollout i fallback
- Deprecacja i komunikacja
- Testy zgodności
- Ryzyka
...
- Wymagania biznesowe i klienckie
- Mapa usług/kontraktów
...
- Plan komunikacji i deprecacji
- Checklisty testów zgodności
- Powiązania do dokumentacji i gateway
...
- [ ] Polityka kompatybilności uzgodniona
- [ ] Mapa kontraktów znana
- [ ] Plan deprecacji wstępny
- [ ] Kanały komunikacji określone


## Kryteria DoD

- [ ] Strategia spisana
- [ ] Plan deprecacji/komunikacji dodany
- [ ] Testy zgodności opisane
...
- Liczba klientów na starą wersję
- Czas migracji
- Incydenty zgodności
- Skuteczność komunikacji (open/click/ack)
