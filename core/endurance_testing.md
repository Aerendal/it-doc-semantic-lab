...
Sprawdzić stabilność systemu przy długotrwałym obciążeniu (soak).


## Zakres i granice

- Obejmuje: długie testy z realistycznym ruchem, wycieki zasobów, degradację, metryki (latency/errors/memory), logowanie i alerty.
- Poza zakresem: jednorazowe piki (spike/stress).
...
- SLO/SLA
- Profile ruchu długotrwałego
- Środowisko testowe
- Narzędzia load/monitoringu
...
- Plan soak/endurance
- Raport wyników
- Rekomendacje (leaks, GC, throttling)
- Powiązania do capacity/ops
