...
## Cel dokumentu
Zdefiniować zasady ochrony danych w ramach funkcji Protect (PR.DS) NIST Cybersecurity Framework — zapewniając właściwe zarządzanie danymi i zabezpieczenie aktywów informacyjnych. Polityka obejmuje: klasyfikację danych, szyfrowanie w tranzycie i spoczynku, zarządzanie kluczami, kontrolę dostępu do wrażliwych danych, procedury bezpiecznego usuwania i ochronę przed wyciekiem danych (DLP).
