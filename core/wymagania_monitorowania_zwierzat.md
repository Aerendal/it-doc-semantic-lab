---
title: Wymagania monitorowania zwierząt
...
aligned_by: codex
---
# Wymagania monitorowania zwierząt
...
Wymagania systemu monitorowania zwierząt (agri).
...
1. Sygnały: pozycja, aktywność, biometria.
2. Urządzenia i łączność.
3. Bezpieczeństwo i dobrostan.
4. Alerty i raporty.
5. Integracje z FMS.
6. Battery/żywotność.
...
- [ ] Sygnały/urządzenia opisane.
- [ ] Bezpieczeństwo/dobrostan ujęte.
- [ ] Alerty/raporty zdefiniowane.
- [ ] Żywotność/bateria zaplanowane.
