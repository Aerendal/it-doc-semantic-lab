---
title: Deployment sensorów ruchu
...
Plan wdrożenia sensorów ruchu (np. w retail/biurach/bezpieczeństwie) z zachowaniem jakości danych i prywatności.
...
1. Zakres i lokalizacja sensorów; cele pomiaru.
2. Montaż i kalibracja; strefy wykrycia, false positives.
3. Łączność i zasilanie; sieć/segmentacja.
4. Integracja (broker/platforma/analytics), format zdarzeń.
5. Prywatność i bezpieczeństwo (brak PII, szyfrowanie, dostęp).
6. Monitoring i utrzymanie (health, bateria, alarmy).
...
- [ ] Lokalizacje i strefy wykrycia dobrane.
- [ ] Kalibracja/false positives przetestowane.
- [ ] Sieć/segmentacja i security (szyfrowanie) ustawione.
- [ ] Integracja i format zdarzeń zweryfikowane.
- [ ] Monitoring zdrowia/baterii działa.
