---
title: Przewodnik zarządzania inventory
...
aligned_by: codex
---
# Przewodnik zarządzania inventory
...
Ujednolicić operacje zarządzania zapasami.
...
1. Katalog i klasyfikacja: SKU, jednostki miary, lokalizacje.
2. Procesy: przyjęcia, wydania, transfery, inwentaryzacje.
3. Stany i alerty: min/max, reorder point, lead time.
4. Jakość danych: identyfikatory, skanowanie, cykliczne inwentaryzacje.
5. Integracje: ERP/WMS/POS, interfejsy i SLA synchronizacji.
6. Raporty: rotacja, shrinkage, aged inventory, prognozy.
...
- [ ] SKU i lokalizacje są zdefiniowane; dane są spójne.
- [ ] Procesy przyjęć/wydań i inwentaryzacji mają checklisty.
- [ ] Alerty min/max i lead time działają.
- [ ] Raporty rotacji i odchyleń są generowane i przeglądane.
