---
title: Reagowanie na alerty środowiskowe
...
aligned_by: codex
---
# Reagowanie na alerty środowiskowe
...
Procedura reakcji na alerty środowiskowe (np. zanieczyszczenia, pogoda).
...
1. Źródła alertów: czujniki, meteo, systemy zewnętrzne.
2. Klasyfikacja i progi: typ zagrożenia, poziomy.
3. Działania: powiadomienia, zamknięcia, ewakuacje, przełączenia.
4. Koordynacja: służby, dostawcy, komunikacja z interesariuszami.
5. Monitorowanie: potwierdzenie ustąpienia zagrożenia.
6. Post-action: raport, wnioski, aktualizacja progów.
...
- [ ] Alert zweryfikowany; poziom zagrożenia określony.
- [ ] Działania i komunikacja wykonane zgodnie z planem.
- [ ] Stan zagrożenia monitorowany do wygaszenia.
- [ ] Raport i aktualizacja procedur po zdarzeniu.
