...
Instrukcja tworzenia sieci wirtualnej (cloud/on-prem).
...
1. Adresacja i CIDR, VPC/VNet.
2. Subnets: public/private, AZ, routing.
3. Bezpieczeństwo: SG/NSG, NACL, firewalle.
4. Connectivity: VPN/ExpressRoute/peering.
5. Observability: flow logs, IDS/IPS.
6. IaC i testy: terraform/arm, smoke.
...
- [ ] CIDR/subnets zaplanowane.
- [ ] Reguły bezpieczeństwa ustawione.
- [ ] Łączność i peering przetestowane.
- [ ] IaC i testy smoke wykonane.
