...
Udokumentować wdrożenie konkretnych kontrolek bezpieczeństwa (kroki, dowody, status).


## Zakres i granice

- Obejmuje: zakres i kontrolki/klasyfikacje, właścicieli, dowody/testy, status i przeglądy.
...
- Kontekst i zakres
- Kontrolki/klasyfikacje/wymagania
- Właściciele i dowody/status
- Testy/przeglądy/monitoring
- Ryzyka i plan działań
...
- Wypełnij sekcje według szkieletu; dodaj status/dowody; sekcje N/A uzasadnij.
...
- Polityki/standardy/regulacje
- Architektura i mapa danych
- Ryzyka/incydenty/audyty
- Wyniki testów/skanów


## Wyjścia

- Dokument/plan/katalog
- Lista kontrolek/klas/ryzyk
- Plan działań/przeglądów
- Powiązania do monitoring/testów



## Szybkie powiązania (uzupełnij)

- [ ] security_controls_rollout_plan.md
...
- Streszczenie statusu, luk i planu działań; rozwinięcia kontroli/klas/wymagań.


## Wymagane powiązania

- Polityki, compliance matrix, monitoring/logging, testy/audyty, status reporty.


## Kryteria DoR

- [ ] Zakres i właściciele zebrani
- [ ] Polityki/regulacje znane
- [ ] Dowody/testy dostępne
- [ ] Mapa danych/ryzyk gotowa


## Kryteria DoD

- [ ] Dokument/plan wypełniony
- [ ] Status/dowody dodane
- [ ] Plan działań/przeglądów wpisany
...
- Sanity dowodów/statusów; w razie potrzeby próbny przegląd/scan.


## Metryki monitorowane

- Kontrolki/klasy green/amber/red
- Luki High/Med
- On-time przeglądy/testy
- Trend ryzyk


## Utrzymanie i aktualizacje

- Przegląd co release/kwartał lub po audycie/incydencie; aktualizacja quick-links/checklist.
