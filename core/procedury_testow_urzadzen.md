---
title: Procedury Testów Urządzeń
...
Zdefiniować procedury testów urządzeń (HW), aby zapewnić zgodność, bezpieczeństwo i jakość przed rolloutem.
...
1. Zakres urządzeń i wariantów: modele, wersje HW/FW, konfiguracje.
2. Rodzaje testów: funkcjonalne, kompatybilność, bezpieczeństwo, środowiskowe, wydajność, regulatory.
3. Macierz pokrycia: testy × modele/wersje; priorytety; automaty vs. manual.
4. Dane/narzędzia: bench, symulatory, logowanie, metryki, przyrządy pomiarowe.
5. Kryteria akceptacji: pass/fail, tolerancje, dokumentacja wyników, re-testy.
6. Raporty i śledzenie defektów: traceability, CAPA, release gates.
...
- [ ] Modele/wersje ujęte w macierzy; testy przypisane i wykonane.
- [ ] Kryteria akceptacji/tolerancje zdefiniowane; logi/metyki zebrane.
- [ ] Defekty zarejestrowane z CAPA; re-testy zaplanowane.
- [ ] Raport końcowy z pokryciem i wnioskami sporządzony.
