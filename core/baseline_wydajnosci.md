...
Ustalić punkt odniesienia dla wydajności systemu (czas odpowiedzi, throughput, zużycie zasobów), aby móc porównywać zmiany i wykrywać regresje.


## Zakres i granice

- Obejmuje: wybór metryk, scenariusze testowe (load/stress/soak), środowisko pomiarowe, metodologia, wyniki i wnioski.
- Nie obejmuje: planu optymalizacji (osobny dokument) ani szczegółowych testów bezpieczeństwa.
...
1. Zakres i scenariusze testów (load/stress/spike/soak).
2. Metryki (latencja p50/p95/p99, throughput, error rate, CPU/RAM/IO).
3. Środowisko i dane (wersja, konfiguracja, seed).
4. Wyniki baseline i wnioski.
5. Zalecenia i następne kroki.
...
- [ ] Scenariusze i metryki zdefiniowane.
- [ ] Środowisko i dane opisane (powtarzalność).
- [ ] Wyniki i wnioski zapisane.
- [ ] Porównanie do SLO wykonane.
...
- „Metryki/SLO” **constrains** „Scenariusze testowe”.
- „Wyniki” **feeds** „Plan optymalizacji”.
