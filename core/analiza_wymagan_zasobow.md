...
Oszacować i opisać, jakie zasoby są potrzebne do realizacji projektu/usługi (ludzie, infra, narzędzia, budżet), aby zaplanować je z wyprzedzeniem.


## Zakres i granice

- Obejmuje: role i FTE, środowiska i quota, licencje, sprzęt/chmura, budżet, dostępność czasową.
- Nie obejmuje: szczegółowego capacity planning (osobny dokument) ani planu rekrutacji (HR).
...
- Wejścia: plan projektu, zakres funkcji, harmonogram, polityki kosztowe, cenniki narzędzi/chmury.
- Wyjścia: lista zasobów z ilością/okresem, szacunek kosztu, ryzyka braków, plan pozyskania lub alternatywy.
...
- Harmonogram/Plan projektu.
- Analiza ograniczeń zasobów.
- Budżet/koszt (analiza kosztów/korzyści).
...
1. Wymagane role i czas (FTE, okresy).
2. Infrastruktura/środowiska/quota.
3. Licencje/narzędzia.
4. Koszt i budżet.
5. Ryzyka braków i plan pozyskania/alternatyw.
...
- [ ] Role/FTE i okresy zdefiniowane.
- [ ] Infra/quota/licencje opisane.
- [ ] Szacunek kosztu wykonany.
- [ ] Ryzyka braków i plan pozyskania zapisane.


## Definicje robocze

- **FTE** — Full-Time Equivalent (pełnoetatowy ekwiwalent).
...
- „Lista zasobów” **defines_structure** „Szacunek kosztu”.
- „Ryzyka braków” **feeds** „Plan pozyskania”.
