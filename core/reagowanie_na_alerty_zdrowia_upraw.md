---
title: Reagowanie na alerty zdrowia upraw
...
aligned_by: codex
---
# Reagowanie na alerty zdrowia upraw
...
Szybko reagować na alerty dotyczące zdrowia upraw.
...
1. Źródła alertów: satelita, drony, sensory, modele.
2. Triage: weryfikacja lokalizacji, uprawy, nasilenia.
3. Akcja: inspekcja w terenie, próbki, zdjęcia.
4. Działania agronomiczne: nawadnianie, nawożenie, środki ochrony.
5. Komunikacja: rolnik, agronom, log zmian.
6. Follow-up: monitoring efektu, aktualizacja modeli.
...
- [ ] Alert potwierdzony źródłami; miejsce i skala znane.
- [ ] Inspekcja/działania podjęte i zapisane.
- [ ] Komunikacja do rolnika/agronoma wykonana.
- [ ] Efekty monitorowane; modele zaktualizowane jeśli trzeba.
