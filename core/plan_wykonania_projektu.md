...
Opisać sposób realizacji projektu: zakres, harmonogram, zasoby, ryzyka i zasady kontroli.
...
2. Harmonogram: etapy, kamienie milowe, zależności, ścieżka krytyczna.
3. Zasoby: zespół, budżet, dostawcy, narzędzia; RACI.
4. Jakość i testy: DoR/DoD, strategia QA, kryteria akceptacji.
5. Ryzyka i zmiany: rejestr ryzyk, mitigacje, proces change, governance.
6. Raportowanie i komunikacja: cadence statusów, format, eskalacje, archiwizacja.
...
- [ ] Zasoby/RACI i budżet ustalone; strategia jakości/testów opisana.
- [ ] Rejestr ryzyk/zmian i governance działają.
- [ ] Plan raportowania/komunikacji uzgodniony.
