...
Program szkoleniowy dla klientów końcowych.
...
1. Audience i cele.
2. Agenda: podstawy, funkcje, bezpieczeństwo.
3. Materiały: prezentacje, demo, video.
4. Ćwiczenia i labs.
5. Ewaluacja i certyfikacja.
6. Wsparcie po szkoleniu.
...
- [ ] Cele i grupa określone.
- [ ] Materiały/ćwiczenia gotowe.
- [ ] Ewaluacja/certyfikacja przygotowane.
- [ ] Kanał wsparcia po szkoleniu wskazany.
