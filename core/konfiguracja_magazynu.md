...
Skonfigurować magazyn logistyczny (WMS) lub magazyn danych (należy doprecyzować w projekcie) tak, by zapewnić poprawne stany, procesy i wydajność.
...
1. Zakres i typ: fizyczny magazyn/WMS vs. magazyn danych; definicje.
2. Master data: lokalizacje, strefy, jednostki, pojemności, indeksy/SKU.
3. Procesy: przyjęcie, odkładanie, kompletacja, inwentaryzacja, zwroty; SLA.
4. Integracje: ERP/OMS/transport/automation (skanery, ASRS), etykiety, numery partii/seriale.
5. Parametry wydajności: slotting, fale, priorytety zleceń, KPI (OTIF, pick rate).
6. Bezpieczeństwo i audyt: role, logi zmian stanów, liczenie cykliczne, ścieżka audytu.
...
- [ ] Zdefiniowano typ magazynu i master data (lokalizacje, jednostki).
- [ ] Procesy przyjęcia/odkładania/kompletacji/zwrotów opisane z SLA.
- [ ] Integracje z ERP/OMS/automatyką działają; etykiety/seriale obsługiwane.
- [ ] KPI i audyt stanów/inwentaryzacji skonfigurowane.
