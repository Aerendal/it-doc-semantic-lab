...
Duplikat zakresu UAT: plan wykonania testów akceptacyjnych użytkownika – zakres, kryteria, scenariusze, dane, środowiska, komunikacja i raportowanie.
...
- Wymagania biznesowe i kryteria akceptacji.
- Środowisko UAT, dane testowe (maskowane/syntetyczne), plan release.
- Lista interesariuszy i kanały komunikacji.


## Wyjścia

- Scenariusze UAT i raport z wynikami/defektami.
- Rekomendacja go/no-go i sign-off.
- Action log i retrospektywa.



## Szybkie powiązania (uzupełnij)

- user_acceptance_testing_uat_plan.md (wskazać jeden z dwóch jako źródło prawdy)
...
- [ ] Zakres/kryteria akceptacji zdefiniowane i zatwierdzone.
