...
Harmonogram działań regulacyjnych.
...
1. Kamienie milowe: analizy, implementacja, testy, audyt, cert.
2. Zależności: dostawcy, laby, regulator.
3. Ryzyka: opóźnienia, zasoby, zmiany regulacji.
4. Bufory i priorytety.
5. Status kamieni: plan vs wykonanie.
6. Aktualizacja planu: wersjonowanie.
...
- [ ] Kamienie i zależności zmapowane.
- [ ] Ryzyka i bufory opisane.
- [ ] Status aktualny; wersja planu zapisana.
- [ ] Komunikacja harmonogramu do interesariuszy.
