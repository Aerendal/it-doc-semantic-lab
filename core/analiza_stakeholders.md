...
Zidentyfikować interesariuszy, ich potrzeby, wpływ i oczekiwania, by dobrać właściwą komunikację, priorytety i decyzje projektowe.


## Zakres i granice

- Obejmuje: mapę interesariuszy (moc vs zainteresowanie), potrzeby/inicjatywy, ryzyka wynikające z braku zaangażowania, plan komunikacji.
- Nie obejmuje: pełnego planu komunikacji projektu (osobny dokument) ani strategii marketingowej.
...
- Wejścia: lista ról/organizacji, cele biznesowe, wcześniejsze analizy, decyzje wpływające na stakeholderów.
- Wyjścia: mapa interesariuszy, priorytety zaangażowania, plan kontaktów/feedbacku, ryzyka i działania łagodzące.
...
1. Identyfikacja interesariuszy (kto, rola).
2. Ocena wpływu i zainteresowania (np. macierz Power/Interest).
3. Potrzeby i oczekiwania.
4. Ryzyka (brak wsparcia, sprzeczne cele) i mitigacje.
5. Plan komunikacji (kanał, częstotliwość, właściciel kontaktu).
...
- [ ] Lista interesariuszy kompletna i aktualna.
- [ ] Macierz wpływ/zainteresowanie wypełniona.
- [ ] Plan komunikacji dla kluczowych stakeholderów.
- [ ] Ryzyka i mitigacje opisane.


## Definicje robocze

- **Stakeholder** — osoba/grupa wpływająca lub dotknięta projektem.
- **Power/Interest matrix** — narzędzie do priorytetyzacji zaangażowania.
...
- „Mapa interesariuszy” **defines_structure** „Plan komunikacji”.
- „Ryzyka” **feeds** „Działania łagodzące”.
