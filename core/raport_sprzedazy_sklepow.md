---
title: Raport sprzedaży sklepów
...
Raportować sprzedaż sklepów stacjonarnych.
...
1. Zakres: sklepy, okres, kanały.
2. Metryki: sprzedaż brutto/netto, transakcje, AOV, konwersja.
3. Segmentacja: region, format sklepu, kategorie.
4. Porównania: rok do roku, budżet, plan.
5. Operacje: out-of-stock, obsada, awarie POS.
6. Wnioski: działania handlowe/operacyjne.
...
- [ ] Dane sprzedażowe zweryfikowane z POS/ERP.
- [ ] Segmentacja i porównania wykonane.
- [ ] Kluczowe problemy (stock/POS) opisane z planem.
- [ ] Wnioski mają właścicieli i daty.
