...
Środowisko dla React Native dev/CI.
...
1. Node/Yarn/PNPM wersje, watchman.
2. Android/iOS toolchain, pods.
3. Metro/babel config.
4. CI cache i build (Android/iOS).
5. Testy: unit/e2e (Detox).
6. Signing i secrets.
...
- [ ] Toolchain Android/iOS działa.
- [ ] Metro/babel ustawione.
- [ ] CI build/testy przechodzą.
- [ ] Signing/secrets zabezpieczone.
