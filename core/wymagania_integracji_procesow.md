---
title: Wymagania integracji procesów
...
Wymagania dla integracji procesowych (BPM/iPaaS).
...
1. Procesy i SLA.
2. Mapping danych i eventów.
3. Idempotencja/konflikty.
4. Bezpieczeństwo i audyt.
5. Monitorowanie i retry.
6. Testy i UAT.
...
- [ ] Procesy/SLA opisane.
- [ ] Mapy danych/eventów gotowe.
- [ ] Idempotencja/bezpieczeństwo ujęte.
