...
Udokumentować standardy i wzorce dokumentacji testów jednostkowych.


## Zakres i granice

- Obejmuje: konwencje nazw, Given/When/Then, fixtures/doubles, pokrycie krytycznych ścieżek, raportowanie.
- Poza zakresem: pisanie konkretnych testów.
