---
title: Baza wiedzy (referencyjna)
...
Zdefiniować strukturę i zasady utrzymania bazy wiedzy referencyjnej: co przechowujemy, jak wersjonujemy, jak szukamy i kto odpowiada za aktualność.


## Zakres i granice

- Obejmuje: kategorie/IA, formaty (how-to, FAQ, runbooki, decyzje), wersjonowanie, governance (ownerzy, przeglądy), wyszukiwanie/tagi, zasady dodawania/aktualizacji.
- Nie obejmuje: treści merytorycznych samych artykułów (to w konkretnych wpisach) ani polityki bezpieczeństwa repo (osobny dokument).
...
- Wejścia: istniejące artykuły, standardy dokumentacji, narzędzia (wiki/KB), potrzeby użytkowników.
- Wyjścia: mapa kategorii, szablony artykułów, R&R właścicieli, workflow publikacji/przeglądu, polityka archiwizacji.
...
- Incident/Runbook repos.
- Search/Taxonomy Policy.
...
1. Struktura informacji (kategorie, tagi, IA).
2. Szablony artykułów (how-to, FAQ, runbook, decision/ADR link).
3. Workflow publikacji i przeglądów (kto, kiedy, kryteria).
4. Wersjonowanie/archiwizacja i przestarzałe treści.
5. Wyszukiwanie i tagowanie (zasady, słowa kluczowe).
6. Jakość i mierniki (użycie, świeżość, feedback).
...
- [ ] IA/kategorie zdefiniowane, tagi opisane.
- [ ] Szablony artykułów dostępne.
- [ ] Workflow publikacji/przeglądu działa.
- [ ] Wersjonowanie/archiwizacja opisana.
- [ ] Mierniki jakości (świeżość/użycie) monitorowane.


## Definicje robocze

- **IA** — Information Architecture (układ informacji).
...
- „Kategorie/IA” **defines_structure** „Szablony artykułów”.
- „Governance” **constrains** „Publikację i przeglądy”.
