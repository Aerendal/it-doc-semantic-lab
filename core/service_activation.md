...
Udokumentować Service Management Plan (SMP) definiujący jak będą zarządzane usługi IT — jako centralny dokument wymagany przez ISO 20000-1 klauzula 6.5 (Service Management Plan). SMP opisuje: zakres SMS (System Management System), polityki zarządzania usługami, procesy i ich wzajemne zależności, role i odpowiedzialności, narzędzia ITSM, metryki i SLA — stanowiąc plan operacyjny dla całego systemu zarządzania usługami.
