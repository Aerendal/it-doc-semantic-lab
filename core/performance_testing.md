...
Wykonać testy wydajnościowe systemu, aby potwierdzić spełnienie SLO i wykryć wąskie gardła.


## Zakres i granice

- Obejmuje: testy load/stress/spike/soak, metryki latency/throughput/error, monitoring zasobów, raportowanie.
- Poza zakresem: testy UI i szczegółowe optymalizacje.
...
- SLO/SLA
- Profil ruchu i krytyczne ścieżki
- Środowisko testowe i narzędzia load
- Dane testowe


## Wyjścia

- Plan i wyniki testów
