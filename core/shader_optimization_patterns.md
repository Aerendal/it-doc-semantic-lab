---
title: Shader Optimization Patterns
...
Zebrać wzorce optymalizacji shaderów, by redukować koszty GPU/CPU i minimalizować regresje jakości.


## Zakres i granice

- Obejmuje: redukcję złożoności shaderów, ograniczanie branching/loops, teksturowanie, lighting, RT/SSR optymalizacje, kompresję danych, precomputations, narzędzia profilowania.
- Poza zakresem: artystyczne style shaderów i asset pipeline.
...
- Kontekst i cele
- Hot-spoty i priorytety
- Wzorce optymalizacji (kategorie)
- Anti‑patterns i ryzyka jakości
- Przykłady przed/po i dowody
- Utrzymanie i regresje
...
- Metryki perf z profilera (GPU/CPU)
- Lista hot-spotów shaderów i efektów
- Cele jakości i budżety per pass
- Profile platform/API


## Wyjścia

- Lista wzorców i anti‑patterns z przykładami
- Checklist optymalizacji per kategoria (lighting/texture/postFX/RT)
- Linki do capture i wyników przed/po
- Powiązania do pipeline i jakości
...
- [ ] Hot-spoty z profilera zebrane
- [ ] Cele jakości/perf uzgodnione
- [ ] Profile platform/API znane
- [ ] Baseline capture dostępne


## Kryteria DoD

- [ ] Wzorce i anti‑patterns spisane
- [ ] Przykłady przed/po z metrykami
- [ ] Ryzyka jakości opisane
- [ ] Quick-links/checklisty uzupełnione


## Artefakty do załączenia

- Tabela wzorców z przykładami
- Capture przed/po (GPU/CPU)
- Raporty metryk po optymalizacji
- Lista anti‑patterns i mitigacje
...
- Spadek czasu shader pass (ms)
- Zmiana FPS/frametime
- Zmiana VRAM/IO
- Liczba regresji jakości
