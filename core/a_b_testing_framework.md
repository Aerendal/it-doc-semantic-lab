...
Zdefiniować ramy prowadzenia testów A/B (planowanie, randomizacja, metryki, analiza, rollout).


## Zakres i granice

- Obejmuje: typy eksperymentów, segmentację, randomizację/assign, metryki i MDE, czas trwania, zatrzymanie/rollout, etyka/privacy.
- Poza zakresem: implementacja konkretnych eksperymentów w kodzie produktu.
...
- Kontekst i cele
- Randomizacja i segmenty
- Metryki/MDE i czas trwania
- Procedury stop/rollout
- Analiza/statystyka
- Privacy/etyka
- Ryzyka
...
- Cele biznesowe i hipotezy
- Docelowe metryki i MDE
- Segmenty i ograniczenia privacy
...
- Framework/kroki A/B
- Checklisty DoR/DoD
- Szablony planu/raportu
- Powiązania do narzędzi/SDK
