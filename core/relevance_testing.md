...
## Cel dokumentu
Relevance Testing definiuje strategię i zakres testów wraz z kryteriami akceptacji i raportowaniem defektów.
...
- Zależność: {'depends_on': 'Search Architecture Design', 'type': 'typical'}
- Zależność: {'depends_on': 'Search Platform Setup', 'type': 'sequential'}
