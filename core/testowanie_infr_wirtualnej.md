---
title: Testowanie infr. wirtualnej
...
Plan testów infrastruktury wirtualnej.
...
1. Zakres: hypervisor, sieć, storage.
2. Testy: HA/DRS, live migration, failover.
3. Performance: CPU/RAM/IO.
4. Bezpieczeństwo: segmentacja, access.
...
- [ ] HA/migration/failover przetestowane.
- [ ] Performance zmierzone.
- [ ] Security/segmentacja zweryfikowane.
- [ ] Raport gotowy.
