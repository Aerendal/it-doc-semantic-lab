---
title: Search Incident Postmortem
...
## Cel dokumentu
Search Incident Postmortem opisuje, jak przygotować się na incydenty i jak reagować/mitygować skutki.
...
## Szybkie powiązania
- Zależność: {'depends_on': 'Search Outage Response', 'type': 'sequential'}
- Zależność: {'depends_on': 'Search Outage Response', 'type': 'sequential'}
