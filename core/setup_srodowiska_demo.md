...
1. Zakres i scenariusze demo.
2. Dane: maskowane/seed, reset.
3. Konfiguracja funkcji/feature flags.
4. Dostępy: konta demo, MFA/offline.
5. Stabilność: monitoring, auto-refresh.
6. Instrukcje i runbook pokazów.
...
- [ ] Scenariusze i dane demo gotowe.
- [ ] Feature flags i konta skonfigurowane.
- [ ] Monitoring/reset działają.
- [ ] Runbook pokazów dostępny.
