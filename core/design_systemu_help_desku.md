---
title: Design systemu help desku
...
Zaprojektować system help desk/ITSM: intake, workflow, SLA, integracje i raportowanie.
...
1. Kanały intake (portal/email/chat/phone) i kategoryzacja/priorytety.
2. Workflow: assignment, automaty, playbooki, eskalacje, approvals.
3. SLA/OLA, KPI (FCR, MTTR, backlog, CSAT), SLO alerty.
4. CMDB/asset, change/problem/incidents relacje.
5. Integracje: SSO, monitoring/alerty→tickets, telephony, chatops.
6. UX/KB/self-service i deflection.
7. Raporty i audyt.
...
- [ ] Intake/kategorie/prio i automaty opisane.
- [ ] SLA/KPI/alerty zdefiniowane.
- [ ] Eskalacje i playbooki gotowe.
- [ ] Integracje SSO/monitoring/telephony działają.
- [ ] KB/self-service i raporty aktywne.
