...
Szkolenie z wybranego frameworka (np. React/Spring).
...
2. Projekt/struktura kodu.
3. State/routing/DI.
4. Testy i debug.
5. Performance/security best practices.
6. Ćwiczenia i projekt.
...
- [ ] Plan obejmuje kluczowe moduły.
- [ ] Ćwiczenia/projekt przygotowane.
- [ ] Testy/performance/security uwzględnione.
- [ ] Materiały i repo dostępne.
