...
Zebrać najważniejsze wskazówki optymalizacji wydajności aplikacji mobilnych (iOS/Android).
...
1. UI/Rendering: minimalizacja overdraw, batch UI updates, lazy lists, throttle animacji.
2. Sieć: cache/ETag, kompresja, retry/backoff, ograniczanie payloadów, prefetch.
3. Pamięć/bateria: ograniczenie alokacji, leak detection, wakelocki, job scheduling.
4. Startup/launch: cold/warm start, deferred init, split loading feature’ów.
5. Media/obrazy: rozmiary, formaty (WebP/AVIF), caching, decode off-main.
6. Observability: trace/logi z samplingiem, crash/ANR monitoring, release gating.
...
- [ ] Kluczowe obszary (UI/sieć/pamięć/start) mają zastosowane optymalizacje.
- [ ] Crash/ANR i metryki start/latency monitorowane.
- [ ] Payloady/bateria/pamięć zmierzone po zmianach.
- [ ] Release gating na metryki krytyczne ustawiony.
