...
Ustandaryzować tworzenie i konfigurację maszyn wirtualnych.
...
1. Szablony i obrazy: golden image, hardening, wersje, właściciel.
2. Parametry: rozmiar, sieć, storage, tagi/koszt, strefy dostępności.
3. Automatyzacja: IaC, pipeline provisioning, approvals, drift detection.
4. Bezpieczeństwo: klucze SSH, konta, patch baseline, antymalware, logowanie.
5. Testy i walidacja: smoke test, monitoring agent, backup snapshot.
6. Eksploatacja: rotacja, lifecycle (stop/start/terminate), dokumentacja.
...
- [ ] Użyto zatwierdzonego obrazu i szablonu IaC.
- [ ] VM ma poprawne tagi/koszty, monitoring i backup.
- [ ] Dostępy/klucze skonfigurowane zgodnie z polityką; SSH/WinRM zabezpieczone.
- [ ] Provisioning zapisany w logach audytowych; drift monitorowany.
