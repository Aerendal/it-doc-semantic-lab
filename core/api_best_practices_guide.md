...
Skatalogować najlepsze praktyki tworzenia i utrzymania API (design, bezpieczeństwo, wydajność, DX).


## Zakres i granice

- Obejmuje: design (naming, errors, pagination), bezpieczeństwo (auth/authz, rate limiting), wydajność (caching, async), dokumentacja/DX, wersjonowanie, monitoring.
- Poza zakresem: szczegóły implementacji poszczególnych usług.
...
- Style guide org
- Feedback deweloperów i partnerów
- Incydenty i postmortem
- Regulacje/compliance jeśli dotyczy


## Wyjścia

- Lista best practices (must/should)
- Checklisty DoR/DoD
- Powiązania do design/security/perf/docs
- Przykłady
...
- [ ] Style guide i feedback zebrane
- [ ] Incydenty i lekcje zebrane
- [ ] Wymagania security/perf znane
- [ ] Owner dokumentu przypisany


## Kryteria DoD

- [ ] Best practices spisane
- [ ] Checklisty dodane
...
- Lista best practices
- Checklisty
- Przykłady
- Linki do stylów i narzędzi
