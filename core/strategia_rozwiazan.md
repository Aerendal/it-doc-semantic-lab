...
Strategia projektowania i wyboru rozwiązań.
...
1. Wizja i zasady architektoniczne.
2. Kryteria wyboru: ROI, ryzyko, time-to-market.
3. Portfolio i priorytetyzacja.
4. Standardy technologiczne.
5. Governance decyzji (ADR).
6. Metryki sukcesu.
...
- [ ] Zasady i kryteria wyboru opisane.
- [ ] Standardy tech ustalone.
- [ ] Governance/ADR działa.
