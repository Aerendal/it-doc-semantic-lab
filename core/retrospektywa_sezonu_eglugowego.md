---
title: Retrospektywa sezonu Å¼eglugowego
...
aligned_by: codex
---
# Retrospektywa sezonu Å¼eglugowego
...
Retrospektywa sezonu żeglugowego — szablon dokumentu IT.

Podsumowuje sprint lub retrospektywę — co poszło dobrze, co wymaga poprawy, action items z właścicielami i terminami oraz metryki sprintu (velocity, burndown, defect rate).

> Dokument satelitarny do: "Retrospektywa sezonu szczytu" - rozszerza lub uszczegolawia jego tresc.
...
- **Wejścia** (co musi być dostępne przed wypełnieniem): Ukończone i nieukończone stories sprintu, feedback zespołu (Start/Stop/Continue lub 4Ls), metryki poprzednich sprintów.
- **Wyjścia** (co dokument wytwarza jako rezultat): Lista action items z właścicielami i terminami, zaktualizowana velocity i prognoza release, wnioski do kolejnego planowania.
...
- **Wpływa na** (downstream — co zależy od tego dokumentu): Planowanie kolejnego sprintu, backlog refinement, raportowanie postępu projektu, metryki jakości zespołu.
- **Zależy od** (upstream — co musi istnieć przed tym dokumentem): Definicja ukończenia (DoD), backlog produktu, metryki poprzednich sprintów, alokacje zasobów.
