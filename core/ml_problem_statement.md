...
Sformalizować definicję problemu ML/AI jako wejście do procesu zarządzania systemem AI zgodnie z ISO/IEC 42001 (AI Management System) i jako podstawę projektowania systemu. Problem Statement obejmuje: opis problemu biznesowego, hipotezę ML, zbiory danych, metryki sukcesu (accuracy, F1, latency), ograniczenia etyczne i wyjaśnialności — będąc punktem wyjścia dla AI Risk Assessment i AI Impact Assessment.
