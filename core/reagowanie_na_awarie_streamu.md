---
title: Reagowanie na awarie streamu
...
Szybko przywrócić stream audio/video.
...
1. Detekcja: monitoring QoE/QoS, alarmy, zgłoszenia.
2. Triage: CDN, encoder, player, region, urządzenia.
3. Stabilizacja: przełączenie źródła, profil bitrate, backup CDN.
4. Naprawa: encoder/config, DRM/ads, sieć.
5. Komunikacja: status, ETA, rekomendacje dla widzów.
6. Postmortem: przyczyna, poprawki, testy regresji.
...
- [ ] Źródło problemu (CDN/encoder/player) zidentyfikowane.
- [ ] Fallback/backup włączony; stream działa.
- [ ] Przyczyna naprawiona i przetestowana.
- [ ] Postmortem zapisany.
