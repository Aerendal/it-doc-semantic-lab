...
Dokumentować Umowę Powierzenia Przetwarzania Danych Osobowych (DPA) wymaganą przez RODO Art. 28 i ISO/IEC 27701 (Privacy Information Management — PIM). DPA precyzuje: zakres i cel przetwarzania przez podmiot przetwarzający, obowiązki w zakresie bezpieczeństwa (techniczne/organizacyjne), warunki angażowania dalszych podmiotów, prawa osoby fizycznej, audyt i zwrot/usunięcie danych po zakończeniu umowy.
