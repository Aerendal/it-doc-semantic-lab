---
title: Reagowanie na awarie MES
...
Przywrócić działanie systemu MES przy awarii.
...
1. Detekcja: alerty, zgłoszenia operatorów.
2. Triage: które linie/stanowiska, wpływ na produkcję.
3. Stabilizacja: przełączenie na procedury manualne, restart usług, fallback.
4. Komunikacja: utrzymanie ruchu, produkcja, kierownictwo.
5. Naprawa: root cause (baza, integracje, sprzęt), testy.
6. Postmortem: działania zapobiegawcze, szkolenia.
...
- [ ] Wpływ na linie/produkty oceniony.
- [ ] Fallback/manualne procedury uruchomione jeśli trzeba.
- [ ] Fix wdrożony i przetestowany; produkcja wznowiona.
