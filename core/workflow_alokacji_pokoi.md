...
Workflow przydziału pokoi (hospitality).
...
1. Zasady przydziału i priorytety.
2. Dane: typ pokoju, preferencje, status.
3. Integracje: PMS/CRM.
4. Edge cases: overbooking, VIP.
5. Automatyzacja i ręczne korekty.
...
- [ ] Zasady/priorytety opisane.
- [ ] Integracje i edge cases uwzględnione.
- [ ] Automatyzacja/korekty opisane.
- [ ] KPI/raport gotowy.
