---
title: Roadmapa badań kwantowych
...
Roadmap badań/eksperymentów kwantowych.
...
2. Platformy: NISQ/symulator, dostępność.
3. Kamienie: eksperymenty, publikacje, prototypy.
4. Zasoby: zespół, budżet, granty.
5. Ryzyka: dostęp do hardware, dekoherencja, IP.
...
- [ ] Cele i kamienie zdefiniowane.
- [ ] Zasoby i ryzyka opisane.
- [ ] Metryki/go-no-go ustalone.
