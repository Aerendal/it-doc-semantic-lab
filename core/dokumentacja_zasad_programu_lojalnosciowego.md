---
title: Dokumentacja zasad programu lojalnościowego
...
aligned_by: codex
---
# Dokumentacja zasad programu lojalnościowego
...
Spisać oficjalne zasady programu lojalnościowego: earn/burn, tier’y, wykluczenia, podatki i prywatność.
...
1. Uczestnictwo: kto może, rejestracja, zgody.
2. Earn: stawki punktów, kwalifikujące transakcje, wykluczenia, limity.
3. Burn: nagrody, kurs wymiany, ograniczenia, expiry, blackout.
4. Tier’y: progi, korzyści, utrzymanie/spadek.
5. Fraud/abuse: monitoring, blokady, appeal.
6. Podatki/regulacje, privacy/RODO, kontakt/support.
7. Zmiany zasad i komunikacja.
...
- [ ] Earn/burn/tier/expiry jasno opisane.
- [ ] Wykluczenia/limity/podatki/RODO uwzględnione.
- [ ] Procedury fraud/appeal opisane.
- [ ] Proces zmian i komunikacji zdefiniowany.
