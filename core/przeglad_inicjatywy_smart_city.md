---
title: Przegląd inicjatywy smart city
...
aligned_by: codex
---
# Przegląd inicjatywy smart city
...
Zweryfikować spójność, bezpieczeństwo i wartość inicjatyw smart city.
...
1. Zakres i interesariusze: transport, energia, bezpieczeństwo, mieszkańcy.
2. Dane i prywatność: źródła (IoT, CCTV), zgody, anonimizacja, open data.
3. Architektura: edge/gateway, chmura, integracje z systemami miejskimi.
4. SLA i ciągłość: dostępność usług krytycznych, DR/BCP.
5. Cyberbezpieczeństwo: segmentacja, certy, zarządzanie urządzeniami, SOC.
6. Wpływ i KPI: ruch, emisje, satysfakcja mieszkańców, koszty operacyjne.
...
- [ ] Mapa interesariuszy i zakres usług jest kompletna.
- [ ] Prywatność i open data mają jasne zasady; dane są anonimizowane.
- [ ] Architektura i zabezpieczenia urządzeń są zgodne z polityką.
- [ ] KPI są mierzone; plany DR/BCP istnieją.
