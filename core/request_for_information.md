...
Szablon RFI do pozyskania informacji od dostawców.
...
1. Cel i zakres RFI.
2. Opis potrzeb i wymagań wysokiego poziomu.
3. Pytania do dostawców: funkcje, skalowanie, bezpieczeństwo.
4. Format odpowiedzi i terminy.
5. Kryteria oceny.
6. Kontakt i NDA.
...
- [ ] Zakres i pytania jasno opisane.
- [ ] Terminy i format odpowiedzi podane.
- [ ] Kryteria oceny określone.
- [ ] Kontakt/NDA wskazane.
