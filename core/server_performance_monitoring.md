...
1. Zakres: typy serwerów, krytyczność.
2. Metryki: CPU, RAM, IO, sieć, procesy.
3. Alerty: progi, burn-rate, eskalacje.
4. Narzędzia: APM/metrics/logs, agent config.
5. Raporty i przeglądy.
...
- [ ] Metryki i progi zdefiniowane.
- [ ] Alerty/escalacje działają.
- [ ] Raporty/przeglądy cykliczne.
- [ ] Plan korekt jest.
