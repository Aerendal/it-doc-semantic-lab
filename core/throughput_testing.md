...
## Cel dokumentu
Throughput Testing definiuje strategię i zakres testów wraz z kryteriami akceptacji i raportowaniem defektów.
...
## Szybkie powiązania
- Zależność: {'depends_on': 'Stream Topology Design', 'type': 'typical'}
- Zależność: {'depends_on': 'Stream Processing Topology', 'type': 'typical'}
- Zależność: {'depends_on': 'Stream Topology Design', 'type': 'typical'}
