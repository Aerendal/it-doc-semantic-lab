...
Zdefiniować specyfikację testów jednostkowych dla modułu/komponentu.


## Zakres i granice

- Obejmuje: zakres funkcji, przypadki pozytywne/negatywne, błędy, mocki, dane testowe, kryteria zaliczenia.
- Poza zakresem: testy integracyjne.
