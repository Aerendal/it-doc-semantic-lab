...
1. Flutter/Dart wersje.
2. Tooling: fvm/asdf, lints.
3. Emulatory/urządzenia.
4. CI: cache pub, build flavors.
5. Testy: unit/widget/integration.
6. Signing i secrets.
...
- [ ] Wersje zainstalowane i przypięte.
- [ ] Build/testy przechodzą.
- [ ] CI cache i flavors ustawione.
