---
title: Cloud Migration Retrospective
...
## Cel dokumentu
Krótka definicja: Cloud Migration Retrospective opisuje cel, rolę w procesie decyzyjnym oraz ryzyka, które dokument ma ograniczać (co najmniej w 2–3 zdaniach).
...
1. Cel i zakres retrospektywy: które fale/systemy, okres, KPI/OKR migracji.
2. Co poszło dobrze / co poszło źle: architektura, bezpieczeństwo/compliance, dane, operacje/SRE, FinOps, zespół.
3. Dane i metryki: postęp vs plan, defekty/regresje, incydenty, SLO, koszty vs budżet.
4. Ryzyka i problemy napotkane: techniczne, organizacyjne, vendor/3rd party; jak je rozwiązano lub przeniesiono.
5. Lekcje i działania usprawniające: zmiany w procesach, narzędziach, guardrails, testach, szkoleniach.
6. Plan follow-up: właściciele, terminy, kryteria weryfikacji (jak sprawdzimy skuteczność).
7. Aktualizacje dokumentów: roadmap, runbooki, polityki, baseline’y; komunikacja do stakeholderów.

## Wymagane rozwinięcia
- Metryki i ryzyka rozwijają: Cloud Migration Plan/Roadmap, Cloud Security Baseline, DR/BCP, FinOps reports.
- Działania usprawniające rozwijają: CI/CD, guardrails/policy-as-code, testy perf/security/DR.

## Wymagane streszczenia
- Streszczenie 5–10 najważniejszych wniosków i akcji z terminami/właścicielami.
...
- DoR:
  - [ ] Zakres fal/systemów i KPI/OKR retrospektywy zdefiniowane; dane/metryki dostępne.
  - [ ] Zebrane sygnały: incydenty, SLO, defekty, koszty, postęp vs plan.
  - [ ] Właściciele domen (architektura, security/compliance, dane, SRE, FinOps) zaangażowani.
- DoD:
  - [ ] Wnioski „co poszło dobrze/źle” udokumentowane z danymi; ryzyka i problemy opisane.
  - [ ] Działania usprawniające mają właścicieli/term. i kryteria weryfikacji; plan follow-up ustalony.
  - [ ] Aktualizacje roadmap/runbooków/polityk zapisane; dokument wersjonowany i udostępniony.
