...
## Cel dokumentu
Model Training Schedule opisuje program szkoleniowy/onboardingowy z celami, modułami i sposobem oceny.
...
## Szybkie powiązania
- Zależność: {'depends_on': 'Dialog Flow Design', 'type': 'sequential'}
- Zależność: {'depends_on': 'Dialog Flow Design', 'type': 'sequential'}
