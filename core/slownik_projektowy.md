...
Słownik pojęć projektu.



## Zakres i granice
Obejmuje: opis architektury (komponenty, warstwy, integracje), wymagania niefunkcjonalne, decyzje projektowe. Nie obejmuje: szczegółów implementacji (kodu) ani konfiguracji operacyjnej.
...
2. Akronimy i skróty.
3. Źródła prawdy.
4. Właściciel i aktualizacja.
5. Powiązania z dokumentacją.
6. Historia zmian.
...
- [ ] Definicje i skróty uzupełnione.
- [ ] Źródła/owner wskazani.
- [ ] Powiązania i aktualizacja opisane.
- [ ] Historia zmian prowadzona.
