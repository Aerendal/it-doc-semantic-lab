---
title: Referencja konfiguracji OPC UA
...
aligned_by: codex
---
# Referencja konfiguracji OPC UA
...
Standard konfiguracji serwerów/klientów OPC UA.
...
1. Endpointy: security modes, certyfikaty, użytkownicy.
2. Model adresów: namespace, tags, typy danych.
3. Subskrypcje: sampling, publishing, queue, deadband.
4. Bezpieczeństwo: cert management, revocation, time sync.
5. Wydajność: batching, compression, network.
6. Monitoring i logi: audyt, retry, reconnect.
...
- [ ] Endpointy i security mode określone; certy zarządzane.
- [ ] Model adresów udokumentowany.
- [ ] Parametry subskrypcji dobrane do wymagań.
- [ ] Monitoring i audyt włączone.
