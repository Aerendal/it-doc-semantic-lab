---
title: Procedury zarządzania cenami
...
Kontrolować cykl życia cen i promocji z uwzględnieniem marży, podatków i zgodności.
...
1. Model cenowy: lista produktów/usług, waluty, podatki/VAT, koszty bazowe.
2. Proces zmian cen: kto inicjuje, akceptacje (komercja/finanse/Legal), okna publikacji.
3. Promocje i kupony: zasady, limity, anti-abuse, stacking rules, daty obowiązywania.
4. Regionalizacja: różnice geograficzne, kursy walut, podatki lokalne, marketplace fees.
5. Publikacja i rollback: synchronizacja kanałów (WWW, POS, partnerzy), plan wycofania.
6. Monitoring: wpływ na sprzedaż, marżę, alerty na anomalie cenowe lub niezgodności.
...
- [ ] Zmiany cen mają zatwierdzenie finansów/Legal i zapis w dzienniku zmian.
- [ ] Promocje mają zdefiniowane limity, daty i mechanizmy anti-abuse.
- [ ] Publikacja cen zsynchronizowana we wszystkich kanałach; plan rollback istnieje.
- [ ] Metryki marży i anomalii cenowych monitorowane po wdrożeniu.
