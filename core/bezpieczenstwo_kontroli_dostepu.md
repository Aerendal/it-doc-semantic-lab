---
title: Bezpieczeństwo kontroli dostępu
...
aligned_by: codex
---
# Bezpieczeństwo kontroli dostępu
...
Zapewnić, że mechanizmy kontroli dostępu (IAM/ACL/RBAC/ABAC) są poprawnie zaprojektowane, egzekwowane i audytowane.


## Zakres i granice

- Obejmuje: model uprawnień (RBAC/ABAC), separację obowiązków, least privilege, zarządzanie rolami i grupami, dostęp uprzywilejowany (PAM), audyt i recertyfikację.
- Nie obejmuje: szczegółowej konfiguracji IdP/SSO (osobny dokument) ani polityk haseł końcowych.
...
- [ ] Role i SoD zdefiniowane, least privilege.
- [ ] PAM/break glass opisane.
- [ ] Przeglądy dostępu i logi działają.
- [ ] Integracje z IdP/SSO skonfigurowane.
