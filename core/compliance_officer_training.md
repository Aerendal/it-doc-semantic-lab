...
## Cel dokumentu
Compliance Officer Training opisuje program szkoleniowy/onboardingowy z celami, modułami i sposobem oceny.
...
## Szybkie powiązania
- Zależność: {'depends_on': 'Compliance Monitoring Runbook', 'type': 'sequential'}
- Zależność: {'depends_on': 'Compliance Monitoring Runbook', 'type': 'sequential'}
