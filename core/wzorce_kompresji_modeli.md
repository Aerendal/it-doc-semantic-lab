...
2. Techniki: quant/prune/distill.
3. Kiedy którą technikę.
4. Walidacja jakości.
5. Deployment (edge/cloud).
6. Przykłady.
...
- [ ] Cele/techniki opisane.
- [ ] Dobór techniki uzasadniony.
- [ ] Walidacja jakości ujęta.
- [ ] Przykłady dodane.
