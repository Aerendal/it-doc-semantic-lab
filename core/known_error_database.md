...
Prowadzić bazę znanych błędów (Known Error Database — KEDB) jako centralny rejestr zidentyfikowanych root causes problemów w środowisku IT — zgodnie z praktyką Problem Management ITIL 4. Każdy wpis KEDB zawiera: opis symptomu, udokumentowany root cause, zatwierdzony workaround, status naprawy i link do Change Request — umożliwiając Service Desk szybkie rozwiązywanie incydentów bez ponownej diagnozy.
