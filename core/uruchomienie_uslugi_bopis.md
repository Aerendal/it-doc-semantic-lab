---
title: Uruchomienie usługi BOPIS
...
1. Proces zamówień i statusy.
2. Synchronizacja inventory.
3. Płatności i refundy.
4. Powiadomienia i obsługa klienta.
5. Monitoring SLA.
6. Fallback.
...
- [ ] Proces/statusy działają.
- [ ] Inventory/płatności synchro.
- [ ] Powiadomienia/SLA monitorowane.
- [ ] Fallback gotowy.
