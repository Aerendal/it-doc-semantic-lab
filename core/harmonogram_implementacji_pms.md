---
title: Harmonogram implementacji PMS
...
Zaplanować wdrożenie PMS (system zarządzania projektami/obiektami): fazy, moduły, lokalizacje i integracje.
...
1. Zakres modułów (portfolio, zasoby, finanse) oraz lokalizacje/piony.
2. Etapy: przygotowanie danych → pilotaż → rollout falami; kamienie milowe.
3. Integracje: ERP/HR/CMMS/BI; zależności i okna techniczne.
4. Migracja danych: źródła, mapping, walidacja i plan cutover.
5. Szkolenia i zarządzanie zmianą; komunikacja do użytkowników.
6. Ryzyka, kryteria Go/No-Go, plan rollback.
...
- [ ] Moduły i lokalizacje opisane z właścicielami.
- [ ] Integracje i okna techniczne uzgodnione.
- [ ] Migracja danych z walidacją i rollbackiem zaplanowana.
- [ ] Plan szkoleń i komunikacji zaakceptowany.
