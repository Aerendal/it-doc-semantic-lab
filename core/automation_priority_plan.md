---
title: Automation Priority Plan
...
Automation Priority Plan określa harmonogram, zakres i odpowiedzialności, aby dowieźć rezultat w kontrolowany sposób.
...
- Zależność: {'depends_on': 'SLI/SLO/SLA Design', 'type': 'INFORMED_BY'}
- Zależność: {'depends_on': 'On-Call Rotation Design', 'type': 'INFORMED_BY'}
- Zależność: {'depends_on': 'SLI/SLO/SLA Design', 'type': 'INFORMED_BY'}
