---
title: Plan komunikacji projektu
...
Zdefiniować komunikację wewnętrzną i zewnętrzną projektu: interesariusze, kanały, częstotliwość i treści.
...
1. Interesariusze i potrzeby: zarząd, zespół, klienci, partnerzy; oczekiwane informacje.
2. Kanały i formaty: spotkania (steering/status), email, chat, raporty, portal, status page.
3. Harmonogram: cadence (daily/weekly/monthly), warunki ad-hoc (incydenty/zmiany scope).
4. Szablony i zawartość: agenda/status, ryzyka, decyzje, KPI/progres, next steps.
5. Rola i odpowiedzialność: kto przygotowuje/akceptuje/wysyła; RACI.
6. Archiwizacja i transparentność: repo komunikacji, dostęp, numeracja wersji.
...
- [ ] Interesariusze i ich potrzeby zmapowane; kanały dobrane.
- [ ] Harmonogram komunikacji ustalony; szablony statusów gotowe.
- [ ] Odpowiedzialności (RACI) przypisane; archiwizacja zapewniona.
- [ ] Ryzyka/decyzje/KPI raportowane konsekwentnie.
