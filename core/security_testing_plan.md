...
Zaplanować testy bezpieczeństwa (SAST/DAST/fuzz/pen) dla systemu/API.


## Zakres i granice

- Obejmuje: zakres usług/komponentów, typy testów, narzędzia, dane, harmonogram, kryteria akceptacji, raportowanie.
- Poza zakresem: pełny pentest infrastruktury fizycznej.
...
- Kontekst i cele
- Zakres i priorytety
- Typy testów (SAST/DAST/fuzz/pen)
- Środowiska/dane
- Kryteria akceptacji
- Harmonogram
- Raportowanie/Ryzyka
...
- Plan testów security
- Scenariusze i narzędzia
- Raportowanie i SLA napraw
- Checklisty DoR/DoD
...
- Streszczenie kluczowych decyzji/ryzyk; rozwinięcia planów/testów/raportów.


## Wymagane powiązania

- Dokumenty compliance/security/testing/logging; runbooki incydentów; monitoring.


## Kryteria DoR

- [ ] Model zagrożeń i spec znane
...
- [ ] Plan i scenariusze spisane
- [ ] Raportowanie/SLA napraw zdefiniowane
...
- Wykonaj próbny przegląd/alerty lub test sanity; zweryfikuj dane/środowiska.
...
- Czas do naprawy
- Pokrycie usług testami
- Regresje bezpieczeństwa


## Utrzymanie i aktualizacje

- Przegląd co release lub wg harmonogramu audytów/testów/reportingu.
