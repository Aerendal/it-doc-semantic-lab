---
title: Hierarchiczny podział pracy
...
Zbudować WBS (Work Breakdown Structure) dla projektu: jasna dekompozycja zakresu, odpowiedzialności i zależności.
...
1. Założenia projektowe i cele biznesowe.
2. Poziomy WBS: fazy → epiki → zadania → deliverable; numeracja i słownik pojęć.
3. Przypisanie ról/właścicieli do elementów WBS (RACI).
4. Zależności między elementami, kamienie milowe i krytyczna ścieżka.
5. Integracja z harmonogramem (Gantt) i budżetem.
6. Mechanizm kontroli zmian WBS i rejestr decyzji.
...
- [ ] WBS pokrywa cały zakres (100% rule) i ma jednoznaczną numerację.
- [ ] Każdy element ma właściciela i zdefiniowane deliverable.
- [ ] Zależności i kamienie milowe oznaczone.
- [ ] Proces zmian i wersjonowania WBS opisany.
