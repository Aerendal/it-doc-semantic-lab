...
Przydzielić zasoby (ludzie/budżet/sprzęt) do inicjatyw projektu w sposób transparentny i zgodny z priorytetami.
...
1. Zakres i cele: projekty/strumienie, priorytety, KPI.
2. Budżet i limity: CAPEX/OPEX, headcount, licencje, sprzęt.
3. Przydziały: role vs projekty, % czasu, daty start/koniec, macierz RACI.
4. Zależności i ryzyka: kluczowe kompetencje, single points, plany backup.
5. Monitorowanie: burn-rate, obciążenie, zmiany w priorytetach; proces replanowania.
6. Komunikacja: zatwierdzenia, publikacja planu, aktualizacje cykliczne.
...
- [ ] Priorytety i KPI ustalone; budżet i limity znane.
- [ ] Przydziały ról/etatu i RACI zapisane; ryzyka zasobowe zidentyfikowane.
- [ ] Mechanizm monitoringu i replanowania działa.
- [ ] Plan opublikowany i aktualizacje cykliczne zaplanowane.
