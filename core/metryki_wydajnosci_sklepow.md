---
title: Metryki wydajności sklepów
...
Monitorować wydajność operacyjną sklepów (retail) w ujęciu sprzedaży, obsługi i operacji.
...
1. Sprzedaż: sprzedaż na m², konwersja odwiedzający→klient, średni koszyk, koszyk brutto/netto.
2. Operacje: czas obsługi, kolejki, dostępność POS, uptime systemów, braki towarowe.
3. Personel: produktywność (sprzedaż/osoba/godzina), grafiki vs. ruch, szkolenia.
4. Obsługa klienta: NPS/CSAT, reklamacje/zwroty, czas rozwiązywania.
5. Merchandising: zgodność planogramów, rotacja, out-of-stock, shrink.
6. Raportowanie: segmentacja (region, format sklepu), alerty na SLA, trend sezonowy.
...
- [ ] Metryki sprzedaży i konwersji zbierane; porównywalne między sklepami.
- [ ] Uptime POS/systemów i operacyjne SLA monitorowane.
- [ ] Produktywność personelu i NPS/CSAT raportowane.
- [ ] Alerty na braki towarowe/out-of-stock i kolejki skonfigurowane.
