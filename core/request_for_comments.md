...
Szablon RFC dla propozycji technicznych.
...
2. Proponowane rozwiązanie i alternatywy.
3. Wpływ: zakres, ryzyka, bezpieczeństwo.
4. Plan wdrożenia i migracji.
5. Otwarte pytania i prośby o feedback.
6. Timeline i właściciele.
...
- [ ] Problem i rozwiązanie opisane.
- [ ] Ryzyka i alternatywy ocenione.
- [ ] Plan wdrożenia istnieje.
- [ ] Feedback i decyzje udokumentowane.
