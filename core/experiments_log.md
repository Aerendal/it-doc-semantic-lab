...
Rejestrować zdarzenia i anomalie związane z systemami AI/ML jako AI Incident Log wymagany przez ISO/IEC 42001 klauzula A.9 (AI Incident Management), lub rejestrować incydenty bezpieczeństwa informacji zgodnie z ISO/IEC 27035 (Incident Log — etap Detection & Reporting). Log zawiera: opis zdarzenia, datę/godzinę, wpływ, działania podjęte, status i eskalację.
