...
Udokumentować incydenty API i wnioski, aby zapobiegać powtórkom.


## Zakres i granice

- Obejmuje: opis incydentu, timeline, RCA, działania korygujące/prewencyjne, lesson learned, follow-up.
- Poza zakresem: incydenty nietechniczne.
...
- Runbook awarii i logi
- Timeline i decyzje
- Impact na użytkowników/SLO
- Dowody (logi, grafy)
...
- RCA i działania
- Ownerzy i terminy
- Aktualizacja checklist/polityk
...
- [ ] Runbook/logi/timeline dostępne
- [ ] Impact opisany
- [ ] Owner postmortem przypisany
- [ ] Dane RCA zebrane


## Kryteria DoD

- [ ] RCA i działania spisane
- [ ] Zadania z ownerami utworzone
- [ ] Lesson learned dodane
...
- Raport postmortem
- Logi/grafy
- Lista zadań i ownerów
- Aktualizacje checklist
...
- Czas do RCA
- Czas zamknięcia działań
- Powtórzenia podobnych incydentów
- Impact (użytkownicy/SLO)
