...
Zebrać dobre praktyki optymalizacji wydajności dla aplikacji/usług.
...
1. Profilowanie: narzędzia, scenariusze, metryki kluczowe.
2. Kod i algorytmy: złożoność, n+1, cache, struktury danych, concurrency.
3. Baza danych: indeksy, query plans, pooling, partitioning, caching.
4. Sieć i I/O: batch/pipeline, kompresja, CDN, connection reuse.
5. Architektura: skalowanie horyzontalne, kolejki, backpressure, circuit breaker.
6. Operacje: testy load/stress/soak, SLO/alerting, regression checks, cost/perf trade-offs.
...
- [ ] Profilowanie wykonane przed optymalizacją; metryki kluczowe znane.
- [ ] Zastosowano praktyki kod/DB/sieć/architektura adekwatne do bottlenecków.
- [ ] Testy wydajności i alerty zaktualizowane po zmianach.
- [ ] Dokumentacja koszt/wydajność i regresje monitorowane.
