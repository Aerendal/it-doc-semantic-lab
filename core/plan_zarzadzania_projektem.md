---
title: Plan zarządzania projektem
...
Ustalić ramy zarządzania projektem: zakres, harmonogram, zasoby, komunikacja i kontrola.
...
1. Zakres i cele: deliverables, KPI, wyłączenia, założenia.
2. Harmonogram i milestones: etapy, daty, zależności, ścieżka krytyczna.
3. Zasoby i RACI: zespół, role, macierz odpowiedzialności, budżet.
4. Zarządzanie zmianą: proces CR, wersjonowanie planu, decyzje.
5. Ryzyka i issues: rejestr, scoring, mitigacje, eskalacje.
6. Komunikacja i raportowanie: cadence statusów, interesariusze, formaty, repo dokumentów.
...
- [ ] Zakres/KPI/wyłączenia i harmonogram zdefiniowane.
- [ ] RACI i budżet ustalone; rejestr ryzyk/issues prowadzony.
- [ ] Proces zmian i komunikacja (status cadence) opisane.
- [ ] Repo planu i dokumentów dostępne, aktualizowane.
