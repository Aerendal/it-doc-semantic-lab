...
Skatalogować najlepsze praktyki testowania (piramida, stabilność, dane, raportowanie) dla zespołów QA/dev.


## Zakres i granice

- Obejmuje: projektowanie testów, piramida, dane, środowiska, stabilność (flaky), raportowanie, kryteria wejścia/wyjścia.
...
- Strategia testów
- Lekcje z incydentów
- Narzędzia/ramy testowe
- Polityki jakości


## Wyjścia

- Lista praktyk must/should
- Checklisty DoR/DoD
- Powiązania do planów i runbooków
- Przykłady
