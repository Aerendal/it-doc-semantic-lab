...
Opisać rejestr operacji przetwarzania PII (Personally Identifiable Information) wymagany przez ISO/IEC 27701 klauzula 6.15.1 (Records of PII Processing Activities). Rejestr dokumentuje: kategorie PII, cele przetwarzania, podstawy prawne, retencję, podmioty przetwarzające, przekazania transgraniczne i środki bezpieczeństwa — będąc odpowiednikiem RoPA z perspektywy systemu zarządzania prywatnością informacji (PIMS).
