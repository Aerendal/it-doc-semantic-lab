---
title: ML Architecture Document
...
Opisać architekturę rozwiązania ML: dane, pipeline, modele, serving, MLOps i bezpieczeństwo.
...
1. Use-case i wymagania: metryki biznesowe/ML, latency, skala, ograniczenia prawne.
2. Dane: źródła, schematy, walidacja, feature store, podział train/val/test.
3. Pipeline: przygotowanie danych, trening, tuning, ewaluacja, eksperymenty.
4. Serving: batch/online, formaty modeli, orkiestracja, kanary/A-B, rollback.
5. Observability: monitoring metryk modelu, drift danych, logging, alerty.
6. Bezpieczeństwo i zgodność: PII, bias/fairness, kontrola dostępu, audyt zmian.
...
- [ ] Wymagania i metryki ML/biznesowe zdefiniowane.
- [ ] Dane/feature store opisane; walidacje i podziały wskazane.
- [ ] Pipeline treningu/ewaluacji oraz strategia serving/rollback udokumentowane.
- [ ] Monitoring driftu/metryk i aspekty bezpieczeństwa/fairness ujęte.
