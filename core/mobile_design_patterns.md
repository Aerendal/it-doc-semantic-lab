...
Zebrać wzorce projektowe UI/UX dla aplikacji mobilnych, zgodne z platformami i skupione na użyteczności.
...
1. Nawigacja: tab/bar, hamburger, gestures, back behavior; kiedy używać.
2. Formularze i input: walidacja inline, klawiatury kontekstowe, maski, autocomplete.
3. Stany ładowania/błędu/pustki: skeletons, retry, offline, toasts/dialogi.
4. Powiadomienia i uprawnienia: timing, kontekst, minimalizacja friction, permission flow.
5. Dostępność: kontrast, wielkość fontów, screen readers, focus order.
6. Wydajność i percepcja: lazy load, batching, animacje, adaptacja do sieci/baterii.
...
- [ ] Wzorce nawigacji dobrane do złożoności app; back behavior spójny.
- [ ] Formularze mają walidację inline i właściwe klawiatury.
- [ ] Stany ładowania/pustki/błędu zaprojektowane; offline/retry przewidziane.
- [ ] Uprawnienia/powiadomienia prezentowane kontekstowo; dostępność spełniona.
