...
Streszczenie kluczowych punktów z posiedzeń CAB (Change Advisory Board): zmiany, decyzje, ryzyka, działania.
...
1. Data i uczestnicy.
2. Zmiany i decyzje (approve/deny/defer).
3. Warunki/ryzyka.
4. Follow-up i właściciele.
...
- [ ] Decyzje dla każdej zmiany.
- [ ] Ryzyka/warunki zapisane.
- [ ] Ownerzy follow-up przypisani.
