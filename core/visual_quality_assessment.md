...
Ocenić subiektywną i obiektywną jakość wizualną produktu, bazując na scenach referencyjnych, testach percepcyjnych i metrykach.


## Zakres i granice

- Obejmuje: wybór scen i kryteriów, testy percepcyjne (panel/ankiety), metryki obiektywne (PSNR/SSIM/perceptual), agregację wyników, rekomendacje.
- Poza zakresem: pełne testy funkcjonalne gameplay.
...
## Wejścia i wyjścia
- Wejścia: inwentarz/CMDB, polityka VA, narzędzia skanowania, SLA, lista wyjątków, dane uwierzytelnień, change windows.
- Wyjścia: harmonogram skanów, raporty VA, lista podatności z priorytetem, zgłoszenia w ticketingu, wskaźniki (MTTR, overdue), raporty compliance.
## Założenia
...
Wskaż: CMDB, narzędzia VA, polityka SLA/wyjątków, SIEM/ticketing, change management; brak – odnotuj.
## Fazy cyklu życia
Planowanie → Skan → Triage → Remediacja → Walidacja → Raport → Przegląd.
## Struktura sekcji (szkielet)

- Kontekst i cele
- Sceny i kryteria
- Metody oceny (subiektywne/obiektywne)
- Wyniki i analiza
- Rekomendacje i plan
...
- Graphics_quality_requirements i sceny referencyjne
- Baseline capture/wideo
- Metryki obiektywne i narzędzia
- Panel testowy/ankiety


## Wyjścia

- Raport oceny jakości (subiektywne + obiektywne)
- Rekomendacje i priorytety
- Linki do capture i testów
- Checklisty DoR/DoD
...
- [ ] Sceny i kryteria zdefiniowane
- [ ] Baseline capture gotowe
- [ ] Narzędzia metryk/ankiet dostępne
- [ ] Panel testowy zaplanowany


## Kryteria DoD

- [ ] Wyniki subiektywne/obiektywne zebrane
...
- Ocena subiektywna (skala)
- Metryki PSNR/SSIM/perceptual
- Liczba rekomendacji wdrożonych
- Zmiana jakości wg kolejnych iteracji
