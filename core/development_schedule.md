...
Development Schedule określa harmonogram, zakres i odpowiedzialności, aby dowieźć rezultat w kontrolowany sposób.
...
- Zależność: {'depends_on': 'Experience Design Document', 'type': 'sequential'}
- Zależność: {'depends_on': 'Experience Design Document', 'type': 'sequential'}
