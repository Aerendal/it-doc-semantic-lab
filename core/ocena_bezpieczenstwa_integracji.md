---
title: Ocena bezpieczeństwa integracji
...
aligned_by: codex
---
# Ocena bezpieczeństwa integracji
...
Ocenić bezpieczeństwo integracji między systemami (API/event/ETL), uwzględniając tożsamość, dane i odporność.
...
1. Zakres integracji: systemy, protokoły, dane wrażliwe, kierunki przepływu.
2. Kontrole: authn/authz, mTLS, podpisy, rate limit, idempotencja, schematy.
3. Dane: klasyfikacja, szyfrowanie in-transit/at-rest, maskowanie, retencja.
4. Bezpieczeństwo operacji: logging/trace, DLQ, retry, monitoring anomalii.
5. Luki i ryzyka: brak limitów, słabe klucze, brak wersjonowania, third-party risk.
6. Plan remediacji: działania, właściciele, terminy; testy/regresja.
...
- [ ] Integracje zmapowane; auth/mTLS/podpisy i rate limit sprawdzone.
- [ ] Dane wrażliwe szyfrowane/maskowane; retencja i logi zgodne.
- [ ] DLQ/retry i monitoring anomalii działają.
- [ ] Plan napraw i testów uzgodniony.
