...
Zdefiniować cele i KPI centrum wsparcia (support), aby ukierunkować procesy, zasoby i usprawnienia.


## Zakres i granice

- Obejmuje: cele biznesowe i operacyjne, KPI (FCR, MTTR, CSAT, backlog aging), poziomy usług/SLA, priorytetyzację, plan poprawy jakości.
- Nie obejmuje: szczegółowych playbooków technicznych ani polityk HR.
...
1. Misja i zakres centrum wsparcia.
2. KPI i cele (wartości docelowe, sposób liczenia).
3. SLA/OLA i priorytety.
4. Plan poprawy (działania, właściciele, kamienie milowe).
5. Raportowanie i przeglądy.
...
- [ ] KPI/cele zdefiniowane z wartościami docelowymi.
- [ ] SLA/priorytety opisane.
- [ ] Plan poprawy z właścicielami i datami.
- [ ] Raportowanie cykliczne ustalone.
