...
Monitorować jakość danych w czasie (reguły DQ, alerty, raporty) i szybko reagować na degradacje.


## Zakres i granice

- Obejmuje: reguły DQ, metryki (kompletność, spójność, zakres), alerty, dashboardy, sampling, SLA danych.
- Poza zakresem: analiza biznesowa wyników.
...
- Reguły/thresholdy DQ
- Źródła danych/metryk
- Lista krytycznych tabel/pól
- SLA danych


## Wyjścia

- Alerty i dashboardy DQ
- Raporty cykliczne
- Lista incydentów DQ
- Powiązania do testów/napraw
