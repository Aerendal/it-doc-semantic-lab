...
Szablon notatek wydania dla aplikacji mobilnych.
...
1. Wersja i data.
2. Nowości i ulepszenia.
3. Poprawki błędów.
4. Znane problemy.
5. Wymagania: OS, urządzenia, uprawnienia.
6. Instrukcje rollout i kontakt.
...
- [ ] Wersja/data podane.
- [ ] Lista zmian i znane problemy klarowne.
- [ ] Wymagania i kontakt dodane.
- [ ] Rollout/kanaly (store/testflight) opisane.
