---
title: Publikowanie artykułów KB
...
Ustandaryzować proces publikacji artykułów bazy wiedzy.
...
1. Przygotowanie: szablon, tagi, słowa kluczowe, dostępność.
2. Review: SME, język, legal/compliance, SEO.
3. Publikacja: kanały (portal, in-app), wersjonowanie, linkowanie.
4. Tłumaczenia: kolejność, narzędzia, walidacja językowa.
5. Monitorowanie: CTR, feedback, deflekcja ticketów.
6. Utrzymanie: przeglądy okresowe, archiwizacja, wycofanie.
...
- [ ] Artykuł przeszedł SME/QA/SEO review i jest w szablonie.
- [ ] Metadane i tagi ustawione; linki działają.
- [ ] Tłumaczenia i wersjonowanie odnotowane.
- [ ] Metryki i feedback są monitorowane.
