...
Monitorować błędy bramek kwantowych (gate error rate), aby poprawiać jakość obliczeń i planować optymalizacje.
...
1. Metryki: error rate dla 1q/2q bram, SPAM, czasy kalibracji, dane RB/IRB.
2. Zbieranie: harmonogram pomiarów, archiwizacja wyników, wersje kalibracji.
3. Alerty: progi wzrostu błędów, porównanie do SLA, alert na konkretnych parach qubitów.
4. Wpływ na transpile: preferencje mapowania, unikanie słabych bram, routing.
5. Raporty: heatmapy error rates, trend per brama, wpływ na fidelity obwodów.
6. Dostęp i audyt: kto ma wgląd, integralność danych, audyt zmian.
...
- [ ] Error rates dla bram 1q/2q mierzone i archiwizowane.
- [ ] Alerty na wzrost błędów ustawione; SLA bram znane.
- [ ] Transpile uwzględnia słabsze bramy/mapowanie.
- [ ] Raporty heatmap i trendów dostępne; dostęp/audyt kontrolowany.
