---
title: Analiza kosztów i korzyści
...
Porównać koszty (czas, pieniądze, ryzyko) z oczekiwanymi korzyściami (przychody, oszczędności, redukcja ryzyk) dla inicjatywy/projektu, by podjąć decyzję go/no-go lub priorytetyzację.


## Zakres i granice

- Obejmuje: koszty jednorazowe i operacyjne, korzyści finansowe i niefinansowe, horyzont czasowy, scenariusze.
- Nie obejmuje: pełnej analizy TCO (osobny dokument) ani szczegółowego biznes case (jeśli istnieje osobny szablon).
...
- Wejścia: estymacje kosztów (dev/ops/licencje), prognozy korzyści (przychód, oszczędność, ryzyko uniknięte), horyzont czasowy, dane historyczne.
- Wyjścia: bilans koszt/korzyść, scenariusze (pesymistyczny/realistyczny/optymistyczny), okres zwrotu, rekomendacja.
...
- Analiza ryzyk (finansowych/operacyjnych).
- Roadmapa produktu (wpływ na priorytety).
...
1. Zakres inicjatywy i horyzont.
2. Założenia (koszty, korzyści, stawki, wzrost).
3. Koszty (CAPEX/OPEX) i harmonogram wydatków.
4. Korzyści (przychody, oszczędności, redukcja ryzyk).
5. Scenariusze i wrażliwość.
6. Wynik (NPV/ROI/Payback) i rekomendacja.
...
- [ ] Jasny zakres i horyzont analizy.
- [ ] Koszty i korzyści policzone w scenariuszach.
- [ ] Kluczowe założenia i ich wrażliwość opisane.
- [ ] Wskaźniki (ROI/NPV/Payback) wyliczone.
...
- „Założenia i scenariusze” **constrains** „Wynik finansowy”.
- „Ryzyka” **feeds** „Rekomendację”.
