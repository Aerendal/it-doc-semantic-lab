...
Plan komunikacji wygaszenia produktu/usługi.
...
1. Zakres i daty EOL.
2. Segmentacja klientów i kanały.
3. Treści komunikatów i FAQ.
4. Migration paths/alternatywy.
5. Wsparcie i SLA w okresie przejściowym.
6. Monitoring sentymentu i ryzyka.
...
- [ ] Daty EOL i kanały ustalone.
- [ ] Komunikaty/FAQ przygotowane.
- [ ] Ścieżki migracji opisane.
- [ ] Wsparcie/monitoring zaplanowane.
