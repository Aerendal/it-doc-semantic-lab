...
Dostarczyć ogólny playbook troubleshootingowy.
...
1. Kategoryzacja problemu: user/system/network/data, severity.
2. Zbieranie faktów: logi, telemetria, odtworzenie, zmiany recent.
3. Hipotezy i testy: minimalny repro, eksperymenty, kontrola zmiennych.
4. Izolacja: podmiana komponentów, feature flags, rollback.
5. Naprawa: patch/fix, konfiguracja, obejście, komunikacja do interesariuszy.
6. Retrospektywa: zapobieganie, dokumentacja, monitorowanie.
...
- [ ] Problem sklasyfikowany i posiada dane wejściowe.
- [ ] Próby repro i hipotezy zapisane; testy dokumentowane.
- [ ] Wybrana naprawa ma plan rollback; komunikacja wykonana.
- [ ] Wnioski i monitoring po naprawie dodane.
