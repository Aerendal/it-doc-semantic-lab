...
1. Scenariusze sprzedaży/zwrotów.
2. Płatności i terminale.
3. Offline i recovery.
4. Integracje (inventory, raporty).
5. Performance i awarie.
6. Raport.
...
- [ ] Sprzedaż/zwroty i płatności przetestowane.
- [ ] Offline/recovery sprawdzone.
- [ ] Integracje i performance zweryfikowane.
- [ ] Raport przygotowany.
