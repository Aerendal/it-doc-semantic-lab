---
title: Inventory Levels Tracking
...
Inventory Levels Tracking — szablon dokumentu IT.

Zawiera inwentarz zasobów IT — urządzeń, oprogramowania, licencji lub komponentów infrastruktury. Każdy element powinien mieć: ID, typ, właściciela, lokalizację, status i daty przeglądu/licencji.

> Dokument satelitarny do: "Inventory Levels Monitoring" - rozszerza lub uszczegolawia jego tresc.
