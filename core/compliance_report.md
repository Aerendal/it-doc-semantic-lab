...
Przygotować raport zgodności dla interesariuszy/organów (zakres, kontrole, wyniki).


## Zakres i granice

- Obejmuje: scope regulacji, stan kontrolek, wyniki testów/audytów, wyjątki/waivery, działania.
- Poza zakresem: szczegółowe logi dowodów.
...
- Scope systemu/danych
- Stan kontrolek i wyniki
- Wyjątki/waivery
- Działania i terminy
- Ryzyka
...
- Mapa wymagań i kontrolek
- Raporty audytów/testów
- Waivery/wyjątki
- Plan działań
...
- [ ] Mapa wymagań/kontrolek gotowa
- [ ] Raporty audytów/testów dostępne
- [ ] Waivery zebrane
...
- [ ] Raport przygotowany
- [ ] Działania i terminy spisane
- [ ] Załączniki podlinkowane
