...
Udostępnić twórcom modów instrukcje jak rozszerzać grę/aplikację: API, narzędzia, zasady bezpieczeństwa.
...
1. Zakres i wersje: jakie elementy można modyfikować, kompatybilne wersje, polityka zgodności.
2. API i rozszerzenia: hooki, eventy, dostępne klasy/zasoby, ograniczenia sandboxu.
3. Narzędzia: SDK/editor, build/deploy modów, debugging, podpisywanie.
4. Packaging i dystrybucja: format paczki, zależności, wersjonowanie, marketplace/manual install.
5. Bezpieczeństwo i jakość: review, limity zasobów, raportowanie błędów, testy.
6. Przykłady i szablony: minimalny mod, przykładowe hooki, best practices.
...
- [ ] Zakres modyfikacji i kompatybilne wersje opisane.
- [ ] API/hooki i ograniczenia sandboxu udokumentowane.
- [ ] Proces build/deploy i format paczki jasno opisane.
- [ ] Wytyczne bezpieczeństwa/testów i przykłady modów dołączone.
