...
## Cel dokumentu
Dokumentować ocenę prywatności (Privacy Plan/PIA — Privacy Impact Assessment) jako realizację wymagań NIST SP 800-53 PT-5 (Privacy Impact Assessments on Identifiable Information) i PM-19 (Privacy Program Plan). Ocena identyfikuje: kategorie PII zbieranych przez system, podstawy prawne, ryzyko prywatności, zastosowane kontrole (NIST Privacy Framework), rezydualny risk i plan remediacji — jako dowód due diligence dla auditora federalnego.
...
## Szybkie powiązania
- Zależność: {'depends_on': 'Data Collection Implementation', 'type': 'sequential'}
- Zależność: {'depends_on': 'Data Collection Implementation', 'type': 'sequential'}
