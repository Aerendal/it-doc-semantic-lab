...
## Cel dokumentu
SLO/SLI Training opisuje program szkoleniowy/onboardingowy z celami, modułami i sposobem oceny.
...
## Szybkie powiązania
- Zależność: {'depends_on': 'SLI/SLO/SLA Design', 'type': 'REQUIRES'}
- Zależność: {'depends_on': 'SLI/SLO Implementation', 'type': 'REQUIRES'}
- Zależność: {'depends_on': 'SLI Monitoring Strategy', 'type': 'REQUIRES'}
