...
Ocenić wpływ planowanej zmiany (technicznej/procesowej) na systemy, użytkowników i ryzyka.
...
1. Opis zmiany: zakres, cel, termin, właściciel.
2. Wpływ: na użytkowników, SLA, bezpieczeństwo, dane, zależności systemowe.
3. Ryzyka i mitigacje: lista ryzyk, prawdopodobieństwo/impact, plan ograniczeń.
4. Testy i walidacja: środowiska, plan testów, kryteria Go/No-Go.
5. Plan wdrożenia i rollback: kroki, okna, komunikacja, fallback.
6. Zgody i komunikacja: interesariusze, kanały, statusy.
...
- [ ] Zakres i właściciel zmiany opisane.
- [ ] Wpływ na SLA/użytkowników/bezpieczeństwo oceniony.
- [ ] Ryzyka z mitigacjami i plan rollback przygotowane.
- [ ] Testy i kryteria Go/No-Go ustalone; komunikacja uzgodniona.
