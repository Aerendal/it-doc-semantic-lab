---
title: Search Platform Selection
...
Search Platform Selection — szablon dokumentu IT.
...
> Dokument satelitarny do: "Search Platform Deployment" - rozszerza lub uszczegolawia jego tresc.
...
- Zależność: {'depends_on': 'Language Support Strategy', 'type': 'cross_industry'}
- Zależność: {'depends_on': 'Language Support Strategy', 'type': 'cross_industry'}
