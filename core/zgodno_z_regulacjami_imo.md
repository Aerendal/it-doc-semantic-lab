---
title: ZgodnoÅ›Ä‡ z regulacjami IMO
...
Zgodność z regulacjami IMO — szablon dokumentu IT.

Dokumentuje stan i wymagania zgodności systemu lub procesu z określonym standardem, regulacją lub polityką. Zawiera: mapowanie wymagań, status implementacji (compliant/gap/na), plan adresowania luk z priorytetami.

> Dokument satelitarny do: "Zgodność z regulacjami środowiskowymi" - rozszerza lub uszczegolawia jego tresc.
