...
1. Persona i use case.
2. Funkcje i SLO.
3. Model cenowy i limitacja.
4. Developer experience: portal, SDK.
...
- [ ] Persona/use case zdefiniowane.
- [ ] Funkcje/SLO opisane.
- [ ] Model cenowy i DX uwzględnione.
