...
Konfiguracja systemu zarządzania flotą (pojazdy/urządzenia).
...
1. Rejestr assetów i telematyka.
2. GPS/trackery: instalacja, kalibracja.
3. Alerty: serwis, paliwo/energia, naruszenia.
4. Integracje: serwis, ubezpieczenia, paliwo.
5. Raporty: wykorzystanie, koszty, incydenty.
6. Bezpieczeństwo danych i dostęp.
...
- [ ] Rejestr i trackery aktywne.
- [ ] Alerty serwis/paliwo ustawione.
- [ ] Integracje potwierdzone.
- [ ] Raporty i dostępy działają.
