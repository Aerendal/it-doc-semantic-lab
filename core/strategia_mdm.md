...
Strategia Master Data Management.
...
1. Domeny danych i właściciele.
2. Model i złote rekordy.
3. Procesy: match/merge, stewardship.
4. Integracje: źródła i konsumenci.
5. Jakość i governance.
6. Roadmap i sukces metrics.
...
- [ ] Domeny i właściciele zmapowani.
- [ ] Proces match/merge opisany.
- [ ] Integracje i jakość danych zdefiniowane.
- [ ] Metryki/roadmap ustalone.
