...
## Cel dokumentu
Zweryfikować poprawność dostarczenia produktu lub usługi do klienta zgodnie z procesem Delivery (DEL.1) ISO/IEC 29110 dla Very Small Entities. Dokument potwierdza że produkt spełnia zaakceptowane kryteria jakości, wszystkie elementy dostawy (kod, dokumentacja, konfiguracja) są kompletne i że klient zaakceptował dostarczony produkt — zamykając cykl życia projektu wg ISO/IEC 29110.
