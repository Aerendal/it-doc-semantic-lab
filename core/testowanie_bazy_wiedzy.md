...
1. Zakres: wyszukiwarka, artykuły, linki.
2. Jakość treści i dostępność.
3. Search relevance i analityka.
4. Uprawnienia i prywatność.
5. Performance i cache.
6. KPI i raporty.
...
- [ ] Wyszukiwanie/relevance przetestowane.
- [ ] Treść/accessibility OK.
- [ ] Uprawnienia i cache zweryfikowane.
- [ ] KPI raportowane.
