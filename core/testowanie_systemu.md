...
Ogólny plan testów systemowych.
...
2. Środowisko i dane.
3. Testy funkcjonalne/niefunkcjonalne.
4. Defekty i priorytety.
5. Raportowanie.
6. Kryteria release.
...
- [ ] Zakres i środowisko opisane.
- [ ] Testy wykonane, defekty sklasyfikowane.
- [ ] Raport gotowy.
- [ ] Kryteria release ustalone.
