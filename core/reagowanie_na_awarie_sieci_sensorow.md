---
title: Reagowanie na awarie sieci sensorów
...
aligned_by: codex
---
# Reagowanie na awarie sieci sensorów
...
Przywrócić łączność sieci sensorów.
...
1. Detekcja: brak telemetrii, alerty gateway, packet loss.
2. Triage: obszar, topologia (mesh/star), wpływ na dane.
3. Stabilizacja: przełączenie kanału/pasma, restart gateway, offline buffering.
4. Naprawa: interferencje, zasilanie, firmware, anteny.
5. Testy: latency, packet delivery, coverage.
6. Postmortem: przyczyna, zmiana konfiguracji/progów.
...
- [ ] Zakres awarii sieci ustalony.
- [ ] Tymczasowe obejście/buffering działa.
- [ ] Przyczyna usunięta; testy łączności OK.
- [ ] Dokumentacja i progi zaktualizowane.
