...
## Cel dokumentu
Dokumentować plan i wyniki testów odporności operacyjnej systemu ICT zgodnie z DORA Art. 25 (Digital Operational Resilience Testing) i Regulacyjnymi Standardami Technicznymi (RTS) EBA/EIOPa. Plan opisuje: zakres testów (TLPT — Threat-Led Penetration Testing, scenario-based tests), kryteria sukcesu, dostawców zewnętrznych testów, harmonogram i procedury remediacji wykrytych luk w odporności operacyjnej.
