---
title: Przewodnik dla personelu sklepów
...
aligned_by: codex
---
# Przewodnik dla personelu sklepów
...
Uprościć korzystanie z systemów sklepowych przez personel front-of-house.
...
1. Logowanie i bezpieczeństwo: konta, hasła, SSO, reset, MFA.
2. Podstawowe operacje POS: sprzedaż, zwroty, rabaty, anulacje.
3. Inne systemy: inventory, zamówienia, raporty dzienne, zamknięcie dnia.
4. Awaryjne procedury: fallback offline, ręczne paragony, kontakt wsparcia.
5. Urządzenia: skanery, drukarki, terminale płatnicze, typowe problemy.
6. Wsparcie i eskalacje: kanały kontaktu, SLA, informacje do przekazania.
...
- [ ] Personel ma dostęp i wie jak resetować hasło/MFA.
- [ ] Checklisty sprzedaży/zwrotów i zamknięcia dnia są dostępne.
- [ ] Procedury offline/fallback są znane i przetestowane.
- [ ] Kanały wsparcia i dane do zgłoszenia są opisane.
