...
Udokumentować mapę procesów organizacji jako kluczowe narzędzie zarządzania jakością zgodnie z ISO 9001 klauzula 4.4 (Quality Management System and its Processes). Mapa procesów opisuje: sekwencję i interakcje procesów, właścicieli procesów, wejścia/wyjścia, kryteria i metody oceny skuteczności, zasoby i ryzyka — stanowiąc podstawę do ciągłego doskonalenia (klauzula 10) i audytów wewnętrznych.
