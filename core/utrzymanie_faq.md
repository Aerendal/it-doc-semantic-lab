...
1. Przeglądy cykliczne i właściciele.
2. Metryki: deflection, search success.
3. Proces aktualizacji i wersjonowania.
4. Feedback i zgłoszenia użytkowników.
5. Archiwizacja i EOL artykułów.
6. Raportowanie.
...
- [ ] Przeglądy i ownerzy zdefiniowani.
- [ ] Metryki zbierane.
- [ ] Proces aktualizacji działa.
- [ ] Archiwizacja/EOL opisana.
