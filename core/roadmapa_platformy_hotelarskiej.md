---
title: Roadmapa platformy hotelarskiej
...
aligned_by: codex
---
# Roadmapa platformy hotelarskiej
...
Roadmapa rozwoju platformy hotelarskiej.
...
1. Moduły: PMS, channel, CRM, mobile key.
2. Integracje: płatności, zamki, POS, housekeeping.
3. Doświadczenie gościa: check-in/out, komunikacja.
4. Bezpieczeństwo/prywatność: dane gości, PSD2.
5. Monetyzacja: subskrypcje, per-room, upsell.
6. Kamienie i KPI.
...
- [ ] Doświadczenie gościa i bezpieczeństwo uwzględnione.
- [ ] Model monetyzacji zmapowany.
- [ ] KPI/kamienie zapisane.
