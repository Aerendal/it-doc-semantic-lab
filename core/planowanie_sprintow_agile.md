---
title: Planowanie sprintów (Agile)
...
Opisać proces planowania sprintów, by zapewnić realistyczny zakres, jasne cele i przewidywalność dostarczania.
...
1. Wejścia: uporządkowany backlog, velocity, zależności, definicja celu sprintu.
2. Przygotowanie: refinement, estymacje, definition of ready, capacity zespołu.
3. Planowanie: wybór zakresu, cel sprintu, task breakdown, kryteria akceptacji.
4. Zasady jakości: DoD, testy, definition of blocked, zasady priorytetyzacji.
5. Komunikacja i artefakty: sprint goal, board, task ownership, calendar, spotkania.
6. Monitorowanie: burndown/burnup, ryzyka w sprint, replan/ scope adjustment.
...
- [ ] Backlog gotowy (refined/DoR) i capacity znane przed planowaniem.
- [ ] Cel sprintu i zakres uzgodnione; zadania mają AC i ownership.
- [ ] DoD/DoR i zasady replaningu ustalone; burndown śledzony.
- [ ] Komunikacja celu/zakresu do zespołu i interesariuszy wykonana.
