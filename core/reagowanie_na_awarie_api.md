---
title: Reagowanie na awarie API
...
Szybko przywrócić działanie API podczas awarii.
...
1. Detekcja: alerty, symptomy, scope (które endpointy).
2. Triage: wpływ, priorytet, czy dotyczy klientów zewnętrznych.
3. Stabilizacja: rollback/deploy wcześniejszej wersji, rate limiting, feature flags.
4. Komunikacja: status page, klienci, wewnętrzne kanały.
5. Naprawa: fix, testy, wdrożenie canary.
6. Postmortem: przyczyna, działania trwałe.
...
- [ ] Zakres awarii i priorytet ustalony.
- [ ] Stabilizacja/rollback wykonany, komunikacja wysłana.
- [ ] Fix wdrożony i przetestowany.
- [ ] Postmortem zapisany i działania trwałe zaplanowane.
