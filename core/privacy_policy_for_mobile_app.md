---
title: Privacy Policy for Mobile App
...
## Cel dokumentu
Opisać zasady zarządzania kryptografią w aplikacji mobilnej zgodnie z OWASP MASVS/ASVS (Cryptography Requirements V3). Policy definiuje: dopuszczalne algorytmy i długości kluczy, zarządzanie kluczami kryptograficznymi, generowanie bezpiecznych liczb losowych, niedopuszczalne praktyki (hardcoded keys, słabe algorytmy RC4/MD5/SHA1) — zapewniając że kryptografia aplikacji spełnia wymagania weryfikacji ASVS Level 1-3.
