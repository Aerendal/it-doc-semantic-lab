...
Zebrać wymagania compliance mające zastosowanie do systemu/API i przypisać właścicieli kontrolek.


## Zakres i granice

- Obejmuje: regulacje/standardy (np. GDPR, PCI, HIPAA, ISO), mapowanie wymagań na kontrolki, właścicieli, częstotliwość testów.
- Poza zakresem: implementacja kontrolki.
...
- Zakres systemu/danych
- Wymagania i kontrolki
- Właściciele i częstotliwość
- Testy/recertyfikacje
- Ryzyka
...
- Przypisani właściciele
- Plan testów/recertyfikacji
...
- [ ] Lista regulacji zebrana
- [ ] Zakres danych/systemu znany
- [ ] Właściciele dostępni
- [ ] Dotychczasowe znaleziska zebrane


## Kryteria DoD

- [ ] Katalog wymagań/kontrolek spisany
...
- Pokrycie wymagań kontrolkami
- Kontrolki bez właściciela
- Znaleziska/High na audyt
- On-time testy/recertyfikacje
