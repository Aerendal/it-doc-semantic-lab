...
## Cel dokumentu
Production Schedule określa harmonogram, zakres i odpowiedzialności, aby dowieźć rezultat w kontrolowany sposób.
...
## Szybkie powiązania
- Zależność: {'depends_on': 'Game Mechanics Design', 'type': 'INFORMED_BY'}
- Zależność: {'depends_on': 'Level Design Document', 'type': 'INFORMED_BY'}
- Zależność: {'depends_on': 'Game Mechanics Design', 'type': 'INFORMED_BY'}
