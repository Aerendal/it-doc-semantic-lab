...
## Cel dokumentu
Raportować wydajność IT jako wejście do podejmowania decyzji przez organy zarządcze zgodnie z ISO/IEC 38500 zasada 4 (Performance) — IT powinno być wydajne w dostarczaniu wartości przy akceptowalnym koszcie i ryzyku. Raport dostarcza KPI IT (dostępność usług, SLA adherence, czas przywracania, satysfakcja użytkowników, koszty IT per business unit) umożliwiając ocenę czy IT spełnia oczekiwania biznesu.
