---
title: Przewodnik Implementacji Android
...
aligned_by: codex
---
# Przewodnik Implementacji Android
...
Ujednolicić praktyki implementacji aplikacji Android.
...
1. Architektura: MVVM/MVI, moduły, DI (Hilt/Koin), navigation.
2. UI: Material 3, accessibility, theming, localization.
3. Dane: Room/SQL, networking (Retrofit/OkHttp), caching, offline sync.
4. Build/CI: flavors, signing, ProGuard/R8, testy (unit/instrumentation).
5. Wydajność: ANR/analityka, memory leaks, battery, startup time.
6. Bezpieczeństwo: keystore, SafetyNet/Play Integrity, TLS pinning, perms.
...
- [ ] Architektura i moduły są opisane; DI działa.
- [ ] Testy (unit/instrumentation/UI) w CI; crash/ANR monitoring skonfigurowany.
- [ ] ProGuard/R8 i signing poprawnie ustawione; permisy ograniczone.
- [ ] Metryki wydajności i zużycia baterii spełniają cele.
