---
title: Cele wsparcia użytkowników
...
Zdefiniować cele i KPI dla wsparcia użytkowników: szybkość i jakość pomocy, satysfakcja, redukcja eskalacji.


## Zakres i granice

- Obejmuje: KPI (FCR, MTTR, CSAT, backlog aging), SLA/priorytety, dostępność kanałów, jakość wiedzy (KB), automatyzację (boty), feedback i poprawę.
- Nie obejmuje: szczegółowych runbooków (osobne) ani polityk HR.
...
1. Misja i zakres wsparcia.
2. KPI i targety (FCR, MTTR, CSAT).
3. Kanały i SLA/priorytety.
4. Baza wiedzy/automatyzacja (boty, self‑service).
5. Feedback i doskonalenie (ankiety, RCA).
...
- [ ] KPI/targety zdefiniowane.
- [ ] SLA/priorytety opisane.
- [ ] KB/self‑service i automatyzacja dostępne.
- [ ] Feedback/RCA cykliczny.
