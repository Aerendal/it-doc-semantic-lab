...
Strategia monitorowania organizacji.
...
1. Zakres: systemy/usługi/dane.
2. SLI/SLO i KPI.
3. Narzędzia i standaryzacja telemetry.
4. Alerty i on-call.
5. Governance i własność dashboardów.
...
- [ ] Zakres i KPI ustalone.
- [ ] Standard telemetry/alertów zdefiniowany.
- [ ] Własność dashboardów i on-call jasna.
- [ ] Proces doskonalenia działa.
