...
Zbierać, analizować i raportować opinie klientów jako wejście do pomiaru satysfakcji i procesu ciągłego doskonalenia zgodnie z ISO 9001 klauzula 9.1.2 (Customer Satisfaction). Analiza identyfikuje trendy, główne przyczyny niezadowolenia, wzorce pochwał i rekomendacje działań korygujących/prewentywnych — dostarczając obiektywnych danych do przeglądu zarządczego (Management Review).
