---
title: Reagowanie na zakłócenia meczu
...
aligned_by: codex
---
# Reagowanie na zakłócenia meczu
...
Obsłużyć zakłócenia w przebiegu meczu/turnieju.
...
1. Detekcja: latency, disconnect, serwer, cheating, publiczność.
2. Triage: wpływ na wynik, regulamin, fairness.
3. Stabilizacja: pause, restart mapy, przeniesienie serwera.
4. Komunikacja: sędziowie, drużyny, widzowie.
5. Naprawa: fix serwerów, anty-cheat, łączność.
6. Post-event: raport, decyzje regulaminowe, poprawki.
...
- [ ] Zakłócenie sklasyfikowane; decyzja sędziowska podjęta.
- [ ] Stabilizacja (pause/restart) wykonana.
- [ ] Komunikacja do drużyn/widzów przeprowadzona.
- [ ] Raport i poprawki po evencie zapisane.
