---
title: Design integracji e-commerce z retail
...
aligned_by: codex
---
# Design integracji e-commerce z retail
...
Zaprojektować spójną integrację online/offline: katalog, ceny, stock, zamówienia, fulfillment i zwroty.
...
1. Katalog/PIM i ceny/promocje (spójność kanałów).
2. Stock i OMS: real-time availability, rezerwacje, BOPIS/ship-from-store.
3. Zamówienia i płatności: statusy, fraud, podatki/opłaty.
4. Fulfillment/zwroty: logistyka, polityki, synchronizacja statusów.
5. POS/loyalty/CRM: account linking, punkty, kupony.
6. Observability: mismatch stock/ceny, SLA zamówień, zwroty.
7. Bezpieczeństwo/RODO/PCI.
...
- [ ] Katalog/ceny spójne, promocje zsynchronizowane.
- [ ] Stock/OMS real-time i rezerwacje.
- [ ] Statusy zamówień/płatności zsynchronizowane.
- [ ] Zwroty/polityki/loyalty zintegrowane.
- [ ] Monitoring mismatch/SLA i compliance.
