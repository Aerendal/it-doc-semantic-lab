---
title: Konfiguracja serwisu katalogowego
...
aligned_by: codex
---
# Konfiguracja serwisu katalogowego
...
Skonfigurować katalog tożsamości (AD/LDAP/IAM directory) dla organizacji, zapewniając strukturę, bezpieczeństwo i integracje.
...
1. Struktura OU/grup: podział na działy, środowiska, role; naming convention.
2. Schemat i atrybuty: rozszerzenia, wymagane pola, walidacje.
3. Provisioning/deprovisioning: źródła HR, automaty, cykl życia kont, konta serwisowe.
4. Bezpieczeństwo: polityki haseł/MFA, blokady, delegacje, audit, tiering adminów.
5. Integracje: SSO, aplikacje, VPN/Wi-Fi, certyfikaty, synchronizacja do chmury.
6. Utrzymanie: backup/restore, monitoring replikacji, cleanup kont/grup, testy DR.
...
- [ ] Struktura OU/grup i nazewnictwo zdefiniowane.
- [ ] Provisioning/deprovisioning zintegrowany z HR, obejmuje konta serwisowe.
- [ ] Polityki haseł/MFA, delegacje i audit włączone.
- [ ] Replikacja, backup/restore i testy DR zaplanowane.
