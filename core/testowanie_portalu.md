...
1. Funkcje i user flows.
2. Dostępność i UX.
3. Bezpieczeństwo (OWASP).
4. Performance i SEO.
5. Testy cross-browser/device.
...
- [ ] Flows i bezpieczeństwo pokryte.
- [ ] Dostępność/SEO przetestowane.
- [ ] Cross-browser/device wykonane.
- [ ] Raport/release criteria są.
