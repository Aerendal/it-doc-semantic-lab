---
title: Plan onboarding developerów
...
Przyspieszyć wdrożenie nowych developerów do projektu, zapewniając dostęp, wiedzę i standardy pracy.
...
1. Dostępy: repozytoria, CI/CD, issue tracker, środowiska, VPN/SSO, secrets.
2. Środowisko dev: stack technologiczny, instalacja, konfiguracje, sample data.
3. Standardy: style guide, branching, code review, testy, security/PII, feature flags.
4. Wiedza domenowa: architektura, kontrakty API, dane, diagramy.
5. Pierwsze zadania: „hello build”, mały bug, PR z testami, shadowing code review.
6. Plan 30/60/90: cele, mentoring, szkolenia, ewaluacja.
...
- [ ] Dostępy i środowisko dev skonfigurowane.
- [ ] Standardy i wiedza domenowa przekazane; materiały dostępne.
- [ ] Pierwsze PR-y wykonane z testami i review.
- [ ] Plan 30/60/90 i mentoring ustawione.
