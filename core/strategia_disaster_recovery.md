---
title: Strategia disaster recovery
...
1. Cele RTO/RPO i krytyczność.
2. Architektura DR: active-active/standby.
3. Dane: replikacja/backup.
4. Testy DR: scenariusze, częstotliwość.
5. Procedury: runbooki, role.
6. Koszty i ciągłe doskonalenie.
...
- [ ] RTO/RPO i krytyczność zdefiniowane.
- [ ] Architektura i dane DR opisane.
- [ ] Testy i runbooki zaplanowane.
- [ ] Koszty/udoskonalenia uwzględnione.
