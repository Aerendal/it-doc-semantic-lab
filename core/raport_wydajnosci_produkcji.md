---
title: Raport wydajności produkcji
...
Raportować wydajność produkcji (produkcyjnej).
...
1. Metryki: throughput, takt, scrap, OEE, przestoje.
2. Zasoby: linie, zmiany, obciążenie.
3. Problemy: awarie, brak materiału, jakość.
4. Porównania: plan vs rzeczywistość, shift/linia.
5. Działania: usprawnienia, TPM, szkolenia.
6. Ryzyka: dostawy, pogoda, regulacje.
...
- [ ] Metryki produkcyjne są kompletne i dokładne.
- [ ] Główne problemy i przyczyny opisane.
- [ ] Działania i właściciele z terminami.
- [ ] Ryzyka i plan awaryjny uwzględnione.
