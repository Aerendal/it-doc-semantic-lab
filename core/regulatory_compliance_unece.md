---
title: Regulatory Compliance (UNECE)
...
Wytyczne zgodności z regulacjami UNECE (np. automotive).
...
1. Zakres regulacji: UNECE R155/R156 itd.
2. Wymagania bezpieczeństwa: CSMS, SUMS.
3. Procesy: ocena ryzyka, homologacja, audyty.
4. Artefakty: dokumentacja, deklaracje zgodności.
5. Testy: wymagane badania, laboratoria, raporty.
6. Monitorowanie: zmiany regulacji, lifecycle.
...
- [ ] Regulacje i zakres opisane.
- [ ] Proces CSMS/SUMS zdefiniowany.
- [ ] Artefakty i testy wyszczególnione.
- [ ] Monitoring zmian zapewniony.
