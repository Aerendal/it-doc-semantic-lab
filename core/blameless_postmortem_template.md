...
## Cel dokumentu
Umożliwić otwartą, bezobwiniającą analizę incydentu/projektu, skupioną na systemowych przyczynach i trwałych usprawnieniach, a nie na winie osób.

## Zakres i granice
Obejmuje: timeline fact-based, przyczyny pierwotne i współczynnikowe, wpływ, decyzje i konteksty, działania naprawcze/prewencyjne, lekcje, zmiany w procesach/monitoringu/szkoleniach. Nie obejmuje: przypisywania winy personalnej.

## Wejścia i wyjścia
- Wejścia: logi incydentu, dane z monitoringu, komunikacja z IR, notatki, decyzje podjęte w trakcie.
- Wyjścia: postmortem z listą CAPA i terminami, wnioski dla procesów/monitoringu, aktualizacje runbooków/alertów/szkoleń.
...
- Streszczenie (co się stało, wpływ, czas trwania)
- Timeline faktów
- Co zadziałało / co nie zadziałało
- Root cause + contributory factors (ludzie/proces/technika/organizacja)
- Decyzje i kontekst (co było wiadomo, presje, ograniczenia)
- CAPA (działania, owner, termin, miary skuteczności)
- Lekcje i zmiany procesowe/szkoleniowe/monitoringowe
- Follow-up i status CAPA
- [Sekcja 3]
