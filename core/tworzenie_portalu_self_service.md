---
title: Tworzenie portalu self-service
...
aligned_by: codex
---
# Tworzenie portalu self-service
...
Plan uruchomienia portalu self-service.
...
1. Use case i journey.
2. Funkcje: reset haseł, status, zgłoszenia.
3. Uprawnienia i prywatność.
4. Wyszukiwalność i KB.
5. Metryki: deflection, CSAT.
6. Utrzymanie i roadmap.
...
- [ ] Journey i funkcje zdefiniowane.
- [ ] Uprawnienia/prywatność uwzględnione.
- [ ] Metryki deflection/CSAT mierzone.
- [ ] Roadmap/utrzymanie opisane.
