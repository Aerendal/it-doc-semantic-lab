...
Zdefiniować podejście do testów kontraktowych API, aby wykrywać niekompatybilne zmiany przed wdrożeniem.


## Zakres i granice

- Obejmuje: testy producer/consumer, schematy (OpenAPI/Proto), backward compatibility, stuby/mocki, pipeline CI, raportowanie.
- Poza zakresem: testy end‑to‑end UI.
...
- Kontekst i cele
- Zakres (producer/consumer)
- Schematy i wersjonowanie
- Pipeline CI i mocki
- Raportowanie i blokery release
- Ryzyka
...
- Spec kontraktów
- Lista konsumentów/producerów
- Polityka wersjonowania
- Narzędzia contract testing (np. Pact)


## Wyjścia

- Plan testów kontraktowych
- Integracja w CI
...
- [ ] Spec kontraktów dostępna
- [ ] Lista konsumentów zebrana
- [ ] Polityka wersjonowania znana
- [ ] Narzędzia contract testing wybrane


## Kryteria DoD

- [ ] Testy w CI skonfigurowane
- [ ] Raporty kompatybilności generowane
- [ ] Blokery release zdefiniowane
...
- Liczba złamanych kontraktów
- Czas detekcji przed release
- Pokrycie kontraktów
- Rollbacks z powodu kompatybilności
