...
Sprawdzić zgodność aplikacji z Apple Human Interface Guidelines (HIG), aby uniknąć odrzuceń i zapewnić spójne UX na iOS/macOS.
...
1. Nawigacja i hierarchia (bars, tabs, modals) zgodna z HIG.
2. Gesty i interakcje (swipe, back, drag) platformowe.
3. Typografia/kolory/kontrast, dynamic type, dark mode.
4. Komponenty systemowe (pickers, alerts, sheets) użyte poprawnie.
5. Ikony/splash/app icon zgodne z wytycznymi.
6. Privacy i permission dialogs (język Apple, kontekst).
7. Accessibility (VoiceOver, focus, hit targets, labels).
...
- [ ] Nawigacja/gesty zgodne z HIG.
- [ ] Typografia/kolory/dynamic type/dark mode.
- [ ] Komponenty systemowe użyte poprawnie.
- [ ] Permissions copy zgodne z HIG, a11y kompletne.
