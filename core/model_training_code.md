...
Opisać standardy i strukturę kodu treningowego modeli, by był powtarzalny, czytelny i gotowy do produkcji.
...
1. Struktura repo: moduły danych, modeli, config, eksperymentów; konwencje nazw.
2. Konfiguracja: YAML/CLI, hermetyzacja seedów, reproducibility.
3. Dane: ładowanie, preprocessing, augmentacje, walidacje, logowanie data lineage.
4. Trening: pętle, checkpointy, early stopping, logi metryk, eksperyment tracking.
5. Testy: jednostkowe, integracyjne na małym batchu, kontrakty danych, smoke.
6. Packaging i CI: dependency pinning, Docker, artefakty, style/lint, security checks.
...
- [ ] Repo ma jasną strukturę i konfigurowalność bez zmian kodu.
- [ ] Dane i preprocessing walidowane; reproducibility zapewnione.
- [ ] Trening loguje metryki/eksperymenty, checkpointy i testy są obecne.
- [ ] CI buduje paczkę/obrazy, pinning zależności i kontrole bezpieczeństwa działają.
