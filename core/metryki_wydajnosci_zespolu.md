---
title: Metryki wydajności zespołu
...
Zdefiniować metryki pracy zespołów (dev/ops/support) wspierające produktywność i zdrowe praktyki.
...
1. Delivery: lead time, cycle time, throughput, deployment frequency.
2. Jakość: defekty, escaped defects, bug rate, code review SLAs, test coverage trend.
3. Reliability (DORA/SRE): change fail rate, MTTR/MTBF, SLO adherence.
4. Flow i przeciążenie: WIP, context switching, przerwy w pracy, on-call load.
5. People: retencja, absenteeism, satysfakcja (eNPS), szkolenia/rozwój.
6. Raportowanie: cadence, segmentacja (podzespoły), działania usprawniające.
...
- [ ] Delivery/Quality/Reliability metryki zdefiniowane i mierzone.
- [ ] WIP/on-call load monitorowane, aby unikać przeciążenia.
- [ ] eNPS/satysfakcja i rozwój włączone do raportów.
- [ ] Metryki są interpretowane z kontekstem, nie służą do micro-managementu.
