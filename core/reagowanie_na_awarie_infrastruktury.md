---
title: Reagowanie na awarie infrastruktury
...
aligned_by: codex
---
# Reagowanie na awarie infrastruktury
...
Koordynować reakcję na awarie infrastruktury (sieć/zasilanie/chmura).
...
1. Detekcja i zakres: sieć, zasilanie, DC, chmura.
2. Triage: usługi krytyczne, zależności, SLA.
3. Stabilizacja: przełączenia, DR, ograniczenie ruchu.
4. Komunikacja: NOC, biznes, klienci, dostawcy.
5. Naprawa: współpraca z dostawcą, przełączenie z powrotem.
6. Postmortem: przyczyna, wnioski, plany odporności.
...
- [ ] Zakres i wpływ ocenione; DR/przełączenia wykonane.
- [ ] Komunikacja do interesariuszy prowadzona.
- [ ] Naprawa i powrót do normalnych ścieżek potwierdzony.
- [ ] Postmortem i plany odporności zapisane.
