---
title: Design analytics w sklepach
...
Zaprojektować analitykę dla sklepów fizycznych: ruch, konwersje, POS, kampanie, stany magazynowe.
...
1. Źródła danych: POS, traffic counters/vision, Wi‑Fi, kampanie, inventory.
2. Model danych i identyfikacja: sesje sklepowe, strefy, konwersja (wejście→zakup), mapowanie do POS.
3. Metryki: footfall, dwell time, conversion, basket size, attach rate, OOS, shrink.
4. Segmentacja: sklep/lokalizacja/godzina/kampania.
5. Pipeline: ingest (stream/batch), privacy (anonimizacja), storage, harmonizacja czasu.
6. DQ/observability: completeness, dedup, time sync, alerty na OOS/anomalia.
7. Dashboards/alerty: konwersje, OOS, kampanie, heatmaps.
...
- [ ] Źródła i identyfikacja klientów/sesji opisane (z poszanowaniem prywatności).
- [ ] Metryki i segmenty zdefiniowane.
- [ ] DQ/time sync/anonimizacja zaadresowane.
- [ ] Alerty na OOS/anomalie i dashboardy gotowe.
