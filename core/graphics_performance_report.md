---
title: Graphics Performance Report
...
Przedstawić cykliczny raport wydajności grafiki (FPS/frametime/VRAM/IO) z trendami i rekomendacjami.


## Zakres i granice

- Obejmuje: metryki perf/stabilności, trend p50/p95, sceny referencyjne, platformy, regresje i rekomendacje.
- Poza zakresem: szczegółowe plany optymalizacji (w improvement plan).
...
- Metryki i trend (per scena/platforma)
- Regresje i incydenty
...
- Telemetry/dashboardy (rendering_performance_monitoring)
- Sceny referencyjne wyniki
- Incydenty/regresje
- Zmiany w pipeline/shader/assetach


## Wyjścia

- Raport (metryki, trend, regresje)
- Rekomendacje i właściciele
- Linki do capture/testów
- Aktualizacja metryk/progów jeśli potrzeba
...
- [ ] Aktualne dane telemetry
- [ ] Sceny referencyjne wyniki
- [ ] Lista zmian w pipeline/shader
- [ ] Incydenty/regresje zebrane


## Kryteria DoD

- [ ] Raport wypełniony i udostępniony
- [ ] Rekomendacje z ownerami
- [ ] Linki/capture dodane
...
- Frametime p50/p95
- FPS per scena/platforma
- VRAM/IO peak
- Liczba regresji od ostatniego raportu
