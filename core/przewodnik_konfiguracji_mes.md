---
title: Przewodnik konfiguracji MES
...
Zdefiniować kroki konfiguracji systemu MES.
...
1. Model produkcji: linie, stanowiska, receptury, marszruty.
2. Integracje: PLC/SCADA, ERP, magazyn, jakościowe systemy.
3. Użytkownicy i role: operatorzy, liderzy, utrzymanie, uprawnienia.
4. Parametry i limity: takt time, KPI, alarmy, andon.
5. Dane i raporty: zbieranie, jakość, raporty OEE, traceability.
6. Testy i uruchomienie: dry-run, szkolenia, wsparcie startu produkcji.
...
- [ ] Model produkcji odwzorowany i przetestowany.
- [ ] Integracje z PLC/ERP działają i mają monitoring.
- [ ] Role i uprawnienia skonfigurowane; audyt logowań aktywny.
- [ ] Raporty OEE/traceability są poprawne po testach.
