---
title: Recovery Point Objective Definition
...
Define and record the RPO for a service.
...
1. Scope: systems, data sets, criticality.
2. Business requirement: max data loss tolerated.
3. Mechanisms: backups, replication, frequency.
4. Validation: restore tests, evidence.
5. Monitoring: backup success, replication lag.
6. Approval and review: owner sign-off, review cadence.
...
- [ ] RPO agreed with business and documented.
- [ ] Mechanisms support the RPO; tested restores.
- [ ] Monitoring/alerts in place for backups/replication.
