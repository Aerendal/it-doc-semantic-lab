...
Error Budget Concept — szablon dokumentu IT.
...
> Dokument satelitarny do: "Error Budget Policy" - rozszerza lub uszczegolawia jego tresc.
...
- Zależność: {'depends_on': 'SLO/SLA Requirements', 'type': 'REQUIRES'}
