...
## Cel dokumentu
Opisać zasoby zgodności (CapabilityStatement) systemu implementującego HL7 FHIR — formalne oświadczenie serwera FHIR o obsługiwanych zasobach, operacjach, profilach i wersjach. CapabilityStatement (zastąpił Conformance w FHIR R4) jest wymaganym metadanym każdego serwera FHIR: informuje klientów o możliwościach systemu, obsługiwanych typach zasobów i rozszerzeniach — umożliwiając interoperacyjność systemów zdrowotnych.
