...
1. Cel zadania i dane wejściowe/wyjściowe.
2. Konfiguracja: executor/driver, memory, shuffle.
3. Optymalizacje: partitioning, cache, broadcast.
4. Wejścia/wyjścia: formaty, schemat, walidacje.
5. Monitoring: metrics, logs, lineage.
6. Testy i SLA.
...
- [ ] Konfiguracja i dane opisane.
- [ ] Optymalizacje dobrane.
- [ ] Monitoring i testy zdefiniowane.
- [ ] SLA ustalone.
