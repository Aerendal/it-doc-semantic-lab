...
Proces odpowiadania na recenzje w sklepach.
...
1. Kategoryzacja opinii: bug/feature/support/ocena.
2. Priorytety i SLA reakcji.
3. Szablony odpowiedzi i ton komunikacji.
4. Eskalacje: krytyczne zgłoszenia, bezpieczeństwo.
5. Metryki: CSAT/NPS, zmiana ocen.
6. Feedback loop do produktu/QA.
...
- [ ] SLA reakcji ustawione.
- [ ] Szablony i ton komunikacji gotowe.
- [ ] Eskalacje zdefiniowane.
- [ ] Feedback do backlogu włączony.
