...
Rejestr ryzyk dla projektów/aplikacji mobilnych.
...
1. Identyfikacja: opis, komponent, platforma.
2. Ocena: prawd./wpływ, priorytet.
3. Mitigacje i plany awaryjne.
4. Status i daty przeglądu.
5. Właściciele i akcje.
6. Powiązania z incydentami/defektami.
...
- [ ] Ryzyka ocenione i posegregowane.
- [ ] Mitigacje i właściciele przypisani.
- [ ] Statusy i daty aktualne.
- [ ] Powiązania z incydentami/defektami opisane.
