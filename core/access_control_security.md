...
Zdefiniować zasady i kontrole bezpieczeństwa dostępu (IAM, RBAC/ABAC, mTLS), aby chronić zasoby.


## Zakres i granice

- Obejmuje: model uprawnień, RBAC/ABAC, authn/authz, least privilege, SoD, audyt/review.
- Poza zakresem: implementacja pojedynczych usług.
...
- Model ról/atrybutów
- Zasady dostępu
- Least privilege i SoD
- Audyt/logowanie/review
- Ryzyka
...
- Model uprawnień i zasady
- Checklisty DoR/DoD
- Plan review i audytu
- Powiązania do implementacji/testów
