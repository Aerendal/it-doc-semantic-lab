...
Zdefiniować szybki, kontrolowany proces wprowadzania poprawek krytycznych na produkcję.
...
1. Kryteria uruchomienia hotfix (SLA, wpływ, bezpieczeństwo).
2. Ścieżka kodu: branch hotfix, zasady commit/CI/CD, podpisy zmian.
3. Testy: minimalny zestaw smoke/regresja, środowiska, kto zatwierdza.
4. Plan wdrożenia i rollback; okno zmian, komunikacja do biznesu/CS.
5. Post-mortem: logi, metryki, akcje trwałe, uczenie.
6. Kontrola dostępu i audyt ścieżki hotfix.
...
- [ ] Spełnione kryteria hotfix i właściciel incydentu wskazany.
- [ ] Branch, CI/CD i podpisy zmian udokumentowane.
- [ ] Wykonane smoke/regresja oraz plan rollback gotowy.
- [ ] Post-mortem zaplanowane i zapisane.
