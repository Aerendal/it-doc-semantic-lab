...
Zorganizować przekazanie wiedzy (KT) między zespołami/osobami tak, by nowy zespół mógł samodzielnie utrzymywać i rozwijać rozwiązanie.
...
1. Zakres: systemy, procesy, runbooki, kontakty, środowiska.
2. Forma i harmonogram: sesje live, nagrania, dokumenty, shadowing, Q&A; terminy i odpowiedzialni.
3. Materiały: repozytoria, diagramy, checklisty operacyjne, access list, backlog pytań.
4. Weryfikacja: ćwiczenia praktyczne, reverse KT, checklisty „ready”, testy dostępu.
5. Ryzyka i luki: brakujące obszary, plan uzupełnień, właściciele tematów.
6. Zamknięcie: potwierdzenie gotowości, podpis KT, plan wsparcia hypercare.
...
- [ ] Zakres wiedzy i materiały kompletne, dostępy nadane.
- [ ] Sesje KT odbyły się wg harmonogramu; Q&A udokumentowane.
- [ ] Reverse KT/ćwiczenia potwierdziły gotowość nowego zespołu.
- [ ] Plan hypercare/ wsparcia po KT ustalony.
