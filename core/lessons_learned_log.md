...
Rejestrować wnioski wyciągnięte z realizacji projektu w celu poprawy przyszłych projektów — jako Lessons Log wymagany przez PRINCE2 7 (Themes: Quality, Risk; Process: Closing a Project). Log jest tworzony na początku projektu (Initiation), aktualizowany w każdym przeglądzie etapu i finalizowany podczas zamknięcia projektu — przekazywany do Portfolio Management jako wkład do bazy wiedzy organizacji.
