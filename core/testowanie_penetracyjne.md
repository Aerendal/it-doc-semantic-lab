...
Plan/pakiet testów penetracyjnych.
...
1. Zakres: aplikacje/API/infrastruktura.
2. Metody: black/grey/white box, narzędzia.
3. Zgody/okna i dane.
4. Raport: severity/CVSS, dowody, rekomendacje.
5. Remediacja i retest.
...
- [ ] Zakres/metody uzgodnione.
- [ ] Zgody/okna testowe ustawione.
- [ ] Raport z dowodami/severity dostarczony.
- [ ] Retest/remediacja zaplanowane.
