---
title: Plan zarządzania zasobami
...
Zaplanować i kontrolować wykorzystanie zasobów (ludzie/sprzęt/budżet), by spełnić cele projektu/programu.
...
1. Inwentarz i zapotrzebowanie: role/kompetencje, sprzęt, licencje, budżet; prognoza obciążenia.
2. Przydziały: alokacja na projekty/strumienie, % czasu, daty start/koniec, RACI.
3. Harmonogram i capacity: kalendarz pracy, urlopy, rezerwy, overbooking.
4. Zmiany i ryzyka: rotacje, single points, plany backup, hiring/outsourcing.
5. Monitorowanie: burn-rate, velocity, wykorzystanie, variances; cykl przeglądów.
6. Komunikacja i narzędzia: repo planu, aktualizacje, workflow akceptacji.
...
- [ ] Zapotrzebowanie i alokacje zapisane; capacity uwzględnia urlopy/rezerwy.
- [ ] RACI i plany backup/hiring przygotowane.
- [ ] Monitoring wykorzystania/budżetu prowadzony cyklicznie.
- [ ] Plan jest wersjonowany i komunikowany interesariuszom.
