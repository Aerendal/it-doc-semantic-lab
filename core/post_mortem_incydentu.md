...
Dokumentować incydent, przyczyny i działania naprawcze, by zapobiegać powtórkom.
...
1. Podsumowanie: czas, wpływ, SLA, dotknięci klienci/usługi.
2. Timeline: fakty, alerty, decyzje, komunikacja.
3. Root cause: techniczne/procesowe/ludzkie; contributory factors.
4. CAPA: działania naprawcze/prewencyjne, właściciele, terminy, status.
5. Usprawnienia: monitoring, runbooki, testy, szkolenia, procesy.
6. Follow-up: retest, weryfikacja CAPA, aktualizacja dokumentacji.
...
- [ ] CAPA z właścicielami/terminami i statusem.
- [ ] Usprawnienia (monitoring/runbooki/testy) zdefiniowane.
- [ ] Follow-up i retest zaplanowane.
