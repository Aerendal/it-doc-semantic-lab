...
## Cel dokumentu
Business Requirements Document (BRD) zbiera wymagania funkcjonalne i niefunkcjonalne z jasnymi kryteriami akceptacji.
...
## Definicje robocze
- **BRD** — dokument zbierający wymagania biznesowe, nie techniczne.
## Przykłady użycia
