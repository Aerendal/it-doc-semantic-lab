...
Wdrożyć system PMS (Project/Property/Portfolio Management) z uwzględnieniem procesów, danych i integracji.
...
1. Zakres procesów i modułów: projekty/portfel/finanse/zasoby; właściciele.
2. Dane i migracja: źródła, mapping pól, czyszczenie, walidacja, plan cutover.
3. Integracje: ERP/HR/CMMS/BI/SSO; zależności i okna techniczne.
4. Konfiguracja workflow i uprawnień: role, RACI, SLA, raporty.
5. Szkolenia, komunikacja i zarządzanie zmianą; materiały dla użytkowników.
6. Testy (SIT/UAT), kryteria Go/No-Go, plan wsparcia po starcie.
...
- [ ] Zakres modułów i właściciele potwierdzeni.
- [ ] Plan migracji danych i cutover opisany oraz przetestowany.
- [ ] Integracje (ERP/HR/BI/SSO) zaplanowane i zweryfikowane.
- [ ] Workflow, role i raporty skonfigurowane; szkolenia przeprowadzone.
