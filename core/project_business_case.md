...
## Cel dokumentu
Project Business Case — szablon dokumentu IT.

Autoryzuje projekt i definiuje jego granice — cel biznesowy, zakres wysokiego poziomu, budżet, sponsor, kluczowych interesariuszy i PM. Stanowi mandat dla PM do angażowania zasobów.
...
## Wejścia i wyjścia
- **Wejścia** (co musi być dostępne przed wypełnieniem): Business case, analiza wykonalności, zatwierdzenia budżetowe, dostępność zasobów, strategic roadmap.
- **Wyjścia** (co dokument wytwarza jako rezultat): Zatwierdzona karta projektu, wyznaczony PM i sponsor, wstępny rejestr interesariuszy, kamienie milowe.
...
- **Wpływa na** (downstream — co zależy od tego dokumentu): Plan zarządzania projektem, rejestr interesariuszy, plan komunikacji, WBS, plan zarządzania ryzykiem.
- **Zależy od** (upstream — co musi istnieć przed tym dokumentem): Business case, analiza CBA, strategic roadmap, portfolio projektów organizacji.
