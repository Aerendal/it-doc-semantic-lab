---
title: Reagowanie na awarie platformy cloud
...
aligned_by: codex
---
# Reagowanie na awarie platformy cloud
...
Procedura na awarie usług chmurowych (provider outage).
...
1. Detekcja: status cloud, alerty, scope usług.
2. Triage: wpływ na systemy, regiony/AZ, priorytet.
3. Stabilizacja: przełączenie regionu, failover DR, ograniczenie funkcji.
4. Komunikacja: vendor, status page, biznes, klienci.
5. Naprawa/powrót: monitorowanie statusu, bezpieczny rollback.
6. Postmortem: odporność multi-AZ/region, limity dostawcy.
...
- [ ] Zakres awarii i priorytety ustalone.
- [ ] Failover/ograniczenia zastosowane.
- [ ] Komunikacja z klientami/biznesem wykonana.
- [ ] Wnioski o odporności zapisane.
