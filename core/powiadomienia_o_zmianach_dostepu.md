---
title: Powiadomienia o zmianach dostępu
...
aligned_by: codex
---
# Powiadomienia o zmianach dostępu
...
Ustalić zasady informowania użytkowników/administratorów o zmianach uprawnień i dostępu, w celu bezpieczeństwa i zgodności.
...
1. Zakres: typy zmian (nadanie/odebranie/zmiana roli, MFA, klucze), kogo dotyczy.
2. Kanały i treści: email/in-app/logs, co zawiera komunikat (kto, co, kiedy, powód, kontakt).
3. Częstotliwość i SLA: powiadomienia natychmiastowe vs. raporty dzienne/tygodniowe.
4. Bezpieczeństwo i prywatność: minimalizacja danych, spoofing protection, audit trail.
5. Integracja: źródła prawdy (IAM/AD/IdP), eventy, szablony, wersjonowanie komunikatów.
6. Monitorowanie: metryki (delivery, open), alerty na nietypowe zmiany, compliance.
...
- [ ] Zdefiniowano jakie zmiany dostępu są powiadamiane i kanały.
- [ ] Szablony komunikatów zawierają kto/co/kiedy/powód i kontakt.
- [ ] SLA powiadomień i raportów ustalone; audit trail dostępny.
- [ ] Monitorowane są nietypowe zmiany; prywatność i bezpieczeństwo zapewnione.
