...
## Cel dokumentu
Device Compatibility Testing definiuje strategię i zakres testów wraz z kryteriami akceptacji i raportowaniem defektów.
...
## Szybkie powiązania
- Zależność: {'depends_on': 'Avatar and Character Design', 'type': 'typical'}
- Zależność: {'depends_on': 'Avatar and Character Design', 'type': 'typical'}
