...
Opisać procedurę User Acceptance Testing danych/raportów: zakres, kryteria akceptacji, przypadki testowe i proces zgłaszania błędów.
...
1. Zakres UAT (raporty/tabele/potoki) i środowisko.
2. Kryteria akceptacji (poprawność, kompletność, zgodność z wymaganiami).
3. Dane testowe i źródła referencyjne.
4. Scenariusze i przypadki testowe (oczekiwane wyniki).
5. Defect process (jak zgłaszać, priorytety, SLA naprawy).
6. Podsumowanie i sign‑off.
...
- [ ] Zakres i kryteria akceptacji opisane.
- [ ] Dane testowe/referencyjne dostępne.
- [ ] Scenariusze z oczekiwanymi wynikami.
- [ ] Proces defect i sign‑off ustalony.
