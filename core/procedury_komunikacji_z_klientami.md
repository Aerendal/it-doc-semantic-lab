---
title: Procedury komunikacji z klientami
...
Ustalić standardy i kroki komunikacji z klientami (B2B/B2C) w przypadkach zmian, incydentów i bieżącej obsługi.
...
1. Segmenty i kanały: typy klientów, kanały (email/in-app/status/telefon/social), SLA odpowiedzi.
2. Typy komunikatów: incydenty/maintenance, release, deprecacje, ankiety, high-touch.
3. Szablony i treść: struktura, język prosty, lokalizacje, a11y, privacy note.
4. Proces: trigger, akceptacje, wysyłka, log komunikatów, follow-up.
5. Monitoring skuteczności: open/click, CSAT, feedback, unsubscribes.
6. Compliance: RODO/PII, opt-in/out, przechowywanie dowodów komunikacji.
...
- [ ] Szablony i kanały dobrane do typów komunikatów/segmentów.
- [ ] SLA odpowiedzi i proces akceptacji/wysyłki zdefiniowane.
- [ ] Log komunikatów i wskaźniki skuteczności monitorowane.
- [ ] Zgodność privacy/opt-in/out oraz archiwizacja zapewnione.
