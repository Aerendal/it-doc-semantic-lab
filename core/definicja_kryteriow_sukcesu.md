---
title: Definicja kryteriów sukcesu
...
Określić mierzalne kryteria sukcesu projektu/produktu, by jednoznacznie ocenić, czy cele zostały osiągnięte.
...
1. Cele biznesowe i techniczne (powiązane z KPI/OKR).
2. Kryteria mierzalne (metryki, progi, horyzont).
3. Zakres i kontekst (co jest uwzględnione, co nie).
4. Metoda pomiaru (źródła danych, częstotliwość, odpowiedzialni).
5. Warunki brzegowe i akceptacja (go/no‑go).
...
- [ ] Kryteria powiązane z celami/KPI.
- [ ] Mierzalne progi, źródła i metoda pomiaru.
- [ ] Zakres i warunki akceptacji opisane.
