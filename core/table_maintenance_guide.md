...
Przewodnik utrzymania tabel danych.
...
1. Harmonogram: vacuum/optimize/compaction.
2. Statystyki i analiza.
3. Partition/pruning.
4. Backup i retencja.
5. Monitoring: skew, small files.
6. Runbook awaryjny.
...
- [ ] Procedury utrzymania opisane.
- [ ] Monitoring metryk tabel włączony.
- [ ] Backup/retencja zdefiniowane.
- [ ] Runbook awaryjny gotowy.
