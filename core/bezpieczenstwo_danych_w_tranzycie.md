---
title: Bezpieczeństwo danych w tranzycie
...
aligned_by: codex
---
# Bezpieczeństwo danych w tranzycie
...
Zapewnić poufność i integralność danych przesyłanych między komponentami/systemami.


## Zakres i granice

- Obejmuje: TLS/mTLS, wersje i szyfry, certyfikaty i rotację, pinning, HSTS, szyfrowanie protokołów wewnętrznych, podpisy wiadomości, ochrona przed MITM/replay.
- Nie obejmuje: szyfrowania danych w spoczynku (osobny dokument) ani szczegółów sieci SDN.
...
1. Wymagania TLS (wersje, szyfry, PFS), mTLS gdzie potrzebne.
2. Zarządzanie certyfikatami (CA, rotacja, odwołanie, pinning).
3. Protokóły wewnętrzne (gRPC/AMQP/Kafka) – szyfrowanie i auth.
4. HSTS/OCSP stapling, ochrona przed downgrade/replay.
5. Testy/monitoring (scanner TLS, expiry alerts).
...
- [ ] TLS 1.2+/1.3, mocne szyfry, HSTS.
- [ ] mTLS na krytycznych ścieżkach.
- [ ] Certyfikaty/rotacja/monitoring wygasania.
- [ ] Pinning (tam gdzie możliwe) i ochrona przed replay.
- [ ] Testy scannerem TLS włączone.
