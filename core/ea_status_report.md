...
## Cel dokumentu
Śledzić postęp realizacji projektu i raportować status do kierownictwa w regularnych interwałach — jako Progress Status Report (PMR) wymagany przez ISO/IEC 29110 PM.4.7 (Monitor Project). Raport informuje o: stopniu realizacji planu (% ukończenia kamieni milowych), odchyleniach od harmonogramu/budżetu, ryzykach, problemach i planowanych działaniach do następnego okresu raportowania.
