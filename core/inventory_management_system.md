...
Prowadzić inwentaryzację aktywów IT jako implementację kontroli Asset Management — wymaganej przez CIS Controls v8 (Control 1: Hardware Assets, Control 2: Software Assets), ISO/IEC 27001 Annex A 5.9 (Information and Technology Assets), ISO/IEC 27017 (Cloud Assets) i NIST CSF (ID.AM). Inwentarz obejmuje: sprzęt, oprogramowanie, zasoby chmurowe, interfejsy, dane — jako fundament wszystkich pozostałych kontroli bezpieczeństwa.
