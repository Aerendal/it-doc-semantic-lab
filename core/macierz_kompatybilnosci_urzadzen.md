---
title: Macierz kompatybilności urządzeń
...
Przedstawić kompatybilność urządzeń z oprogramowaniem/usługami: wersje, funkcje, ograniczenia.
...
1. Zakres: modele urządzeń, wersje OS/FW, regiony, funkcje wspierane.
2. Macierz: urządzenie × wersja oprogramowania × funkcje/feature flags × status (tak/ograniczone/brak).
3. Wymagania minimalne: HW/OS, sieć, zależności (biblioteki, sterowniki).
4. Ograniczenia i known issues: lista, severity, workarounds.
5. Polityka aktualizacji: częstotliwość, deprecacja wsparcia, komunikacja.
6. Źródła: repozytorium macierzy, automaty aktualizacji danych, data ostatniej rewizji.
...
- [ ] Macierz obejmuje modele/OS/FW/funkcje z jasnym statusem.
- [ ] Wymagania minimalne i known issues podane.
- [ ] Polityka aktualizacji i komunikacji deprecacji opisana.
- [ ] Macierz wersjonowana i publikowana w ustalonym repo/portalu.
