---
title: Wizja strategii wsparcia
...
Wizja strategii wsparcia (support).
...
1. Cele SLA/CSAT.
2. Model wsparcia i kanały.
3. Automatyzacja i self-service.
4. Procesy incident/problem.
5. Metryki i raporty.
6. Roadmap.
...
- [ ] Cele/model wsparcia opisane.
- [ ] Automatyzacja/self-service uwzględnione.
- [ ] Procesy/metryki zdefiniowane.
