---
title: Integracja systemów bezpieczeństwa
...
Zintegrować systemy bezpieczeństwa fizycznego i/lub cyber (CCTV, ACS, SIEM, SOC tools), zapewniając korelację zdarzeń i spójne uprawnienia.
...
1. Zakres i inwentarz: CCTV, kontrola dostępu, alarmy, SIEM, EDR/NDR; właściciele.
2. Dane i zdarzenia: schematy, taksonomie, korelacja (np. badge + wideo), retention.
3. Integracje techniczne: API/SDK, syslog, webhooki, message bus; synchronizacja tożsamości.
4. Uprawnienia i RBAC: role, delegacje, zasady dostępu do wideo/logów, audyt.
5. Observability i SLA: monitoring źródeł, health checks, alerty na brak danych.
6. Compliance: RODO/cctv, przechowywanie nagrań, polityki prywatności, inspekcje.
...
- [ ] Inwentarz systemów i taksonomia zdarzeń zdefiniowane.
- [ ] Integracje (API/syslog/bus) działają; korelacja zdarzeń przetestowana.
- [ ] RBAC i audyt dostępu do wideo/logów skonfigurowane.
- [ ] Retencja i wymagania prawne (RODO/CCTV) opisane i spełnione.
