...
Zdefiniować zasady komunikacji w kryzysie (incydent, awaria, PR issue): kto mówi, co mówi, kiedy i jak.
...
1. Scenariusze kryzysowe i poziomy (severity, wpływ).
2. Role i odpowiedzialności (spokesperson, incident commander, PR/legal).
3. Kanały i odbiorcy (użytkownicy, partnerzy, media, wewnętrznie).
4. Szablony komunikatów (initial, updates, resolution, FAQ).
5. Czas reakcji i kadencja aktualizacji.
6. Zatwierdzanie i koordynacja (PR/legal/security).
7. Post-incident: retrospekcja i poprawki w playbooku.
...
- [ ] Role i kanały zdefiniowane.
- [ ] Szablony komunikatów przygotowane.
- [ ] Kadencja aktualizacji określona.
- [ ] Koordynacja z PR/legal/security działa.
