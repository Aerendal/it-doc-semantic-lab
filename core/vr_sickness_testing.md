...
## Cel dokumentu
VR Sickness Testing definiuje strategię i zakres testów wraz z kryteriami akceptacji i raportowaniem defektów.
...
## Szybkie powiązania
- Zależność: {'depends_on': '3D Asset Design Specification', 'type': 'typical'}
- Zależność: {'depends_on': '3D Asset Design Specification', 'type': 'typical'}
