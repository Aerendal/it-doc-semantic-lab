---
title: Reagowanie na awarie POS
...
Zapewnić ciągłość sprzedaży przy awarii POS.
...
1. Detekcja: alerty, zgłoszenia sklepów, błędy transakcji.
2. Triage: zakres (sklep/kanał), płatności vs sprzedaż.
3. Stabilizacja: tryb offline, paragony ręczne, alternatywne terminale.
4. Komunikacja: personel, wsparcie, finanse.
5. Naprawa: sieć, konfiguracja, aktualizacje, integracje.
6. Postmortem: przyczyny, zapobieganie, szkolenia.
...
- [ ] Zakres awarii znany; sprzedaż umożliwiona w trybie awaryjnym.
- [ ] Komunikacja do sklepów i finansów wykonana.
- [ ] Przyczyna usunięta; POS działa; test transakcji OK.
- [ ] Postmortem i poprawki wdrożone.
