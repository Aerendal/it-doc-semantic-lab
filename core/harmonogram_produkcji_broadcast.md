---
title: Harmonogram produkcji broadcast
...
aligned_by: codex
---
# Harmonogram produkcji broadcast
...
Zaplanować produkcję transmisji (TV/stream) z wyprzedzeniem: preprodukcję, realizację live i postprodukcję.
...
1. Kalendarz wydarzeń i okna produkcyjne; zasoby (studio, wozy, ekipy).
2. Preprodukcja: scenariusz, grafika, insert, prawa do treści, próby techniczne.
3. Realizacja live: setup, runbook techniczny, redundancja sygnału, łączność.
4. Postprodukcja: montaż, QC, archiwizacja, dystrybucja VOD.
5. Ryzyka: łączność, awarie sprzętu, zgody/prawa; plany awaryjne.
6. Metryki: SLA sygnału, downtime, odbiory QC.
...
- [ ] Kalendarz wydarzeń i zasoby potwierdzone.
- [ ] Próby techniczne wykonane, runbook live gotowy.
- [ ] Redundancja sygnału i plany awaryjne opisane.
- [ ] QC i archiwizacja po wydarzeniu zaplanowane.
