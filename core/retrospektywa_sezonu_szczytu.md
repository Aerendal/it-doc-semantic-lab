---
title: Retrospektywa sezonu szczytu
...
Retrospektywa sezonu peak (np. holiday).
...
1. Cele i przygotowania.
2. Wyniki: sprzedaż, SLA, incydenty.
3. Co zadziałało/nie: capacity, fulfillment.
4. Klient: satysfakcja, zwroty.
5. Działania na kolejny sezon.
6. Ownerzy i terminy.
...
- [ ] Wyniki i incydenty zebrane.
- [ ] Co zadziałało/nie opisane.
- [ ] Plan na kolejny sezon ustalony.
- [ ] Ownerzy/terminy dodani.
