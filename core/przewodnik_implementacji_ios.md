---
title: Przewodnik Implementacji iOS
...
Ustalić standardy implementacji aplikacji iOS.
...
1. Architektura: MVC/MVVM/Clean, moduły, DI, nawigacja.
2. UI: Human Interface Guidelines, auto layout, dynamic type, dostępność.
3. Dane i sieć: URLSession/Alamofire, persistence (CoreData/Realm), offline.
4. Build/CI: schematy, konfiguracje, signing/provisioning, testy (unit/UI).
5. Wydajność: Instruments (memory/CPU), cold start, rozmiar appek.
6. Bezpieczeństwo: Keychain, ATS, jailbreak detection, privacy perms.
...
- [ ] Architektura i nawigacja są zdefiniowane; moduły testowalne.
- [ ] Testy unit/UI w CI; provisioning i signing stabilne.
- [ ] Offline/cache i obsługa błędów działają; rozmiar i start w budżecie.
- [ ] Bezpieczeństwo i prywatność (ATS/Keychain/perms) skonfigurowane.
