---
title: Raport śledzenia kosztów
...
Monitorować koszty i ich zgodność z budżetem.
...
1. Zakres: jednostki kosztowe, centra, okres.
2. Budżet vs wykonanie: per kategoria, odchylenia.
3. Trendy i prognozy: run rate, forecast do końca.
4. Driverzy kosztów: czynniki, zmiany cen, wolumen.
5. Działania: optymalizacje, renegocjacje, limity.
6. Ryzyka: przekroczenia, kursy, zależności.
...
- [ ] Koszty zestawione z budżetem; odchylenia opisane.
- [ ] Prognoza do końca okresu przygotowana.
- [ ] Driverzy kosztów znane; działania podjęte.
- [ ] Ryzyka i limity kosztowe opisane.
