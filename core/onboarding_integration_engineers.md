---
title: Onboarding integration engineers
...
aligned_by: codex
---
# Onboarding integration engineers
...
Wprowadzić inżynierów integracji w standardy, konektory i procesy, aby szybko dostarczali stabilne integracje.
...
1. Dostępy: iPaaS/ESB, repozytoria, secrets, monitoring/DLQ, katalog integracji.
2. Standardy: naming/versioning, kontrakty, mapowania, idempotencja, retry/backoff, observability.
3. Bezpieczeństwo: auth/mTLS, tokeny, PII handling, rate limit, audyt.
4. Narzędzia: testy kontraktowe, mocking, lokalne środowisko, pipeline CI/CD.
5. Proces: review, release, change management, runbooki, rejestr integracji.
6. Pierwsze zadania: mała integracja, dodanie monitoringu/DLQ, dokumentacja w katalogu.
...
- [ ] Dostępy do iPaaS/ESB, secrets, monitoring nadane.
- [ ] Standardy kontraktów/idempotencji i bezpieczeństwa poznane.
- [ ] Potrafi użyć CI/testów/mocking i wprowadzić integrację do katalogu.
- [ ] Pierwsza integracja dostarczona z monitoringiem i dokumentacją.
