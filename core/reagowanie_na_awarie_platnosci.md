---
title: Reagowanie na awarie płatności
...
aligned_by: codex
---
# Reagowanie na awarie płatności
...
Zapewnić ciągłość płatności podczas awarii.
...
1. Detekcja: spadek autoryzacji, błędy gateway, chargebacks.
2. Triage: kanały, procesorzy, metody płatności.
3. Stabilizacja: failover na innego PSP, włączenie trybu offline/autoryzacja opóźniona.
4. Komunikacja: klienci, wsparcie, finanse.
5. Naprawa: konfiguracja, certy, limity, integracje.
6. Postmortem: przyczyna, odzyskanie transakcji, poprawki.
...
- [ ] Skala problemu (metody/PSP) zidentyfikowana.
- [ ] Failover/tryb offline zastosowany.
- [ ] Transakcje odzyskane/zweryfikowane; komunikacja wysłana.
- [ ] Postmortem i działania zapobiegawcze zapisane.
