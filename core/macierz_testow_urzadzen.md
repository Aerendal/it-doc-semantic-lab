...
Zdefiniować zestaw testów i pokrycie dla urządzeń (hardware), aby zapewnić jakość i zgodność przed rolloutem.
...
2. Rodzaje testów: funkcjonalne, kompatybilność, wydajność, bezpieczeństwo, środowiskowe.
3. Macierz pokrycia: testy × modele/wersje; priorytety; automaty vs. manual.
4. Dane testowe i narzędzia: bench, symulatory, logowanie, metryki.
5. Kryteria akceptacji: pass/fail, tolerancje, warunki środowiskowe.
6. Raportowanie: wyniki, defekty, traceability, re-testy.
...
- [ ] Modele/wersje HW/FW ujęte w macierzy.
- [ ] Pokrycie testów funkcjonalnych/kompatybilności/wydajności/bezpieczeństwa określone.
- [ ] Kryteria akceptacji i metryki zdefiniowane.
- [ ] Raporty testów i re-testy śledzone.
