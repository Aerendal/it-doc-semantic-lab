...
Wymagania bezpieczeństwa (safety) dla systemu/produktu.
...
1. Zakres i normy (np. ISO 26262, IEC 61508).
2. Analiza ryzyka: FMEA/FTA, poziomy ASIL/SIL.
3. Wymagania funkcjonalne i techniczne safety.
4. Walidacja i weryfikacja: testy, dowody.
5. Traceability: wymaganie->design->test.
6. Zarządzanie zmianą i audyt.
...
- [ ] Normy i poziomy safety zidentyfikowane.
- [ ] Ryzyka ocenione FMEA/FTA.
- [ ] Traceability i dowody testów istnieją.
- [ ] Plan audytu i zmian zapisany.
