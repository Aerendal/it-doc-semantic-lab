...
Zebrać przykłady kodu ilustrujące użycie kluczowych komponentów.
...
1. Zakres: języki, frameworki, domeny (API, data, UI).
2. Standardy: style guide, konwencje nazewnicze, komentarze.
3. Przykłady: minimalne działające, warianty, edge cases.
4. Bezpieczeństwo: sekrety, walidacja, obsługa błędów.
5. Testy: snippet + test, jak uruchomić.
6. Licencje i wkład: zasady korzystania, jak dodawać nowe przykłady.
...
- [ ] Przykłady są uruchamialne i zgodne ze style guide.
- [ ] Nie zawierają sekretów; mają test lub instrukcję uruchomienia.
- [ ] Opisują edge cases i bezpieczeństwo.
- [ ] Każdy przykład ma właściciela i wersję.
