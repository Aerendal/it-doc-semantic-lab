---
title: Checklist Submisji App Store
...
aligned_by: codex
---
# Checklist Submisji App Store (Apple)
...
Lista kontrolna przed zgłoszeniem aplikacji do Apple App Store, aby uniknąć odrzuceń i przyspieszyć publikację.
...
1. Metadane i zgodność (bundle id, wersja, build, privacy manifest, age rating).
2. Zgodność z wytycznymi (Guidelines) i prywatnością (ATT, dane zbierane).
3. Testy i stabilność (crash-free, wydajność, rozmiar).
4. UX i treści (screenshots, preview, lokalizacje, opis).
5. Płatności/in-app (jeśli dotyczy) i licencje.
6. Kontrola urządzeń/permisji (kamera/mic/location) i powiadomień.
7. Release info (phased release/TestFlight final, kontakt review).
...
- [ ] Metadane/wersja/build poprawne.
- [ ] Privacy/ATT i permissions opisane.
- [ ] Screenshots/preview lokalizowane.
- [ ] Crash-free rate akceptowalny.
- [ ] Release info ustawione.
