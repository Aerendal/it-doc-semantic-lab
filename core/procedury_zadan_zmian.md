...
Standaryzować sposób zgłaszania, oceny i realizacji żądań zmian w systemach/procesach.
...
1. Zakres i definicje: co jest zmianą, klasy (standard/normalna/pilna).
2. Role: wnioskodawca, właściciel systemu, CAB, realizator, bezpieczeństwo.
3. Wniosek o zmianę (RFC): opis, uzasadnienie, wpływ, ryzyka, plan wdrożenia i powrotu.
4. Ocena i aprobata: kryteria ryzyka, wymagane zgody, okna serwisowe.
5. Realizacja: checklista pre-wdrożeniowa, komunikacja, monitoring, rollback.
6. Zamknięcie: weryfikacja sukcesu, dokumentacja, aktualizacja CMDB i lessons learned.
...
- [ ] Każde żądanie ma kompletne RFC z planem wdrożenia i powrotu.
- [ ] Ocena ryzyka i wymagane zgody (CAB/owner/security) są udokumentowane.
- [ ] Zmiana wykonana w zaplanowanym oknie, z monitoringiem i rollbackiem.
- [ ] Po wdrożeniu potwierdzono sukces i zaktualizowano dokumentację/CMDB.
