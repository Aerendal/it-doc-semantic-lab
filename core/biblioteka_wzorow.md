...
Zdefiniować bibliotekę wzorów (templates/patterns) dla zespołów: co zawiera, jak jest wersjonowana, kto utrzymuje i jak z niej korzystać.


## Zakres i granice

- Obejmuje: katalog wzorów (dokumenty, komponenty, procesy), strukturę i metadane, wersjonowanie, proces dodawania/aktualizacji, kryteria jakości, dostępność i wyszukiwanie.
- Nie obejmuje: treści samych wzorów (są w plikach) ani licencjonowania zewnętrznych szablonów.
...
1. Zakres i typy wzorów (dokumenty, kody, diagramy, checklisty).
2. Struktura katalogu i metadane (tagi, domeny, wersje).
3. Proces dodawania/aktualizacji (przegląd, właściciele, release notes).
4. Kryteria jakości i zatwierdzania.
5. Dostęp i wyszukiwanie (narzędzia, indeksy).
6. Utrzymanie i archiwizacja (przeglądy okresowe).
...
- [ ] Katalog i metadane zdefiniowane.
- [ ] Proces dodawania/review ustalony.
- [ ] Wersje i daty przeglądów dostępne.
- [ ] Kryteria jakości i archiwizacji opisane.
