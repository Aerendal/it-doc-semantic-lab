---
title: Wymagania predykcji plonów
...
Wymagania systemu prognoz plonów.
...
1. Dane: pogoda, gleba, sat/dron.
2. Metryki modeli.
3. Granularność: region/uprawa.
4. Drift i sezonowość.
5. Integracje (FMS).
6. Raporty i UX.
...
- [ ] Sezonowość/drift uwzględnione.
- [ ] Integracje i raporty opisane.
- [ ] UX zmapowany.
