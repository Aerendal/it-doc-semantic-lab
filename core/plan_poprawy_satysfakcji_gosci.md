---
title: Plan poprawy satysfakcji gości
...
aligned_by: codex
---
# Plan poprawy satysfakcji gości
...
Zwiększyć satysfakcję gości (hospitality) przez działania operacyjne, produktowe i komunikacyjne.
...
1. Baseline i cele: obecny NPS/CSAT, główne pain points, target.
2. Analiza źródeł: feedback (ankiety/recenzje), incydenty, SLA usług, dane operacyjne.
3. Inicjatywy: szybkie wygrane i większe projekty (check-in, housekeeping, Wi-Fi, obsługa).
4. Właściciele i terminy: RACI, harmonogram, priorytety.
5. Pomiar efektu: metryki, A/B/piloty, monitoring bieżący.
6. Komunikacja: do gości (zmiany/korzyści), do personelu (szkolenia), status dla zarządu.
...
- [ ] Baseline/cele i pain points zidentyfikowane.
- [ ] Lista inicjatyw z właścicielami/terminami gotowa.
- [ ] Metryki efektu i pilotaże zaplanowane.
- [ ] Komunikacja do gości/personelu i statusy ustalone.
