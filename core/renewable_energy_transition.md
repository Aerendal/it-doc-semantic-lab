...
Plan przejścia na miks z większym udziałem OZE.
...
1. Cele i KPI: udział OZE, emisje, koszty.
2. Inwentaryzacja: obecne źródła, kontrakty, zużycie.
3. Ścieżki: PV/wiatr/PPA/magazyny, kolejność wdrożeń.
4. Grid i technika: przyłącza, inwertery, magazyny, regulacje.
5. Finanse i ryzyka: CAPEX/OPEX, taryfy, certyfikaty.
6. Roadmap i governance: kamienie, role, raportowanie.
...
- [ ] KPI i cele zdefiniowane.
- [ ] Ścieżki technologiczne i przyłącza opisane.
- [ ] Finanse/ryzyka oszacowane.
- [ ] Roadmap z rolami i raportowaniem istnieje.
