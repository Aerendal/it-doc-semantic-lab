...
1. Parametry i dokładność.
2. Łączność i protokoły.
3. Zasilanie i żywotność.
4. Bezpieczeństwo i OTA.
...
- [ ] Parametry/łączność opisane.
- [ ] Zasilanie/OTA uwzględnione.
- [ ] Monitoring/alerty ustawione.
- [ ] Testy/certy zaplanowane.
