---
title: Prywatność danych klientów
...
Zapewnić zgodność i bezpieczeństwo przetwarzania danych klientów B2C/B2B.
...
1. Kategorie danych: identyfikacyjne, kontakt, transakcje, wsparcie, marketing.
2. Podstawy przetwarzania: umowa, uzasadniony interes, zgody marketingowe.
3. Minimalizacja/retencja: profile danych, harmonogram usuwania, archiwa prawne.
4. Udostępnienia i podwykonawcy: lista procesorów, SCC/DPA, due diligence.
5. Bezpieczeństwo: szyfrowanie, kontrola dostępu, rejestrowanie, testy bezpieczeństwa.
6. Prawa osób i obsługa incydentów: kanały żądań, SLA, rejestry, notyfikacje.
...
- [ ] Rejestr czynności przetwarzania zawiera zakres i podstawy prawne.
- [ ] Retencja i minimalizacja są opisane i wdrożone.
- [ ] Lista procesorów aktualna; umowy/DPA podpisane; transfery ocenione.
- [ ] Procedury praw osób i incydentów są ćwiczone; logi audytowe prowadzone.
