...
Udokumentować wyniki testów Disaster Recovery.
...
1. Cel i scenariusze testów.
2. Środowisko i zakres systemów.
3. Czasy RTO/RPO uzyskane; porównanie do celów.
4. Problemy i odstępstwa.
5. Wnioski i działania naprawcze.
6. Plan kolejnych testów i doskonalenia.
...
- [ ] Scenariusze i wyniki są udokumentowane.
- [ ] RTO/RPO spełnione lub odnotowane odstępstwa.
- [ ] Działania naprawcze mają właścicieli/datę.
- [ ] Kolejny test zaplanowany.
