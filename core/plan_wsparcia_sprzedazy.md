...
Zapewnić działania wspierające sprzedaż (enablement) dla zespołów handlowych i partnerów.
...
1. Cele i KPI: pipeline, win rate, time-to-first-sale, przychód/segment.
2. Materiały i narzędzia: pitch decki, battlecards, demo, case studies, pricing, CRM/CPQ.
3. Szkolenia: produkt/konkurencja, objection handling, certyfikacje, harmonogram.
4. Wsparcie dealów: SME on-call, deal desk, niestandardowe wyceny, SLA odpowiedzi.
5. Feedback loop: zbieranie uwag z pola, aktualizacja materiałów, roadmap input.
6. Raportowanie: wykorzystanie materiałów, efektywność szkoleń, KPI sprzedażowe.
...
- [ ] KPI sprzedażowe i cele enablement zdefiniowane.
- [ ] Materiały i narzędzia aktualne, dostępne i wersjonowane.
- [ ] Szkolenia/certyfikacje zaplanowane; SLA deal desk ustalone.
- [ ] Feedback loop i raportowanie skuteczności działają.
