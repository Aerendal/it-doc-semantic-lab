---
title: Vehicle-to-Everything (V2X) Vision
...
# Vehicle-to-Everything (V2X) Vision
...
## Cel dokumentu
Vehicle-to-Everything (V2X) Vision definiuje kierunek, filary i KPI oraz ramy wdrożenia.
