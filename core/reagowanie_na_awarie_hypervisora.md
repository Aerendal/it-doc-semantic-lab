---
title: Reagowanie na awarie hypervisora
...
aligned_by: codex
---
# Reagowanie na awarie hypervisora
...
Przywrócić środowisko po awarii hypervisora.
...
1. Detekcja: host down, panic, storage errors.
2. Triage: które VM dotknięte, HA/DRS status.
3. Stabilizacja: evacuate/przeniesienie, restart hosta, izolacja.
4. Analiza: logi hypervisora, hardware, firmware.
5. Naprawa: patch, replace hardware, config fix.
6. Postmortem: capacity/HA przegląd, testy HA/DR.
...
- [ ] VM przeniesione/przywrócone; usługi działają.
- [ ] Przyczyna hosta zidentyfikowana i naprawiona.
- [ ] HA/DR test po zdarzeniu wykonany.
- [ ] Postmortem i działania w HA/capacity zapisane.
