...
Konfiguracja crash reporting w aplikacji.
...
1. Wybór narzędzia i zakres platform.
2. Inicjalizacja i key.
3. Symbolikacja/obfuscation mapping.
4. Alerty i progi.
5. Testy (force crash).
6. Polityka danych/PII.
...
- [ ] Crash tool zintegrowany i test force-crash.
- [ ] Symbole/mapping uploadowane.
- [ ] Alerty ustawione.
- [ ] PII/config zgodne z polityką.
