---
title: Procedury wsparcia graczy
...
Standaryzować obsługę zgłoszeń graczy, zwiększać satysfakcję i bezpieczeństwo ekosystemu.
...
1. Kanały zgłoszeń: in-game, web, email, chat; weryfikacja konta gracza.
2. Kategoryzacja i priorytety: płatności, dostęp, progres, nadużycia, moderacja społeczności.
3. Playbooki: refundy, utrata przedmiotów, blokady kont, eskalacje do anti-cheat/devops.
4. Monitorowanie nadużyć: spam, phishing, chargeback, toksyczne zachowania; narzędzia moderacji.
5. Komunikacja: szablony odpowiedzi, ETA, aktualizacje statusu, język i ton marki.
6. Metryki: SLA reakcji, NPS/CSAT, first contact resolution, backlog, defekty produktowe.
...
- [ ] Zgłoszenia graczy są kategoryzowane i priorytetyzowane według playbooków.
- [ ] Weryfikacja konta wykonana przed działaniem; działania zgodne z politykami anti-cheat.
- [ ] Refundy/blokady/zwroty przedmiotów udokumentowane i odwracalne.
- [ ] Metryki SLA i satysfakcji mierzone; defekty produktowe zgłaszane do backlogu.
