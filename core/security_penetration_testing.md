...
Zaplanować i wykonać testy penetracyjne bezpieczeństwa (app/API/network) oraz zarządzić wynikami.


## Zakres i granice

- Obejmuje: scope usług, typy testów (SAST/DAST/fuzz/pentest), dane/środowiska, raportowanie, retest.
- Poza zakresem: fizyczne testy socjotechniczne.
...
- Wypełnij sekcje według szkieletu; dodaj scope, wyniki i rekomendacje; jeśli sekcja N/A, uzasadnij.
...
- Model zagrożeń
- Scope usług i dane wrażliwe
- Polityki bezpieczeństwa/IR
- Środowisko testowe
- Narzędzia testów
...
- Plan testów security/pentest
- Raport podatności
- Rekomendacje i SLA napraw
- Powiązania do runbooków IR
...
- Streszczenie wyników/ryzyk; plan retestu i SLA napraw.


## Wymagane powiązania

- Runbooki IR, logging/audyt, polityki scoringu, SLA napraw.


## Kryteria DoR

- [ ] Scope i zgody uzgodnione
- [ ] Środowiska/narzędzia gotowe
- [ ] Dane testowe przygotowane
- [ ] Ownerzy napraw zidentyfikowani


## Kryteria DoD

- [ ] Testy wykonane/raportowane
- [ ] Rekomendacje z ownerami/SLA
- [ ] Retest zaplanowany/wykonany
...
- Weryfikacja dowodów i scoringu; sanity retestu; zgodność z zakresem i zgodami.


## Metryki monitorowane

- Liczba podatności High/Med
- Czas do naprawy/retestu
- Pokrycie scope
...
- Przegląd po każdym cyklu testów; aktualizacja quick-links/checklist i planów.
