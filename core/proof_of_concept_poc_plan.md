---
title: Proof of Concept (PoC) Plan
...
Proof of Concept (PoC) Plan określa harmonogram, zakres i odpowiedzialności, aby dowieźć rezultat w kontrolowany sposób.
...
- Zależność: {'depends_on': 'Solution Architecture Document', 'type': 'INFORMED_BY'}
- Zależność: {'depends_on': 'System Context Diagram', 'type': 'INFORMED_BY'}
- Zależność: {'depends_on': 'Solution Architecture Document', 'type': 'INFORMED_BY'}
