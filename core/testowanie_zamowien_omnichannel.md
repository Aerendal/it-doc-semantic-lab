---
title: Testowanie zamówień omnichannel
...
aligned_by: codex
---
# Testowanie zamówień omnichannel
...
1. Scenariusze: click&collect, ship-from-store, returns.
2. Kanały i synchronizacja.
3. Płatności i logistyka.
4. Powiadomienia.
5. KPI i raport.
6. Regresje.
...
- [ ] Scenariusze omni pokryte.
- [ ] Synchro/płatności/logistyka przetestowane.
