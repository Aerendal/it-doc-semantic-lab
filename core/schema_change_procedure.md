...
1. Planowanie: migracje, kompatybilność wstecz.
2. Review i testy: staging, dane przykładowe.
3. Wykonanie: kolejność, locki, rollout.
4. Monitoring: czas, błędy, wpływ na aplikacje.
5. Rollback i backup.
...
- [ ] Migracja zaplanowana z kompatybilnością.
- [ ] Testy/staging wykonane.
- [ ] Monitoring i rollback gotowe.
- [ ] Zmiana udokumentowana i zakomunikowana.
