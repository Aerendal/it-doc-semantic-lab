...
1. Cel i scope.
2. Informacja architektura: kategorie, tagi.
3. Proces tworzenia/review.
4. Technologia i wyszukiwarka.
5. Governance i właściciele.
6. Metryki i utrzymanie.
...
- [ ] IA i proces zdefiniowane.
- [ ] Technologia dobrana.
- [ ] Właściciele/metryki ustalone.
