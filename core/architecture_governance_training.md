---
title: Architecture Governance Training
...
# Architecture Governance Training
...
## Cel dokumentu
Architecture Governance Training opisuje program szkoleniowy/onboardingowy z celami, modułami i sposobem oceny.
...
## Szybkie powiązania
- Zależność: {'depends_on': 'Enterprise Architecture Vision', 'type': 'REQUIRES'}
- Zależność: {'depends_on': 'Enterprise Architecture Repository', 'type': 'REQUIRES'}
- Zależność: {'depends_on': 'Enterprise Architecture Vision', 'type': 'REQUIRES'}
