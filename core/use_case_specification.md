...
## Cel dokumentu
Opisać, jak użytkownik (aktor) wchodzi w interakcję z systemem, w jasno zdefiniowanych scenariuszach. Zapewnia wspólny język między biznesem, analitykami i zespołem technicznym, przed rozbiciem na user stories lub przypadki testowe.

## Zakres i granice
Obejmuje: aktorów, główne i alternatywne przebiegi, pre-/post-conditions, reguły biznesowe, wyjątki, wymagania niefunkcjonalne powiązane ze scenariuszem. Nie obejmuje: implementacji UI ani szczegółów technicznych backendu.

## Wejścia i wyjścia
- Wejścia: BRD/FRS, Problem Statement, persony, makiety wysokiego poziomu, reguły biznesowe.
- Wyjścia: spójny opis przebiegów, kryteria akceptacji, powiązane wymagania NFR dla danego scenariusza, lista wyjątków i błędów.
...
- Konsumuje: wymagania biznesowe (BRD/FRS), reguły biznesowe, makiety.
- Dostarcza do: backlogu user stories/test cases, API/UX design, Test Plan.

## Powiązania sekcja↔sekcja
- Pre-/post-conditions ↔ definicje danych wej./wyj. w API/UX.
- Przebieg alternatywny ↔ obsługa błędów w specyfikacji API.
- Kryteria akceptacji ↔ Test Plan / test cases.
...
- Identyfikator i nazwa przypadku użycia
- Aktorzy i interesariusze
- Cel/przynoszona wartość
- Pre-conditions i trigger
- Główny przebieg (kroki)
- Przebiegi alternatywne i wyjątki
- Post-conditions i rezultaty
- Reguły biznesowe powiązane
- Wymagania niefunkcjonalne specyficzne dla scenariusza
- Powiązane interfejsy/API/ekrany
