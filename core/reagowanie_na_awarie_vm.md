...
Szybko przywrócić niedziałające maszyny wirtualne.
...
1. Detekcja: monitoring, alerty hypervisora, zgłoszenia.
2. Triage: krytyczność VM, usługi zależne.
3. Stabilizacja: restart, przeniesienie na inny host, przywrócenie z backupu/snapshot.
4. Komunikacja: właściciele aplikacji, status.
5. Naprawa: analiza hosta/storage/sieci, patching.
6. Postmortem: działania trwałe, capacity, automatyzacja.
...
- [ ] Lista dotkniętych VM i priorytety ustalone.
- [ ] Przywrócenie/restart/przeniesienie wykonane.
- [ ] Przyczyna ustalona i naprawiona.
- [ ] Postmortem i działania trwałe zapisane.
