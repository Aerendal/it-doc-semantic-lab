---
title: Referencja designu obwodów
...
Referencja projektowania obwodów PCB.
...
1. Stos technologiczny: warstwy, materiały, stack-up.
2. Zasady projektowe: impedancja, separacja, ścieżki mocy/sygnału.
3. EMC/EMI: ekranowanie, filtrowanie, uziemienia.
4. Zasilanie i termika: plane, via stitching, chłodzenie.
5. DFM/DFA: reguły produkcyjne, testy, BOM.
6. Walidacja: symulacje, SI/PI, prototyp, testy.
...
- [ ] Stack-up i reguły DRC/DFM zdefiniowane.
- [ ] EMC/termika uwzględnione.
- [ ] Symulacje/testy zaplanowane.
- [ ] Dokumentacja produkcyjna kompletna.
