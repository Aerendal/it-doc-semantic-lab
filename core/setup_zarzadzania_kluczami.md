---
title: Setup zarządzania kluczami
...
Konfiguracja systemu zarządzania kluczami (KMS/HSM).
...
1. Źródła i typy kluczy: aplikacyjne, certy.
2. Polityki: rotacja, uprawnienia, izolacja.
3. Integracje: aplikacje, CI/CD, secrets.
4. Audyt i logi.
5. Backup i recover.
6. Testy i procedury incydentowe.
...
- [ ] Polityki rotacji/ACL zdefiniowane.
- [ ] Integracje z aplikacjami działają.
- [ ] Audyt/logi włączone.
- [ ] Backup/recover przetestowane.
