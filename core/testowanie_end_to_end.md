...
1. Ścieżki krytyczne i user journey.
2. Dane testowe i środowisko.
3. Automatyzacja i stabilność testów.
4. Monitoring flakiness.
5. Raport i SLA uruchomień.
6. Utrzymanie suite.
...
- [ ] Ścieżki/journey zdefiniowane.
- [ ] Dane/środowisko gotowe.
- [ ] Stabilność i monitoring flakiness opisane.
- [ ] Raport/SLA uruchomień ustalone.
