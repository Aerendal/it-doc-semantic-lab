...
Przeprowadzić ogólną ocenę bezpieczeństwa systemu/usługi, identyfikując luki i priorytety remediacji.
...
1. Zakres: komponenty, środowiska, dane wrażliwe, regulacje.
2. Metodyka: testy (pentest/VA), przegląd konfiguracji, threat modeling, policy gap.
3. Wyniki: luki z CVSS/ryzykiem, dowody, wpływ.
4. Plan napraw: priorytety, właściciele, terminy, zależności.
5. Residual risk i akceptacja: decyzje, wyjątki, daty przeglądów.
6. Raportowanie: podsumowanie dla managementu, szczegóły techniczne, załączniki.
...
- [ ] Zakres i metoda oceny zdefiniowane.
- [ ] Luki opisane z ryzykiem/CVSS i dowodami.
- [ ] Plan remediacji z właścicielami/terminami ustalony.
- [ ] Residual risk/wyjątki udokumentowane i zatwierdzone.
