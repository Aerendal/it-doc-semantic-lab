...
## Cel dokumentu
Udokumentować wyniki testowania oprogramowania (Software Test Report) na jednym z etapów procesu Software Verification (SVE.4) zgodnie z ISO/IEC 12207 Software Life Cycle Processes. Raport rejestruje: zakres testów, środowisko, wyniki per test case, wykryte defekty, metryki pokrycia i rekomendację: oprogramowanie nadaje się / nie nadaje się do przejścia do następnej fazy cyklu życia.
