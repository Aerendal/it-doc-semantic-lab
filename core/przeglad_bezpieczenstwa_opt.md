---
title: Przegląd bezpieczeństwa opt.
...
Przeprowadzić okresowy przegląd bezpieczeństwa operacyjnego i technologicznego.
...
1. Zakres: systemy, procesy, łączność, fizyczne kontrole; częstotliwość przeglądu.
2. Ocena ryzyk: zmiany w środowisku, nowe zagrożenia, wyniki testów/pentestów.
3. Kontrole techniczne: patching, hardening, backup, monitoring, IAM, sieć.
4. Kontrole procesowe: procedury IR, BCP/DR, szkolenia, świadomość, dostawcy.
5. Wnioski i plan działania: priorytety, właściciele, terminy, zależności.
6. Raportowanie: streszczenie dla leadership, ścieżka audytu, retencja wyników.
...
- [ ] Przegląd obejmuje uzgodniony zakres i aktualne ryzyka.
- [ ] Luki są sklasyfikowane i mają właścicieli oraz terminy naprawy.
- [ ] Plan działania jest zatwierdzony i monitorowany.
- [ ] Raport i dowody przeglądu są przechowywane zgodnie z polityką audytu.
