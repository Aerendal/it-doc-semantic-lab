---
title: Referencja techniczna streaming
...
aligned_by: codex
---
# Referencja techniczna streaming
...
Techniczna referencja streamingów audio/video.
...
1. Kodeki i profile: wideo/audio, HDR, DRM.
2. Packaging i protokoły: HLS/DASH, CMAF, LL streaming.
3. CDN i edge: cache, tokeny, multiple CDN.
4. Player: ABR, buffer, błędy, retry.
5. Monitoring: QoE/QoS metryki, logi.
6. Testy: urządzenia, sieci, regresje.
...
- [ ] Kodeki/protokoły i profile opisane.
- [ ] ABR/player i CDN praktyki zawarte.
- [ ] Monitoring QoE/QoS określony.
- [ ] Testy urządzeń/sieci zaplanowane.
