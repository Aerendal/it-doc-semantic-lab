...
Śledzić postęp realizacji roadmapy produktowej/projektowej.
...
1. Zakres: inicjatywy, kwartalne cele, odpowiedzialni.
2. Status: wykonane/w toku/zagrożone, % realizacji.
3. Ryzyka i blokery: opis, wpływ, plan mitigacji.
4. Zależności: między zespołami/systemami, daty.
5. Wskaźniki: lead time, throughput, burn-up/burn-down.
6. Decyzje i zmiany: replany, przesunięcia, scope creep.
...
- [ ] Status inicjatyw aktualny i wspólny dla wszystkich zespołów.
- [ ] Ryzyka i blokery mają właścicieli i terminy.
- [ ] Metryki przepływu są uwzględnione.
- [ ] Decyzje o zmianach są zapisane i zakomunikowane.
