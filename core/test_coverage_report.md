...
Raportować pokrycie testami dla release/iteracji, ze wskazaniem luk i rekomendacji.


## Zakres i granice

- Obejmuje: metryki pokrycia (linie/gałęzie/ścieżki), zmiany vs poprzedni release, luki krytyczne, rekomendacje.
- Poza zakresem: wykonanie samych testów.
...
- Raporty pokrycia
- Mapa wymagań/ścieżek
- Targety pokrycia
- Defect leakage/ryzyka
...
- Raport pokrycia
- Luki i rekomendacje
- Plan testów uzupełniających
- Powiązania do backlogu



## Szybkie powiązania (uzupełnij)

- [ ] test_coverage_monitoring.md
