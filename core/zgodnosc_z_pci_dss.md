...
1. Zakres CDE i segmentacja: systemy/strefy, PAN/SAD w zakresie, typ SAQ/AOC.
2. Kontrolki PCI DSS v4 (1–12): status, dowód, owner, data; tokenizacja/szyfrowanie/klucze.
3. Dostęp/logi: IAM, MFA, logowanie, SIEM, retencja.
4. Podatności/testy: ASV, pentesty, patching, wyjątki i CAPA.
5. Third parties: dostawcy/processorzy, AOC/SAQ, due diligence, umowy.
6. Raporty i certyfikacja: AOC/ROC/SAQ, harmonogram, waivery/compensating controls, utrzymanie.
...
- [ ] Zakres/segmentacja i SAQ/AOC opisane.
- [ ] Kontrolki 1–12 mają status/dowody/ownerów; wyjątki opisane.
- [ ] ASV/pentest i remediacje w planie; vendorzy i ich AOC/SAQ włączeni.
- [ ] Raporty PCI zdefiniowane; utrzymanie (cykl audytów) zaplanowane.
...
- Streszczenie statusu wymagań 1–12, głównych ryzyk i planów naprawczych.
