---
title: Referencja sieci sensorów
...
Referencyjna architektura sieci sensorów.
...
1. Topologie: star/mesh, gateway, protokoły (LoRa, Zigbee, BLE, Wi-Fi).
2. Adresacja i identyfikacja: ID, provisioning.
3. QoS: sampling, latencja, utrata pakietów.
4. Zasilanie: bateryjne, energy harvesting, sleep.
5. Bezpieczeństwo: klucze, OTA, fizyczne zabezpieczenia.
6. Monitoring i utrzymanie: inventory, alerty, rotacja baterii.
...
- [ ] Topologia i protokoły dobrane do use-case.
- [ ] Provisioning/ID i bezpieczeństwo opisane.
- [ ] QoS i zasilanie zaplanowane.
- [ ] Plan utrzymania i monitoring istnieje.
