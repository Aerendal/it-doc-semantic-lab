---
title: Ocena bezpieczeństwa IAM
...
Ocenić bezpieczeństwo systemów IAM: tożsamości, uprawnienia, procesy i audyt.
...
1. Zakres: IdP/dir, SSO, MFA, provisioning/deprovisioning, role/polityki, konta uprzywilejowane.
2. Metodyka: review konfiguracji, testy MFA/SSO, recertyfikacje, SoD, klucze/tajemnice.
3. Wyniki: luki (brak MFA, role creep, shadow admin, stare klucze), ryzyko.
4. Plan napraw: wdrożenie MFA, rotacja kluczy, recertyfikacje, JIT, logowanie/audyt.
5. Monitoring i alerty: anomalie logowania, geolokacja, brute/spray, nieużywane konta.
6. Raport: podsumowanie, priorytety, daty przeglądów, wyjątki.
...
- [ ] MFA/SSO i cykl życia kont ocenione; luki SoD/role creep zidentyfikowane.
- [ ] Klucze/tajemnice i konta admin przejrzone; plan rotacji.
- [ ] Anomalie logowania i alerty skonfigurowane.
- [ ] Plan napraw i recertyfikacji uzgodniony.
