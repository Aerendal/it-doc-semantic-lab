...
Zdefiniować wymagania rate limiting/QoS dla API, aby chronić usługi przed nadużyciami i zapewnić SLO.


## Zakres i granice

- Obejmuje: limity globalne i per-klient/per-route, burst/steady, priorytety, wyjątki, retry/429, monitorowanie i alerty.
- Poza zakresem: implementacja gateway (osobne dokumenty).
...
- Kontekst i cele
- Model klientów i priorytety
- Limity (global/per-route/per-client)
- Burst/steady i retry
- Monitoring/alerty
- Ryzyka i wyjątki
...
- Profil ruchu i SLO/SLA
- Modele klientów/kluczy
- Ryzyka abuse i krytyczne ścieżki
- Polityki biznesowe i regulacyjne


## Wyjścia

- Tabela limitów i polityk
- Scenariusze wyjątków/whitelist
- Plan monitoringu/alertów
- Checklisty DoR/DoD
...
- [ ] Profil ruchu i SLO znane
- [ ] Model klientów/kluczy zdefiniowany
- [ ] Ryzyka abuse zebrane
- [ ] Polityki biznesowe uzgodnione


## Kryteria DoD

- [ ] Tabela limitów uzupełniona
- [ ] Monitoring/alerty opisane
- [ ] Wyjątki/whitelist spisane
...
- Alerting config
- Raporty z testów obciążeniowych
