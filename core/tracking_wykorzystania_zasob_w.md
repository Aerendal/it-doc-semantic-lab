---
title: Tracking wykorzystania zasobÃ³w
...
aligned_by: codex
---
# Tracking wykorzystania zasobÃ³w
...
Tracking wykorzystania zasobów — szablon dokumentu IT.

Zawiera mechanizm śledzenia i raportowania statusu zadań, elementów konfiguracji, zasobów lub metryk. Każdy element powinien mieć: ID, właściciela, status (aktualny i historyczny), termin i powiązane działania.

> Dokument satelitarny do: "Raport wykorzystania zasobów" - rozszerza lub uszczegolawia jego tresc.
