---
title: Resource Allocation Plan (Capacity)
...
aligned_by: codex
---
# Resource Allocation Plan (Capacity)
...
Plan pojemności zasobów ludzkich/IT.
...
1. Założenia popytu: projekty, sezonowość.
2. Dostępność: zespoły, umiejętności, narzędzia.
3. Luki i ryzyka: brak kompetencji, PTO, attrition.
4. Scenariusze: bazowy/wysoki/niski.
5. Plan działań: hiring, szkolenia, outsourcing.
6. Przeglądy: cykl, metryki.
...
- [ ] Założenia popytu/dostępności opisane.
- [ ] Luki i ryzyka zidentyfikowane.
- [ ] Scenariusze i plan działań istnieją.
- [ ] Przeglądy i metryki ustalone.
