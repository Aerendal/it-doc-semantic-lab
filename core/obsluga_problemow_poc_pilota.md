---
title: Obsługa problemów POC/pilota
...
Ustalić proces zgłaszania, triage i naprawy problemów w trakcie POC/pilota, by szybko ocenić wykonalność rozwiązania.
...
1. Kanały zgłoszeń i szablon: minimalne dane (scenariusz, środowisko, logi).
2. Klasyfikacja i priorytety: blocker/major/minor; wpływ na KPI POC.
3. Triage i odpowiedzialni: właściciel techniczny/biznesowy, SLA reakcji.
4. Reprodukcja i logi: środowiska, dane testowe, feature flags, trace/logging.
5. Komunikacja: statusy do sponsorów, częstotliwość, zmiany scope.
6. Zamknięcie i wnioski: fix/wa, wpływ na wynik POC, aktualizacja ryzyk.
...
- [ ] Zgłoszenia mają komplet danych (scenariusz/logi/środowisko).
- [ ] Priorytety/SLA i właściciele przypisani.
- [ ] Fix/workaround potwierdzony w środowisku POC/pilot.
- [ ] Wpływ na KPI POC i ryzyka zaktualizowany.
