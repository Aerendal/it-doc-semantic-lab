---
title: Referencja metryk wydajności
...
Słownik metryk wydajności systemów.
...
1. Definicje: latencja, throughput, percentyle, SLO/SLA.
2. Kontekst: per warstwa (app/db/cache/net).
3. Sposób pomiaru: sampling, okna czasowe, histogramy.
4. Alerty i progi: ustalanie progów, noise reduction.
5. Prezentacja: dashboardy, standardy nazw.
6. Własność i utrzymanie: kto definiuje, zmiany.
...
- [ ] Metryki zdefiniowane i jednoznaczne.
- [ ] Metody pomiaru i agregacji opisane.
- [ ] Progi/alerty uzasadnione.
- [ ] Właściciele metryk wyznaczeni.
