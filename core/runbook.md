...
## Cel dokumentu
Zapewnić operacyjny, krok‑po‑kroku opis czynności (utrzymanie, monitoring, diagnostyka, naprawa) tak, aby dyżurny/on‑call mógł bezpiecznie i szybko wykonać zadanie lub reakcję.
