---
title: Skalowanie zasobów wirtualnych
...
aligned_by: codex
---
# Skalowanie zasobów wirtualnych
...
Instrukcja skalowania zasobów VM/containers.
...
1. Kiedy skalować: progi, SLO.
2. Rodzaje skalowania: poziome/pionowe.
3. Procedury: resize, migrowanie, rolling.
4. Bezpieczeństwo i dane: snapshot, backup.
5. Testy po zmianie.
6. Monitorowanie kosztów.
...
- [ ] Progi i typ skalowania zdefiniowane.
- [ ] Procedury resize/migrate opisane.
- [ ] Testy post-change wykonane.
- [ ] Koszty monitorowane.
