---
title: Analiza całkowitego kosztu
...
Obliczyć i wyjaśnić całkowity koszt realizacji/utrzymania rozwiązania w zadanym okresie (np. projekt, funkcja, usługa), aby wspierać decyzje biznesowe.


## Zakres i granice

- Obejmuje: koszty bezpośrednie (licencje, chmura, sprzęt), koszty pracy, wsparcie/operacje, ryzyka kosztowe, warianty (capex/opex), okres analizy.
- Nie obejmuje: pełnej analizy TCO w całym cyklu życia (to w „Analiza całkowitego kosztu posiadania”).
...
- Wejścia: zakres rozwiązania, estymacje zasobów, cenniki, zużycie usług, kontrakty vendorów, scenariusze obciążenia.
- Wyjścia: zestawienie kosztów per kategoria, warianty scenariuszy, czułość na założenia, rekomendacja kosztowa.
...
- Budżet/Business Case.
- Capacity/obciążenie (do przeliczeń).
- SLA/SLO (wpływają na koszty redundancji).
...
1. Zakres analizy i okres.
2. Założenia (obciążenie, ceny, rabaty, model licencjonowania).
3. Koszty bezpośrednie (licencje/chmura/sprzęt).
4. Koszty pracy i wsparcia.
5. Ryzyka i zmienność (czułość na założenia).
6. Scenariusze (np. pesymistyczny/realistyczny/optymistyczny).
7. Rekomendacje i następne kroki.
...
- [ ] Jasny zakres i okres analizy.
- [ ] Źródła cen i założeń udokumentowane.
- [ ] Scenariusze i wrażliwość policzone.
- [ ] Ryzyka kosztowe zidentyfikowane.
...
- **Czułość kosztowa** — jak koszt zmienia się przy zmianie kluczowych założeń.
...
- „Założenia i scenariusze” **constrains** „Estymacje kosztów”.
- „Ryzyka kosztowe” **feeds** „Rekomendacje”.
