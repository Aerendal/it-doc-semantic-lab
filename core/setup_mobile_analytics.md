...
Konfiguracja analityki mobilnej.
...
1. SDK i zgody (privacy).
2. Schemat eventów i identyfikatory.
3. Sample rate i performance.
4. Debug/QA i środowiska.
5. Integracje: push, A/B, ads.
6. Walidacja danych i audyt.
...
- [ ] SDK zainstalowane zgodnie z privacy.
- [ ] Event schema wdrożona.
- [ ] Performance/sample ustawione.
- [ ] Walidacja i audyt danych działa.
