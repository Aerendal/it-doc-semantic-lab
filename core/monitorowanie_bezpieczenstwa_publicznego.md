---
title: Monitorowanie bezpieczeństwa publicznego
...
Zaprojektować system monitorowania bezpieczeństwa publicznego (miasto/obiekt), integrujący dane z wielu źródeł i zapewniający szybkie reagowanie.
...
1. Źródła danych: CCTV, czujniki środowiskowe, alarmy, 112/911, social, IoT; klasy zdarzeń.
2. Ingest i integracja: protokoły, normalizacja, geolokalizacja, korelacja zdarzeń.
3. Analiza i detekcja: reguły, ML (anomalie), alerty priorytetowe, fałszywe alarmy.
4. Operacje i reakcja: centrum monitoringu, playbooki, dyspozytornia, współpraca z służbami.
5. Bezpieczeństwo i prywatność: RODO, retencja nagrań, maskowanie, dostęp role-based, audyt.
6. Raportowanie: SLA reakcji, statystyki zdarzeń, heatmapy, testy i ćwiczenia.
...
- [ ] Źródła danych i klasy zdarzeń zmapowane i znormalizowane.
- [ ] Alerty/prioritety i playbooki reakcji zdefiniowane.
- [ ] Prywatność/retencja i dostęp role-based spełniają wymagania RODO.
- [ ] SLA reakcji i raporty zdarzeń monitorowane; ćwiczenia przeprowadzane.
