...
Zebrać, uporządkować i potwierdzić wymagania klienta (funkcjonalne i niefunkcjonalne) tak, by były zrozumiałe, testowalne i śledzone.


## Zakres i granice

- Obejmuje: potrzeby biznesowe, przypadki użycia, wymagania jakościowe (SLO, bezpieczeństwo, dostępność), priorytety, kryteria akceptacji.
- Nie obejmuje: pełnej analizy UX (osobny artefakt) ani szczegółowego projektu technicznego.
...
- Wejścia: warsztaty/wywiady, dokumenty klienta, dane z analityki, ograniczenia prawne.
- Wyjścia: lista wymagań z priorytetem, kryteria akceptacji, mapa do backlogu/user stories, lista luk/pytań do doprecyzowania.
...
- Security/Compliance wymagania.
- Analiza kosztów i korzyści (priorytetyzacja).
...
1. Kontekst biznesowy i cele klienta.
2. Wymagania funkcjonalne (use cases, aktorzy).
3. Wymagania niefunkcjonalne (wydajność, bezpieczeństwo, dostępność).
4. Priorytety i kryteria akceptacji.
5. Luki/ryzyka i pytania do klienta.
6. Mapowanie do backlogu/stories.
...
- [ ] Wymagania funkcjonalne i niefunkcjonalne opisane.
- [ ] Priorytety i AC ustalone z klientem.
- [ ] Luki/pytania spisane i przypisane.
- [ ] Mapowanie do backlogu wykonane.


## Definicje robocze

- **AC (Acceptance Criteria)** — warunki, po których spełnieniu uznajemy wymaganie za zrealizowane.
...
- „Wymagania i AC” **defines_structure** „Mapa do backlogu”.
- „Luki i pytania” **feeds** „Warsztaty/clarifications”.
