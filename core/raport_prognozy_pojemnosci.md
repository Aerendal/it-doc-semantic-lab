---
title: Raport prognozy pojemności
...
Alternatywna forma raportu prognoz pojemności (np. cykliczna).
...
1. Zakres okresu i systemów.
2. Aktualne obciążenie i trend.
3. Prognozy scenariuszowe: bazowy/niski/wysoki.
4. Bufory i polityka zapasu.
5. Plan zakupów i optymalizacji kosztów.
...
- [ ] Prognozy obejmują kilka scenariuszy.
- [ ] Zapas i polityka buforów są określone.
- [ ] Plan zakupów/optymalizacji ma daty.
- [ ] Ryzyka są zidentyfikowane z właścicielami.
