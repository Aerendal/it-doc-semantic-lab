---
title: Specyfikacja designu API
...
1. Cel i kontrakt: zasoby/akcje.
2. Model danych i schematy.
3. Standardy: nazewnictwo, wersjonowanie, błędy.
4. Bezpieczeństwo: auth, rate limit, audyt.
5. Wydajność: paginacja, cache, batch.
6. Dokumentacja i SDK.
...
- [ ] Zasoby/kontrakty opisane.
- [ ] Schematy zgodne ze standardem.
- [ ] Bezpieczeństwo i rate-limit ujęte.
- [ ] Dokumentacja/SDK zaplanowane.
