---
title: Integration Component Inventory
...
aligned_by: codex
---
# Integration Component Inventory
...
Integration Component Inventory opisuje jak dostarczyć rozwiązanie (kroki, migrację, testy, ryzyka).
