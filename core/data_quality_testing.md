...
Zaplanować i wykonywać testy jakości danych (kompletność, spójność, zakres, duplikaty) w pipeline/DB.


## Zakres i granice

- Obejmuje: testy schematu, zakresów, unikalności, referencji, anomaly detection, dane syntetyczne, raporty.
- Poza zakresem: biznesowa interpretacja wyników analitycznych.
...
- Spec schematu i reguły jakości
- Dane testowe lub próbki prod
- Narzędzia DQ
- Mapa krytycznych tabel/pól
...
- Plan testów DQ
- Raporty i alerty DQ
- Lista defektów i ownerów
- Powiązania do SLA danych
