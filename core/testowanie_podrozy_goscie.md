---
title: Testowanie podróży goście
...
Testy user journey gości (hospitality).
...
1. Ścieżki: rezerwacja -> pobyt -> check-out.
2. Kanały: web/app/front desk.
3. Płatności, uprawnienia, klucze.
4. Ankiety i feedback.
5. SLA i incydenty.
6. Raport i KPI.
...
- [ ] Ścieżki i kanały pokryte.
- [ ] Płatności/klucze przetestowane.
- [ ] Feedback/SLA uwzględnione.
- [ ] Raport z KPI przygotowany.
