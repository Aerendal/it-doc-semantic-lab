---
title: Raport wykorzystania zasobów
...
Raportować wykorzystanie zasobów (ludzie/IT).
...
1. Zakres: zespoły/systemy, okres.
2. Metryki: utilization %, dostępność, nadgodziny, zużycie CPU/RAM/IO.
3. Hotspoty: przeładowania, niedowykorzystanie.
4. Przyczyny: priorytety, awarie, planowanie.
5. Rekomendacje: rebalans, hiring, autoscaling.
6. Plan: działania, daty, monitoring.
...
- [ ] Utilization policzone i zweryfikowane.
- [ ] Hotspoty i przyczyny opisane.
- [ ] Rekomendacje i plan wdrożenia z właścicielami.
