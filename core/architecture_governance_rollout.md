---
title: Architecture Governance Rollout
...
# Architecture Governance Rollout
...
## Cel dokumentu
Architecture Governance Rollout określa harmonogram, zakres i odpowiedzialności, aby dowieźć rezultat w kontrolowany sposób.
...
- Zależność: {'depends_on': 'Enterprise Security Architecture', 'type': 'INFORMED_BY'}
