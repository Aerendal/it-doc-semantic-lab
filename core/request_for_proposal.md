...
Szablon RFP dla postępowań zakupowych.
...
1. Kontekst i cel.
2. Zakres prac/produktów.
3. Wymagania funkcjonalne/niefunkcjonalne.
4. Warunki komercyjne i prawne.
5. Terminy: pytania, oferty, decyzja.
6. Format oferty i kryteria oceny.
...
- [ ] Zakres i wymagania kompletne.
- [ ] Warunki i terminy opisane.
- [ ] Format/Kryteria oceny podane.
- [ ] Kanał komunikacji z dostawcami określony.
