...
Zdefiniować procedurę wsparcia dla użytkowników API (zgloszenia, SLA, eskalacje, komunikacja).


## Zakres i granice

- Obejmuje: kanały zgłoszeń, kategoryzację, SLA, eskalacje, runbooki, komunikację statusu.
...
- Kontekst i SLA
- Kanały i kategoryzacja
- Eskalacje/ownerzy
- Runbooki i bazowe diagnozy
- Komunikacja status
...
- player-support-procedure
- integration-support-procedure
...
- Kanały support i SLA
- Runbooki API/gateway
- Lista właścicieli usług
- Szablony komunikatów


## Wyjścia

- Procedura i checklisty
- Mapa eskalacji
- Szablony komunikatów
- Powiązania do postmortem/KB
