---
title: Cele zrównoważonego rozwoju miejskiego
...
aligned_by: codex
---
# Cele zrównoważonego rozwoju miejskiego
...
Określić cele smart city w obszarze zrównoważonego rozwoju: środowisko, energia, mobilność, jakość życia mieszkańców.


## Zakres i granice

- Obejmuje: metryki jakości powietrza/hałasu, energia i OZE, transport zrównoważony, zielona infrastruktura, gospodarka odpadami, otwarte dane, partycypacja mieszkańców.
- Nie obejmuje: polityk urbanistycznych/fizycznych (osobne dokumenty).
...
1. Cele i KPI (np. emisje, udział OZE, modal split, zielone tereny).
2. Dane i źródła (sensory, open data, integracje miejskie).
3. Inicjatywy i projekty (mobilność, energia, odpady, zieleń).
4. Monitoring i raportowanie (dashboardy, cykl przeglądu).
5. Zaangażowanie mieszkańców i komunikacja.
...
- [ ] Projekty powiązane z KPI.
- [ ] Monitoring/raporty publiczne działają.
