...
Zidentyfikować i ocenić ryzyka projektu, przygotować plan mitigacji i monitoringu.
...
1. Identyfikacja: lista ryzyk (zakres, harmonogram, zasoby, technologia, dostawcy, regulacje).
2. Ocena: prawdopodobieństwo, wpływ, scoring (np. RAG), właściciel.
3. Mitigacje i contingency: działania prewencyjne, plany awaryjne, trigerry.
4. Monitoring: wskaźniki wczesnego ostrzegania, cadence przeglądów, narzędzia.
5. Rejestr i status: aktualizacje, zmiany scoringu, zamknięcia.
6. Raportowanie: do interesariuszy/steering, decyzje i akceptacje ryzyk.
...
- [ ] Ryzyka zmapowane i ocenione (prob/impact, właściciele).
- [ ] Mitigacje i plany awaryjne opisane z triggerami.
- [ ] Monitoring/rewizje ryzyk mają ustalony rytm.
- [ ] Raporty i akceptacje ryzyk dokumentowane.
