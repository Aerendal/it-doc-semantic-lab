---
title: LOD (Level of Detail) Strategy
...
Zdefiniować strategię LOD/streamingu dla modeli/tekstur/animacji, aby balansować jakość i wydajność.


## Zakres i granice

- Obejmuje: zasady LOD dla modeli/tekstur/materialów/animacji, progi dystansu/kąta, culling, impostory/billboardy, streaming zasobów, metryki akceptacji.
- Poza zakresem: szczegółowy design assetów (oddzielny dokument art).
...
- Kontekst i cele
- Kategorie assetów i zasady LOD
- Progi i metryki (distance/angle/screen size)
- Streaming i preload
...
- Budżety VRAM/IO i limity streaming
- Dane z perf/telemetrii (popping, hitching)
- Lista scen referencyjnych i krytycznych obiektów


## Wyjścia

- Zasady LOD i progi; tabela per asset category
- Polityki streaming/preload i fallback
- Checklisty DoR/DoD dla assetów i kodu
- Powiązania z pipeline renderingu i ustawieniami jakości
...
- [ ] Cele jakości/FPS i platformy ustalone
- [ ] Budżety VRAM/IO zebrane
- [ ] Lista krytycznych assetów/scen gotowa
- [ ] Narzędzia pomiaru (telemetria/pipeline) działają


## Kryteria DoD

- [ ] Tabela zasad LOD wypełniona
- [ ] Progi/streaming opisane i uzasadnione
- [ ] Testy/metryki zdefiniowane
- [ ] Quick-links/checklisty uzupełnione


## Artefakty do załączenia

- Tabela LOD per kategoria
- Diagram przepływu streaming/preload
- Baseline zrzuty LOD/popping
- Logi/telemetria LOD
...
- FPS/frametime p95
- VRAM peak i IO throughput
- Częstość popping/hitch
