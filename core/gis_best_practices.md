...
GIS Best Practices — szablon dokumentu IT.
...
> Dokument satelitarny do: "EA Best Practices" - rozszerza lub uszczegolawia jego tresc.
...
- Zależność: {'depends_on': 'GIS Operations Runbook', 'type': 'sequential'}
- Zależność: {'depends_on': 'GIS Operations Runbook', 'type': 'sequential'}
