---
title: Reagowanie na awarie synchronizacji
...
aligned_by: codex
---
# Reagowanie na awarie synchronizacji
...
Przywrócić synchronizację danych/systemów.
...
1. Detekcja: lag, błędy replikacji, rozjazdy danych.
2. Triage: kierunek sync, zakres tabel/encje.
3. Stabilizacja: pauza/tryb read-only, ograniczenie zmian.
4. Naprawa: kolejki, retry, naprawa rekordów, rerun.
5. Walidacja: kontrola spójności, checksumy, reconciliation.
6. Postmortem: przyczyna, poprawki, alerty.
...
- [ ] Lag/rozjazd zmierzony; ryzyko ocenione.
- [ ] Sync ustabilizowany lub wstrzymany kontrolowanie.
- [ ] Naprawa i walidacja spójności wykonane.
- [ ] Postmortem i alerty zaktualizowane.
