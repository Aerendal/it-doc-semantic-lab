---
title: Przewodnik konfiguracji POS
...
Standard konfiguracji systemu POS.
...
1. Hardware i sieć: terminale, drukarki, skanery, sieć przewodowa/wi-fi.
2. Oprogramowanie: wersje, pluginy, aktualizacje, backup konfiguracji.
3. Katalog produktów: PLU/SKU, podatki, rabaty, promocje.
4. Płatności: integracja z terminalami, metody, limity, testy.
5. Użytkownicy i uprawnienia: kasjer, manager, serwis; logi.
6. Testy i go-live: paragony testowe, raport dobowy, failover offline.
...
- [ ] Sprzęt i sieć działają; wersje oprogramowania aktualne.
- [ ] Katalog produktów i podatki poprawne; promocje zweryfikowane.
- [ ] Płatności przetestowane; logi i uprawnienia poprawnie ustawione.
- [ ] Tryb offline/failover przetestowany przed go-live.
