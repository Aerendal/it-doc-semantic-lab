---
title: Plany projektu (referencyjne)
...
Udostępnić zestaw referencyjnych planów projektowych (szablon), które można adaptować do nowych inicjatyw.
...
1. Zakres szablonów: typy projektów (IT, infra, produkt), poziom szczegółu.
2. Zawartość: zakres/KPI, harmonogram, RACI, budżet, ryzyka, komunikacja, QA/DoR/DoD.
3. Jak używać: adaptacja do projektu, pola do uzupełnienia, przykłady.
4. Wersjonowanie i właściciel: repo, numeracja wersji, kto utrzymuje.
5. Zgodność i standardy: linki do polityk org, standardów PM, checklisty.
6. Feedback i ulepszenia: proces zgłaszania zmian, release notes.
...
- [ ] Szablony obejmują kluczowe sekcje (zakres/harmonogram/RACI/ryzyka/komunikację/QA).
- [ ] Instrukcja adaptacji i pola do uzupełnienia jasno opisane.
- [ ] Wersjonowanie i właściciel szablonów wskazane.
- [ ] Mechanizm feedbacku/ulepszeń działa.
