...
Kanon kodów błędów i znaczeń dla API/aplikacji.
...
1. Zakres: warstwa (API/UI/SDK), format (HTTP/grpc).
2. Konwencja: przestrzenie kodów, pola, trace id.
3. Mapowanie: komunikaty user/dev, kategorie (auth/validation/system).
4. Lokalizacja i tłumaczenia: języki, fallback.
5. Utrzymanie: właściciel, wersjonowanie, deprecjacje.
6. Przykłady: typowe kody i scenariusze.
...
- [ ] Kody i znaczenia zmapowane i spójne.
- [ ] Komunikaty user/dev przygotowane.
- [ ] Wersjonowanie i właściciel ustaleni.
- [ ] Przykłady zweryfikowane z implementacją.
