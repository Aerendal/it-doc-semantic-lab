...
## Cel dokumentu
Zapewnić zgodność z regulacjami bezpieczeństwa lotniczego (TSA/ICAO Annex 17/EU Reg 300 i pokrewne) dla obszarów airside/landside: kontrola dostępu, screening osób/bagażu/ładunku, łańcuch dostaw, monitoring, inspekcje i szkolenia. Minimalizować ryzyko incydentów, kar i utraty certyfikacji.

## Zakres i granice
- Obejmuje: polityki i procedury dla airside/landside, ID/badge management, kontrolę dostępu fizycznego i logicznego, screening pax/baggage/cargo, secure supply chain (Known Consignor/Regulated Agent), monitoring/SOC/CCTV, reagowanie na incydenty, raportowanie, audyty/inspekcje, szkolenia.
- Poza zakresem: szczegółowe SOP checkpointów i profili ryzyka specyficznych linii/lotniska (linki), projekt infrastruktury fizycznej (oddzielne dokumenty).

## Wejścia i wyjścia
- Wejścia: regulacje TSA/ICAO/EU 300, lokalne przepisy, layout stref (airside/landside), systemy kontroli dostępu/CCTV/PSIM, procedury screening, listy autoryzacji, rejestry szkoleń, plany reagowania, wyniki audytów/inspekcji.
- Wyjścia: plan zgodności (polityki/procedury), rejestr kontroli i dowodów, harmonogram audytów/inspekcji, plan szkoleń, raport luk i remediacji, matryca odpowiedzialności.
...
- Zakres regulacyjny i strefy: airside/landside, terminale, cargo, MRO.
- Kontrola dostępu: ID/badge, role, wydawanie/odbiór, logi, anti-passback, visitor management.
- Screening: pax/baggage/cargo/mail; technologie; SOP; wskaźniki (detection rate, alarm rate); testy penetracyjne.
- Łańcuch dostaw cargo: Known Consignor/Regulated Agent, zabezpieczenie ładunku, dokumentacja.
- Monitoring i SOC: CCTV, intrusion detection, PSIM, alarmy, integracja z SOC/incident response.
- Incydenty i raportowanie: procedury, SLA eskalacji, komunikacja z władzami.
- Szkolenia i certyfikacje: zakres, częstotliwość, rejestry, egzaminy.
- Audyty/inspekcje: plan, checklists, wyniki, CAPA, przeglądy okresowe.
- Dokumentacja i dowody: rejestry, logi, raporty, kontrola wersji.

## Wymagane rozwinięcia
- Regulacje: TSA, ICAO Annex 17, EU Reg 300/2014 i akty wykonawcze.
- Kontrola dostępu → Physical Security Policy, Badge Management SOP.
- Screening → lokalne SOP, testy penetracyjne, maintenance urządzeń.
- SOC/monitoring → CCTV/PSIM runbooks, Incident Response Plan.
- Audyty → Internal Audit Plan, zewnętrzne inspekcje.

## Wymagane streszczenia
- Streszczenie luk zgodności i CAPA.
- Streszczenie harmonogramu audytów/inspekcji i szkoleń.
...
- DoR:
  - [ ] Zakres stref i systemów zdefiniowany; regulacje zmapowane.
  - [ ] Role/odpowiedzialności i dostęp do logów/dowodów zapewnione.
- DoD:
  - [ ] Kontrole dostępu, screening, supply chain, monitoring, incydenty, audyty i szkolenia opisane z dowodami.
  - [ ] Luki i CAPA z terminami; harmonogram audytów/szkoleń wpisany.
  - [ ] Dokument wersjonowany; sekcje N/A uzasadnione; linki do SOP i logów działają.
