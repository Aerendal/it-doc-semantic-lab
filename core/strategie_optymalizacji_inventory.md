---
title: Strategie optymalizacji inventory
...
aligned_by: codex
---
# Strategie optymalizacji inventory
...
1. Cele: poziom zapasu, koszty, SLA.
2. Metody: EOQ, safety stock, reorder point, demand forecasting.
3. Segmentacja SKU i klasyfikacja ABC.
4. Procesy: replenishment, transfery, returns.
5. Technologia: WMS, automatyzacja, alerty.
6. KPI i przeglądy.
...
- [ ] Cele i KPI zdefiniowane.
- [ ] Metody i segmentacja dobrane.
- [ ] Procesy/technologia opisane.
- [ ] Przeglądy cykliczne ustalone.
