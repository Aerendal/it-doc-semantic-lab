...
Przygotować plan wykonania testów jednostkowych (zakres, odpowiedzialności, harmonogram).


## Zakres i granice

- Obejmuje: zakres modułów, pokrycie krytycznych ścieżek, kryteria wejścia/wyjścia, harmonogram i zasoby.
- Poza zakresem: testy integracyjne/systemowe.
