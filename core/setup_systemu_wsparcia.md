...
Uruchomienie platformy wsparcia (support).
...
1. Typy zgłoszeń i workflow.
2. Uprawnienia ról i dostęp.
3. Baza wiedzy i szablony odpowiedzi.
4. Integracje: CRM, status page, phone/chat.
5. SLA i komunikacja.
6. Monitoring jakości i raporty.
...
- [ ] Workflow i role skonfigurowane.
- [ ] KB i szablony gotowe.
- [ ] Integracje działają.
- [ ] SLA/raporty monitorowane.
