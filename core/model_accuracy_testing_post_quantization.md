---
title: Model Accuracy Testing (Post-Quantization)
...
# Model Accuracy Testing (Post-Quantization)
...
## Cel dokumentu
Model Accuracy Testing (Post-Quantization) opisuje docelową architekturę/projekt wraz z trade-offami i kryteriami akceptacji.
