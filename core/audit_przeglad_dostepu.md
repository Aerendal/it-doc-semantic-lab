...
Opisać proces cyklicznego przeglądu dostępu do systemów/danych (access review), by zapewnić zasadę least privilege i zgodność (ISO/SOC/RODO).


## Zakres i granice

- Obejmuje: zakres systemów i ról, częstotliwość przeglądów, właścicieli zatwierdzających, dowody i audyt, obsługę wyjątków, revoke/adjust dostępy.
- Nie obejmuje: definicji ról (osobny dokument) ani konfiguracji narzędzi IAM.
...
- Wejścia: lista użytkowników/ról/uprawnień, właściciele systemów, wymagania compliance, logi użycia (opcjonalnie do weryfikacji).
- Wyjścia: raport z przeglądu (kto zatwierdził/odrzucił), lista zmian (revoke/adjust), dowody dla audytu.
...
- Access Policy / Role Definitions.
- IAM/IdP narzędzia.
- Audit compliance (dowody).
...
1. Zakres systemów/danych i częstotliwość (kvartal/roczny).
2. Role i właściciele zatwierdzający.
3. Przebieg przeglądu (zbieranie list, review, decyzje, wyjątki).
4. Wykonanie zmian (revoke/adjust) i SLA.
5. Dowody i audyt (logi, protokoły, export).
...
- [ ] Zakres i częstotliwość przeglądu zdefiniowane.
- [ ] Właściciele przypisani do systemów/ról.
- [ ] Decyzje (approve/revoke) udokumentowane.
- [ ] Zmiany w dostępach wykonane w SLA.
- [ ] Dowody audytowe zapisane.


## Definicje robocze

- **Access review** — okresowe potwierdzenie zasadności uprawnień.
...
- „Zakres i właściciele” **defines_structure** „Przebieg przeglądu”.
- „Zmiany” **feeds** „Dowody i audyt”.
