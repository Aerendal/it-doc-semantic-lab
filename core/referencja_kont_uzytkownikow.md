---
title: Referencja kont użytkowników
...
Standardy tworzenia i utrzymania kont użytkowników.
...
1. Identyfikatory: format loginu, aliasy, unikalność.
2. Atrybuty: profile, minimalny zestaw, źródła prawdy.
3. Lifecycle: joiner/mover/leaver, konwencje grup/rol.
4. Bezpieczeństwo: MFA, recovery, lockout.
5. Prywatność: zgody, retencja, anonimizacja.
6. Audyt: logi zmian kont, recertyfikacje.
...
- [ ] Formaty loginów i atrybuty zdefiniowane.
- [ ] Proces JML opisany i zautomatyzowany.
- [ ] MFA/recovery/lockout skonfigurowane.
- [ ] Logi i recertyfikacje działają.
