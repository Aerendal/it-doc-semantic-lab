---
title: Plan zaangażowania obywateli
...
Zwiększyć udział obywateli w usługach/consultacjach/publicznym feedbacku, zapewniając transparentność i użyteczność.
...
1. Cele i grupy: jakie rezultaty (udział, feedback, współdecydowanie), segmenty obywateli.
2. Kanały i narzędzia: portal/ankiety/app, spotkania, social, konsultacje, dostępność (WCAG/języki).
3. Kampanie i harmonogram: tematy, daty, komunikacja, zachęty.
4. Dane i prywatność: minimalizacja danych, zgody, anonimizacja, publikacja wyników.
5. Metryki: udział, odpowiedzi, jakość feedbacku, satysfakcja, reprezentatywność.
6. Raportowanie i działania: publikacja wyników, decyzje, pętla informacji zwrotnej.
...
- [ ] Cele/segmenty i kanały zdefiniowane; dostępność zapewniona.
- [ ] Kampanie i harmonogram komunikacji przygotowane.
- [ ] Prywatność/zgody i publikacja wyników uwzględnione.
- [ ] Metryki udziału/feedbacku mierzone; decyzje i informacja zwrotna komunikowane.
