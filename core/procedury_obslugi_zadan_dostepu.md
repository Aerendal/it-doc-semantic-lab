---
title: Procedury obsługi żądań dostępu
...
aligned_by: codex
---
# Procedury obsługi żądań dostępu
...
Ustalić spójny proces obsługi wniosków o dostęp (IAM), zapewniając zgodność z zasadą least privilege i audytowalność.
...
1. Kanał i format wniosku: formularz, wymagane dane (rola/system/cel/czas), zgody.
2. Kryteria i zatwierdzenia: SoD, właściciel systemu, security/compliance, czasowe vs stałe.
3. Realizacja: provisioning (SCIM/hand), SLA, logowanie zmian, powiadomienia.
4. Weryfikacja: test dostępu, recertyfikacja okresowa, expiry dla dostępów czasowych.
5. Audyt i logi: kto/co/kiedy, narzędzia, raporty, integracja z SIEM.
6. Wycofanie: offboarding, cofanie po projekcie, czyszczenie tokenów/kluczy.
...
- [ ] Formularz/wniosek zawiera dane i trafia do właściwych zatwierdzających.
- [ ] SoD i approval’e spełnione; provisioning zarejestrowany.
- [ ] Test dostępu i recertyfikacja okresowa zaplanowane.
- [ ] Logi/audyt dostępów prowadzone; cofanie przy zakończeniu/czasowym dostępie działa.
