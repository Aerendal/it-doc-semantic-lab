...
## Cel dokumentu
Application Architecture Design opisuje docelową architekturę/projekt wraz z trade-offami i kryteriami akceptacji.
...
## Szybkie powiązania
- Zależność: {'depends_on': 'Business Capability Analysis', 'type': 'INFORMED_BY'}
- Zależność: {'depends_on': 'Current State Assessment', 'type': 'INFORMED_BY'}
- Zależność: {'depends_on': 'Business Capability Analysis', 'type': 'INFORMED_BY'}
