...
Zdefiniować, kiedy i jak eskalować problemy/incydenty, aby szybko przywracać usługi i angażować właściwe osoby.
...
1. Poziomy i kryteria: severity, wpływ, SLA; kiedy eskalować (czas/objawy).
2. Ścieżki eskalacji: L1→L2→L3, produkt, bezpieczeństwo, dostawcy; kontakty i kanały.
3. Proces: trigger, powiadomienia, właściciel incydentu, war room, decyzje.
4. Dokumentacja: logi eskalacji, timeline, decyzje, komunikaty do interesariuszy.
5. Testy i ćwiczenia: tabletop/DR drills, review skuteczności, aktualizacja list kontaktów.
6. Governance: kto utrzymuje procedurę, przeglądy, audyt SLA.
...
- [ ] Kryteria/severity i ścieżki eskalacji jasno opisane z kontaktami.
- [ ] Proces powiadomień i rola właściciela incydentu zdefiniowane.
- [ ] Logowanie eskalacji i komunikacja do interesariuszy wykonywane.
- [ ] Ćwiczenia/testy i aktualizacja kontaktów odbywają się cyklicznie.
