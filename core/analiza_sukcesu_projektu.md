---
title: Analiza sukcesu projektu
...
Zdefiniować i zmierzyć, czy projekt osiągnął zakładane cele (biznesowe, techniczne, jakościowe), oraz wskazać wnioski na przyszłość.


## Zakres i granice

- Obejmuje: KPI/OKR projektu, kryteria akceptacji, wyniki vs plan (czas/koszt/zakres), satysfakcję interesariuszy, lessons learned.
- Nie obejmuje: szczegółowych retrospektyw sprintowych (osobny artefakt) ani pełnych raportów finansowych (są w analizach kosztów).
...
- Wejścia: plan projektu, KPI/OKR, raporty statusu, metryki jakości, feedback klienta/użytkowników.
- Wyjścia: ocena realizacji celów, odchylenia i przyczyny, rekomendacje usprawnień, lista działań follow-up.
...
1. Cele i kryteria sukcesu (KPI/OKR, akceptacja).
2. Wyniki vs plan (czas, koszt, zakres, jakość).
3. Feedback interesariuszy/klientów.
4. Lessons learned (co działało, co nie).
5. Rekomendacje i działania dalsze.
...
- [ ] KPI/OKR zdefiniowane i zmierzone.
- [ ] Odchylenia opisane z przyczyną.
- [ ] Feedback z kluczowych stakeholderów zebrany.
- [ ] Lessons learned i konkretne działania follow-up.


## Definicje robocze

- **KPI/OKR** — mierzalne cele projektu.
- **Lessons learned** — wnioski na przyszłość, nie tylko błędy.
...
- „KPI/OKR i kryteria” **defines_structure** „Ocena wyników”.
- „Lessons learned” **feeds** „Rekomendacje i działania”.
