---
title: Dashboard wydajności projektu
...
Monitorować tempo i zdrowie projektu: postęp, terminy, jakość, ryzyka.
...
1. Postęp: burnup/burndown, velocity, lead/cycle time.
2. Terminy: plan vs actual milestone, ETA.
3. Jakość: bug rate, escaped defects, test coverage, flaki.
4. Ryzyka i blokery: liczba/severity, czas rozwiązania.
5. Zasoby: capacity wykorzystanie, dostępność zespołu.
6. Satysfakcja: NPS/CSAT interesariuszy (opcjonalnie).
...
- [ ] Burnup/burndown i velocity aktualne.
- [ ] Milestony plan vs actual widoczne.
- [ ] Defekty/testy/flaki monitorowane.
- [ ] Ryzyka/blokery z ownerami.
