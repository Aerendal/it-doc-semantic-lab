...
Zebrać ogólne zasady tuningu wydajności systemów.
...
1. Cel tuningu i KPI: latency, throughput, koszty.
2. Profilowanie: narzędzia, trace, hot paths.
3. Obszary: CPU/IO/pamięć, baza danych, cache, sieć.
4. Eksperymenty: jeden parametr na raz, A/B, rollback.
5. Obserwowalność: metryki po zmianie, alarmy.
6. Dokumentacja i utrzymanie: zapis zmian, regresje, harmonogram przeglądów.
...
- [ ] KPIs zdefiniowane; baseline zebrany.
- [ ] Profilowanie wykonane i priorytety hot paths ustalone.
- [ ] Eksperymenty mają metryki i plan rollback.
- [ ] Zmiany i wyniki udokumentowane; monitoring zaktualizowany.
