...
Plan implementacji systemów safety.
...
1. Architektura safety: redundancja, fail-safe.
2. Hardware/Software: cert komponenty, watchdog.
3. Diagnostyka: pokrycie, testy online.
4. Procedury: update, konfiguracja, serwis.
5. Walidacja: testy safety, zgodność.
6. Dokumentacja i audyt.
...
- [ ] Architektura fail-safe opisana.
- [ ] Diagnostyka i pokrycie testów określone.
- [ ] Procedury update/serwis opisane.
- [ ] Walidacja i audyt zaplanowane.
