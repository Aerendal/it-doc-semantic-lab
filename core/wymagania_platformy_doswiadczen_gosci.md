---
title: Wymagania platformy doświadczeń gości
...
aligned_by: codex
---
# Wymagania platformy doświadczeń gości
...
Wymagania platformy gościnności.
...
1. Journey gościa i touchpointy.
2. Funkcje: personalizacja, mobile key, chat.
3. Integracje: PMS, POS, CRM.
...
- [ ] Journey/funkcje opisane.
- [ ] Integracje/bezpieczeństwo uwzględnione.
- [ ] Metryki/SLA zdefiniowane.
- [ ] Support zaplanowany.
