...
UAT Execution Plan określa harmonogram, zakres i odpowiedzialności, aby dowieźć rezultat w kontrolowany sposób.
...
- Zależność: {'depends_on': 'Security Testing Report', 'type': 'INFORMED_BY'}
- Zależność: {'depends_on': 'Compliance Testing Report', 'type': 'INFORMED_BY'}
