---
title: Checklist Submisji Google Play
...
aligned_by: codex
---
# Checklist Submisji Google Play
...
Lista kontrolna przed publikacją w Google Play, żeby przejść weryfikację i uniknąć odrzuceń.
...
1. Metadane (package name, versionCode/versionName, release track).
2. Zgodność z zasadami Google Play (policy, content rating).
3. Prywatność i dane (Data Safety form, uprawnienia, ograniczenie background).
4. Testy/stabilność/rozmiar (Android Vitals, ANR/Crash, bundle size).
5. UX i assets (screenshots, feature graphic, short/long description, lokalizacje).
6. Płatności/billing (Play Billing) i reklamy (ad ID, disclosure).
7. Release info (open/closed testing, staged rollout), kontakt.
...
- [ ] Metadane i versionCode ustawione.
- [ ] Data Safety/permissions poprawnie wypełnione.
- [ ] ANR/Crash w normie, rozmiar bundla akceptowalny.
- [ ] Assets/teksty lokalizowane.
- [ ] Release track/rollout skonfigurowany.
