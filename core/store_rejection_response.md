---
title: Store Rejection Response
...
Procedura reakcji na odrzucenie aplikacji w sklepach (Apple/Google).
...
1. Analiza odrzucenia: powód, guideline, logi.
2. Ocena wpływu i priorytet.
3. Plan poprawek: kod, metadane, treści, uprawnienia.
4. Komunikacja: zespół, PM, prawnicy.
5. Retest i resubmission.
6. Wnioski do checklists QA/Release.
...
- [ ] Powód odrzucenia zrozumiany i udokumentowany.
- [ ] Plan poprawek z ownerami i terminem.
- [ ] Resubmission po retestach.
- [ ] Checklista QA/Release zaktualizowana.
