...
Udokumentować wyniki pentestu: podatności, dowody, impact, rekomendacje, status napraw.


## Zakres i granice

- Obejmuje: opis scenariuszy, lista podatności z CVSS/ryzykiem, dowody, rekomendacje, status napraw/retest.
- Poza zakresem: szczegółowy exploit code (załączniki opcjonalne).
...
- Streszczenie i scope
- Metody i scenariusze
- Podatności (CVSS/ryzyko)
- Dowody
- Rekomendacje i SLA
- Status/retest
- Ryzyka
...
- Plan pentest
- Dowody/exploit próby
- Polityki scoringu (CVSS)
- SLA napraw
...
- Raport pentest
- Lista podatności i status
- Plan napraw/retest
- Powiązania do IR/monitoringu
...
- Streszczenie wyników/ryzyk; rozwinięcia rekomendacji i planów retestu.
...
- [ ] Scope i środowiska uzgodnione
- [ ] Dostęp/zgody na testy uzyskane
- [ ] Modele zagrożeń i priorytety znane
- [ ] Kanały IR/komunikacji gotowe


## Kryteria DoD

- [ ] Raport i podatności spisane
- [ ] Rekomendacje z ownerami/SLA dodane
...
- Weryfikacja dowodów; sanity retestu; zgodność z zakresem i zgodami.
...
- Pokrycie scope
- Regresje po pentestach


## Utrzymanie i aktualizacje

- Przegląd po każdym pentest/reteście; aktualizacja quick-links/checklist.
