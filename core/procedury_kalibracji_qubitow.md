---
title: Procedury kalibracji qubitów
...
Opisać kalibrację qubitów w systemie kwantowym, aby utrzymać wysoką fidelity bram i pomiarów.
...
1. Zakres: QPU/backends, typy kalibracji (T1/T2, π pulse, readout, cross-resonance, RB/IRB).
2. Harmonogram: częstotliwość kalibracji, warunki wyzwalające (drift, temperatura, error rates).
3. Procedura: kroki kalibracji, kolejność, narzędzia/SDK, walidacje po (fidelity/err rates).
4. Bezpieczeństwo i dostęp: kto może uruchamiać, blokady równoległych jobów, rezerwacje.
5. Monitoring: zapis wyników, trend, alerty na drift, wersjonowanie parametrów.
6. Dokumentacja: raport kalibracji, historia, wpływ na scheduling obwodów.
...
- [ ] Harmonogram i warunki wyzwalania kalibracji zdefiniowane.
- [ ] Procedura i walidacje fidelity po kalibracji opisane.
- [ ] Dostępy/rezerwacje i blokady równoległe ustawione.
- [ ] Wyniki kalibracji wersjonowane; alerty na drift włączone.
