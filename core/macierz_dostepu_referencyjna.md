---
title: Macierz dostępu (referencyjna)
...
Przygotować referencyjną macierz dostępu: kto (role) ma dostęp do jakich zasobów i operacji, z zachowaniem separacji obowiązków.
...
1. Role i aktorzy: lista ról, opis odpowiedzialności, typ użytkownika.
2. Zasoby i operacje: systemy, moduły, dane; CRUD/administracja.
3. Macierz: role × zasoby × operacje; znaczniki (allow/deny/approval).
4. Zasady specjalne: SoD, JIT/JEA, wyjątki, środowiska (prod/non-prod).
5. Proces utrzymania: przeglądy, recertyfikacja, zmiany ról, audyt.
6. Publikacja: format (CSV/DB), miejsce przechowywania, wersjonowanie.
...
- [ ] Role i zasoby zdefiniowane i zmapowane w macierzy.
- [ ] SoD/JIT oraz wyjątki opisane.
- [ ] Proces przeglądów/recertyfikacji i audytu ustalony.
- [ ] Macierz wersjonowana i dostępna w repo/DB.
