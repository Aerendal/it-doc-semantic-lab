---
title: Reagowanie na awarie urządzeń
...
Obsłużyć awarie urządzeń końcowych.
...
1. Detekcja: monitoring, zgłoszenia użytkowników.
2. Triage: typ urządzenia, krytyczność, liczba.
3. Stabilizacja: restart, przełączenie na zapas, izolacja.
4. Serwis: diagnoza, części, RMA, firmware.
5. Przywrócenie: testy, konfiguracja, aktualizacje.
6. Postmortem: przyczyna, trendy awarii, poprawki.
...
- [ ] Urządzenia dotknięte zidentyfikowane.
- [ ] Fallback/zapas użyty jeśli potrzeba.
- [ ] Naprawa/replace wykonane; test OK.
- [ ] Trendy awarii i prewencja odnotowane.
