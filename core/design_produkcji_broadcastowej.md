---
title: Design produkcji broadcastowej
...
aligned_by: codex
---
# Design produkcji broadcastowej
...
Zaprojektować architekturę i procesy produkcji broadcastowej (live/linear/VOD): ingest, reżyserka, encodery, CDN, failover.
...
1. Ingest sygnału: kamery/SDI/IP, redundancy (N+1), sync (genlock/timecode).
2. Reżyserka/mix: switcher, grafika, audio mix, interkom.
3. Encoding/transcode: primary/backup, profiles/bitrates, DRM, captions.
4. Dystrybucja: origin/CDN, ABR packaging, ad insertion (SCTE), blackout rules.
5. Monitoring i QoE: probes, telemetry (start time, rebuffer), alerty.
6. DR/failover: path primary/secondary, site failover, runbook.
7. Compliance: loudness, captions/subtitles, prawa/geo.
...
- [ ] Redundant ingest/encodery/origin.
- [ ] Profiles/ABR/captions/DRM ustawione.
- [ ] Monitoring QoE i alerty aktywne.
- [ ] Failover/runbook przetestowane.
