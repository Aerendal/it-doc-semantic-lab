...
Checklista środowiska Android dev/CI.
...
1. SDK/NDK/JDK wersje.
2. Gradle i wrapper.
3. Emulatory/urządzenia testowe.
4. Lint/testy: unit, instrumentation.
5. Signing/keystore secrets.
6. CI cache/artifacts.
...
- [ ] SDK/NDK/JDK zainstalowane.
- [ ] Build i testy przechodzą.
- [ ] Keystore/secrets bezpieczne.
- [ ] CI artefakty/caching ustawione.
