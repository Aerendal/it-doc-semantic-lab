---
title: Testowanie kontraktów API
...
1. Specyfikacja i źródło prawdy.
2. Testy kontraktowe producent/konsument.
3. Mocki i wersjonowanie.
4. CI/CD integracja.
5. Raport i breaking change alerty.
6. Kryteria release.
...
- [ ] Spec/źródło prawdy wskazane.
- [ ] Testy prod/cons dodane.
- [ ] Mocki/wersjonowanie opisane.
- [ ] Alerty breaking i release kryteria ustalone.
