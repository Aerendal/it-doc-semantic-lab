...
Opisać wybór i użycie frameworku automatyzacji testów (architektura, konwencje, pipeline CI).


## Zakres i granice

- Obejmuje: architekturę frameworku, konwencje testów, zarządzanie danymi, raportowanie, integrację CI/CD, utrzymanie.
- Poza zakresem: implementacja pojedynczych testów.
