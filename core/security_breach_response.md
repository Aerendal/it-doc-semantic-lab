...
Zdefiniować procedurę reakcji na naruszenia bezpieczeństwa (breach) zgodnie z regulacjami i SLA.


## Zakres i granice

- Obejmuje: detekcję, klasyfikację, containment, komunikację wewn./zewn., notyfikacje regulacyjne/klienckie, forensics, post-breach actions.
- Poza zakresem: naprawy kodu usług.
...
- Notyfikacje (regulator/klient)
- Komunikacja wewn./zewn.
- Recovery i monitorowanie
- Postmortem
...
- Alert/log incydentu
- Polityki/regulacje dot. notyfikacji (GDPR/PCI/PII)
- Kanały komunikacji
- Lista kontaktów regulator/klient


## Wyjścia

- Runbook breach
- Plan komunikacji/notyfikacji
- Forensics plan
- Trigger postmortem
...
- Streszczenie kluczowych decyzji/ryzyk; rozwinięcia komunikacji/notyfikacji.


## Wymagane powiązania

- Runbooki incydentów/awarii, polityki/privacy/compliance, monitoring/alerty.


## Kryteria DoR

- [ ] Ownerzy/role potwierdzeni
- [ ] Kanały komunikacji/status page dostępne
- [ ] Polityki/regulacje znane
- [ ] Mapa interesariuszy/kontaktów zebrana


## Kryteria DoD

- [ ] Sekcje wypełnione lub N/A z uzasadnieniem
- [ ] Szablony/komunikaty przygotowane
...
- Plan/harmonogram
- Lista kontaktów
- Raport/forensics link


## Walidacja / testy

- Przegląd/symulacja komunikacji lub ćwiczenie breach; sanity status page.


## Metryki monitorowane

- Czas pierwszego komunikatu
- Liczba update w SLA
- Zgłoszenia wsparcia w trakcie incydentu
- MTTR/impact trend


## Utrzymanie i aktualizacje

- Przegląd co release lub po incydencie/breachu; aktualizacja quick-links/checklist.
