...
Wdrożyć model „Buy Online, Pick-up In Store” z jasnym przepływem zamówień, stanów i obsługi klienta.
...
1. Journey klienta: zamówienie online, potwierdzenie, odbiór w sklepie, zwroty.
2. Proces operacyjny w sklepie: rezerwacja stoku, kompletacja, odkładnia, wydanie.
3. Integracje: e-commerce, OMS, WMS, POS, płatności, powiadomienia.
4. SLA i KPI: czas kompletacji, czas do odbioru, błędne wydania.
5. Bezpieczeństwo i fraud: weryfikacja tożsamości, limity, zgody.
6. Szkolenia personelu i komunikacja do klientów.
...
- [ ] Zmapowany pełny flow klienta i proces sklepu.
- [ ] Integracje (OMS/WMS/POS/płatności) przetestowane end-to-end.
- [ ] SLA/KPI zdefiniowane i monitorowane.
- [ ] Procedury bezpieczeństwa i szkolenia personelu wdrożone.
