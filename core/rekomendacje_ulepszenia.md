...
Szablon rekomendacji ulepszeń (produkt/proces/tech).
...
2. Propozycja ulepszenia i oczekiwany efekt.
3. Koszt/korzyść i ryzyka.
4. Plan wdrożenia i mierniki sukcesu.
5. Zależności i zasoby.
6. Decyzja i priorytet.
...
- [ ] Problem i efekt opisane.
- [ ] ROI/ryzyka ocenione.
- [ ] Plan wdrożenia i metryki zdefiniowane.
- [ ] Decyzja/priorytet udokumentowane.
