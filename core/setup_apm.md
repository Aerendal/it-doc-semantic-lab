...
1. Zakres: serwisy, języki, agent.
2. Instalacja agenta i sampling.
3. Metryki: latencja, błędy, throughput.
4. Trace i log correlation.
5. Alerty i dashboardy.
6. Walidacja i tune.
...
- [ ] Agent zainstalowany w krytycznych serwisach.
- [ ] Sampling/trace/log correlation działa.
- [ ] Alerty/dashboardy skonfigurowane.
- [ ] Tuning potwierdzony testami.
