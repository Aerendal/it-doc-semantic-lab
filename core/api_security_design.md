...
Zaplanować projekt bezpieczeństwa API (authn/authz, dane wrażliwe, rate limiting, logging) spójny z architekturą i regulacjami.


## Zakres i granice

- Obejmuje: modele authn/authz (OIDC/OAuth/mTLS/API keys), zarządzanie tajemnicami, walidację danych, rate limiting/abuse, nagłówki bezpieczeństwa, logowanie/audyt, privacy/PII.
...
- design-bezpieczenstwa-api
- design-api-mi-dzyagencyjnego
- design-api-gateway
...
- Polityki rate limiting i logowania
- Mapa danych wrażliwych


## Wyjścia

- Spec bezpieczeństwa API
- Polityki authz/rate limiting/logging
- Powiązania do testów i runbooków
- Checklisty DoR/DoD
...
- [ ] Wymagania bezpieczeństwa/regulacyjne znane
- [ ] Modele uprawnień i dane wrażliwe zmapowane
- [ ] Polityki rate limiting/logging zebrane
- [ ] Ownerzy bezpieczeństwa ustaleni


## Kryteria DoD

- [ ] Spec bezpieczeństwa wypełniony
- [ ] Polityki/sekcje uzupełnione
...
- Pokrycie usług specem security
- Incydenty security/kwartał
- Czas wdrożenia polityk
