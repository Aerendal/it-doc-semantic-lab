...
Zdefiniować standardowe procedury operacyjne systemu MES, aby zapewnić ciągłość produkcji i jakość danych.
...
1. Zakres: linie/stanowiska, role użytkowników, krytyczne funkcje (zlecenia, raportowanie, jakości).
2. Codzienne operacje: uruchamianie/kończenie zleceń, zmiany receptur, ewidencja przestojów, raportowanie scrap.
3. Monitoring i alerty: status interfejsów (SCADA/ERP/WMS), kolejki, lag danych, błędy terminali.
4. Incydenty: procedury przy awarii MES/terminala, tryb offline/paper, eskalacje.
5. Utrzymanie danych: walidacje, zamykanie zmian, korekty, reprocess.
6. Raportowanie: OEE/produktywność, wyjątki, audyt operacji.
...
- [ ] Role i krytyczne funkcje MES opisane; operacje codzienne udokumentowane.
- [ ] Monitoring interfejsów/terminali i alerty skonfigurowane.
- [ ] Tryb awaryjny/offline oraz eskalacje zdefiniowane.
- [ ] Walidacje/korekty danych i raporty operacyjne prowadzone.
