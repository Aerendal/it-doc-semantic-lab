---
title: Testowanie jakości danych
...
1. Wymiary: kompletność, spójność, unikalność, aktualność.
2. Reguły i progi.
3. Sample i automatyzacja.
4. Alerty i raporty.
5. Gaps i poprawki.
6. Cykliczność.
...
- [ ] Reguły/progi zdefiniowane.
- [ ] Automatyzacja i alerty działają.
- [ ] Raporty i poprawki zaplanowane.
- [ ] Cykle testów ustalone.
