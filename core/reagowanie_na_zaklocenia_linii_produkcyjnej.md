---
title: Reagowanie na zakłócenia linii produkcyjnej
...
aligned_by: codex
---
# Reagowanie na zakłócenia linii produkcyjnej
...
Minimalizować przestoje przy zakłóceniach linii produkcyjnej.
...
1. Detekcja: andon, czujniki, operator.
2. Triage: stacja, typ zakłócenia, bezpieczeństwo.
3. Stabilizacja: zatrzymanie/zwolnienie, obejście, bufor.
4. Naprawa: przyczyna mechaniczna/elektryczna/IT.
5. Restart: testy jakości, ramp-up, scrap kontrola.
6. Postmortem: OEE wpływ, działania prewencyjne.
...
- [ ] Bezpieczeństwo zapewnione; linia zabezpieczona.
- [ ] Stabilizacja/obejście zastosowane.
- [ ] Przyczyna usunięta; testy jakości OK.
- [ ] Postmortem i działania prewencyjne zapisane.
