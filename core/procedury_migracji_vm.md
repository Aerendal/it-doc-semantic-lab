...
Opisać standardowe kroki migracji maszyn wirtualnych, zapewniając spójność danych i minimalny downtime.
...
1. Przygotowanie: inwentarz, zgodność wersji, backup/snapshot, okna zmian, test pilota.
2. Metoda migracji: vMotion/HCX/export-import, sieć/storage, adresacja, kompatybilność sterowników.
3. Wykonanie: sekwencja, batch/fale, monitoring, komunikacja statusów.
4. Walidacja po: ping/app checks, logi, performance sanity, monitoring alertów.
5. Rollback: warunki, kroki, cleanup, komunikacja.
6. Dokumentacja: log działań, raport wyników, lessons learned.
...
- [ ] Backup/snapshot i test pilota wykonane; okno zmian ustalone.
- [ ] Metoda migracji dobrana; sieć/storage/sterowniki sprawdzone.
- [ ] Walidacja po migracji wykonana; monitoring stabilny.
- [ ] Rollback i dokumentacja migracji przygotowane.
