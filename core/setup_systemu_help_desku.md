---
title: Setup systemu help desku
...
Konfiguracja systemu help desk.
...
1. Kolejki i kanały: email/chat/phone/portal.
2. Formularze i pola obowiązkowe.
3. Kategoryzacja/SLA/eskalacje.
4. Automatyzacje: reguły, makra, chatbot.
5. Integracje: SSO, CMDB, status page.
...
- [ ] Kolejki/kategorie/SLA ustawione.
- [ ] Formularze/pola wymagane skonfigurowane.
- [ ] Automatyzacje i integracje działają.
- [ ] Raporty/dashboardy dostępne.
