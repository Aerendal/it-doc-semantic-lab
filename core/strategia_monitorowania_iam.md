---
title: Strategia monitorowania IAM
...
1. Zakres: IdP, MFA, provisioning, access.
2. Logi i sygnały: auth, anomalie, SoD.
3. Alerty i progi.
4. Raporty zgodności.
5. Runbooki IR dla IAM.
...
- [ ] Sygnały/alerty IAM zdefiniowane.
- [ ] Raporty zgodności działają.
- [ ] Runbooki IR gotowe.
