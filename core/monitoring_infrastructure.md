...
Zaprojektować monitoring infrastruktury (serwery, sieć, storage, DB) z metrykami, alertami i runbookami.
...
1. Zakres: compute, network, storage, DB, load balancers, chmura vs on-prem.
2. Metryki i logi: CPU/RAM/IO/latency, sieć (latency/loss), dysk (IOPS/lat), DB (QPS/locks), logi systemowe.
3. Alerting i SLO: progi, zależności, tłumienie hałasu, eskalacje.
4. Wizualizacja: dashboardy per warstwa/usługa, heatmapy, capacity planning.
5. Runbooki: kroki diagnostyczne, linki do logów, narzędzia, playbooki awarii.
6. Utrzymanie: testy alertów, audits, tagging, wersjonowanie konfiguracji monitoringu.
...
- [ ] Pokryto compute/network/storage/DB metrykami i logami.
- [ ] Alerty mają progi/SLO i eskalacje; hałas redukowany.
- [ ] Dashboardy i runbooki dostępne; testy alertów wykonywane.
- [ ] Konfiguracja monitoringu wersjonowana i audytowana.
