...
## Cel dokumentu
Krótka definicja: Functional Safety (ISO 26262) opisuje cel, rolę w procesie decyzyjnym oraz ryzyka, które dokument ma ograniczać (co najmniej w 2–3 zdaniach).
...
- Item/HARA rozwija: Item Definition, HARA Report.
- TSC i HSR/SSR rozwijają: Architecture/Design, Interface Specs, Timing/Scheduling, Diagnostics.
- Analizy/walidacja rozwijają: FMEA/FMEDA/FTA raporty, Test Strategy, Tool Qualification Plan.

## Wymagane streszczenia
- Streszczenie Safety Goals z ASIL, głównych mechanizmów bezpieczeństwa i wyników metryk (SPFM/LFM/PMHF).
...
- DoR:
  - [ ] Item definition i wstępny HARA (hazardy, S/E/C) gotowe; role (FSM/SE) przydzielone.
  - [ ] Plan kwalifikacji narzędzi i źródła danych do analiz (FMEA/FTA) dostępne.
  - [ ] Traceability repo skonfigurowane (req→design→test).
- DoD:
  - [ ] Safety Goals/FSR/TSC opracowane i prześledzone do HARA; HSR/SSR zdefiniowane.
  - [ ] Analizy (FMEA/FMEDA/FTA, metryki SPFM/LFM/PMHF) wykonane; weryfikacja/walidacja zaplanowana i w toku/zakończona.
  - [ ] Safety case zbudowany (artefakty ISO 26262), plany zmian/OTA/recall opisane; dokument wersjonowany i udostępniony.
