...
Ustalić dobre praktyki pracy zespołu wsparcia (support): przyjmowanie zgłoszeń, priorytetyzacja, SLA, komunikacja, eskalacje, jakość i feedback.


## Zakres i granice

- Obejmuje: kanały przyjmowania, klasyfikację i priorytety, SLA/OLA, playbooki/FAQ, eskalacje do L2/L3, komunikację z użytkownikami, mierzenie jakości (CSAT/FCR/MTTR).
- Nie obejmuje: szczegółowych runbooków technicznych (oddzielne dokumenty) ani polityk HR.
...
1. Kanały i intake (portal/chat/email/phone), kategoryzacja.
2. Priorytety i SLA/OLA, definicje sev.
3. Playbooki/FAQ i bazy wiedzy.
4. Eskalacje i przekazanie do inżynierii (R&R).
5. Komunikacja i statusy (szablony, częstotliwość).
6. Metryki jakości: FCR, MTTR, CSAT, backlog aging.
7. Przeglądy i doskonalenie (feedback loop).
...
- [ ] Kanały/kategorie/prio zdefiniowane.
- [ ] SLA/OLA i sev opisane.
- [ ] Playbooki/FAQ dostępne i aktualne.
- [ ] Eskalacje i R&R zdefiniowane.
- [ ] Metryki (FCR/MTTR/CSAT) mierzone i przeglądane.
