---
title: Data Quality Standards Training
...
# Data Quality Standards Training
...
## Cel dokumentu
Data Quality Standards Training opisuje program szkoleniowy/onboardingowy z celami, modułami i sposobem oceny.
...
- Cele → Moduły → Ćwiczenia → Ocena → Feedback/iteracje.
...
- Szczegółowe scenariusze labów/dem.
- Kryteria zaliczenia i rubryki oceny.



## Wymagane streszczenia
- Skrót sylabusa dla uczestnika i managera.



## Guidance
DoR: zdefiniowane cele, profil uczestników, dostęp do środowisk i materiałów.
DoD: moduły gotowe, ćwiczenia i ocena opisane, harmonogram i instrukcje przekazane, metadane aktualne.
