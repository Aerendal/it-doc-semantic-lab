---
title: Sample Throughput Monitoring
...
Monitorowanie przepustowości próbek (lab/produkcja).
...
1. Zakres: linie/laby, typ próbek.
2. Metryki: throughput, TAT, kolejki, odrzuty.
3. Źródła danych i częstotliwość.
4. Alerty i progi.
...
- [ ] Metryki/próg zdefiniowane.
- [ ] Źródła danych działają.
