...
Standardowy formularz wniosku o zmianę (RFC) do CAB/ITSM: opis, uzasadnienie, ryzyka, plan i okno wdrożenia.
...
1. Identyfikator zmiany, wnioskodawca, data.
2. Opis zmiany i uzasadnienie biznesowe/techniczne.
3. Zakres/komponenty dotknięte, zależności.
4. Ryzyka i plan mitigacji.
5. Plan wdrożenia, testy wsteczne, plan rollback.
6. Okno wdrożenia i wpływ na użytkowników.
7. Załączniki (test evidence, diagramy).
...
- [ ] Opis/uzasadnienie jasne.
- [ ] Ryzyka i rollback opisane.
- [ ] Test evidence dołączone.
- [ ] Okno i wpływ określone.
