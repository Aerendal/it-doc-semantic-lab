---
title: Raport jakości środowiska
...
Ocenić jakość środowisk (dev/test/prod) i ich stabilność.
...
1. Zakres: środowiska, wersje, konfiguracje.
2. Dostępność i stabilność: uptime, incydenty, rollbacki.
3. Spójność: drift konfiguracji vs IaC, różnice między env.
4. Dane: refresh, maskowanie, zgodność.
5. Testy: smoke/automatyczne, coverage, awarie.
6. Ryzyka i plany: modernizacje, dekomisje, działania.
...
- [ ] Drift i spójność środowisk zmierzone.
- [ ] Dostępność i incydenty raportowane; przyczyny znane.
- [ ] Dane są odświeżone/maskowane zgodnie z polityką.
- [ ] Plany poprawy środowisk mają właścicieli.
