---
title: Raport zamknięcia projektu
...
Podsumować projekt po zakończeniu.
...
1. Cele vs wyniki: zakres, czas, budżet, KPI.
2. Dostarczone artefakty i akceptacje.
3. Budżet: plan vs wykonanie, odchylenia.
4. Ryzyka/problemy: co wystąpiło, jak rozwiązano.
5. Lessons learned: co działało/nie działało.
6. Przekazanie: do operacji/supportu, dokumentacja, otwarte działania.
...
- [ ] Cele i wyniki zestawione; akceptacje podpisane.
- [ ] Budżet i odchylenia opisane.
- [ ] Lekcje nauczone i rekomendacje zapisane.
- [ ] Przekazanie do operacji/supportu zakończone.
