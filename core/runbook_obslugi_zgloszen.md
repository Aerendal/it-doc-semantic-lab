---
title: Runbook obsługi zgłoszeń
...
Runbook dla obsługi zgłoszeń (support).
...
1. Przyjęcie zgłoszenia: dane wymagane.
2. Kategoryzacja i SLA.
3. Triage i eskalacje.
4. Komunikacja z klientem.
5. Zamknięcie i feedback.
6. Raportowanie i doskonalenie.
...
- [ ] SLA i kategorie zdefiniowane.
- [ ] Eskalacje opisane.
- [ ] Szablony komunikacji dostępne.
- [ ] Raporty SLA generowane.
