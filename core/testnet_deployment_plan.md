...
1. Cel i zakres (blockchain/protokół).
2. Topologia i węzły.
3. Bezpieczeństwo: klucze, permissions.
4. Monitoring i obserwowalność.
5. Testy i scenariusze.
6. Aktualizacje i rollback.
...
- [ ] Topologia/zakres opisane.
- [ ] Bezpieczeństwo/klucze ustawione.
- [ ] Monitoring/testy przygotowane.
- [ ] Plan aktualizacji/rollback jest.
