---
title: Reagowanie na awarie systemu rezerwacji
...
aligned_by: codex
---
# Reagowanie na awarie systemu rezerwacji
...
Zachować możliwość rezerwacji mimo awarii systemu.
...
1. Detekcja: błędy transakcji, brak potwierdzeń, alerty.
2. Triage: kanały dotknięte (web/app/call), funkcje (create/modify/cancel).
3. Stabilizacja: kolejka offline, manual booking, freeze zmian.
4. Naprawa: DB, cache, payment, integracje.
5. Komunikacja: klienci, partnerzy, personel.
6. Postmortem: przyczyna, utracone/duplikaty, reconciliacja.
...
- [ ] Zakres awarii i funkcji znany.
- [ ] Fallback rezerwacji/manual jest dostępny.
- [ ] System naprawiony; reconciliacja wykonana.
- [ ] Postmortem i poprawki zapisane.
