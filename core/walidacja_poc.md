...
Szablon walidacji Proof of Concept.
...
- [ ] Kryteria sukcesu zdefiniowane.
- [ ] Wyniki i dane zebrane.
- [ ] Wnioski/ryzyka opisane.
- [ ] Rekomendacja go/no-go podana.
