...
Zaplanować projekt bramki API (funkcje, polityki, rozszerzenia) spójny z architekturą i wymaganiami bezpieczeństwa/performancji.


## Zakres i granice

- Obejmuje: wybór funkcji (auth, rate limiting, WAF, transformacje), polityki per ścieżka, rozszerzalność (plugins), wersjonowanie, migration plan.
- Poza zakresem: detale backendów usług.
...
- Wymagania architektury gateway
- Lista usług i ścieżek
- Wymagania bezpieczeństwa/compliance
- Profil ruchu i limity SLA


## Wyjścia

- Spec funkcji i polityk
- Plan rollout/migracji
- Checklisty DoR/DoD
- Powiązania do konfiguracji i monitoringu
...
- [ ] Lista usług/ścieżek zebrana
- [ ] Wymagania bezpieczeństwa/SLA znane
- [ ] Model authn/authz ustalony
- [ ] Plan migracji wstępny


## Kryteria DoD

- [ ] Polityki/funkcje opisane
- [ ] Plan rollout/testów dodany
...
- Latency per feature path
- Error/throttle rate
- Migration success rate
- Incident rate po wdrożeniu
