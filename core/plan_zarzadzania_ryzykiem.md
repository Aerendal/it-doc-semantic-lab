...
Zidentyfikować, ocenić i kontrolować ryzyka projektu/operacji, minimalizując ich wpływ.
...
1. Metodyka: skala prawdopodobieństwo/impact, scoring, progi RAG.
2. Identyfikacja: źródła (zakres, harmonogram, technologia, dostawcy, regulacje), warsztaty, rejestr.
3. Analiza i priorytety: ranking, ryzyka krytyczne, zależności.
4. Plany reakcji: avoid/mitigate/transfer/accept; właściciele, terminy, trigerry.
5. Monitoring: wskaźniki wczesnego ostrzegania, cadence przeglądów, aktualizacje rejestru.
6. Raportowanie i governance: status do steering, decyzje, akceptacje wyjątków.
...
- [ ] Rejestr ryzyk prowadzony z scoringiem i właścicielami.
- [ ] Plany reakcji i trigerry zdefiniowane.
- [ ] Regularne przeglądy i aktualizacje rejestru odbywają się.
- [ ] Raporty do interesariuszy/steering zapewniają widoczność i decyzje.
