---
title: Testowanie aplikacji obywatelskiej
...
aligned_by: codex
---
# Testowanie aplikacji obywatelskiej
...
Plan testów aplikacji obywatelskiej.
...
1. Zakres funkcji i usług.
2. Środowiska i dane (maskowane).
3. Testy funkcjonalne, dostępności, bezpieczeństwa.
4. Performance i obciążenie.
5. Prywatność i zgody.
6. Raport i kryteria release.
...
- [ ] Funkcje/usługi pokryte.
- [ ] Dostępność/bezpieczeństwo przetestowane.
- [ ] Performance wykonane.
- [ ] Raport/release criteria zdefiniowane.
