---
title: Definicja zakresu projektu
...
Jasno określić, co wchodzi i nie wchodzi w zakres projektu, wraz z kryteriami akceptacji.
...
1. Cel i kontekst.
2. Zakres in (zakres funkcji/obszarów).
3. Zakres out (wykluczenia).
4. Założenia i ograniczenia.
5. Kryteria akceptacji zakresu i zmiany (change control).
...
- [ ] Kryteria akceptacji i change control ustalone.
