---
title: Przegląd jakości broadcast
...
Ocenić jakość transmisji broadcast (audio/video) i procesów utrzymania.
...
1. Zakres kanałów i formatów: linear, OTT, VOD, HDR, audio.
2. Parametry techniczne: bitrate, latencja end-to-end, synchronizacja A/V, reklamy.
3. Monitoring: sondy, QoS/QoE metryki, alarmy, progi SLA.
4. Źródła zakłóceń: encodery, sieć, CDN, DRM/ad insertion.
5. Proces incident response: triage, switchovery, komunikacja, postmortem.
6. Testy i certyfikacja: nowe urządzenia/platformy, regression suite.
...
- [ ] Parametry QoS/QoE są mierzone i mają progi SLA.
- [ ] Monitoring i alarmy pokrywają krytyczne punkty łańcucha transmisji.
- [ ] Runbooki na awarie (fallback, restart, reroute) są aktualne.
- [ ] Testy regresyjne i certyfikacje są wykonywane przed zmianami.
