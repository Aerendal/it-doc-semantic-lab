---
title: GDPR Compliance Dla Wsparcia
...
Zapewnić zgodność z GDPR (i CCPA gdzie dotyczy) poprzez kontrolki prawne/techniczne i procesowe.


## Zakres i granice

- Obejmuje: inwentaryzację PII, podstawy prawne, zgody, prawa podmiotów danych, retencję, maskowanie/anonimizację, logowanie/audyt, procedury incydentów.
- Poza zakresem: szczegółowy kod usług (oddzielne dokumenty techniczne).
...
- Mapa danych/PII/przepływów
- Zgody/podstawy prawne
- Prawa podmiotów danych (DSR)
- Retencja/maskowanie/anonimizacja
- Monitoring/logi/IR
- Ryzyka
...
- kontrola-dostepu-dla-wsparcia
- gdpr-compliance-for-support
...
- [ ] customer_data_security_in_support.md
...
- Streszczenie kluczowych decyzji/ryzyk; rozwinięcia procedur DSR/maskowania/retencji.


## Wymagane powiązania

- Dokumenty privacy/security/logging; audyt/IR; ROPA/DPIA; wsparcie klienta jeśli dotyczy.


## Kryteria DoR

- [ ] Polityki/regulacje zebrane
- [ ] Mapa danych/PII dostępna
- [ ] Rejestr ROPA/DPIA aktualny
- [ ] Ownerzy DSR/IR potwierdzeni


## Kryteria DoD

- [ ] Plan kontroli spisany
- [ ] Działania/ownerzy z terminami
...
- Rejestr ROPA/DPIA
- Plan kontroli i działań
- Masking/retencja zasady
- Procedury DSR/IR


## Walidacja / testy

- Sprawdź próbne DSR/procedury; sanity logów/maskowania.
...
- Incydenty privacy
- Luki audytowe
- Retencja/zgody zgodne (%)


## Utrzymanie i aktualizacje

- Przegląd co release lub po zmianie regulacji/incydencie; aktualizacja quick-links/checklist.
