---
title: Design procedur eskalacji
...
Zaprojektować procedury eskalacji dla incydentów/problemów: kiedy, do kogo, jak szybko i jak komunikować.
...
1. Poziomy sev/priorytetu i kryteria eskalacji (P0–P3): kiedy podnieść poziom.
2. Ścieżki eskalacji: technik → L2 → L3/SRE/Sec/Product/PR; fallback jeśli brak odpowiedzi.
3. SLA reakcji i rezolucji per sev; RACI; warunki de‑escalacji.
4. Kanały i format komunikacji: pager/phone/chat/war room/status page/email; szablony komunikatów.
5. Dokumentacja i logowanie: timeline, decyzje, aktualizacje status page, noty dla postmortem.
6. Testy/ćwiczenia i przeglądy: częstotliwość, zakres, kto uczestniczy, jak usprawnienia są wdrażane.
...
- Kryteria i SLA rozwijają: Incident Classification, Incident Response Playbook.
- Komunikacja rozwija: Comms Plan/Status Page Playbook, PR/Legal guidelines.
- Dokumentacja rozwija: Postmortem Template, Logging/Tracking policy.


## Wymagane streszczenia

- Streszczenie ścieżek eskalacji (tabela sev → kto/ile czasu) i kanałów komunikacji.


## Checklisty jakości (DoR/DoD skrót)

- DoR:
  - [ ] Sev/priorytety i kryteria ustalone; właściciele dla każdego poziomu.
  - [ ] Kanały komunikacji i fallback potwierdzone; kontakty aktualne.
  - [ ] SLA reakcji/rezolucji wstępnie uzgodnione.
- DoD:
  - [ ] Ścieżki eskalacji i de‑escalacji opisane; RACI i fallback zapisane.
  - [ ] Szablony komunikatów/status page gotowe; logowanie timeline/decisions opisane.
  - [ ] Plan ćwiczeń/przeglądów z częstotliwością; dokument wersjonowany i udostępniony.
