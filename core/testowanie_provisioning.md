...
Testy provisioning zasobów/użytkowników.
...
1. Scenariusze JML i szablony.
2. Automatyzacja i IdP/SCIM.
3. Bezpieczeństwo: least privilege, audyt.
4. Rollback i wyjątki.
5. Monitoring i logi.
6. Raport i SLA.
...
- [ ] Scenariusze JML pokryte.
- [ ] Automatyzacja/SCIM działa.
- [ ] Bezpieczeństwo/logi zweryfikowane.
- [ ] Raporty/SLA ustalone.
