...
Zaplanować obsadę zespołów wsparcia (CS/2nd line), aby zapewnić SLA i satysfakcję klientów.
...
1. Prognoza popytu: wolumen ticketów/kanały/sezonowość, SLA.
2. Headcount i role: specjalizacje, języki, zmiany, on-call, rezerwy.
3. Grafik: coverage stref czasowych, przerwy, backup, rotacje.
4. Rekrutacja i onboarding: profile, ramp-up, szkolenia produktowe/polityki.
5. Rozwój: coaching, QA odpowiedzi, certyfikacje, ścieżki awansu.
6. Monitoring: metryki obciążenia, CSAT/NPS, burnout, replanowanie.
...
- [ ] Headcount/grafik dostosowany do wolumenu i SLA.
- [ ] Rekrutacja/onboarding zaplanowane; szkolenia pokrywają produkt/polityki.
- [ ] QA/coaching i rozwój zespołu uwzględnione.
- [ ] Metryki obciążenia i wellbeing monitorowane; plan korekt istnieje.
