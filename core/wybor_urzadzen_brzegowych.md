---
title: Wybór urządzeń brzegowych
...
1. Use case i wymagania (CPU/GPU/NPU, rugged).
2. Łączność i protokoły.
3. Zarządzanie i OTA.
4. Bezpieczeństwo.
5. Koszt/ROI.
6. Lista kandydatów i ocena.
...
- [ ] Wymagania i kryteria zdefiniowane.
- [ ] Zarządzanie/OTA/bezpieczeństwo uwzględnione.
- [ ] Kandydaci ocenieni.
- [ ] ROI/koszt opisane.
