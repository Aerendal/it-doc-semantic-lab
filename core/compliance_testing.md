...
Zaplanować i wykonać testy zgodności (kontrolki, scenariusze regulacyjne) dla systemu/API.


## Zakres i granice

- Obejmuje: scenariusze testowe z regulacji/standardów, dane testowe, środowiska, raportowanie, kryteria zaliczenia.
- Poza zakresem: pełne audyty.
...
- Lista wymagań i kontrolek
- Regulacje/standardy
- Środowiska testowe
- Dane testowe/PII zasady


## Wyjścia

- Plan i scenariusze testów
- Raport wyników
- Lista niezgodności
- Powiązania do planów naprawczych
...
- [ ] Regulacje dostępne
- [ ] Środowiska gotowe
- [ ] Zasady danych/PII znane


## Kryteria DoD

- [ ] Testy wykonane/raportowane
- [ ] Niezgodności spisane
...
- Niezgodności High/Med
- Czas remediacji
- On-time wykonanie testów
- Trend zgodności
