---
title: Referencja zasad esportowych
...
Referencyjny zestaw zasad dla turniejów e-sport.
...
1. Format turnieju: fazy, mapy, seedowanie.
2. Zasady fair play: anty-cheat, sprzęt, konta.
3. Procedury meczowe: start/pause/restart, protesty.
4. Sędziowanie: role, decyzje, komunikacja.
5. Kary i sankcje: katalog, eskalacje.
6. Bezpieczeństwo i wellbeing: przerwy, zdrowie, publiczność.
...
- [ ] Format i mapy opisane.
- [ ] Anty-cheat i sprzęt określone.
- [ ] Procedury meczowe i kary zdefiniowane.
- [ ] Sędziowie i komunikacja opisane.
