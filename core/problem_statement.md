...
## Cel dokumentu
Precyzyjnie opisuje problem biznesowy/produktowy, kto go doświadcza, w jakich sytuacjach i jaki jest koszt braku rozwiązania. Ustala wspólne rozumienie potrzeby, zanim powstaną wymagania.

## Zakres i granice
Obejmuje: objawy problemu, segmenty użytkowników, wpływ na KPI, obecne obejścia i ograniczenia. Nie obejmuje: szczegółowych rozwiązań ani decyzji technologicznych.
...
- Kryteria sukcesu → rozwinięcie w FRS/NFR.
- Priorytet i wpływ na KPI → streszczenie w Business Case.
- Obecne obejścia → powiązanie z ryzykami w Risk Register.
...
- Tło i kontekst (kogo dotyczy, gdzie występuje)
- Opis problemu (objawy, częstotliwość, wpływ)
- Kogo dotyczy (persony/segmenty)
- Wpływ na KPI/KRI (czas, koszt, ryzyko, satysfakcja)
- Obecne obejścia i ich koszty
