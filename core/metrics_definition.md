...
## Cel dokumentu
Zdefiniować Definition of Done (DoD) — formalne kryteria ukończenia User Story lub Sprint — jako fundamentalny element transparentności w Scrum. DoD opisuje mierzalne warunki które muszą być spełnione zanim praca zostanie uznana za Done: pokrycie testami, code review, dokumentacja, integracja, deployment do środowiska testowego — zapobiegając akumulacji ukrytego długu technicznego.
