---
title: BIM Management Operations
...
Opisać koncepcję operacyjną systemu (Concept of Operations — ConOps) definiującą jak system będzie używany, przez kogo i w jakim środowisku operacyjnym — zgodnie z ISO/IEC 15288 Business or Mission Analysis Process. ConOps stanowi wejście do wymagań systemowych: opisuje potrzeby użytkowników, scenariusze operacyjne, ograniczenia środowiskowe i kryteria sukcesu z perspektywy operatora/użytkownika.
...
- Wymagania → Projekt/Proces → Implementacja/Testy → Operacje/monitoring.
- Ryzyka i decyzje → Plan wdrożenia → Runbooki/monitoring → Postmortem/lessons learned.
