...
Specyfikacja ekranów aplikacji.
...
1. Lista ekranów i stany.
2. Layout i komponenty.
3. Nawigacja i przepływy.
4. Stany pusty/błąd/loading.
5. Dostępność i responsywność.
6. Assety i zależności.
...
- [ ] Ekrany i stany opisane.
- [ ] Nawigacja spójna.
- [ ] Stany edge (empty/error/loading) ujęte.
- [ ] Accessibility/responsywność uwzględnione.
