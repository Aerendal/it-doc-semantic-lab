...
Przewodnik integracji źródeł OZE z infrastrukturą.
...
1. Źródła: PV, wiatr, magazyny energii.
2. Sterowanie i prognozy: EMS, forecast, curtailment.
3. Połączenia sieci: inwertery, ochrona, normy.
4. Dane i monitorowanie: SCADA, metering, cyber.
5. Ekonomia: taryfy, net-metering, ROI.
6. Zgodność: regulacje lokalne, certyfikacje.
...
- [ ] Źródła i połączenia opisane.
- [ ] Sterowanie/prognozy uwzględnione.
- [ ] Bezpieczeństwo/monitoring opisane.
- [ ] Ekonomia i regulacje ujęte.
