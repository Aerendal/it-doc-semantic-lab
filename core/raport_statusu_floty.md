...
Raportować stan floty (pojazdy/urządzenia).
...
1. Inwentarz: liczba, typy, lokalizacja.
2. Dostępność: uptime, serwis, awarie.
3. Zużycie i koszty: paliwo/energia, serwis, opony.
4. Bezpieczeństwo: incydenty, telematyka, naruszenia.
5. Plany: przeglądy, wymiany, inwestycje.
6. Ryzyka: niedostępność, regulacje, pogoda.
...
- [ ] Dane inwentarza aktualne.
- [ ] Dostępność i serwis raportowane.
- [ ] Koszty/zużycie monitorowane; anomalie opisane.
- [ ] Plany serwisów/wymian z datami.
