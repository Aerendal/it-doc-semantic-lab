---
title: Bezpieczeństwo danych miejskich
...
aligned_by: codex
---
# Bezpieczeństwo danych miejskich
...
Zapewnić ochronę danych miejskich (infrastruktura, transport, energia, dane mieszkańców) przy jednoczesnym umożliwieniu usług smart city i open data.


## Zakres i granice

- Obejmuje: klasyfikację (public/open vs restricted), segmentację dostępu, szyfrowanie, anonimizację/pseudonimizację, zgody/RODO, udostępnianie API/open data, audyt i monitoring.
- Nie obejmuje: polityk administracyjnych miasta ani bezpieczeństwa fizycznego.
...
1. Klasyfikacja danych miejskich (public/open/internal/restricted).
2. Dostęp i udostępnianie (API, open data, throttling, rejestr konsumentów).
3. Szyfrowanie i anonimizacja/pseudonimizacja.
4. Zgody i prywatność (RODO, zgody mieszkańców, DPIA).
5. Monitoring/audyt użycia danych.
...
- [ ] Klasyfikacja i poziomy dostępu zdefiniowane.
- [ ] Zasady API/open data i rejestr konsumentów.
- [ ] Szyfrowanie i anonimizacja wdrożone.
- [ ] Zgody/RODO i DPIA wykonane tam, gdzie trzeba.
- [ ] Monitoring/audyt użycia danych działa.
