...
## Cel dokumentu
Search Data Security definiuje zasady i kontrole oraz sposób ich egzekwowania.
...
## Szybkie powiązania
- Zależność: {'depends_on': 'Search Platform Setup', 'type': 'sequential'}
- Zależność: {'depends_on': 'Search Platform Setup', 'type': 'sequential'}
