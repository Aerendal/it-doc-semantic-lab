...
Skatalogować praktyki bezpieczeństwa API (authn/authz, rate limiting, input validation, logging, secrets), aby standaryzować implementacje.


## Zakres i granice

- Obejmuje: uwierzytelnianie/autoryzacja, rate limiting/abuse, walidacja danych, nagłówki bezpieczeństwa, logowanie/audyt bez PII, secrets/mTLS, hardening gateway.
- Poza zakresem: szczegółowe testy (osobne dokumenty).
...
- Polityki bezpieczeństwa org
- Spec API i modele uprawnień
- Wymagania compliance (GDPR/PCI/PII)
- Wnioski z incydentów i testów


## Wyjścia

- Zbiór reguł must/should
- Checklisty DoR/DoD dla zmian w API
- Powiązania do runbooków i testów
- Linki do konfiguracji gateway/waf
...
- [ ] Polityki bezpieczeństwa zebrane
- [ ] Modele uprawnień znane
- [ ] Wymagania compliance zebrane
- [ ] Incydenty/testy przeanalizowane


## Kryteria DoD

- [ ] Reguły must/should spisane
...
- Liczba naruszeń polityk
- Pokrycie checklist
- Incydenty security na kwartał
- Czas reakcji na naruszenie
