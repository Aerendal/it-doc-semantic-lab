---
title: Resource Allocation for QA
...
## Cel dokumentu
Krótka definicja: Resource Allocation for QA opisuje cel, rolę w procesie decyzyjnym oraz ryzyka, które dokument ma ograniczać (co najmniej w 2–3 zdaniach).
...
- Zapotrzebowanie na ludzi: role (QA Lead/Engineer/Automation/Perf/Security/UX QA), FTE per iteracja, kompetencje, rotacja/pokrycie stref czasowych.
- Zapotrzebowanie na środowiska i sprzęt: liczba instancji, konfiguracje, wersje, licencje, runnerzy CI, urządzenia mobilne/lab.
- Narzędzia i licencje: frameworki testowe, APM/monitoring, security scanners, performance rigs; koszty/liczba seatów.
- Obciążenie w czasie: wykres obłożenia per sprint/iteracja/release, kolizje między projektami.
- Priorytety i trade-offy: gdzie inwestujemy automatyzację, gdzie manual, które obszary testujemy głębiej vs płycej.
- Ryzyka zasobowe: flaki na infra, wąskie gardła (np. limited devices), plan awaryjny.
- RACI i eskalacja: kto zatwierdza rezerwacje, kto zwalnia zasoby, ścieżka eskalacji.

## Wymagane rozwinięcia
- Zapotrzebowanie na ludzi rozwija: QA Strategy, QA Project Schedule, Hiring/Staffing Plan.
- Środowiska rozwijają: Environment Runbook, Test Data Management, Secrets Management.
- Narzędzia rozwijają: Tooling Strategy, CI/CD Pipeline Design, Security/Performance test plans.

## Wymagane streszczenia
- Streszczenie obciążenia per release/sprint (z harmonogramu QA) – tylko liczby kluczowe i kolizje.
- Streszczenie krytycznych wąskich gardeł (np. ograniczone urządzenia, licencje) z planem obejścia.
...
- DoR:
  - [ ] Zdefiniowane role/kompetencje potrzebne na iterację/release.
  - [ ] Znana dostępność środowisk, runnerów, urządzeń; licencje zabezpieczone.
  - [ ] Obciążenie w czasie zsynchronizowane z QA Project Schedule.
- DoD:
  - [ ] Przydziały zasobów zaakceptowane (RACI), kolizje rozwiązane.
  - [ ] Ryzyka zasobowe mają plan awaryjny i właściciela.
  - [ ] Dokument udostępniony interesariuszom (QA/Dev/Ops/Sec/Product) i wersjonowany.
