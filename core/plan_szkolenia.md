...
Zaplanować szkolenie (temat/rola), definiując cele, zakres, logistykę i ewaluację.
...
1. Cele i odbiorcy: czego mają się nauczyć, poziom, prerekwizyty.
2. Program: agenda, moduły, czas, materiały, ćwiczenia.
3. Logistyka: terminy, format (online/on-site), trenerzy, narzędzia, dostęp.
4. Ewaluacja: test/quiz, zadanie praktyczne, ankieta, kryteria zaliczenia.
5. Certyfikacja i rejestr: wpis do LMS/HR, certyfikaty, powtarzalność/recert.
6. Follow-up: materiały po, Q&A, wsparcie, ścieżka dalszego rozwoju.
...
- [ ] Cele/prerekwizyty i odbiorcy jasno określeni.
- [ ] Agenda i materiały przygotowane; logistyka potwierdzona.
- [ ] Ewaluacja i kryteria zaliczenia zdefiniowane; rejestr w LMS.
- [ ] Follow-up i dalsze kroki zapewnione.
