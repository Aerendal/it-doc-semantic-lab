---
title: Bezpieczeństwo danych rolniczych
...
aligned_by: codex
---
# Bezpieczeństwo danych rolniczych
...
Chronić dane rolnicze (lokalizacja pól, plony, telemetry z maszyn/sensorów, dostawy) przy współpracy z dostawcami, dronami, platformami agrarnymi.


## Zakres i granice

- Obejmuje: klasyfikację danych (produkcyjne, lokalizacja, dane handlowe), kontrolę dostępu, szyfrowanie, udostępnianie partnerom, anonimizację/agg danych, zgodność z regulacjami lokalnymi.
- Nie obejmuje: polityk dopłat/UE ani szczegółowej agronomii.
...
1. Klasyfikacja danych (wrażliwe vs open/aggregated).
2. Dostęp i udostępnianie (partnerzy, API, urządzenia, drony).
3. Szyfrowanie i przechowywanie (edge/cloud), klucze.
4. Anonimizacja/agregacja dla raportów i modeli.
5. Zgody/umowy z dostawcami (DPA), lokalne regulacje.
6. Monitoring/audyt użycia danych.
...
- [ ] Klasyfikacja danych rolniczych wykonana.
- [ ] Dostępy i udostępnianie partnerom kontrolowane.
- [ ] Szyfrowanie edge/cloud i zarządzanie kluczami.
- [ ] Anonimizacja/agregacja dla raportów/modeli.
