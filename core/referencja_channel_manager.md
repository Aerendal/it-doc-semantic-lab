---
title: Referencja channel manager
...
Opis referencyjny integracji channel managera (hotel/ecommerce).
...
1. Zakres i model danych: pokoje/produkty, taryfy, dostępność.
2. Integracje: PMS/OMS, płatności, inventory.
3. API i protokoły: push/pull, webhooks, auth, limity.
4. Mapowanie kanałów: OTA, marketplace, własny sklep.
5. Błędy i retry: kody, idempotencja, kolejki.
6. Monitoring i bezpieczeństwo: logi, audit, certyfikaty.
...
- [ ] Mapowanie pól i kanałów udokumentowane.
- [ ] API/limity i retry opisane.
- [ ] Bezpieczeństwo i audyt wskazane.
- [ ] Monitoring i właściciel integracji określony.
