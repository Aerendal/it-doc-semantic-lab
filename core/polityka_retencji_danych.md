...
Określić zasady przechowywania i usuwania danych, zgodne z regulacjami i potrzebami biznesu.
...
1. Zakres danych: kategorie, wrażliwość, właściciele, systemy.
2. Okresy retencji: per kategoria/system, podstawy prawne/umowne, wyjątki.
3. Operacjonalizacja: harmonogramy purge/archiwum, anonimizacja/pseudonimizacja, narzędzia.
4. Bezpieczeństwo: szyfrowanie, dostęp, logowanie operacji, immutability jeśli wymagane.
5. Compliance i audyt: raporty, kontrole, dowody zgodności, procedura żądań (Rodo/DSAR).
6. Przeglądy: cykl aktualizacji polityki, właściciele, zmiany w regulacjach.
...
- [ ] Kategorie danych i okresy retencji zmapowane z podstawami prawnymi.
- [ ] Proces purge/archiwum i anonimizacji opisany i egzekwowany.
- [ ] Bezpieczeństwo (szyfrowanie/dostępy/logi) zapewnione.
- [ ] Raporty zgodności i cykl przeglądów polityki ustalone.
