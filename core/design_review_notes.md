...
## Cel dokumentu
Dokumentować obserwacje, decyzje i action items ze Sprint Review — ceremonii Scrum umożliwiającej inspekcję Produktu przez interesariuszy i adaptację Product Backlog. Notatki rejestrują: co zostało zademonstowane, jakie feedback otrzymał zespół, które elementy zostały zaakceptowane/odrzucone i jakie nowe pozycje backlogu zidentyfikowano — jako transparentny zapis event Scrum.
