...
Prognozować zapotrzebowanie na zasoby (compute/storage/network) w horyzoncie czasowym, by planować skalowanie i koszty.


## Zakres i granice

- Obejmuje: dane historyczne, czynniki wzrostu (ruch, funkcje, sezonowość), modele prognoz, scenariusze, zalece nia scalingu, wpływ na budżet.
- Nie obejmuje: szczegółowej architektury (osobny plan) ani kontraktów z dostawcami.
...
1. Zakres i horyzont prognozy.
2. Dane wejściowe (historyczne metryki, sezonowość, eventy).
3. Model prognozy (trend, scenariusze, założenia).
4. Wyniki (compute/storage/network) z marginesem bezpieczeństwa.
5. Zalecenia (scaling, rezerwy, optymalizacje) i wpływ na koszt.
6. Ryzyka/odchylenia i plan przeglądów.
...
- [ ] Dane wejściowe i założenia opisane.
- [ ] Scenariusze prognozy policzone.
- [ ] Rekomendacje scalingu/kosztu podane.
- [ ] Plan przeglądów/aktualizacji prognozy ustalony.
