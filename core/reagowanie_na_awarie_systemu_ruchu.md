---
title: Reagowanie na awarie systemu ruchu
...
aligned_by: codex
---
# Reagowanie na awarie systemu ruchu
...
Reagować na awarie systemów zarządzania ruchem (transport/miasto).
...
1. Detekcja: sensory, kamery, center kontrolny.
2. Triage: obszar, krytyczność (korytarze, węzły).
3. Stabilizacja: ręczne sterowanie, priorytety, objazdy.
4. Naprawa: serwery, łączność, sterowniki, sygnalizacja.
5. Komunikacja: służby, społeczeństwo, media.
6. Postmortem: przyczyna, prewencja, testy systemu.
...
- [ ] Obszar i wpływ ocenione.
- [ ] Sterowanie alternatywne/objazdy wdrożone.
- [ ] System przywrócony; test sygnalizacji.
- [ ] Raport i prewencja zapisane.
