...
Opisać, jak używać SDK (platforma/API): instalacja, konfiguracja, przykłady, wersjonowanie i wsparcie.
...
1. Wsparcie języków/platf., wymagania wstępne.
2. Instalacja/konfiguracja (keys, endpoints, env).
3. Quickstart/przykłady kodu (auth, podstawowe operacje).
4. Błędy i retry, logging, best practices.
5. Wersjonowanie/changelog, kompatybilność z API.
6. Testy/examples, contribution guide.
7. Support: kanały, SLA, zgłaszanie bugów.
...
- [ ] Quickstart i przykłady działają.
- [ ] Konfiguracja i błędy/retry opisane.
- [ ] Changelog/compat z API aktualne.
- [ ] Support/contrib ścieżki podane.
