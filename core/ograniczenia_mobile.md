...
Wypunktować ograniczenia platform mobilnych (iOS/Android) wpływające na projektowanie i implementację produktu.
...
1. Systemowe: sandbox, tła, limity baterii/CPU, rozmiary APK/IPA, uprawnienia.
2. Sieć: niestabilność, captive portals, limity transferu, offline/edge cases.
3. Hardware: różnice urządzeń, sensory, notch/ekrany, pamięć, wydajność.
4. Dystrybucja: polityki sklepów, review guidelines, rollout, krótki czas na poprawki.
5. Bezpieczeństwo: cert pinning, keychain/keystore, anty-tamper, root/jailbreak.
6. Observability: ograniczenia logów/trace, sampling, crash reporting.
...
- [ ] Uwzględniono sandbox/limity tła/baterii/pamięci w projekcie.
- [ ] Obsługa sieci offline/niestabilnej zaplanowana.
- [ ] Polityki sklepów i rollout przewidziane.
- [ ] Bezpieczeństwo i observability dostosowane do mobile.
