...
1. Cele i ryzyka.
2. Architektura: IdP, federacja, provisioning.
3. Polityki: MFA, SoD, lifecycle.
4. Zgodność i audyt.
5. KPI i roadmap.
6. Partnerzy/narzędzia.
...
- [ ] Cele/architektura IAM opisane.
- [ ] Polityki/zgodność uwzględnione.
- [ ] KPI/roadmap zdefiniowane.
- [ ] Partnerzy/narzędzia wskazani.
