...
Opisać plan i procedury konserwacji systemu przez cały cykl życia — zgodnie z procesem System Maintenance Process (MNT) zdefiniowanym w ISO/IEC 15288. Plan obejmuje: strategię konserwacji (korektywna/prewentywna/adaptacyjna/doskonaląca), procedury zgłaszania problemów, kryteria priorytetyzacji zmian, środowisko konserwacji, testy regresji i zarządzanie wersjami systemu.
