...
Określić kamienie milowe projektu/programu, ich kryteria akceptacji i sposób monitorowania.
...
1. Lista milestones: nazwa, data docelowa, właściciel, zależności.
2. Kryteria akceptacji: DoD dla milestone, wymagane artefakty/testy/zgody.
3. Zależności i ścieżka krytyczna: mapowanie, ryzyka opóźnień.
4. Raportowanie: status (green/yellow/red), cadence przeglądów, dashboard.
5. Zmiany: procedura przesunięć, akceptacje, komunikacja.
6. Linki: powiązane epiki/tickety, dokumenty, decyzje.
...
- [ ] Kamienie milowe mają jasne kryteria akceptacji i właścicieli.
- [ ] Zależności/ryzyka ścieżki krytycznej zmapowane.
- [ ] Raportowanie statusów regularne; zmiany terminów kontrolowane.
- [ ] Artefakty i linki do zadań/decydentów podpięte.
