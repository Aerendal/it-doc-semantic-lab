---
title: Adaptive Bitrate Streaming (ABR) Design
...
# Adaptive Bitrate Streaming (ABR) Design
...
## Cel dokumentu
Adaptive Bitrate Streaming (ABR) Design opisuje docelową architekturę/projekt wraz z trade-offami i kryteriami akceptacji.
