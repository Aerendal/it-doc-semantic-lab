---
title: Setup provisioning użytkowników
...
aligned_by: codex
---
# Setup provisioning użytkowników
...
Konfiguracja provisioning/deprovisioning użytkowników.
...
1. IdP i źródło prawdy: HR/LDAP/SCIM.
2. Role i grupy: mapping, SoD.
3. Workflow JML: joiner/mover/leaver, approvals.
4. Automatyzacja: SCIM/Graph/Okta/AD, szablony.
5. Bezpieczeństwo: MFA, least privilege, audyt.
6. Testy i monitoring: dry-run, logi, alerty.
...
- [ ] Źródło prawdy i IdP skonfigurowane.
- [ ] Role/grupy i SoD opisane.
- [ ] Workflow JML zautomatyzowany i przetestowany.
- [ ] Logi/audyt i alerty działają.
