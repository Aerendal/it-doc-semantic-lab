...
## Zakres i granice
Obejmuje: kroki wdrożenia, środowiska docelowe, testy weryfikacyjne, rollback, komunikację. Nie obejmuje: architektury systemu ani specyfikacji wymagań.
...
1. Zakres i cele.
2. Uczestnicy/pilot sites.
3. Środowisko i dane.
4. Scenariusze i metryki.
5. Wsparcie i monitoring.
6. Kryteria sukcesu i go/no-go.
...
- [ ] Zakres/cel i miejsca pilota zdefiniowane.
- [ ] Scenariusze/metyki opisane.
- [ ] Monitoring/wparcie gotowe.
- [ ] Go/no-go ustalone.
