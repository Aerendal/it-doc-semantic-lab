...
Zebrać ogólne dobre praktyki (uniwersalne) dla projektów IT: planowanie, jakość, bezpieczeństwo, obserwowalność, współpraca.
...
- [ ] DoD i standardy codingu ustalone.
- [ ] Testy i code review stosowane.
- [ ] Bezpieczeństwo podstawowe (secrets, dependencies) włączone.
- [ ] Logi/metryki/alerty skonfigurowane.
- [ ] Zmiany i decyzje udokumentowane.
