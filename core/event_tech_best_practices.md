---
title: Event Tech Best Practices
...
Zebrać dobre praktyki technologiczne dla eventów (konferencje/live): rejestracja, streaming, wi-fi, aplikacja, bezpieczeństwo.
...
1. Rejestracja/check-in: system, QR, badge, anti-fraud.
2. Connectivity: Wi‑Fi plan (capacity, segmentation), fallback LTE, monitoring.
3. Streaming/AV: redundancja, testy, encoding, CDN, audio/napisy.
4. Aplikacja eventowa: agenda, powiadomienia, networking, mapy.
5. Dane/privacy: zgody, tracking, analityka, retention.
6. Bezpieczeństwo: sieć, dostęp fizyczny, awarie, komunikacja kryzysowa.
7. Observability: realtime metrics (join, QoE), support desk.
...
- [ ] Rejestracja/anti-fraud gotowe.
- [ ] Wi‑Fi/AV/streaming przetestowane, redundancja.
- [ ] App/agenda/notifications działają.
- [ ] Privacy/zgody/analityka i bezpieczeństwo zaadresowane.
