---
title: Przewodnik Submisji App Store
...
Poprowadzić proces przygotowania i wysyłki aplikacji do Apple App Store.
...
1. Pre-check: zgodność z HIG, treści, privacy, funkcje wymagające zgód.
2. Metadane: nazwa, opisy, słowa kluczowe, kategorie, rating treści.
3. Privacy/permissions: privacy manifest, declarations, link do polityki.
4. Build: provisioning, signing, bitcode (jeśli dot.), architektury, testflight.
5. Testy i review: testy urządzeń, screeny, wideo, notatki dla review.
6. Wysyłka i follow-up: submission, statusy, odpowiadanie na rejection, rollout phased.
...
- [ ] Metadane i privacy manifest są kompletne i zgodne.
- [ ] Build przeszedł testy i ma poprawne provisioning/signing.
- [ ] Zrzuty ekranu/wideo i notatki dla review są przygotowane.
- [ ] Plan rollout i monitoring po publikacji istnieje.
