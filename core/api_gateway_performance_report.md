---
title: API Gateway Performance Report
...
Raportować wydajność bramki API (latencja, przepustowość, błędy, throttling) oraz rekomendacje.


## Zakres i granice

- Obejmuje: metryki per ścieżka/region, trend, incydenty, rekomendacje.
- Poza zakresem: szczegółowe fixy — trafiają do planów działań.
...
- Raport z metrykami/trendem
- Lista regresji i rekomendacji
- Powiązania do zadań/ownerów
- Aktualizacja progów jeśli trzeba
...
- [ ] Zmiany konfig zapisane


## Kryteria DoD

- [ ] Raport i rekomendacje spisane
- [ ] Ownerzy przypisani
