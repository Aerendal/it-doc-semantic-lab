...
## Cel dokumentu
Opisać System Security Plan (SSP) dokumentujący kontrole bezpieczeństwa wdrożone w systemie federalnym — jako kluczowy artefakt wymagany przez NIST SP 800-53 klauzula 3.1 i NIST SP 800-18. SSP zawiera: opis systemu i granicy autoryzacji, kategorizację bezpieczeństwa (FIPS 199), tabelę wdrożonych kontroli bezpieczeństwa i prywatności, odpowiedzialności za kontrole oraz plan wdrożenia kontroli planowanych.
