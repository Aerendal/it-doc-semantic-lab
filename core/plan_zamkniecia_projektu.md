---
title: Plan zamknięcia projektu
...
Zamknąć projekt w sposób uporządkowany: rozliczyć zakres/budżet, przekazać utrzymanie i zebrać wnioski.
...
1. Weryfikacja zakresu i akceptacji: checklisty DoD, protokoły odbioru, spełnienie KPI.
2. Finanse i umowy: final billing, rozliczenie budżetu, zamknięcie kontraktów.
3. Przekazanie: dokumentacja, runbooki, własność operacyjna, dostępy, szkolenia BAU.
4. Cleaning: porządki w repo/koncie, archiwizacja, dane testowe, deprovision.
5. Lessons learned i retrospektywa: co działało/nie, rekomendacje, rejestr LL.
6. Komunikacja i formalne zamknięcie: raport końcowy, decyzja steering, świętowanie 
...
- [ ] Zakres/KPI zaakceptowane; odbiory podpisane.
- [ ] Finanse/umowy zamknięte; deprovision i archiwizacja wykonane.
- [ ] Przekazanie operacyjne i dokumentacja ukończone; dostępy zaktualizowane.
- [ ] Lessons learned spisane; raport końcowy i komunikacja wysłane.
