...
## Cel dokumentu
Zdefiniować politykę kontroli dostępu do środowiska Cardholder Data Environment (CDE) zgodnie z wymaganiami PCI DSS Requirement 7 (Restrict Access to System Components). Polityka opisuje zasadę least privilege, role i uprawnienia, mechanizmy uwierzytelniania MFA, zarządzanie kontami uprzywilejowanymi i przeglądy dostępu — zapewniając że tylko autoryzowane osoby mają dostęp do danych kart płatniczych.
