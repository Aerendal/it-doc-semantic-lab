...
Przewodnik po bibliotece komponentów UI: jak używać, wersjonować i utrzymywać spójność w projektach.
...
1. Zakres bibliotek (platformy: web/mobile, framework).
2. Konwencje: nazewnictwo, theming, accessibility, internationalization.
3. Komponenty: katalog, props/stan, przykłady użycia, warianty, ograniczenia.
4. Wersjonowanie i publikacja (semver, changelog, release process).
5. Testy i jakość (visual regression, a11y tests, lint).
6. Contribution guide (jak dodawać/zmieniać komponent).
...
- [ ] Komponenty mają opis, props i przykłady.
- [ ] A11y/internationalization uwzględnione.
- [ ] Semver/changelog publikowane.
- [ ] Testy (visual/a11y/unit) wymagane przy zmianach.
