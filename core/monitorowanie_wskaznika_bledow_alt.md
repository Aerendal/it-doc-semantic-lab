...
Monitorować error rate usług, by szybko wykrywać degradacje i priorytetyzować naprawy.
...
1. Zakres: API/frontend/batch; definicja błędu (4xx/5xx/exceptions).
2. Metryki: error rate %, burn error budget, top endpoints/klasy błędów, korelacja z latency.
3. Segmentacja: release/region/tenant/device.
4. Alerty: progi SLA/SLO, skoki błędów, brak ruchu, spike 5xx.
5. Diagnostyka: trace/logi, sample payloads, DLQ, stack traces.
6. Raporty: trend/Pareto, wpływ na konwersję/CSAT, backlog bugów.
...
- [ ] Error rate i burn-rate monitorowane z segmentacją.
- [ ] Alerty na skoki błędów/skoki 5xx skonfigurowane.
- [ ] Trace/logi/DLQ dostępne do analizy; Pareto raportowane.
- [ ] Backlog bugów powiązany z danymi i wpływem na biznes.
