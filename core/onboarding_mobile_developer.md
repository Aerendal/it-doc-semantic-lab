---
title: Onboarding Mobile Developer
...
Przyspieszyć wdrożenie nowego developera mobile, dostarczając listę zadań, dostępy i standardy.
...
1. Dostępy i narzędzia: repo, CI/CD, certyfikaty/klucze, konta store, VPN, MDM.
2. Środowisko dev: IDE/SDK wersje, bundlery, emulatory/urządzenia, konfiguracje.
3. Standardy kodu: style, architektura (MVVM/MVI), testy (unit/UI), feature flags, analytics.
4. Build i release: schematy, signing, konfiguracje env, beta/testflight, release process.
5. Bezpieczeństwo: secret handling, cert pinning, privacy, logowanie bez PII.
6. Pierwsze zadania: „hello build”, mały bug, code review, dołączenie do rytuałów zespołu.
...
- [ ] Developer ma wszystkie dostępy i skonfigurowane środowisko.
- [ ] Zna standardy kodu/testów i proces release.
- [ ] Potrafi zbudować i uruchomić appkę (device/emulator) i przejść przez beta.
- [ ] Wie jak obchodzić się z sekretami/PII i cert pinningiem.
