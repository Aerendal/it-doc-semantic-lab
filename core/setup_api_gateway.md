...
Instrukcja konfiguracji API Gateway.
...
1. Wymagania: domain, cert, auth.
2. Routing i wersjonowanie.
3. Bezpieczeństwo: rate-limit, WAF, JWT/OAuth.
4. Observability: logi, metrics, trace.
5. Deployment: IaC, testy, canary.
...
- [ ] Routing/bezpieczeństwo skonfigurowane.
- [ ] Observability działa.
- [ ] Deployment IaC przetestowany.
- [ ] Rollback/runbook gotowe.
