---
title: Referencja kontaktów wsparcia
...
Aktualny spis kontaktów i ścieżek wsparcia.
...
1. Kategorie: produkt, infrastruktura, bezpieczeństwo, dostawcy.
2. Kanały: telefon, email, chat, ticket; SLA.
3. Eskalacje: L1/L2/L3, on-call, manager.
4. Godziny i strefy: coverage, święta.
5. Procedury zgłoszeń: dane wymagane, szablony.
6. Utrzymanie: właściciel listy, aktualizacje.
...
- [ ] Lista kontaktów kompletna i z SLA.
- [ ] Eskalacje i on-call podane.
- [ ] Procedury zgłoszeń zdefiniowane.
- [ ] Właściciel i harmonogram aktualizacji ustalone.
