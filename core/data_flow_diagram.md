...
## Cel dokumentu
Zmapować i udokumentować przepływ danych posiadaczy kart płatniczych (Cardholder Data — CHD i SAD) przez środowisko CDE zgodnie z wymaganiem PCI DSS 1.2.4 (Cardholder Data Flow Diagram). Diagram jest obowiązkowym artefaktem każdego audytu PCI DSS: pokazuje wszystkie systemy, aplikacje, interfejsy i media przechowujące/przetwarzające/transmitujące dane kart — definiując granice zakresu audytu.
