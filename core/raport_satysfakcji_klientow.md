---
title: Raport satysfakcji klientów
...
Raportować satysfakcję klientów B2C/B2B.
...
1. Metodologia: kanały ankiet, czas po zdarzeniu, próba.
2. Metryki: NPS/CSAT/retention, churn signals.
3. Segmenty: branża, wartość klienta, produkt.
4. Tematy: obsługa, produkt, cena, dostawa.
5. Działania: poprawki produktowe, procesowe, szkolenia.
6. Monitorowanie: trend, cele, kolejne badania.
...
- [ ] Metryki i segmenty policzone.
- [ ] Tematy feedbacku zmapowane do działań.
- [ ] Właściciele i terminy działań zdefiniowane.
- [ ] Trend do celu monitorowany.
