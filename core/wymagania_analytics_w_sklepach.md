---
title: Wymagania analytics w sklepach
...
aligned_by: codex
---
# Wymagania analytics w sklepach
...
Wymagania analityki w sklepach stacjonarnych.
...
1. Dane: POS, footfall, heatmap.
2. Metryki: konwersja, AOV, queue times.
3. Prywatność (CCTV, wi-fi).
4. Dashboardy i alerty.
5. Integracje z CRM/OMS.
6. SLA danych.
...
- [ ] Dane/metryki zdefiniowane.
- [ ] Prywatność uwzględniona.
- [ ] Dashboardy/alerty zaplanowane.
- [ ] Integracje/SLA opisane.
