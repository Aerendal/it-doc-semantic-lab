...
1. Scenariusze: host/region/network.
2. Metryki: czas przełączenia, utrata danych.
3. Runbook i automaty.
4. Testy regularne i chaos.
5. Raport i wnioski.
6. Plan usprawnień.
...
- [ ] Scenariusze failover pokryte.
- [ ] Metryki/utrata danych zmierzone.
- [ ] Runbook/automaty działają.
- [ ] Raport i usprawnienia zapisane.
