---
title: Metryki zaangażowania fanów
...
Zdefiniować metryki mierzące zaangażowanie fanów w produkt/serwis (np. broadcast, aplikacja second-screen, grywalizacja).
...
1. Aktywność: MAU/DAU, czas w aplikacji/sesja, liczba interakcji na użytkownika.
2. Udział w funkcjach: głosowania/polle, quizy, czat, leaderboard, nagrody/redemptions.
3. Jakość doświadczenia: latency eventów live, błędy, porzucenia, satisfaction/NPS fanów.
4. Viralność i społeczność: udostępnienia, zaproszenia, referral rate, UGC.
5. Monetyzacja związana z engagement: ARPU z funkcji angażujących, konwersje kampanii, CTR.
6. Raportowanie: segmentacja (wydarzenie, region, platforma), trendy, alerty spadków.
...
- [ ] Kluczowe interakcje fanów mierzone i segmentowane.
- [ ] Latency/błędy funkcji live monitorowane.
- [ ] Viralność/referral i monetyzacja powiązane z engagement raportowane.
- [ ] Alerty na spadki zaangażowania skonfigurowane.
