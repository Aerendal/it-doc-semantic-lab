...
Raportować status zgodności (kontrolki, audyty, luki, działania) w ustalonym cyklu.


## Zakres i granice

- Obejmuje: stan kontrolek, wyniki audytów, luki, działania naprawcze, KPI compliance.
- Poza zakresem: szczegółowe wdrożenia kontrolek.
...
- Raport statusu
- Lista blokujących luk
- Postęp działań
- Powiązania do audytów
...
- [ ] Dashboard/audyty dane zebrane
- [ ] Lista luk/działań aktualna
- [ ] KPI compliance zdefiniowane
...
- Luki High/Med
- Procent działań zamkniętych
- On-time audyty/testy
- Trend KPI compliance
