...
Zasady alokacji zasobów (ludzi/IT).
...
1. Priorytety i portfel inicjatyw.
2. Model alokacji: capacity, role, timeboxing.
3. Proces: wnioski, decyzje, przeglądy.
4. Konflikty i eskalacje.
5. Monitoring: wykorzystanie, efekty.
6. Zmiany i rebalans.
...
- [ ] Priorytety i model alokacji zdefiniowane.
- [ ] Proces i eskalacje opisane.
- [ ] Monitoring wykorzystania działa.
- [ ] Rebalans ma zasady.
