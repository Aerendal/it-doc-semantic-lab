...
Zaplanować testy wydajności (load/stress/spike/soak) dla systemu.


## Zakres i granice

- Obejmuje: scenariusze, dane, cele SLO, narzędzia, harmonogram, kryteria akceptacji.
- Poza zakresem: szczegóły implementacji fixów.
...
- Skrypty load
- Raporty wyników
- Powiązania do capacity/rate limiting
...
- [ ] SLO i profil ruchu zebrane
- [ ] Ścieżki krytyczne zdefiniowane
- [ ] Środowiska/narzędzia gotowe
- [ ] Dane syntetyczne przygotowane
