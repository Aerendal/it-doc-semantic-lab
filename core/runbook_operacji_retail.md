...
Runbook operacji IT/operacyjnych w retail.
...
1. Otwarcie/zamknięcie dnia.
2. POS/Płatności: kontrole, fallback.
3. Inventory i dostawy.
4. Incydenty sklepowe: sieć, urządzenia.
5. Raporty dzienne.
6. Eskalacje i wsparcie.
...
- [ ] Checklisty otwarcia/zamknięcia są.
- [ ] Fallback POS/płatności opisany.
- [ ] Raporty dzienne działają.
- [ ] Eskalacje i wsparcie zdefiniowane.
