...
Zapewnić kompletną referencję API (endpointy, schematy, przykłady) dla deweloperów.


## Zakres i granice

- Obejmuje: opisy endpointów, parametry, typy danych, przykłady, błędy, auth, rate limiting.
