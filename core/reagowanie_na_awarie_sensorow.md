---
title: Reagowanie na awarie sensorów
...
Obsłużyć awarie pojedynczych sensorów.
...
1. Detekcja: brak danych, wartości nierealne, alerty kalibracji.
2. Triage: typ sensora, lokalizacja, wpływ.
3. Stabilizacja: przełączenie na redundancję, estymacja, filtrowanie.
4. Serwis: inspekcja, czyszczenie, wymiana, kalibracja.
5. Rejestr: log zdarzenia, numer sensora, przyczyna.
6. Post-action: test, przywrócenie do systemu, aktualizacja progów.
...
- [ ] Sensor/obszar zidentyfikowany, wpływ oceniony.
- [ ] Dane zastępcze lub redundancja aktywowana.
- [ ] Sensor naprawiony/wymieniony i skalibrowany.
- [ ] Log i progi zaktualizowane.
