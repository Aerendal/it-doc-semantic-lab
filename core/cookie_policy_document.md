...
Opisać politykę zarządzania plikami cookie i podobnymi technologiami śledzenia na platformach cyfrowych organizacji — zgodnie z wymaganiami RODO Art. 5-7 (zgoda), ePrivacy Directive oraz wymaganiami przejrzystości platform. Polityka informuje użytkowników o typach plików cookie (niezbędne, analityczne, marketingowe), celach przetwarzania, sposobach zarządzania zgodą i czasie retencji.
