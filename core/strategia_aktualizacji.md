...
Strategia aktualizacji oprogramowania/usług.
...
2. Kanały release (canary/staged).
3. Zależności i okna serwisowe.
...
- [ ] Cykle i kanały release zdefiniowane.
- [ ] Rollback/okna serwisowe opisane.
