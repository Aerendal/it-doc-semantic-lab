...
Plan testów wydajności aplikacji mobilnych.
...
1. Profile obciążenia i scenariusze (cold/warm start, scroll, offline).
2. Metryki: czas startu, FPS/jank, zużycie CPU/RAM/bateria.
3. Urządzenia/OS matrix.
4. Narzędzia i automatyzacja.
5. Raport i progi.
6. Regresje i monitorowanie po release.
...
- [ ] Matrix urządzeń ustalony.
- [ ] Automatyzacja działa.
- [ ] Raport/progi/regresje przygotowane.
