---
title: Penetration Testing Schedule
...
Ustalić harmonogram i zakres cyklicznych pentestów dla systemu/API.


## Zakres i granice

- Obejmuje: częstotliwość, scope, okna testowe, środowiska, koordynację z release, retest.
- Poza zakresem: wykonanie pojedynczych testów.
...
- Releases/zmiany
- Ryzyka/systemy krytyczne
- Budżet i vendorzy


## Wyjścia

- Harmonogram pentestów
- Scope per cykl
- Okna testowe/komunikacja
- Powiązania do SLA napraw
