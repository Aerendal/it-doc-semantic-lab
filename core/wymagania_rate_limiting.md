...
Wymagania rate limiting API/usług.
...
1. Zakres i cele (ochrona, QoS).
2. Polityki: per user/IP/key, burst.
3. Bezpieczeństwo i nadużycia.
4. Komunikacja klienta (kody, retry).
...
- [ ] Polityki/zasięg opisane.
- [ ] Bezpieczeństwo/klient komunikacja ujęte.
- [ ] Monitoring/testy zaplanowane.
- [ ] Rollout zdefiniowany.
