---
title: Reagowanie na dekoherencję
...
Postępować przy dekoherencji w eksperymentach kwantowych.
...
1. Detekcja: spadek fidelności, wzrost błędów, T1/T2.
2. Triage: który qubit/układ, warunki środowiskowe.
3. Stabilizacja: powtórzenie kalibracji, reset, skrócenie obwodów.
4. Analiza: źródła szumu, cross-talk, drift kalibracji.
5. Działania: lepsze ekranowanie, korekcja błędów, zmiana parametrów.
6. Dokumentacja: wyniki, logi, wpływ na eksperymenty.
...
- [ ] Dekoherencja potwierdzona pomiarami.
- [ ] Kalibracja/mitigacje wykonane.
- [ ] Parametry/obwody dostosowane; wyniki poprawiły fidelność.
- [ ] Zmiany udokumentowane dla kolejnych eksperymentów.
