---
title: Procedury maintenance POS
...
Opisać utrzymanie systemów POS, aby zapewnić dostępność, bezpieczeństwo i zgodność płatności.
...
1. Zakres: terminale/hardware, wersje softu, sieć, peryferia (drukarki/skanery/pinpad).
2. Harmonogram: aktualizacje soft/firmware, przeglądy sprzętu, czyszczenie, testy transakcyjne.
3. Bezpieczeństwo: PCI, rotacja kluczy, hardening, logi, kontrola fizyczna.
4. Monitoring: uptime, błędy płatności, offline mode usage, sieć (latency/loss).
5. Procedury awarii: rollback, przełączenie do offline, wsparcie helpdesk, części zamienne.
6. Dokumentacja: checklisty, log maintenance, raporty sklepów, audyty.
...
- [ ] Harmonogram aktualizacji i testów transakcyjnych utrzymywany.
- [ ] Bezpieczeństwo (PCI/klucze/logi/fizyczne) włączone.
- [ ] Monitoring uptime/błędów/offline i procedury awarii przygotowane.
- [ ] Logi maintenance/audyty prowadzone.
