...
## Cel dokumentu
SLI/SLO/SLA Design opisuje docelową architekturę/projekt wraz z trade-offami i kryteriami akceptacji.
...
- Zależność: {'depends_on': 'SLO/SLI Training', 'type': 'REQUIRES'}
