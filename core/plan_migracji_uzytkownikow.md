---
title: Plan migracji użytkowników
...
Przeprowadzić migrację kont/użytkowników między systemami/IdP, zapewniając spójność dostępu i minimalny wpływ na użytkowników.
...
1. Zakres: populacje, atrybuty, grupy/role, aplikacje zależne.
2. Przygotowanie: mapping atrybutów, czyszczenie danych, testy pilota, okna zmian.
3. Migracja: batchy, SCIM/bulk import, hasła/klucze, MFA, komunikacja do użytkowników.
4. Walidacja: loginy/SSO, uprawnienia, aplikacje krytyczne, audit logi.
5. Rollback i wsparcie: warunki, helpdesk, instrukcje resetu, monitoring błędów logowania.
6. Po migracji: cleanup starych kont, recertyfikacja, dokumentacja, lessons learned.
...
- [ ] Mapping atrybutów/rol gotowy; pilotaż migracji wykonany.
- [ ] Batch migracji zaplanowany; komunikacja do użytkowników wysłana.
- [ ] Walidacja logowania/SSO/uprawnień po migracji potwierdzona.
- [ ] Rollback/support i cleanup starych kont zabezpieczone.
