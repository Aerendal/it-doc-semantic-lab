---
title: Dashboard metryk wydajności
...
Zaprojektować dashboard wydajności systemu/aplikacji: latencja, throughput, błędy, zasoby.
...
1. Metryki główne: p50/p95/p99 latencja, error rate, throughput/QPS.
2. Zasoby: CPU/RAM/IO/network, GC, pod/instance count.
3. Segmentacja: endpoint/serwis, region, release, klient.
4. Alerty: progi SLO/budżet błędów, regresje.
5. Drill‑down: trace/log correlation, top slow ops/queries.
6. Trendy i porównania release.
...
- [ ] Alerty SLO/budżet błędów ustawione.
- [ ] Drill‑down do trace/logów działa.
- [ ] Trendy release dostępne.
