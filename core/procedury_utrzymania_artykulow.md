---
title: Procedury utrzymania artykułów
...
aligned_by: codex
---
# Procedury utrzymania artykułów
...
Utrzymywać aktualność i spójność artykułów (KB, katalog produktowy, treści pomocowe).
...
1. Katalog i właściciele: przypisanie właściciela treści, SLA aktualizacji, klasyfikacja tematyczna.
2. Cykl życia: tworzenie, review, publikacja, wersjonowanie, wycofanie/archiwizacja.
3. Jakość treści: szablony, styl językowy, linki powiązane, multimedia, dostępność.
4. Lokalizacja: języki, workflow tłumaczeń, śledzenie zmian źródła vs tłumaczeń.
5. SEO/wyszukiwalność: słowa kluczowe, metadane, testy trafności wyszukiwania.
6. Monitoring i wskaźniki: CTR, czas na stronie, feedback użytkowników, defekty treści.
...
- [ ] Każdy artykuł ma właściciela, datę ostatniego review i status.
- [ ] Szablon i styl zgodny z wytycznymi; linki i media działają.
- [ ] Tłumaczenia zsynchronizowane ze źródłem lub oznaczone do aktualizacji.
- [ ] Artykuły zbierają feedback i są planowane do kolejnych przeglądów.
