---
title: Compliance Material Design 3
...
Zweryfikować zgodność aplikacji z Material Design 3: komponenty, układ, motywy, dostępność.
...
1. Kolorystyka i theming (MD3 tokens, dynamic color).
2. Typografia i siatka (type scale, layout grid).
3. Komponenty MD3 (buttons, cards, fab, nav bar) – użycie i stany.
4. Motion i interakcje (elevation, transitions).
5. Accessibility (contrast, touch targets, focus).
6. Ikony i obrazy (shape, rounding).
...
- [ ] Motyw/kolory MD3, dynamic color.
- [ ] Komponenty/stany zgodne z MD3.
- [ ] Typografia/spacing/ikonografia dopasowane.
- [ ] A11y: kontrast, focus, targets.
