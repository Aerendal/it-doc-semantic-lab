...
Konfiguracja Unity Catalog (Databricks).
...
1. Hierarchia metastore/catalog/schema.
2. Uprawnienia i ACL.
3. Klasyfikacja danych i masking.
4. Integracje z IdP/KMS.
5. Audyt i logi.
6. Migracja i testy.
...
- [ ] Hierarchia i ACL zdefiniowane.
- [ ] Masking/klasyfikacja ustawione.
- [ ] Integracje IdP/KMS działają.
- [ ] Audyt/migracja przetestowane.
