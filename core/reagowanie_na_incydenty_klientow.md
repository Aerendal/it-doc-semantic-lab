---
title: Reagowanie na incydenty klientów
...
aligned_by: codex
---
# Reagowanie na incydenty klientów
...
Obsłużyć incydenty zgłoszone przez klientów.
...
1. Przyjęcie zgłoszenia: kanał, dane klienta, severity.
2. Triage: wpływ, SLA, kategoria.
3. Działania: obejście, eskalacja techniczna, update statusu.
4. Komunikacja: ETA, status page, dedykowany opiekun.
5. Rozwiązanie: fix, walidacja z klientem.
6. Zamknięcie i postmortem: przyczyna, lekcje, zapobieganie.
...
- [ ] SLA i severity przypisane; klient ma kontakt.
- [ ] Działania i status udokumentowane.
- [ ] Rozwiązanie potwierdzone z klientem.
