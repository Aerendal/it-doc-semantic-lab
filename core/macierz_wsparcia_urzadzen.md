---
title: Macierz Wsparcia Urządzeń
...
Określić poziomy wsparcia (support matrix) dla urządzeń/sprzętu/OS, by komunikować kompatybilność i EOL.
...
1. Zakres: modele urządzeń, wersje OS/FW, regiony.
2. Poziomy wsparcia: full, limited, deprecated, unsupported; definicje i kryteria.
3. Macierz: urządzenie × OS/FW × region × data wsparcia/EOL.
4. Wymagania minimalne: RAM/CPU, funkcje, zależności (app wersja, API level).
5. Polityka zmian: ogłaszanie deprecacji, grace period, komunikacja do klientów.
6. Źródła prawdy i publikacja: gdzie utrzymywana (repo/portal), częstotliwość aktualizacji.
...
- [ ] Macierz obejmuje urządzenia/OS/FW/regiony z datami wsparcia/EOL.
- [ ] Poziomy wsparcia i kryteria jasne; wymagania minimalne podane.
- [ ] Proces ogłaszania deprecacji i aktualizacji macierzy opisany.
- [ ] Miejsce publikacji i częstotliwość aktualizacji ustalone.
