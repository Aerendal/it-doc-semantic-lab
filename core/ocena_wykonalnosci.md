...
Sprawdzić, czy planowane przedsięwzięcie jest wykonalne technicznie, biznesowo i organizacyjnie.
...
1. Zakres i cele: co ma być dostarczone, KPI sukcesu.
2. Aspekt techniczny: architektura wstępna, wymagania, prototyp/POC, ryzyka techniczne.
3. Aspekt biznesowy: wartość, koszty, ROI/TCO, alternatywy.
4. Aspekt organizacyjny: zasoby, kompetencje, harmonogram, zależności.
5. Ryzyka i blokery: listy, prawdopodobieństwo/impact, mitigacje.
6. Rekomendacja: Go/No-Go/Refine, następne kroki.
...
- [ ] Zakres i KPI jasno określone.
- [ ] Ocena techniczna/biznesowa/organizacyjna wykonana.
- [ ] Ryzyka i mitigacje opisane.
- [ ] Rekomendacja i następne kroki zapisane.
