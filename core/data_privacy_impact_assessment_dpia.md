...
## Cel dokumentu
Krótka definicja: Data Privacy Impact Assessment (DPIA) opisuje cel, rolę w procesie decyzyjnym oraz ryzyka, które dokument ma ograniczać (co najmniej w 2–3 zdaniach).
...
- Opis przedsięwzięcia i przepływów danych: cele, zakres, systemy, mapy danych (źródła → przetwarzanie → odbiorcy → lokalizacje).
- Charakter danych i ryzyka: kategorie PII/PHI, dane wrażliwe, dzieci, profilowanie, zautomatyzowane decyzje, transfery transgraniczne.
- Analiza konieczności i proporcjonalności: podstawa prawna, minimum necessary, okres retencji, privacy by design/default.
- Ocena ryzyka dla osób: zagrożenia, prawdopodobieństwo/impact, środki techniczne/procesowe (kontrolki).
- Konsultacje: DPO, interesariusze, ewentualne konsultacje z organem.
- Plan działań i śledzenie: luki, właściciele, terminy, status; re-evaluacja po zmianach.
- Podsumowanie: wnioski, akceptacja ryzyka/waivery, rekomendacje.

## Wymagane rozwinięcia
- Mapy danych rozwijają: Data Inventory/ROPA, Architecture/Data Flow Diagrams.
- Ryzyka rozwijają: Threat Model (dane), Security Controls, Retention/Deletion Policy.
- Plan działań rozwija: CAPA/Remediation Plan, Change Management.

## Wymagane streszczenia
- Streszczenie kluczowych ryzyk dla osób i planu mitigacji (top 5), plus decyzja „czy DPIA wymaga konsultacji z organem”.
...
- DoR:
  - [ ] Mapy przepływów danych i kategorie danych dostępne.
  - [ ] Podstawa prawna, retencja, odbiorcy/transfery zidentyfikowane.
  - [ ] DPO i właściciele biznes/tech wyznaczeni.
- DoD:
  - [ ] Ocena ryzyka dla osób zrobiona; środki mitigacji przypisane i zaplanowane.
  - [ ] Plan działań/CAPA z terminami; decyzja o konsultacji z organem podjęta i udokumentowana.
  - [ ] DPIA zatwierdzone/zaakceptowane lub odnotowane wyjątki; dokument wersjonowany i udostępniony.
