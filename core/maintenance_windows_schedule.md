---
title: Maintenance Windows Schedule
...
Maintenance Windows Schedule określa harmonogram, zakres i odpowiedzialności, aby dowieźć rezultat w kontrolowany sposób.
...
- Zależność: {'depends_on': 'User and Group Management Design', 'type': 'INFORMED_BY'}
- Zależność: {'depends_on': 'System Architecture Design', 'type': 'INFORMED_BY'}
