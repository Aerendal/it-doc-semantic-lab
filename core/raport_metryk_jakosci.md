...
Zestawić metryki jakości produktu/procesu.
...
1. Zakres: produkt/proces, okres, źródła danych.
2. Metryki: defekty, DPMO, first pass yield, escapes, SLA.
3. Trend i cel: targety, tolerancje, sezonowość.
4. Pierwotne przyczyny: pareto defektów, moduły, typy błędów.
5. Działania: plany poprawy, właściciele, status.
6. Wnioski: wpływ na klienta, rekomendacje.
...
- [ ] Metryki są zdefiniowane i zweryfikowane ze źródłami.
- [ ] Pareto defektów wskazuje priorytety.
- [ ] Działania naprawcze mają właścicieli i status.
- [ ] Cele i trend są widoczne; rekomendacje z datami.
