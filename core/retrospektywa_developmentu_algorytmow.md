---
title: Retrospektywa developmentu algorytmów
...
aligned_by: codex
---
# Retrospektywa developmentu algorytmów
...
Retrospektywa pracy nad algorytmami/modelami.
...
1. Cele sprintu/projektu.
2. Co poszło dobrze (dane, wyniki).
3. Problemy: dane, pipeline, deployment.
4. Eksperymenty: co zadziałało/nie.
5. Proces: code review, reproducibility.
6. Akcje: backlog, ulepszenia procesu.
...
- [ ] Cele i wyniki zestawione.
- [ ] Problemy i eksperymenty opisane.
- [ ] Proces i reproducibility ocenione.
- [ ] Akcje i właściciele zapisani.
