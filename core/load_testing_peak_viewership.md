---
title: Load Testing (Peak Viewership)
...
## Cel dokumentu
Load Testing (Peak Viewership) definiuje strategię i zakres testów wraz z kryteriami akceptacji i raportowaniem defektów.
