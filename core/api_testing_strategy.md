...
Określić strategię testowania API (poziomy, typy, narzędzia) spójną z ryzykiem i SLO.


## Zakres i granice

- Obejmuje: podział testów (unit/contract/integration/perf/security), priorytety ścieżek, dane testowe, automatyzację, kryteria zaliczenia.
- Poza zakresem: testy UI.
...
- Strategia i piramida testów
- Plan danych testowych
- Kryteria zaliczenia (DoR/DoD)
- Powiązania do runbooków/monitoringu
...
- [ ] Ryzyka i SLO zmapowane
- [ ] Spec i ścieżki krytyczne zebrane
- [ ] Środowiska/narzędzia dostępne
- [ ] Plan danych testowych wstępny


## Kryteria DoD

- [ ] Strategia i piramida spisane
- [ ] Kryteria zaliczenia zdefiniowane
...
- Flaki w testach vs prod incydenty
- Czas cyklu testów
