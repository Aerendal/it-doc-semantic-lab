---
title: Reagowanie na detekcję oszustwa
...
aligned_by: codex
---
# Reagowanie na detekcję oszustwa
...
Postępować po wykryciu potencjalnego oszustwa.
...
1. Detekcja: reguły, modele, zgłoszenia; typ oszustwa.
2. Triage: ryzyko, kwota, dotknięci klienci.
3. Działania natychmiastowe: blokada kont/tras, wstrzymanie transakcji.
4. Śledztwo: logi, dane, korelacje, potwierdzenie.
5. Remediacja: zwroty, korekty, poprawa reguł/modeli.
6. Raportowanie: compliance, regulator, klient, postmortem.
...
- [ ] Oszustwo potwierdzone/obalone na danych.
- [ ] Blokady i zabezpieczenia zastosowane.
- [ ] Zwroty/korekty wykonane; klient poinformowany.
- [ ] Reguły/model zaktualizowane; raport zapisany.
