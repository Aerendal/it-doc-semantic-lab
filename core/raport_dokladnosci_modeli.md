---
title: Raport dokładności modeli
...
Raportować dokładność i stabilność modeli ML/AI.
...
1. Zakres modeli: wersje, cele, właściciele.
2. Metryki: accuracy/precision/recall/F1/ROC, kalibracja, koszt błędów.
3. Segmentacja: per segment/region/dataset/time.
4. Drift i stabilność: zmiany danych, concept drift, alerty.
5. Eksperymenty: A/B, shadow, różnice metryk.
6. Wnioski: rekomendacje, retraining, ryzyka.
...
- [ ] Metryki obliczone na aktualnych danych z segmentacją.
- [ ] Drift monitorowany; alerty działają.
- [ ] Eksperymenty udokumentowane; decyzje podjęte.
- [ ] Rekomendacje i plan retrainingu są przypisane.
