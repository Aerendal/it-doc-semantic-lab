...
Sprawdzić zachowanie systemu poza zakładanym obciążeniem, aby zidentyfikować punkty awarii i strategię odzysku.


## Zakres i granice

- Obejmuje: scenariusze przekraczające SLA (ruch, dane), degradację kontrolowaną, monitorowanie, kryteria zatrzymania, recovery/rollback.
- Poza zakresem: optymalizacje po testach.
...
- Profil ruchu i limity
- Środowisko testowe
- Narzędzia load/fault injection
- Runbook awarii
...
- Plan testów stress
- Wyniki i punkty awarii
- Rekomendacje i runbook update
- Checklisty DoR/DoD
