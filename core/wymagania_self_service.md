...
Wymagania funkcji self-service.
...
1. Use case i role.
2. Funkcje: reset hasła, status, zgłoszenia.
3. Dostępność i UX.
...
- [ ] Use case/role zdefiniowane.
- [ ] Funkcje/UX opisane.
- [ ] Bezpieczeństwo/metryki uwzględnione.
- [ ] Integracje/SLA określone.
