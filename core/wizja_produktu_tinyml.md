...
Wizja produktu opartego na TinyML.
...
1. Use case i wymagania edge (latencja, energia).
2. Sprzęt i modele.
3. Pipeline deploy/OTA.
...
- [ ] Use case/edge wymagania opisane.
- [ ] Sprzęt/modele/pipeline zdefiniowane.
- [ ] Bezpieczeństwo/monetyzacja uwzględnione.
