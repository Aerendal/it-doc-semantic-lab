...
Zaplanować proces zamówień (zakupy/procurement), by zapewnić terminowe dostawy, kontrolę kosztów i zgodność.
...
1. Zakres i kategorie: sprzęt/soft/usługi, progi, tryby zakupu.
2. Harmonogram i zapotrzebowanie: forecast, cykle zamówień, priorytety.
3. Dostawcy i umowy: lista preferowanych, SLA, warunki płatności, compliance.
4. Proces i role: wnioski, akceptacje, PO, odbiory, faktury; RACI.
5. Kontrola i ryzyka: budżet, limity, segregacja obowiązków, audyt, alternatywy dostawców.
6. Monitorowanie: lead time, OTIF, koszty, reklamacje; raporty okresowe.
...
- [ ] Forecast i priorytety zamówień zdefiniowane.
- [ ] Dostawcy/SLA/umowy i akceptacje ustawione.
- [ ] Budżet/limity i segregacja obowiązków kontrolowane.
- [ ] Raporty OTIF/koszty i reklamacje monitorowane.
