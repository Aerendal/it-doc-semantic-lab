---
title: Bezpieczeństwo sieci w sklepach
...
aligned_by: codex
---
# Bezpieczeństwo sieci w sklepach
...
Zabezpieczyć sieć w punktach sprzedaży (retail): oddzielenie klientów/IoT/POS, kontrola dostępu, monitoring, aktualizacje i zgodność (np. PCI).


## Zakres i granice

- Obejmuje: segmentację (VLAN/SSID), izolację POS/IoT/guest Wi-Fi, firewalle, NAC, mTLS/VPN do centrali, aktualizacje urządzeń, monitoring, logowanie, PCI wymagania.
- Nie obejmuje: polityk HR ani fizycznego bezpieczeństwa sklepu.
...
1. Topologia i segmentacja (POS, zaplecze, IoT, goście).
2. Dostęp i uwierzytelnianie (WPA3/802.1X, NAC, VPN).
3. Aktualizacje i hardening urządzeń (AP/switche/POS).
4. Monitoring i logi (IDS/IPS, syslog, alerty).
5. Zgodność (PCI, data privacy), procedury audytu.
...
- [ ] Segmentacja VLAN/SSID i izolacja POS/IoT/guest.
- [ ] VPN/mTLS do centrali, 802.1X/NAC.
- [ ] Aktualizacje/hardening urządzeń.
- [ ] Monitoring/IDS i logi działają.
- [ ] PCI/audyt przygotowany.
