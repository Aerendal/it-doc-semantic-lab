...
1. Profile VM: rozmiary, CPU/RAM/IO.
2. Use case per profil.
3. Bezpieczeństwo: obraz, hardening, agent.
4. Tagi/koszty i lokalizacje.
5. Monitoring/backup.
6. Proces zamawiania i zmian.
...
- [ ] Profile i use-case opisane.
- [ ] Hardening/agent zdefiniowane.
- [ ] Monitoring/backup ustawione.
- [ ] Proces zmian udokumentowany.
