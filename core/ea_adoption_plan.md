...
## Cel dokumentu
EA Adoption Plan określa harmonogram, zakres i odpowiedzialności, aby dowieźć rezultat w kontrolowany sposób.
...
- Zależność: {'depends_on': 'Compliance Architecture Framework', 'type': 'INFORMED_BY'}
- Zależność: {'depends_on': 'Enterprise Security Architecture', 'type': 'INFORMED_BY'}
