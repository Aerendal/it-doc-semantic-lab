---
title: Referencja dostępu do aplikacji
...
aligned_by: codex
---
# Referencja dostępu do aplikacji
...
Standardy dostępu do aplikacji (IAM).
...
1. Modele: RBAC/ABAC, role, atrybuty.
2. Autoryzacja: OAuth/OIDC/SAML, sesje, timeouts.
3. Provisioning: IdP, SCIM, JML.
4. Dostęp uprzywilejowany: PIM/PAM, elevation, audyt.
5. Kontrole bezpieczeństwa: MFA, polityki haseł/kluczy.
6. Logi i zgodność: audyt, SoD, recertyfikacje.
...
- [ ] Role/ABAC opisane; MFA wymagane.
- [ ] Provisioning/deprovisioning zautomatyzowane.
- [ ] PIM/PAM i SoD ujęte; logi audytowe.
- [ ] Proces recertyfikacji zdefiniowany.
