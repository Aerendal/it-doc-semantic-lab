...
Dostarczyć listę kontrolną do prowadzenia incydentów (technicznych/biznesowych) krok po kroku, z dowodami i decyzjami.


## Zakres i granice

- Obejmuje: warunki wejścia, klasyfikację/severity, triage, działania C/E/R, komunikację, dowody, eskalacje, zamknięcie i postmortem trigger.
- Poza zakresem: szczegółowe runbooki dla konkretnych typów incydentów (opisane osobno).
...
- Alerty/zgłoszenia, matryca severity, polityka IR, lista kontaktów/runbooków.


## Wyjścia

- Wypełniona checklist z dowodami i decyzjami.
- Action log i komunikacja.
- Trigger postmortem i raport.
...
- regulatory_incident_reporting.md
- service_incident_postmortem.md
- high_error_rate_incident_response.md
- logging_and_audit_trail.md


## Wymagane rozwinięcia / streszczenia

- Tabela checklisty z polami: krok → status → dowód → owner → czas.
- Streszczenie decyzji i wpływu.


## Wymagane powiązania

- Polityka IR, matryca severity, runbooki tematyczne, kanały komunikacji, audyt/logi.


## Kryteria DoR

- [ ] Matryca severity, kontakty i runbooki dostępne.
- [ ] Kanały komunikacji/eskalacji znane.
- [ ] Formularz checklisty przygotowany.


## Kryteria DoD

- [ ] Checklist wypełniona; dowody i decyzje zapisane.
- [ ] Action log i komunikacja zrealizowane.
- [ ] Postmortem trigger dodany; quick-links/checklisty zaktualizowane.


## Artefakty do załączenia

- Checklist (MD/CSV/forma), logi/dowody.
- Action log i komunikaty.
- Link do postmortem.


## Walidacja / testy

- Test użycia checklisty na scenariuszu; peer review.
- Weryfikacja kompletności dowodów/logów.


## Metryki monitorowane

- % incydentów z kompletną checklistą.
- Czas wypełnienia kluczowych kroków; liczba brakujących dowodów.


## Utrzymanie i aktualizacje

- Przegląd checklisty po incydentach i cyklicznie (np. kwartalnie).
- Aktualizuj kroki po zmianach w runbookach/procesach.


## Zakończenie

Po spełnieniu DoD podlinkuj artefakty, odhacz checklisty w `reports/checklist_atomic.jsonl` i udostępnij zespołom IR/SRE.
