...
Vendor Evaluation Matrix — szablon dokumentu IT.
...
Ten szablon jest zgodny ze standardem **ISO/IEC 25040**.
...
- Zależność: {'depends_on': 'Test Plan', 'type': 'REFERENCES'}
- Zależność: {'depends_on': 'QA Test Plan', 'type': 'REFERENCES'}
- Zależność: {'depends_on': 'Test Plan', 'type': 'REFERENCES'}
