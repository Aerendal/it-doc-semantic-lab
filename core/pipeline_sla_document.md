...
Określić SLA/SLO dla pipeline’u danych/przetwarzania i sposób ich monitorowania.
...
1. Zakres: ścieżki danych, joby, konsumenci, środowiska.
2. SLO/SLA: dostępność, opóźnienie (latency/lag), świeżość danych, dokładność/kompletność, RPO/RTO.
3. Metryki i pomiar: definicje, narzędzia, wzory, okna obliczeń, error budget.
4. Alerty i eskalacje: progi, kanały, on-call, reakcje.
5. Raportowanie: dashboardy, cykl przeglądów, wyjątki, zgody na naruszenia.
6. Zmiany: procedura zmiany SLO, wersjonowanie, komunikacja.
...
- [ ] SLO/SLA jasno zdefiniowane dla kluczowych ścieżek.
- [ ] Metryki/pomiary i error budget uzgodnione; alerty działają.
- [ ] Raporty i przeglądy regularne; wyjątki dokumentowane.
- [ ] Proces zmiany SLO i komunikacji opisany.
