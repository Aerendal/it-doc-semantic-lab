---
title: Reagowanie na przekroczenie progów błędów
...
aligned_by: codex
---
# Reagowanie na przekroczenie progów błędów
...
Reagować na wzrost błędów ponad progi SLO.
...
1. Detekcja: alerty error rate, segmentacja (endpoint/region).
2. Triage: recent changes vs ruch, krytyczność.
3. Stabilizacja: throttling, feature flag, rollback.
4. Diagnoza: logi, trace, zależności.
5. Naprawa: fix, konfiguracja, scaling.
6. Postmortem: wnioski, tuning progów/alertów.
...
- [ ] Alert potwierdzony; zakres błędów znany.
- [ ] Środki stabilizacyjne wdrożone.
- [ ] Przyczyna naprawiona; error rate spadł.
- [ ] Postmortem i progi zaktualizowane.
