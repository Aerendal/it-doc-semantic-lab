...
Zweryfikować i doprecyzować role w projekcie/produkcie (zakres odpowiedzialności, uprawnienia, udział w decyzjach), żeby uniknąć luk i konfliktów.


## Zakres i granice

- Obejmuje: opis ról, RACI, uprawnienia dostępu, kompetencje wymagane, zależności między rolami.
- Nie obejmuje: szczegółowych ścieżek karier ani polityk HR (osobne dokumenty).
...
- Wejścia: lista ról z projektu/organizacji, struktura zespołu, wymagania bezpieczeństwa (least privilege), RACI z innych dokumentów.
- Wyjścia: zaktualizowana definicja ról, matryca RACI, mapowanie ról na uprawnienia/systemy.
...
- [ ] Każda rola ma opis i granice.
- [ ] RACI kompletne i spójne między dokumentami.
- [ ] Uprawnienia minimalne (least privilege).
- [ ] Zidentyfikowane luki/konflikty ról.
...
- „Opis ról” **defines_structure** „RACI”.
- „Uprawnienia” **constrains** „Dostępy w systemach”.
