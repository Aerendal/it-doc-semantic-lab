...
Opisać szczegółowy projekt architektury oprogramowania (Software Detailed Design Document — SDDD) zgodnie z ISO/IEC 12207 (Software Design Process, SDP.2) i IEEE 1016. Dokument zawiera: dekompozycję architektoniczną na komponenty i moduły, interfejsy, algorytmy, struktury danych, wzorce projektowe, decyzje architektoniczne (ADR) i uzasadnienie — jako wejście do implementacji i testów.
...
3. Widoki: logiczny, procesowy, deployment.
4. Jakość: dostępność, wydajność, bezpieczeństwo.
5. Decyzje architektoniczne (ADR).
6. Plan wdrożenia i ryzyka.
...
- [ ] Cele i założenia opisane.
- [ ] Widoki architektury kompletne.
- [ ] ADR udokumentowane.
- [ ] Plan i ryzyka zdefiniowane.
