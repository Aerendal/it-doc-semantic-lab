---
title: Strategia monitorowania API
...
1. SLI: latencja, błędy, quota.
2. Syntetyki i RUM.
3. Alerty: progi, burn rate.
4. Dashboardy per API/partner.
5. Runbooki i eskalacje.
...
- [ ] SLI i progi zdefiniowane.
- [ ] Syntetyki/RUM działają.
- [ ] Alerty/burn-rate ustawione.
- [ ] Runbooki/raporty dostępne.
