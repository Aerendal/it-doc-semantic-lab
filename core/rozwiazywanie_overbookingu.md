---
title: Rozwiązywanie overbookingu
...
Procedura obsługi overbookingu.
...
1. Detekcja: sygnały z systemów rezerwacji.
2. Priorytety: segmenty klientów, SLA.
3. Opcje: relokacja, upgrade, vouchery.
4. Komunikacja: klient, partner, wewnętrznie.
5. Rozliczenia i raport.
6. Prewencja: prognozy, limity, alerty.
...
- [ ] Overbooking potwierdzony i sklasyfikowany.
- [ ] Opcje rekomendowane z kosztami.
- [ ] Klient poinformowany i obsłużony.
- [ ] Raport i działania prewencyjne zapisane.
