---
title: Harmonogram szkoleń personelu
...
Zaplanować cykl szkoleń dla ról/zespołów, aby zapewnić wymagane kompetencje i zgodność.
...
1. Matryca ról vs kompetencje; wymagane certyfikacje.
2. Kalendarz szkoleń: daty, format (online/on-site), trenerzy, grupa docelowa.
3. Prerekwizyty: materiały, laboratoria, konta dostępowe.
4. Ewaluacja: testy, ankiety, zaliczenia i rejestr obecności.
5. Integracje z HR/LMS: zapisy, przypomnienia, ścieżki rozwojowe.
6. Koszty i blokady operacyjne (kto jest wyłączony z pracy).
...
- [ ] Matryca kompetencji i wymagane certyfikaty zmapowane.
- [ ] Kalendarz szkoleń i grupy docelowe ogłoszone.
- [ ] Materiały i dostępy przygotowane przed terminem.
- [ ] Wyniki i frekwencja rejestrowane w LMS/HR.
