---
title: Wymagania integracji e-commerce
...
aligned_by: codex
---
# Wymagania integracji e-commerce
...
1. Zakres: katalog, ceny, stock, zamówienia.
2. API i webhooki.
3. Autoryzacja i rate limit.
4. Testy i sandbox.
5. Monitoring i retry.
6. SLA/umowy partnerów.
...
- [ ] Zakres/API opisane.
- [ ] Auth/rate limit ustalone.
- [ ] Testy/sandbox dostępne.
- [ ] SLA/monitoring opisane.
