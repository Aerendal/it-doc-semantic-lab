...
Zebrać szablon przewodnika integracyjnego: jak podłączyć się do systemu/usługi, z wymaganiami, przykładami i testami.
...
1. Zakres integracji: use-case, odbiorcy, poziom dostępu.
2. Wymagania wstępne: konta, klucze, certyfikaty, whitelisting, wersje API.
3. Kroki konfiguracji: rejestracja, endpointy, auth, przykładowe żądania/odpowiedzi.
4. Testy i walidacja: sandbox vs. produkcja, checklisty, znane ograniczenia.
5. Bezpieczeństwo i limity: rate limits, podpisy, szyfrowanie, dane wrażliwe.
6. Support i zmiany: kanały wsparcia, wersjonowanie, changelog, SLA.
...
- [ ] Wymagania wstępne i dane dostępowe jasno opisane.
- [ ] Kroki konfiguracji z przykładami request/response działają.
- [ ] Checklisty testów i limity bezpieczeństwa ujęte.
- [ ] Informacje o wsparciu, zmianach i SLA dodane.
