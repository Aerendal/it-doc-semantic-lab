---
title: Reagowanie na awarie serwerów
...
Przywrócić niedziałające serwery fizyczne/wirtualne.
...
1. Detekcja: monitoring HW, zgłoszenia.
2. Triage: krytyczność usług, redundancja.
3. Stabilizacja: przełączenie na zapas, restart, izolacja.
4. Naprawa: hardware, firmware, storage, sieć.
5. Przywrócenie: testy usług, dane, backup.
6. Postmortem: przyczyna, RMA, plan prewencji.
...
- [ ] Usługi przeniesione lub przywrócone.
- [ ] Przyczyna awarii zidentyfikowana i naprawiona.
- [ ] Testy potwierdziły działanie.
- [ ] Postmortem i RMA/plan prewencji zapisane.
