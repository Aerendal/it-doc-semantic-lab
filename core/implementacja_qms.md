...
Wdrożyć system zarządzania jakością (QMS) wspierający normy (np. ISO 9001) i procesy audytowe.
...
1. Zakres procesów jakości: dokumentacja, NCR/CAPA, audyty, ryzyka, kompetencje.
2. Wymagania normatywne i branżowe; mapa procesów do modułów QMS.
3. Konfiguracja i migracja: słowniki, formularze, workflow, uprawnienia.
4. Integracje: ERP/MES/LIMS/HR, rejestry dostawców, szkolenia.
5. Testy i walidacja: UAT, ścieżki audytowe, raporty zgodności.
6. Szkolenia użytkowników, utrzymanie i cykl doskonalenia.
...
- [ ] Procesy jakości zmapowane na moduły i workflow.
- [ ] Wymagania normatywne odzwierciedlone w konfiguracji.
- [ ] Integracje (ERP/MES/LIMS/HR) zaplanowane i przetestowane.
- [ ] Ścieżki audytowe i raporty zgodności zweryfikowane.
