...
## Cel dokumentu
Udokumentować wyniki przeglądu zarządczego systemu zarządzania bezpieczeństwem informacji (ISMS) przez kierownictwo wyższego szczebla, wymagane przez ISO/IEC 27001 klauzula 9.3. Przegląd ocenia skuteczność ISMS, wyniki audytów i incydentów, status działań korygujących, zmiany kontekstu organizacji, postęp celów bezpieczeństwa i decyzje o zasobach — jako wejście do ciągłego doskonalenia ISMS.
