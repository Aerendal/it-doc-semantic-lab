---
title: Formularz zgÅ‚oszenia zmiany
...
Formularz zgłoszenia zmiany — szablon dokumentu IT.

Formalny wniosek o zmianę w systemie lub procesie — opis zmiany, uzasadnienie biznesowe, analiza wpływu (techniczny, operacyjny, bezpieczeństwo), plan wdrożenia, plan rollback i ocena ryzyka.

> Dokument satelitarny do: "Formularz zgłoszenia zmiany" - rozszerza lub uszczegolawia jego tresc.
...
- **Wejścia** (co musi być dostępne przed wypełnieniem): Opis problemu lub potrzeby biznesowej, analiza wpływu na powiązane systemy, wyniki testów w środowisku niższym, szacowanie pracochłonności.
- **Wyjścia** (co dokument wytwarza jako rezultat): Zatwierdzony lub odrzucony wniosek zmiany (z uzasadnieniem CAB), plan wdrożenia zmiany, zaktualizowana dokumentacja.
...
- **Wpływa na** (downstream — co zależy od tego dokumentu): Harmonogram wdrożenia (change window), plan testów regresji, aktualizacje CMDB, powiadomienia dla użytkowników.
- **Zależy od** (upstream — co musi istnieć przed tym dokumentem): Zgłoszenie incydentu lub wymagania nowej funkcjonalności, polityka zarządzania zmianami, harmonogram releaseów.
