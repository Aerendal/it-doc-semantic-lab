---
title: Raport satysfakcji obywateli
...
Raportować satysfakcję obywateli z usług publicznych.
...
1. Zakres usług i kanałów (online/offline).
2. Metryki: NPS/CSAT, czas obsługi, complaint rate.
3. Segmenty: region, grupa społeczna, typ usługi.
4. Feedback: tematy, bariery dostępności, język.
5. Działania: usprawnienia procesowe/techniczne, komunikacja.
6. Monitorowanie: cele, raportowanie do interesariuszy.
...
- [ ] Badanie jest reprezentatywne i opisane.
- [ ] Główne tematy i bariery są zidentyfikowane.
- [ ] Działania mają właścicieli i terminy.
- [ ] Raportowanie do interesariuszy zaplanowane.
