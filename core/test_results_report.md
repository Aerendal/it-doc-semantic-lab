...
Raportować wyniki testów (pass/fail, defekty, pokrycie) dla release/iteracji.


## Zakres i granice

- Obejmuje: metryki pass/fail, defekty, pokrycie, flaky, ryzyka, rekomendacje.
- Poza zakresem: szczegółowe plany napraw.
