...
1. Zakres i centra kosztów.
2. Budżet vs wykonanie.
3. Forecast i scenariusze.
4. Alerty i progi.
5. Raporty.
6. Proces zmian.
...
- [ ] Zakres/koszty zdefiniowane.
- [ ] Forecast/alerty opisane.
- [ ] Raporty dostępne.
- [ ] Proces zmian ustalony.
