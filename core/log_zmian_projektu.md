...
Utrzymywać chronologiczny rejestr zmian w projekcie (scope/harmonogram/budżet/ryzyka) dla transparentności i audytu.
...
1. Format wpisu: data, opis zmiany, obszar (scope/czas/koszt/jakość/ryzyko), powód, zatwierdzający.
2. Źródła zmian: decyzje steering, CR, ustalenia z klientem, odkryte ryzyka.
3. Wpływ: na zakres, terminy, budżet, zasoby, zależności.
4. Status i wdrożenie: planowane/w toku/zakończone, linki do ticketów/planów.
5. Komunikacja: kogo informujemy, kiedy, w jakiej formie.
6. Audyt i archiwum: numeracja wpisów, przechowywanie, raporty okresowe.
...
- [ ] Każdy wpis ma powód, wpływ i zatwierdzającego.
- [ ] Zmiany powiązane z ticketami/planami i komunikacją.
- [ ] Wpływ na zakres/termin/koszt oceniony.
- [ ] Archiwum i numeracja wpisów prowadzone.
