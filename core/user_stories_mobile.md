...
Szablon user stories dla aplikacji mobilnej.
...
1. Story format i Definition of Ready.
2. AC i testy akceptacyjne.
3. NFR mobile (wydajność, offline, bateria).
4. Dane i privacy.
5. Śledzenie w backlogu.
6. Review i refinements.
...
- [ ] Story/AC zgodne z DoR.
- [ ] NFR mobile ujęte.
- [ ] Dane/privacy opisane.
- [ ] Story zlinkowane w backlogu.
