...
Wytyczne doboru formatu tabel (Parquet/Iceberg/Delt).
...
1. Use case: batch/stream, update pattern.
2. Formaty: cechy, compaction, time travel.
3. Koszty i wydajność.
4. Zgodność i narzędzia.
5. Migracja i testy.
6. Rekomendacja i kryteria wyboru.
...
- [ ] Use case i kryteria zdefiniowane.
- [ ] Plusy/minusy formatów opisane.
- [ ] Migracja/testy zaplanowane.
- [ ] Rekomendacja jasna.
