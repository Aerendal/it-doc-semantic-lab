...
Wymagania dla systemów SCADA/ICS.
...
1. Zakres: procesy, stacje, sieci OT.
2. Bezpieczeństwo: segmentacja, kontrole dostępu, monitoring.
3. Niezawodność: redundancja, czas reakcji, UPS.
4. Integracje: PLC, MES/ERP, historian.
5. Dane: sampling, retencja, jakość.
6. Zgodność: normy (IEC 62443), audyt.
...
- [ ] Bezpieczeństwo OT i segmentacja zdefiniowane.
- [ ] Niezawodność i redundancja opisane.
- [ ] Integracje i dane (sampling/retencja) ustalone.
- [ ] Wymagania zgodności/audytu ujęte.
