---
title: Design procesów wsparcia
...
Zaprojektować procesy wsparcia (support): intake, triage, rozwiązywanie, eskalacje, feedback i doskonalenie.
...
1. Intake/kanały i kategoryzacja (sev/priority, typ zgłoszenia).
2. Triage i routing (L1/L2/L3, automaty, playbooki).
3. SLA/OLA i metryki (FCR, MTTR, backlog aging, CSAT).
4. Eskalacje (zgodne z procedurą eskalacji), komunikacja z klientem.
5. Baza wiedzy/playbooki i deflection/self-service.
6. Observability: raporty, przeglądy, ciągłe usprawnianie.
...
- [ ] Kanały/intake i klasyfikacja jasno opisane.
- [ ] Triage/routing i playbooki gotowe.
- [ ] SLA/OLA, FCR/MTTR/CSAT mierzone.
- [ ] Eskalacje i komunikacja standardowa.
- [ ] KB/self-service i raporty/przeglądy działają.
