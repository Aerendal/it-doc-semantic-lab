---
title: Load Testing (Peak Attendance)
...
## Cel dokumentu
Load Testing (Peak Attendance) definiuje strategię i zakres testów wraz z kryteriami akceptacji i raportowaniem defektów.
