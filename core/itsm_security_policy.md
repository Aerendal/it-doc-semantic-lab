...
## Cel dokumentu
Zdefiniować politykę bezpieczeństwa informacji dla środowisk i usług IT — spełniającą wymagania ISO/IEC 27017 (Virtual Environment Security Policy), ISO/IEC 27035 (Information Security Incident Policy), NIS2 Art. 21 (Network and Information Systems Security Policy) i SOC 2 TSC CC6.1 (Logical and Physical Access Controls). Polityka stanowi nadrzędny dokument ISMS określający zasady, role, obowiązki i bazowe kontrole bezpieczeństwa.
