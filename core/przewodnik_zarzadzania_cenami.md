---
title: Przewodnik zarządzania cenami
...
Wytyczne operacyjne do codziennego zarządzania cenami.
...
1. Źródła danych: koszty, konkurencja, kursy walut, podatki.
2. Proces zmian: wnioski, akceptacje, okna publikacji, komunikacja.
3. Promocje: warunki, limity, kupony, anti-abuse, expiracje.
4. Kanały: synchro cenników w WWW/POS/marketplace, testy po publikacji.
5. Monitoring: alerty na anomalie cenowe, marża, wpływ na popyt.
6. Audyt: rejestr zmian, wersjonowanie cenników, raporty.
...
- [ ] Zmiany cen mają źródła danych i akceptacje.
- [ ] Promocje mają limity i daty; komunikacja do kanałów wykonana.
- [ ] Po publikacji brak anomalii; marża monitorowana.
- [ ] Rejestr zmian i wersje cenników aktualne.
