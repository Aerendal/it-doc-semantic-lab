...
1. Architektura: konta, role, warstwy.
2. Bezpieczeństwo: RBAC, maskowanie, network policy.
3. Zasilanie danych: pipelines, staging, COPY.
4. Wydajność i koszty: warehouses, auto-suspend, caching.
5. Observability: query history, alerts.
6. Migracja i testy.
...
- [ ] Role/RBAC i sieć skonfigurowane.
- [ ] Pipelines/testy załadowania wykonane.
- [ ] Warehouses i koszty zoptymalizowane.
- [ ] Monitoring i security polityki aktywne.
