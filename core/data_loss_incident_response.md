---
title: Data Loss Incident Response
...
## Cel dokumentu
Poprowadzić zespół przez reakcję na incydent utraty danych: klasyfikacja, ograniczenie, odzysk, komunikacja i eskalacje.

## Zakres i granice
Obejmuje: klasyfikację incydentu (PII/krytyczne dane), containment, plan odzysku, komunikację, decyzje o zgłoszeniach regulacyjnych, post‑incident review. Nie obejmuje: szczegółowych runbooków technicznych (referencja).

## Wejścia i wyjścia
- Wejścia: zgłoszenie incydentu, rejestr danych/PII, informacje o backupach/snapshotach, polityki zgłoszeń (regulator/klient), monitoring.
- Wyjścia: wykonany IR dla data loss, status odzysku, komunikaty, decyzje o raportowaniu, wejście do postmortem.
...
- Klasyfikacja incydentu i zakres danych
- Containment (wstrzymanie procesów, blokady zapisów)
- Plan odzysku (ścieżka wybrana, RTO/RPO)
- Komunikacja i zgłoszenia (wew./zew./regulator)
- Monitoring post‑recovery i walidacja integralności
- Przekazanie do PIR/Postmortem i follow‑up
