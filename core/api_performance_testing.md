...
Zaplanować i wykonać testy wydajności API, aby zweryfikować SLO i odporność na ruch szczytowy.


## Zakres i granice

- Obejmuje: testy load/stress/spike/soak, scenariusze per kluczowe ścieżki, dane syntetyczne, SLA/SLO, monitorowanie i raportowanie.
- Poza zakresem: testy UI end‑to‑end.
...
- SLO/SLA i profile ruchu
- Lista krytycznych ścieżek
- Dane testowe (syntetyczne)
- Narzędzia load (k6/JMeter/Locust) i monitoring


## Wyjścia

- Plan testów (scenariusze, cele, progi)
- Wyniki i raport z rekomendacjami
- Powiązania do rate limiting i capacity
- Checklisty DoR/DoD
...
- [ ] SLO i profile ruchu zebrane
- [ ] Ścieżki krytyczne zdefiniowane
- [ ] Dane syntetyczne gotowe
- [ ] Narzędzia load/monitoringu dostępne
