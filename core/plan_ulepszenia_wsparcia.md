---
title: Plan ulepszenia wsparcia
...
Usprawnić dział wsparcia (CS/HD), podnosząc SLA/CSAT i efektywność.
...
1. Baseline i cele: SLA (FRT/TTR), CSAT/NPS, backlog, pain points.
2. Procesy: klasyfikacja, routing, eskalacje, knowledge base, deflection, QA.
3. Narzędzia: ticketing/CRM/telefony/chat, integracje, automatyzacje, monitoring jakości.
4. Zespół: staffing/grafik, szkolenia, coaching, QA scoring, wellbeing.
5. Eksperymenty/ulepszenia: pilotaże, boty, zmian flow, KPI obserwowane.
6. Raportowanie: cadence, dashboardy, backlog usprawnień, komunikacja do biznesu.
...
- [ ] Cele SLA/CSAT i problemy zmapowane.
- [ ] Ulepszenia procesów/narzędzi/KB/deflection zaplanowane.
- [ ] Staffing/szkolenia/QA i wellbeing ujęte.
- [ ] Metryki i raportowanie usprawnień działają.
