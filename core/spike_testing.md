...
Zweryfikować reakcję systemu na krótkotrwałe skoki ruchu.


## Zakres i granice

- Obejmuje: krótkie piki RPS/concurrency, warmup/cooldown, metryki latency/errors/throttle, monitoring zasobów, kryteria akceptacji.
- Poza zakresem: długotrwałe obciążenie (soak).
...
- Streszczenie wyników i rekomendacji; rozwinięcia scenariuszy i kryteriów.


## Wymagane powiązania

- Plany/strategie testów, rate limiting, monitoring, runbooki incydentów.


## Kryteria DoR

- [ ] SLO/profil ruchu zebrane
- [ ] Środowisko/narzędzia gotowe
- [ ] Dane/skrpty przygotowane
- [ ] Ownerzy/test lead przypisani


## Kryteria DoD

- [ ] Testy wykonane i udokumentowane
- [ ] Rekomendacje/ownerzy dodane
...
- Sanity smoke przed/po teście; weryfikacja alertów/monitoringu.
...
- Throughput
- Error/throttle rate
- Resource usage/leaks


## Utrzymanie i aktualizacje

- Przegląd po każdym cyklu testów lub release; aktualizacja quick-links/checklist.
