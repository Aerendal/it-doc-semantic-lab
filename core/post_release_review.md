...
## Cel dokumentu
Ocenić przebieg i wynik releasu: czy cele biznesowe/techniczne zostały osiągnięte, jakie były odchylenia, incydenty, jakość, satysfakcja użytkowników, i jakie usprawnienia wprowadzić przed następnymi releasami.

## Zakres i granice
Obejmuje: zakres releasu, metryki jakości/operacyjne, incydenty/rollbacki, feedback użytkowników/CS, efektywność procesu (czas, koszty, zgodność z planem), decyzje follow-up. Nie obejmuje: szczegółowych kroków deploy (Deployment Plan) ani PIR po incydentach (te są osobno).

## Wejścia i wyjścia
- Wejścia: Release Plan, raporty testów, metryki SLO/SLA, log z wdrożenia, incydenty/alerty, ankiety/CSAT, dane biznesowe (np. adopcja, konwersje).
- Wyjścia: raport PRR z wnioskami, lista działań usprawniających (proces/monitoring/automatyzacja), decyzje dot. przyszłych releasów, aktualizacje checklist/procedur.
...
- Zakres releasu i cele (biznes/tech)
- Metryki jakości i operacyjne (SLO/SLA, defekty, MTTR/MTBF, stabilność)
- Przebieg wdrożenia (zgodność z planem, odchylenia, rollbacki)
- Incydenty i problemy podczas/po releasie
- Feedback użytkowników/CS i dane biznesowe
- Wnioski i działania usprawniające (owner, termin)
- Aktualizacje procesów/checklist/automatyzacji
