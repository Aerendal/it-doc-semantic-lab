---
title: Natural Language Query Syntax
...
Natural Language Query Syntax — szablon dokumentu IT.
...
> Dokument satelitarny do: "Natural Language Query Requirements" - rozszerza lub uszczegolawia jego tresc.
