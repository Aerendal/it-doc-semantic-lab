---
title: Procedury uzgadniania danych
...
Zapewnić spójność danych między systemami źródłowymi i docelowymi poprzez cykliczne uzgodnienia.
...
1. Zakres i modele danych: tabele/encje, mapowanie pól, identyfikatory główne.
2. Częstotliwość i okna uzgodnień: batch, near-real-time, okna serwisowe.
3. Reguły dopasowania: klucze główne, fuzzy match, tolerancje różnic, progi akceptacji.
4. Procedury porównania: zapytania kontrolne, checksumy, kontrola sumaryczna i próbki.
5. Obsługa rozbieżności: klasyfikacja (brak/duplikat/rozjazd wartości), ścieżki naprawcze, zgłoszenia.
6. Raportowanie i audyt: logi, raport z wynikami, właściciel akceptacji, retencja danych.
...
- [ ] Mapowanie pól i identyfikatory są udokumentowane i wersjonowane.
- [ ] Harmonogram uzgodnień i progi tolerancji są ustalone i monitorowane.
- [ ] Raport z uzgodnienia zawiera rozbieżności i decyzje naprawcze.
- [ ] Dowody audytowe (logi/raporty) przechowywane zgodnie z polityką.
