...
Przeprowadzić audyt zgodności (regulacja/standard) i udokumentować znaleziska oraz plan remediacji.


## Zakres i granice

- Obejmuje: scope audytu, kontrole, dowody, znaleziska, scoring, plan remediacji, status.
- Poza zakresem: implementacja fixów.
...
- Streszczenie znalezisk i planu remediacji; status kontrolek.


## Wymagane powiązania

- Dokumenty compliance/security/logging; monitoring/testy; status reporty.


## Kryteria DoR

- [ ] Scope audytu uzgodniony
- [ ] Dowody/logi dostępne
- [ ] Ownerzy kontrolek potwierdzeni
- [ ] Harmonogram audytu ustalony


## Kryteria DoD

- [ ] Raport/plan uzupełniony
- [ ] Znaleziska i status wpisane
- [ ] Plan remediacji dodany
...
- Weryfikacja dowodów i scoringu; sanity planu remediacji.
...
- Czas do remediacji
- On-time audyt
- Powtórzenia znalezisk


## Utrzymanie i aktualizacje

- Przegląd wg cyklu audytów; aktualizacja quick-links/checklist i statusów.
