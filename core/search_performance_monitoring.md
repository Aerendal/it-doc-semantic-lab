...
## Cel dokumentu
Search Performance Monitoring definiuje co i jak monitorować, aby wcześnie wykrywać odchylenia i reagować runbookami.
...
- Zależność: {'depends_on': 'Search Operations Runbook', 'type': 'typical'}
- Zależność: {'depends_on': 'Search Operations Runbook', 'type': 'sequential'}
