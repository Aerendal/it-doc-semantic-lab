---
title: Recovery Time Objective Definition
...
Define and document RTO targets and how to meet them.
...
1. Scope and priority: services and tiers.
2. Targets: RTO per service and dependencies.
3. Strategies: DR patterns, standby, runbooks.
4. Testing: DR exercises, measured times.
5. Resources: people, tooling, contracts.
6. Approval/review: sign-off, cadence.
...
- [ ] RTO defined and signed off.
- [ ] Runbooks/DR patterns support targets.
- [ ] Tests confirm or gap to RTO documented.
- [ ] Review cadence set.
