...
## Cel dokumentu
Opisać program zarządzania podatnościami (Vulnerability Management Program) implementujący CIS Control 7 (Continuous Vulnerability Management) z CIS Controls v8. Program definiuje: proces skanowania podatności (scheduled + on-demand), klasyfikację severity (CVSS), priorytety remediacji per Implementation Group (IG1/IG2/IG3), procedury patch management, wyjątki i metryki programu — jako ciągły proces redukcji powierzchni ataku.
