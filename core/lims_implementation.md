...
Wdrożyć Laboratory Information Management System (LIMS) wspierający próbki, wyniki, sprzęt i zgodność regulacyjną.
...
1. Zakres labu: typy testów, matryce, wolumen próbek, regulacje (GLP/ISO).
2. Konfiguracja: słowniki, workflow próbek, numery/etykiety, role i uprawnienia.
3. Integracje: urządzenia lab (instrumenty), ELN, ERP/QMS, raportowanie, podpis elektroniczny.
4. Dane i jakość: śledzenie próbek, traceability, wersjonowanie wyników, walidacja.
5. Bezpieczeństwo i zgodność: audyt, ALCOA, backup, retencja, kalibracje/maintenance.
6. Szkolenia i uruchomienie: UAT, walidacja systemu, SOP, wsparcie po starcie.
...
- [ ] Workflow próbek i role zdefiniowane; słowniki skonfigurowane.
- [ ] Integracje z instrumentami/ERP/QMS i podpis elektroniczny działają.
- [ ] Traceability, audyt i wymagania ALCOA spełnione.
- [ ] UAT/walidacja i szkolenia przeprowadzone; SOP opublikowane.
