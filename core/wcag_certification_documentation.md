---
title: WCAG Certification Documentation
...
aligned_by: codex
---
# WCAG Certification Documentation
...
Dokumentacja do certyfikacji WCAG.
...
1. Zakres stron/aplikacji.
2. Wyniki audytu WCAG.
3. Naprawy i status.
4. Dowody (screens, raporty).
5. Oświadczenia o dostępności.
6. Plan utrzymania.
...
- [ ] Zakres i audyt opisane.
- [ ] Naprawy/status udokumentowane.
- [ ] Dowody dołączone.
- [ ] Plan utrzymania przygotowany.
