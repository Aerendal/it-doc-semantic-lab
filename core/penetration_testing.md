...
Zaplanować i wykonać testy penetracyjne systemu/API w celu wykrycia podatności.


## Zakres i granice

- Obejmuje: scope usług, recon/threat model, testy sieci/app/API, exploit attempts, raportowanie, retest.
- Poza zakresem: fizyczne testy socjotechniczne (oddzielne).
