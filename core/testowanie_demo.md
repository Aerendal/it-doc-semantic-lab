...
1. Zakres funkcji demo.
2. Dane seed/maskowane.
3. Stabilność i reset.
4. Performance pod obciążeniem prezentacji.
5. Security: ograniczenia, konta demo.
6. Checklisty przed demo.
...
- [ ] Zakres/dane demo gotowe.
- [ ] Reset/stabilność przetestowane.
- [ ] Performance i security sprawdzone.
- [ ] Checklisty przed demo odhaczone.
