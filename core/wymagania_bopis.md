...
Wymagania funkcjonalne/niefunkcjonalne BOPIS.
...
1. Use case i zakres.
2. Procesy: zamówienie/pickup/zwrot.
3. Systemy: OMS/POS/inventory.
4. NFR: SLA, dostępność, bezpieczeństwo.
5. Powiadomienia i UX.
...
- [ ] Use case/zakres spisane.
- [ ] Procesy/systemy opisane.
- [ ] NFR i powiadomienia ujęte.
- [ ] Kryteria akceptacji dodane.
