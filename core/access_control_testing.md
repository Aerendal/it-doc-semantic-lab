...
Zaplanować i wykonać testy kontroli dostępu (authz), aby wykryć luki w uprawnieniach.


## Zakres i granice

- Obejmuje: testy pozytywne/negatywne, privilege escalation, horizontal/vertical bypass, misconfig, audyt/logi.
- Poza zakresem: pełny pentest sieci.
...
- Model ról/zasobów
- Scenariusze misuse/abuse
- Środowisko testowe i dane
- Narzędzia testów authz
