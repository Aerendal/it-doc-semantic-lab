---
title: Log decyzji projektowych
...
Rejestrować kluczowe decyzje projektowe (ADR-lite), by zachować kontekst, alternatywy i konsekwencje.
...
1. Format wpisu: data, decyzja, kontekst, opcje, wybrana opcja, konsekwencje, właściciel.
2. Zakres: architektura, proces, narzędzia, standardy, koszty.
3. Identyfikacja i linki: ID decyzji, powiązane ticket/ADR, repozytoria, diagramy.
4. Cykl życia: proponowana → zatwierdzona → wdrożona → zdezaktualizowana.
5. Widoczność: gdzie publikowane (repo/docs), wyszukiwalność, oznaczanie tagami.
6. Przeglądy: okresowe rewizje, kryteria deprecjacji, właściciele rewizji.
...
- [ ] Każdy wpis ma kontekst, opcje, decyzję i konsekwencje.
- [ ] Decyzje mają ID i linki do ticketów/ADR/diagramów.
- [ ] Status cyklu życia i właściciel decyzji zapisane.
- [ ] Przeglądy okresowe i tagowanie zapewniają odnajdywalność.
