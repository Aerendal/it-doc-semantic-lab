...
Szkolenie personelu obsługi gości.
...
1. Standardy obsługi i tone of voice.
2. Systemy: PMS, POS, komunikacja.
3. Procesy check-in/out, reklamacje.
4. Bezpieczeństwo i dane gości.
5. Ćwiczenia scenariuszy.
6. KPI i feedback.
...
- [ ] Standardy i systemy opisane.
- [ ] Scenariusze ćwiczone.
- [ ] Dane gości/bezpieczeństwo uwzględnione.
- [ ] KPI i feedback zdefiniowane.
