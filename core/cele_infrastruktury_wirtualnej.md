---
title: Cele infrastruktury wirtualnej
...
aligned_by: codex
---
# Cele infrastruktury wirtualnej
...
Zdefiniować cele i KPI dla infrastruktury wirtualnej (hypervisor/VM): wydajność, dostępność, bezpieczeństwo i efektywność kosztowa.


## Zakres i granice

- Obejmuje: SLO/SLA dla VM, wykorzystanie zasobów, gęstość, HA/DR, czas provisioningu, bezpieczeństwo/hardening, koszt/efektywność.
- Nie obejmuje: konteneryzacji (osobny dokument) ani polityk zakupowych.
...
1. SLO/SLA (dostępność, perf: CPU ready, I/O latency).
2. Wydajność i gęstość (ceilings, overcommit policy).
3. Provisioning i automatyzacja (czas dostarczenia VM, IaC).
4. HA/DR (RTO/RPO, testy).
5. Bezpieczeństwo (patching, hardening, segmentacja).
6. Koszt i efektywność (koszt/VM, rightsizing).
...
- [ ] SLO/SLA zdefiniowane i mierzone.
- [ ] Overcommit/gęstość polityka ustalona.
- [ ] Provisioning zautomatyzowany, czas mierzony.
- [ ] HA/DR testowane.
- [ ] Hardening/patching i segmentacja wdrożone.
