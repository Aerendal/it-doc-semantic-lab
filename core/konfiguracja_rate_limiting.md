---
title: Konfiguracja Rate Limiting
...
Udokumentować konfigurację rate limiting dla API/gateway (limity, kolejki, wyjątki, alerty).


## Zakres i granice

- Obejmuje: limity global/per-client/per-route, burst/steady, kolejki, wyjątki/whitelist, retry/429, monitoring/alerty.
- Poza zakresem: implementacja backendów.
...
- Tabela wymagań rate limiting
- Profil ruchu i SLO
- Model klientów/kluczy
- Polityki biznesowe/wyjątki


## Wyjścia

- Konfiguracja limitów i kolejek
- Lista wyjątków/whitelist
- Alerting i dashboard
- Checklisty DoR/DoD
...
- [ ] Wymagania i profil ruchu zebrane
- [ ] Model klientów znany
- [ ] Wyjątki uzgodnione
