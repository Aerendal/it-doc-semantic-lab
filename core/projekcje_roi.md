...
Przygotować realistyczne projekcje ROI dla inicjatywy wraz z założeniami i ryzykami.
...
1. Zakres i horyzont czasowy: scenariusze (bazowy/ostrożny/agresywny).
2. Koszty: CAPEX/OPEX, licencje, infra, zespół, szkolenia, utrzymanie.
3. Przychody/korzyści: nowe przychody, oszczędności, unikanie kosztów, efekty pośrednie.
4. Założenia i źródła: dane wejściowe, benchmarki, referencje rynkowe.
5. Ryzyka i czułość: analiza wrażliwości, punkty krytyczne, bufory.
6. Prezentacja: tabelaryczne projekcje, NPV/IRR/Payback, warianty i rekomendacja.
...
- [ ] Założenia są udokumentowane i mają źródła.
- [ ] Scenariusze zawierają koszty i korzyści oraz analizę wrażliwości.
- [ ] Metryki finansowe (NPV/IRR/Payback) policzone dla wariantów.
- [ ] Ryzyka i punkty krytyczne mają przypisane działania mitigujące.
