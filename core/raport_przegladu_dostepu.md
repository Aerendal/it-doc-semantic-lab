---
title: Raport przeglądu dostępu
...
Udokumentować wyniki okresowego przeglądu dostępu.
...
1. Zakres: systemy, role, konta uprzywilejowane.
2. Metoda: kryteria przeglądu, SoD, wyjątki.
3. Wyniki: dostępy do usunięcia, wyjątki, potwierdzenia.
4. Czas reakcji i zgodność: SLA przeglądu, audyt.
5. Działania: odebranie dostępu, recertyfikacje, follow-up.
6. Wnioski: luki procesowe, automatyzacja.
...
- [ ] Lista dostępu została przejrzana i zatwierdzona.
- [ ] Nadmiarowe dostępy mają zadania odebrania.
- [ ] Wyjątki są uzasadnione i zarejestrowane.
- [ ] Audyt i SLA przeglądu są spełnione.
