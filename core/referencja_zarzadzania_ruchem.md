---
title: Referencja zarządzania ruchem
...
Referencyjna architektura systemów zarządzania ruchem.
...
1. Warstwy: sensory/kamery, edge, centrum sterowania, kanały informacji.
2. Modele danych: zdarzenia, odcinki, sygnalizacja, priorytety.
3. Algorytmy: sterowanie sygnalizacją, priorytety dla służb, optymalizacja.
4. Integracje: transport publiczny, nawigacje, open data.
5. Bezpieczeństwo i prywatność: CCTV, retencja, dostęp.
6. DR/BCP: awarie centrów, fallback ręczny.
...
- [ ] Warstwy i dane opisane.
- [ ] Algorytmy i priorytety zmapowane.
- [ ] Integracje i bezpieczeństwo uwzględnione.
- [ ] Plany DR/BCP istnieją.
