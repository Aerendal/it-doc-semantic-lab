...
Raportować wyniki zakładu produkcyjnego: OEE, throughput, jakość, downtime i działania poprawcze.
...
1. Zakres i okres: linie/zmiany/produkty, daty.
2. KPI: OEE (A/P/Q), throughput, scrap/rework, downtime, energy, bezpieczeństwo.
3. Analiza: Six Big Losses, Pareto strat, korelacje, przyczyny główne.
4. Akcje i status: CAPA, właściciele, terminy, postęp, skuteczność.
5. Trend i porównania: vs poprzedni okres/target, benchmarki, sezonowość.
6. Wnioski i następne kroki: priorytety, potrzeby zasobowe, plan kolejnego okresu.
...
- [ ] KPI raportowane z podziałem na linie/zmiany/produkty.
- [ ] Analiza strat i RCA dołączona; CAPA z właścicielami i terminami.
- [ ] Trendy i porównania do targetów/benchmarków pokazane.
- [ ] Wnioski i plan działań na kolejny okres wpisane.
