---
title: Reagowanie na incydenty bezpieczeństwa
...
Standardowy playbook IR dla incydentów bezpieczeństwa.
...
1. Detekcja i klasyfikacja: źródła, severity.
2. Izolacja: konta, hosty, sieć, klucze.
3. Analiza: timeline, IOC, zasięg.
4. Remediacja: patch, rotacja, usunięcie artefaktów.
5. Komunikacja: SOC, właściciele, prawo/regulator, użytkownicy.
6. Post-incident: postmortem, reguły, trening.
...
- [ ] Severity ustalone; incydent zarejestrowany.
- [ ] Izolacja wykonana; artefakty zabezpieczone.
- [ ] Zasięg i IOC ustalone; remediacja wykonana.
- [ ] Postmortem i aktualizacje reguł/szkoleń wykonane.
