---
title: Post-mortem incydentu wsparcia
...
aligned_by: codex
---
# Post-mortem incydentu wsparcia
...
Przeanalizować incydent w zespole wsparcia (CS/L2), by poprawić jakość obsługi i procesy eskalacji.
...
1. Podsumowanie: czas, wpływ na klientów/SLA/CSAT, kanały.
2. Timeline: alerty, zgłoszenia, decyzje, komunikacja.
3. Root cause: proces/narzędzia/personel; contributory factors.
4. CAPA: działania naprawcze/prewencyjne, właściciele, terminy.
5. Usprawnienia: zmiany w routing, KB, automatyzacji, szkoleniach, raportowaniu.
6. Follow-up: retest, aktualizacja runbooków/KB, informacja do klientów/agentów.
...
- [ ] Timeline fact-based, root cause ustalone.
- [ ] CAPA z właścicielami/terminami zaplanowane.
- [ ] Usprawnienia procesów/KB/automatyzacji opisane.
- [ ] Follow-up (retest, komunikacja) wykonany.
