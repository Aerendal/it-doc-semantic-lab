...
Ustalić wzorce zarządzania tożsamością i dostępem (IAM) dla systemów organizacji.
...
1. Modele kontroli: RBAC/ABAC, separacja obowiązków, zasada najmniejszych uprawnień.
2. Cykl życia tożsamości: onboarding, zmiana ról, offboarding; automatyzacja.
3. Uwierzytelnianie i MFA: polityki haseł, klucze, FIDO2, SSO.
4. Autoryzacja: role, atrybuty, delegacja, przeglądy dostępu.
5. Zarządzanie kluczami i tajemnicami: rotacja, przechowywanie, audyt.
6. Monitorowanie i zgodność: logi, alerty, raporty, testy penetracyjne.
...
- [ ] Zdefiniowano model RBAC/ABAC i separację obowiązków.
- [ ] Opisano pełny cykl życia tożsamości z automatyzacją offboardingu.
- [ ] MFA/SSO oraz polityki haseł/kluczy wdrożone i opisane.
- [ ] Regularne przeglądy dostępu i logowanie/audyt zaplanowane.
