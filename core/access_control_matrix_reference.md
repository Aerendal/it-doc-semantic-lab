---
title: Access Control Matrix Reference
...
Udokumentować macierz uprawnień (role/zasoby/akcje) jako referencję dla implementacji i audytów.


## Zakres i granice

- Obejmuje: role, zasoby, akcje, wyjątki, właścicieli, daty review.
- Poza zakresem: kod/konfiguracje usług.
...
- Mapa ról/zasobów
- Polityki i wymagania
- Lista wyjątków/waiverów
- Historia incydentów
...
- Lista wyjątków
- Plan review
- Powiązania do audytu/implementacji
