---
title: Geocoding Accuracy Testing
...
## Cel dokumentu
Geocoding Accuracy Testing definiuje strategię i zakres testów wraz z kryteriami akceptacji i raportowaniem defektów.
...
## Szybkie powiązania
- Zależność: {'depends_on': 'Map Tile Strategy', 'type': 'typical'}
- Zależność: {'depends_on': 'Map Tile Strategy', 'type': 'typical'}
