...
Wdrożenie SLA/OLA wewnątrz organizacji.
...
1. Mapa usług i zależności.
2. Definicje SLA vs OLA (warstwy).
3. Pomiar: źródła metryk, SLI.
4. Procesy: reakcja, eskalacje, raporty.
5. Zmiany i przeglądy.
...
- [ ] SLA/OLA zdefiniowane na każdym poziomie.
- [ ] Metryki/SLI zmapowane do źródeł.
- [ ] Eskalacje i raporty ustalone.
- [ ] Plan przeglądów i szkoleń istnieje.
