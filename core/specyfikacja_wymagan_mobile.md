---
title: Specyfikacja Wymagań Mobile
...
Specyfikacja wymagań aplikacji mobilnej.
...
2. Wymagania funkcjonalne per ekran/flow.
3. Niefunkcjonalne: wydajność, offline, bezpieczeństwo.
4. Platformy/urządzenia/wsparcie OS.
5. Analytica i logging.
...
- [ ] KPI i funkcje opisane.
- [ ] NFR (wydajność/offline/bezpieczeństwo) ujęte.
- [ ] Wsparcie OS/urządzeń zdefiniowane.
- [ ] Testy/akceptacja spisane.
