---
title: Reagowanie na poważne problemy
...
aligned_by: codex
---
# Reagowanie na poważne problemy
...
Koordynować reakcję na poważne problemy/major incidents.
...
1. Deklaracja Major Incident: kryteria, role (incident commander).
2. War room: komunikacja, podział zadań, timeline.
3. Stabilizacja: containment, obejścia.
4. Naprawa: ścieżki robocze, decyzje, testy.
5. Komunikacja: wewnętrzna/klient, status page, raporty.
6. Postmortem: RCA, działania, follow-up.
...
- [ ] Incident commander i kanały komunikacji ustanowione.
- [ ] Stabilizacja wykonana; przywrócono usługę lub obejście.
- [ ] RCA i działania trwałe zdefiniowane.
- [ ] Raport i follow-up zaplanowane.
