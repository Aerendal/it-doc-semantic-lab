---
title: Implementacja systemu zarzÄ…dzania
...
aligned_by: codex
---
# Implementacja systemu zarzÄ…dzania
...
Implementacja systemu zarządzania — szablon dokumentu IT.

Dokumentuje plan i przebieg implementacji konkretnego komponentu, modułu lub systemu. Zawiera: zakres implementacji, podejście techniczne, zależności od innych komponentów, plan etapów (milestones), kryteria akceptacji technicznej i plan testów.
Ten szablon jest zgodny ze standardem **IEEE 830**.

> Dokument satelitarny do: "Implementacja systemu zarządzania projektami" - rozszerza lub uszczegolawia jego tresc.
