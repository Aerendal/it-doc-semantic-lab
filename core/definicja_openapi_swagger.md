---
title: Definicja OpenAPI/Swagger
...
Przygotować i utrzymywać definicję API w OpenAPI/Swagger jako źródło prawdy dla kontraktów.
...
1. Zakres API i wersja definicji.
2. Konwencje: nazwy, status codes, error format, auth, versioning.
3. Schematy i typy (components/schemas), przykłady.
4. Parametry/paginacja/filtry, idempotencja.
5. Testy kontraktowe i walidacja (lint, CI).
6. Publikacja i dystrybucja (portal, SDK generation).
...
- [ ] Definicja kompletna i lintowana w CI.
- [ ] Schematy/components spójne, przykłady dodane.
- [ ] Auth/versioning/paginacja opisane.
- [ ] Publikacja (portal/SDK) aktualizowana z definicji.
