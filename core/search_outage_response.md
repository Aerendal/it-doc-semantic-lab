...
Search Outage Response opisuje, jak przygotować się na incydenty i jak reagować/mitygować skutki.
...
- Zależność: {'depends_on': 'Search Performance Monitoring', 'type': 'typical'}
- Zależność: {'depends_on': 'Search Operations Runbook', 'type': 'sequential'}
