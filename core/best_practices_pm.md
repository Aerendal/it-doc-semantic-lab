...
Zebrać dobre praktyki zarządzania projektami/produktami: planowanie, komunikacja, ryzyka, decyzje, mierzenie postępu, aby zespoły pracowały przewidywalnie.


## Zakres i granice

- Obejmuje: definiowanie celu/zakresu, roadmapa i priorytety, komunikacja ze stakeholderami, ryzyka i decyzje, metryki (burnup/velocity/lead time), change management, retrospektywy.
- Nie obejmuje: szczegółowych metod agile/scrum (osobne guide) ani finansów (są w analizach kosztów).
...
- Wejścia: cele biznesowe, backlog, ograniczenia, interesariusze.
- Wyjścia: plan/roadmapa, RACI/stakeholder map, ryzyka i decyzje, rytm komunikacji, metryki postępu.
...
1. Cel i zakres.
2. Roadmapa i priorytety (MVP, etapy).
3. Komunikacja i rytm (demo, status, stakeholdery).
4. Ryzyka i decyzje (rejestr, ADR/Decision log).
5. Metryki i raportowanie (burnup/velocity/lead time).
6. Zmiany i retrospektywy (co, kiedy, jak).
...
- [ ] Cel/zakres i roadmapa opisane.
- [ ] Rytm komunikacji ustalony.
- [ ] Ryzyka i decyzje zapisane.
- [ ] Metryki postępu raportowane.
- [ ] Retrospektywy i zmiany procesu prowadzone.
...
- „Zakres/roadmapa” **defines_structure** „Komunikację i metryki”.
- „Ryzyka/decyzje” **feeds** „Zmiany i retrospektywy”.
